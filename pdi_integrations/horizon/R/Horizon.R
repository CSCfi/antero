...
data5 <- subset(data5, language == 'en', select=c(X.U.FEFF.id, title, shortTitle,rcn))
data6 <- subset(data6, language == 'en', select=c(X.U.FEFF.id, code, title, call, rcn))
data7 <- subset(data7, language == 'en', select=c(code, title))
