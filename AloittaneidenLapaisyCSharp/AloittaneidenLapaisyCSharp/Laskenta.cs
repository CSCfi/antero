...
namespace AloittaneidenLapaisyCSharp
{
    public class Laskenta
    {
        ...
        public void LaskeTiivistetytRivit(string dbYhteysOsoite, bool JatkaLaskentaa)
        {
            ...
            tiivistetyt[6] = "suorv";
            tiivistetyt[7] = "suorlk";
            tiivistetyt[8] = "kmaak";
            tiivistetyt[9] = "olotamm";
            tiivistetyt[10] = "olosyys";
            tiivistetyt[11] = "ptoim1r5";
            tiivistetyt[12] = "amas";
        ...
        public Dictionary<string, string> Laske_johdetut_muuttujat(ref Dictionary<string, string> Arvot, bool Debug)
        {
            ...
            else if (koulutuslaji2 == "31" | koulutuslaji2 == "32" | koulutuslaji2 == "35" | koulutuslaji2 == "36")
            {
            ...
            else if (koulutuslaji2 == "33" | koulutuslaji2 == "34" | koulutuslaji2 == "37" | koulutuslaji2 == "38")
            {
