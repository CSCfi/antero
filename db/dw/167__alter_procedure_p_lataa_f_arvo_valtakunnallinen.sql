ALTER PROCEDURE dbo.p_lataa_f_arvo AS

TRUNCATE TABLE dbo.f_arvo

INSERT INTO dbo.f_arvo (
  d_organisaatio_id,
...
LEFT JOIN dbo.d_arvokyselykerta d7 ON d7.kyselykertaid = f.kyselykertaid
