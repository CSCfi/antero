IF NOT EXISTS (select * from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA='dbo' and TABLE_NAME='d_arvokysymys') BEGIN

CREATE TABLE dbo.d_arvokysymys(
...
;
ALTER TABLE dbo.d_arvokysymys ADD  CONSTRAINT DF__d_arvokysymys__loadtime  DEFAULT (getdate()) FOR loadtime
;
ALTER TABLE dbo.d_arvokysymys ADD  CONSTRAINT DF__d_arvokysymys__username  DEFAULT (suser_sname()) FOR username
;
END
