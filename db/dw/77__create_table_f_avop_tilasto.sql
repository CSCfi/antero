IF NOT EXISTS (select * from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA='dbo' and TABLE_NAME='f_avop_tilasto') BEGIN

CREATE TABLE dbo.f_avop_tilasto (
...
ALTER TABLE dbo.f_avop_tilasto ADD  CONSTRAINT PK__f_avop_tilasto PRIMARY KEY CLUSTERED (id ASC)
;

ALTER TABLE dbo.f_avop_tilasto ADD  CONSTRAINT DF__f_avop_tilasto__loadtime  DEFAULT (getdate()) FOR loadtime
;
ALTER TABLE dbo.f_avop_tilasto ADD  CONSTRAINT DF__f_avop_tilasto__username  DEFAULT (suser_sname()) FOR username
;
