...
if not exists (select * from dbo.d_kansainvalinen_yhteisjulkaisu where id=-1) begin
  set identity_insert dbo.d_kansainvalinen_yhteisjulkaisu on;
  insert into dbo.d_kansainvalinen_yhteisjulkaisu (
    id,
  ...
  and koodi='-1'
  ;
  set identity_insert dbo.d_kansainvalinen_yhteisjulkaisu off;
end else begin
  update d
  ...
  from dbo.d_kansainvalinen_yhteisjulkaisu d
  join ANTERO_SA.dbo.sa_koodistot s on s.koodi=d.kansainvalinen_yhteisjulkaisu_koodi
