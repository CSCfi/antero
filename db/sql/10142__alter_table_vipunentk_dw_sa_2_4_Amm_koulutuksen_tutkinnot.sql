...
/****** Object:  Table [dbo].[sa_2_4_Amm_koulutuksen_tutkinnot]    Script Date: 25.9.2024 15:09:53 ******/
SET ANSI_NULLS ON
GO
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sa_2_4_Amm_koulutuksen_tutkinnot]') AND type in (N'U')) DROP TABLE [dbo].[sa_2_4_Amm_koulutuksen_tutkinnot]
GO
