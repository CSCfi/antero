...
/****** Object:  View [dw].[v_arvo_uraseuranta]    Script Date: 5.3.2026 14.38.31 ******/
SET ANSI_NULLS ON
GO
...
,CASE WHEN f.kysymysryhma = 'VI  TYÖ JA OSAAMINEN (3/3)' 
		THEN 1.000000 / 6.000000 ELSE 1.0 END					AS rahoituskysymys_paino
...
LEFT JOIN dw.d_virta_rahoituslahde d12 on d12.id = -1
...
SELECT 
	...
	d9.rahoituslahde_nimi_fi as 'Rahoituslähde',
	d9.rahoituslahde_nimi_sv as 'Finansieringskälla',
	d9.rahoituslahde_nimi_en as 'Source of funding',
	...
	CASE	
		WHEN d1.kysymysryhma_fi in ('I  TYÖMARKKINATILANTEESI','I  TYÖMARKKINATILANNE') THEN 'I TYÖMARKKINATILANNE'
		WHEN d1.kysymysryhma_fi in ('III  TOHTORIKOULUTUS JA SEN MERKITYS (1/5)', 'III  TOHTORIKOULUTUS JA SEN MERKITYS (1/4)') THEN 'III  TOHTORIKOULUTUS JA SEN MERKITYS'
		WHEN d1.kysymysryhma_fi ='III  TOHTORIKOULUTUS JA SEN MERKITYS (2/5)' and kyselyvuosi = 2025 THEN 'III  TOHTORIKOULUTUS JA SEN MERKITYS. Kuinka tärkeitä seuraavat tiedot ja taidot ovat työssäsi'
		WHEN d1.kysymysryhma_fi ='III  TOHTORIKOULUTUS JA SEN MERKITYS (3/5)' and kyselyvuosi = 2025 THEN 'III  TOHTORIKOULUTUS JA SEN MERKITYS. Miten tohtorikoulutus kehitti kyseisiä valmiuksia?'
		WHEN d1.kysymysryhma_fi ='III  TOHTORIKOULUTUS JA SEN MERKITYS (5/5)' and kyselyvuosi = 2025 THEN 'III  TOHTORIKOULUTUS JA SEN MERKITYS. Arvioi, miten seuraavat tekijät ovat vaikuttaneet työllistymiseesi valmistumisen jälkeen?'
		WHEN d1.kysymysryhma_fi ='III  TOHTORIKOULUTUS JA SEN MERKITYS (2/4)' and kyselyvuosi = 2024 THEN 'III  TOHTORIKOULUTUS JA SEN MERKITYS. Kuinka tärkeitä seuraavat tiedot ja taidot ovat työssäsi'
		WHEN d1.kysymysryhma_fi ='III  TOHTORIKOULUTUS JA SEN MERKITYS (3/4)' and kyselyvuosi = 2024 THEN 'III  TOHTORIKOULUTUS JA SEN MERKITYS. Miten tohtorikoulutus kehitti kyseisiä valmiuksia?'
	...
	CASE 
		...
		WHEN f.kyselypohja='URASEURANTA-TOHTORI' and f.Kyselyvuosi = 2025 THEN REPLACE(d1.kysymys_fi, '2019', '2022')
		...
		WHEN f.kyselypohja='URASEURANTA-MAISTERI' and f.Kyselyvuosi = 2025 THEN REPLACE(d1.kysymys_fi, '2017', '2020')
		ELSE d1.kysymys_fi
	 END as Kysymys,
	CASE 
	...
	CASE	
		WHEN d1.kysymysryhma_fi in ('I TYÖMARKKINATILANNE','I  TYÖMARKKINATILANTEESI','I  TYÖMARKKINATILANNE') THEN 'I  ARBETSMARKNADSSITUATION'
		WHEN d1.kysymysryhma_fi in ('III  TOHTORIKOULUTUS JA SEN MERKITYS (1/5)', 'III  TOHTORIKOULUTUS JA SEN MERKITYS (1/4)') THEN 'III  DOKTORSUTBILDNINGEN OCH DESS BETYDELSE'
		WHEN d1.kysymysryhma_fi ='III  TOHTORIKOULUTUS JA SEN MERKITYS (2/5)' and kyselyvuosi = 2025 THEN 'III  DOKTORSUTBILDNINGEN OCH DESS BETYDELSE. Hur viktiga är följande kunskaper och färdigheter i ditt nuvarande arbete?'
		WHEN d1.kysymysryhma_fi ='III  TOHTORIKOULUTUS JA SEN MERKITYS (3/5)' and kyselyvuosi = 2025 THEN 'III  DOKTORSUTBILDNINGEN OCH DESS BETYDELSE. Hur mycket bidrog doktorsutbildningen till dessa färdigheter?'
		WHEN d1.kysymysryhma_fi ='III  TOHTORIKOULUTUS JA SEN MERKITYS (5/5)' and kyselyvuosi = 2025 THEN 'III  DOKTORSUTBILDNINGEN OCH DESS BETYDELSE. Bedöm hur följande faktorer har påverkat din sysselsättning efter utexamineringen.'
		WHEN d1.kysymysryhma_fi ='III  TOHTORIKOULUTUS JA SEN MERKITYS (2/4)' and kyselyvuosi = 2024 THEN 'III  DOKTORSUTBILDNINGEN OCH DESS BETYDELSE. Hur viktiga är följande kunskaper och färdigheter i ditt nuvarande arbete?'
		WHEN d1.kysymysryhma_fi ='III  TOHTORIKOULUTUS JA SEN MERKITYS (3/4)' and kyselyvuosi = 2024 THEN 'III  DOKTORSUTBILDNINGEN OCH DESS BETYDELSE. Hur mycket bidrog doktorsutbildningen till dessa färdigheter?'
	...
	CASE 
		...
		WHEN f.kyselypohja='URASEURANTA-TOHTORI' and f.Kyselyvuosi = 2025 THEN REPLACE(d1.kysymys_sv, '2019', '2022')
...
WHEN f.kyselypohja='URASEURANTA-MAISTERI' and f.Kyselyvuosi = 2025 THEN REPLACE(d1.kysymys_sv, '2017', '2020')
		ELSE d1.kysymys_sv
	END as [Fråga],
	-- CSCVIPUNEN-3471
	CASE 
	...
	CASE	
		WHEN d1.kysymysryhma_fi in ('I TYÖMARKKINATILANNE','I  TYÖMARKKINATILANTEESI','I  TYÖMARKKINATILANNE') THEN 'I  YOUR JOB MARKET SITUATION'
		WHEN d1.kysymysryhma_fi in ('III  TOHTORIKOULUTUS JA SEN MERKITYS (1/5)', 'III  TOHTORIKOULUTUS JA SEN MERKITYS (1/4)') THEN 'III  DOCTORAL EDUCATION AND ITS SIGNIFICANCE'
		WHEN d1.kysymysryhma_fi ='III  TOHTORIKOULUTUS JA SEN MERKITYS (2/5)' and kyselyvuosi = 2025 THEN 'III  DOCTORAL EDUCATION AND ITS SIGNIFICANCE. How important are the following knowledge and skills in your current job?'
		WHEN d1.kysymysryhma_fi ='III  TOHTORIKOULUTUS JA SEN MERKITYS (3/5)' and kyselyvuosi = 2025 THEN 'III  DOCTORAL EDUCATION AND ITS SIGNIFICANCE. How did your doctoral education develop these capabilities?'
		WHEN d1.kysymysryhma_fi ='III  TOHTORIKOULUTUS JA SEN MERKITYS (5/5)' and kyselyvuosi = 2025 THEN 'III  DOCTORAL EDUCATION AND ITS SIGNIFICANCE. Assess how the following factors have affected your employment after graduation.'
		WHEN d1.kysymysryhma_fi ='III  TOHTORIKOULUTUS JA SEN MERKITYS (2/4)' and kyselyvuosi = 2024 THEN 'III  DOCTORAL EDUCATION AND ITS SIGNIFICANCE. How important are the following knowledge and skills in your current job?'
		WHEN d1.kysymysryhma_fi ='III  TOHTORIKOULUTUS JA SEN MERKITYS (3/4)' and kyselyvuosi = 2024 THEN 'III  DOCTORAL EDUCATION AND ITS SIGNIFICANCE. How did your doctoral education develop these capabilities?'
	...
	CASE 
		...
		WHEN f.kyselypohja='URASEURANTA-TOHTORI' and f.Kyselyvuosi = 2025 THEN REPLACE(d1.kysymys_en, '2019', '2022')
		...
		WHEN f.kyselypohja='URASEURANTA-MAISTERI' and f.Kyselyvuosi = 2025 THEN REPLACE(d1.kysymys_en, '2017', '2020')
		ELSE d1.kysymys_en
	END as [Question],
	-- CSCVIPUNEN-3471
	CASE 
	...
	CASE 
		...
		ELSE 1 -- Muutetaan manuaalisesti sen jälkeen kun on saatu julkaisulupa
	...
	CASE 
		...
		WHEN d1.kysymysryhma_fi in ('III  TOHTORIKOULUTUS JA SEN MERKITYS (4/5)') THEN 6
	...
	CASE 
		...
		ELSE NULL
	END as 'jarjestys_kysymys_rahoitusmalli',
	d9.jarjestys_rahoituslahde_koodi as jarjestys_rahoituslahde
...
LEFT JOIN ANTERO.dw.d_virta_rahoituslahde d9 on d9.id = f.d_virta_rahoituslahde_id