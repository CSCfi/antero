...
/****** Object:  View [dbo].[v_f_korkeakoulujen_tutkimus_kehitys_5_2_tyovuodet]    Script Date: 12.12.2017 17:07:32 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN VipunenTK.dbo.d_koulutusluokitus d_tt ON d_tt.Koulutusaste_taso2_koodi=(SELECT TOP 1 Koulutusaste_taso2_koodi FROM VipunenTK.dbo.d_koulutusluokitus WHERE Koulutusaste_taso2_koodi=f.tutkintotaso_avain)
