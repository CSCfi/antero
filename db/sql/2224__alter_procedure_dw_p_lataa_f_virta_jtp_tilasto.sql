...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_jtp_tilasto]    Script Date: 6.5.2019 15:06:32 ******/
SET ANSI_NULLS ON
GO
...
INSERT INTO dw.f_virta_jtp_tilasto (
  ...
  d_tieteenala_id,
  d_taiteenala_id,
  d_taidealantyyppikategoria_id,    -- added 2019-05-04
  lkm,                              -- added 2019-05-04
  d_ohjauksenala_id,
  d_koulutusala95_id,
  d_koulutusala02_id,
...
SELECT
  ...
  coalesce(d21.taidealanTyyppiKategoria,-1) AS d_taidealantyyppikategoria_id,     -- added 2019-05-04
  coalesce(d21.lkm,1) AS lkm,                                       -- added 2019-05-04
...
left join sa.sa_virta_jtp_taidealantyyppikategoria d21 on d21.julkaisunTunnus = f.julkaisunTunnus    -- added 2019-05-04
...
SELECT
  ...
  -1 as d_taidealantyyppikategoria_id,   -- added 2019-05-04
  1 as lkm,                              -- added 2019-05-04
