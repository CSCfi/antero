...
/****** Object:  View [dw].[v_virta_otp_55_tilasto]    Script Date: 18.9.2026 14.05.28 ******/
SET ANSI_NULLS ON
GO
...
select 
	  ...
	  ,[Henkilo_koodi] = HASHBYTES('SHA2_256', vs.salt + f.henkilokoodi)
...
INNER JOIN ANTERO.dbo.view_salt vs on vs.[view] = 'v_virta_otp_55_tilasto'