...
/****** Object:  StoredProcedure [dw].[p_lataa_d_tutkintonimike]    Script Date: 18.10.2023 7:58:13 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dw].[p_lataa_d_tutkintonimike] AS
...
USING (
	...
	WHERE koodisto = 'tutkintonimikkeet'
) AS src
