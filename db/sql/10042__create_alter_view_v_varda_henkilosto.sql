...
/****** Object:  View [dw].[v_varda_henkilosto]    Script Date: 19.8.2024 12:43:33 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER   VIEW [dw].[v_varda_henkilosto] AS
	...
	-- organisaatiomuuttujat
		...
		CASE WHEN tm.kuvaus_en is null THEN 'Information is missing' ELSE tm.kuvaus_en END as toimintamuoto_en,
...
--tilapäinen rajaus, poista myöhemmin	
	WHERE hl.tilastovuosi between 2022 and 2023
