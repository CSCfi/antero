...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_55_kuluva_lukuvuosi]    Script Date: 18.8.2026 12.17.19 ******/
SET ANSI_NULLS ON
GO
...
SELECT  
	...
	coalesce(d11.id,-1) as d_tk_koulutustyyppi_id,
	getdate() as loadtime,
...
LEFT JOIN VipunenTK.dbo.d_koulutustyyppi d11 on d11.koulutustyyppi_koodi = f.koulutustyyppi
