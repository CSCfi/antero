...
/****** Object:  View [dbo].[v_sa_5_4_Ammattikorkeakoulujen_tutkimus_ja_kehitys]    Script Date: 30.3.2026 12.37.37 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
	  ...
	  ,[luontipvm]
	  ,tieteenalakoodisto='TA10'
      ,[tietolahde]='TK_5_4_sopv_20_amk'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY TK_Koodi)
FROM [TK_H9098_CSC].[dbo].[TK_K5_4_sopv_20_amk]
...
SELECT [tilv]
	  ...
	  ,[luontipvm]
	  ,tieteenalakoodisto='TA10'
      ,[tietolahde]='TK_5_4_sopv_21_amk'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY TK_Koodi)
FROM [TK_H9098_CSC].[dbo].[TK_K5_4_sopv_21_amk]
...
SELECT [tilv]
	  ...
	  ,[luontipvm]
	  ,tieteenalakoodisto='TA10'
      ,[tietolahde]='TK_5_4_sopv_22_amk'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY TK_Koodi)
FROM [TK_H9098_CSC].[dbo].[TK_K5_4_sopv_22_amk]
...
SELECT [tilv]
	  ...
	  ,[luontipvm]
	  ,tieteenalakoodisto='TA10'
      ,[tietolahde]='TK_5_4_sopv_23_amk'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY TK_Koodi)
FROM [TK_H9098_CSC].[dbo].[TK_K5_4_sopv_23_amk]
...
SELECT [tilv]
	  ...
	  ,[luontipvm]
	  ,tieteenalakoodisto='TA10'
      ,[tietolahde]='TK_5_4_sopv_24_amk'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY TK_Koodi)
FROM [TK_H9098_CSC].[dbo].[TK_K5_4_sopv_24_amk]
...
SELECT [tilv]
	  ...
	  ,[luontipvm]
	  ,tieteenalakoodisto='TA10'
      ,[tietolahde]='TK_5_4_sopv_25_amk'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY TK_Koodi)
FROM [TK_H9098_CSC].[dbo].[TK_K5_4_sopv_25_amk]
