...
IF NOT EXISTS (
  ...
  where TABLE_SCHEMA='sa' and TABLE_NAME='sa_valos_2015'
)
CREATE TABLE sa.sa_valos_2015(
...
EXEC dbo.sp_executesql @statement = N'create view dw.v_valos_koulutuksenkustannukset as select 1 as a'
GO
