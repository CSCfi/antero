...
/****** Object:  View [dbo].[v_f_tab_otv_korkeakoulut_amk]    Script Date: 2.12.2020 9:02:33 ******/
SET ANSI_NULLS ON
GO
...
--
,case 
	when f.oppilaitos in ('02470','02609','10126') then 'LAB-ammattikorkeakoulu' 
	when coalesce(d9.oppilaitoksen_korvaavakoodi,d9.oppilaitoskoodi) = '10118' then 'Kaakkois-Suomen ammattikorkeakoulu' 
	else d9.oppilaitos 
end as Ammattikorkeakoulu
...
--
,case 
	when f.oppilaitos in ('02470','02609','10126') then 'LAB University of Applied Sciences' 
	when coalesce(d9.oppilaitoksen_korvaavakoodi,d9.oppilaitoskoodi) = '10118' then 'South-Eastern Finland University of Applied Sciences' 
...
SELECT [tilastointivuosi] as Tilastovuosi
  ...
  FROM [dbo].[f_OTV_4_9_Vaestorakenne_kunnittain]
	...
	LEFT JOIN [dbo].d_valtio_historia d40 ON d40.id = f.maanosa_id
	LEFT JOIN [dbo].d_valtio_historia d41 ON d41.id = f.eumaa_id
	LEFT JOIN [dbo].d_valtio_historia d42 ON d42.id = f.etamaa_id
