...
/****** Object:  View [dbo].[v_f_vaeston_koulutusrakenne_ja_paaasiallinen_toiminta]    Script Date: 5.9.2025 15.50.37 ******/
SET ANSI_NULLS ON
GO
...
,d24a.kylla_ei as "Tutkinto sama kuin viim. aloitettu (viim. aloitettu kk-koulutus)"
,d24b.kylla_ei as "Tutkinto sama kuin viim. aloitettu (viim. aloitettu II-aste koulutus)"
...
,d24a.kylla_ei_SV as "Samma examen som den som senast inletts (senast inledda högre utbildning)"
,d24b.kylla_ei_SV as "Samma examen som den som senast inletts (senast inledda annan utbildning)"
...
,d24a.kylla_ei_EN as "Qualification same as latest started (latest started higher education)"
,d24b.kylla_ei_EN as "Qualification same as latest started (latest started secondary education)"
...
LEFT JOIN d_kylla_ei d24a on d24a.id = f.d_kylla_ei_koulutusluokitus_korkein_viimeisin_aloitettu_sama_ka_id
LEFT JOIN d_kylla_ei d24b on d24b.id = f.d_kylla_ei_koulutusluokitus_korkein_viimeisin_aloitettu_sama_ta_id
