...
/****** Object:  View [dw].[v_virta_otp_sosiaali_ja_terveysalan_patevyydet]    Script Date: 20.9.2024 7:51:49 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER VIEW  [dw].[v_virta_otp_sosiaali_ja_terveysalan_patevyydet] AS
