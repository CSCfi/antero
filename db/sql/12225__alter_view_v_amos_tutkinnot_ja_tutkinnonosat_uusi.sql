...
/****** Object:  View [dw].[v_amos_tutkinnot_ja_tutkinnonosat_uusi]    Script Date: 25.9.2026 17.24.21 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	...
	,[Vaativa erityinen tuki] =
		case 
			when d3.erityisopetus_koodi in ('4','5','6') then 'Tutkintokoulutus'
			--when d3.erityisopetus_koodi in ('7','8','9') and d2.koulutusluokitus_koodi in ('999901','999908') then 'TUVA/VALMA'
			--when d3.erityisopetus_koodi in ('7','8','9') and d2.koulutusluokitus_koodi = '999903' then 'TELMA'
	...
	,[Koodit Toimipiste (OID)] = d1c.organisaatio_oid
...
LEFT JOIN dw.d_amos_spl_jarjestaja_linkki d27 ON d27.id = f.d_amos_spl_jarjestaja_linkki_id -- CSCVIPUNEN-3358: Taustatiedot uusimman varainhoitovuoden järjestäjärakenteen mukaan. JK
...
WHERE 1=1
AND painottamaton_osaamispisteet + painottamaton_tutkinnot + painottamaton_osatutkinnot > 0.0