...
/****** Object:  View [dw].[v_amos_spl_vaikuttavuus]    Script Date: 21.6.2023 12:44:59 ******/
SET ANSI_NULLS ON
GO
...
SELECT
	...
	,[Koulutuksen aloitusvuosi] = case when [Tutkinnon aloitusvuosi] > [Tutkinnon suoritusvuosi] then 'Tieto puuttuu' else [Tutkinnon aloitusvuosi] end
	,[Koulutuksen aloituslukukausi] = [Tutkinnon aloituslukukausi]
	,[Tilastovuosi]

	-- HENKILÖMUUTTUJAT
	,[Ikä tutkinnon suoritusvuonna]
	,[Ikä tilastovuonna]
	...
	,[ytunnus_amos_spl] AS [Koodit Koulutuksen järjestäjä]
	...
	,[v lkm]
FROM [dw].[f_amos_spl_vaikuttavuus]
