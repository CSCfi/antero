...
/****** Object:  StoredProcedure [dw].[p_lataa_api_suorittanut55_esilataus]    Script Date: 25.8.2026 12.01.55 ******/
SET ANSI_NULLS ON
GO
...
SELECT
  ...
  LEFT JOIN VipunenTK.dbo.d_koulutustyyppi d3 on d3.id = f.d_tk_koulutustyyppi_id
  GROUP BY
