...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dw].[api_amm_rahoitus_palautteet]') AND type in (N'U'))
DROP TABLE [dw].[api_amm_rahoitus_palautteet]
GO
...
CREATE TABLE [dw].[api_amm_rahoitus_palautteet](
	...
	[painotetut_pisteet_lkm] [decimal](38, 17) NULL,
