...
/****** Object:  StoredProcedure [dbo].[p_lataa_f_vastaavuusavain]    Script Date: 16.9.2024 16:30:29 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	...
	WHERE d15.ammatillisen_koulutuksen_koulutuslaji = 'ammatillinen perustutkinto' and f.tilastointivuosi >= 2017 and 
