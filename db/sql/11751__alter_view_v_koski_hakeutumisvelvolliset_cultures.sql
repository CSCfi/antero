...
/****** Object:  View [dw].[v_ovara_koski_hakeutumisvelvolliset_cultures]    Script Date: 5.2.2026 8.22.26 ******/
SET ANSI_NULLS ON
GO
...
FROM (
	...
	SELECT  --DISTINCT
		...
		,[valittu_1_0] = ht.valittu
		,[vastaanottanut_1_0] = ht.vastaanottanut_paikan
		,[ilmoittautunut_1_0] = ht.ilmoittautunut
		...
		*/
		...
		,hakutoiveen_tila_fi = 
			CASE 
				WHEN ht.ilmoittautunut = 1 THEN 'Ilmoittautunut'
				WHEN ht.vastaanottanut_paikan = 1 THEN 'Vastaanottanut'
				WHEN ht.valittu = 1 THEN 'Valittu'
		...
		,hakutoiveen_tila_sv = 
			CASE 
				WHEN ht.ilmoittautunut = 1 THEN 'Inskriven'
				WHEN ht.vastaanottanut_paikan = 1 THEN 'Mottagit plats'
				WHEN ht.valittu = 1 THEN 'Antagen'
		...
		,jarjestys_hakutoiveen_tila = 
			CASE 
				WHEN ht.ilmoittautunut = 1 THEN 1
				WHEN ht.vastaanottanut_paikan = 1 THEN 2
				WHEN ht.valittu = 1 THEN 3
