...
SELECT DISTINCT
	...
	--tulevaa varainhoitovuotta koskevat suoritteet
	,[painotetut_opv_lahtotaso_hyv_ka] = cast(null as decimal(20,10))
	,[painotetut_opv_kr_hyv_ka] = cast(null as decimal(20,10))
	,[painotetut_tutk_ja_osp_hyv_ka] = cast(null as decimal(20,10))
	,[tyoll_ja_jatkoopisk_ei_tyoll_ennen_koul_ka] = cast(null as decimal(20,10))
	,[tyopaikkakysely_pisteet] = cast(null as decimal(20,10))
	,[tyopaikkaohjaajakysely_painotetut_pisteet] = cast(null as decimal(20,10))
	,[aloituskysely_painotetut_pisteet] = cast(null as decimal(20,10))
	,[paattokysely_painotetut_pisteet] = cast(null as decimal(20,10))
