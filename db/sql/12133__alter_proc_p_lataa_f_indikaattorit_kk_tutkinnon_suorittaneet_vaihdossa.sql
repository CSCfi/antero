...
/****** Object:  StoredProcedure [dw].[p_lataa_f_indikaattorit_kk_tutkinnon_suorittaneet_vaihdossa]    Script Date: 12.8.2026 12.29.10 ******/
SET ANSI_NULLS ON
GO
...
USING (
	...
	FROM (
		...
		and d1.organisaatio_koodi not in ('02557', '02633','10031')
	...
	OUTER APPLY (
		...
		and d1b.organisaatio_koodi not in ('02557', '02633','10031')
