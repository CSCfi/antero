...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_ainekelpoisuudet_jaadytys]    Script Date: 11.1.2023 14:11:07 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	' FROM (' +
		...
		' LEFT JOIN ANTERO.dw.d_virta_patevyydet d on d.patevyys_koodi = pat.patevyyskoodi' +
		' INNER JOIN ANTERO.sa.sa_virta_otp_ope_patevyydet_2021 pat2 on pat.henkilo = pat2.henkilo and pat2.patevyyskoodi in (' + '''' + 'ik' + '''' + ', ' + '''' + 'il' + '''' + ', ' + '''' + 'im' + '''' + ',' + '''' + 'ja' + '''' + ',' + '''' + 'jb' + '''' + ',' + '''' + 'jc' + '''' + ', ' + '''' + 'ir' + '''' + ', ' + '''' + 'jd' + '''' + ', ' + '''' + 'oa' + '''' + ', ' + '''' + 'ix' + '''' + ')' +
