...
/****** Object:  View [dw].[v_koski_amm_opiskelijat_ja_tutkinnot_cultures_TK_1_22_sopv_24_amm]    Script Date: 10.5.2024 18:13:32 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER VIEW [dw].[v_koski_amm_opiskelijat_ja_tutkinnot_cultures_TK_1_22_sopv_24_amm] AS

SELECT --top 1000
	f.uusi
	,f.samanaikainen_tuva
...
FROM dw.f_koski_amm_opiskelijat_TK_1_22_sopv_24_amm f
