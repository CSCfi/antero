...
/****** Object:  View [dbo].[v_sa_R4_17_Elakkeelle_siirt_ja_heidan_ammatti]    Script Date: 1.12.2022 9:16:47 ******/
SET ANSI_NULLS ON
GO
...
--      ,[amm2001_m2x]
      ...
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
      ,'1' AS tietojen_ajankohta
FROM [TK_H9098_CSC].[dbo].[TK_K4_17a_sopv_21]
...
--    ,[amm2001_m2x]
      ...
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
      ,'1' AS tietojen_ajankohta
FROM [TK_H9098_CSC].[dbo].[TK_K4_17b_sopv_21]
...
--      ,[amm2001_m2x]
      ...
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
      ,'1' AS tietojen_ajankohta
FROM [TK_H9098_CSC].[dbo].[TK_K4_17a_sopv_22]
...
--    ,[amm2001_m2x]
      ...
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
      ,'1' AS tietojen_ajankohta
FROM [TK_H9098_CSC].[dbo].[TK_K4_17b_sopv_22]
