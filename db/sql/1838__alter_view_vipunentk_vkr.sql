...
/****** Object:  View [dbo].[v_f_vaeston_koulutusrakenne_ja_paaasiallinen_toiminta]    Script Date: 12.9.2018 17:16:48 ******/
SET ANSI_NULLS ON
GO
...
FROM dbo.f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta F
	  ...
	  LEFT JOIN d_paaasiallinen_toiminta_versio2 d14 on d14.paaasiallinen_toiminta_versio2_koodi = paaasiallinen_toiminta_versio6
