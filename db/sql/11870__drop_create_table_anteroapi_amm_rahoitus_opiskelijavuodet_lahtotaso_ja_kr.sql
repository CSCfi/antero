...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[api].[amm_rahoitus_opiskelijavuodet_lahtotaso_ja_kr]') AND type in (N'U'))
DROP TABLE [api].[amm_rahoitus_opiskelijavuodet_lahtotaso_ja_kr]
GO
