...
/****** Object:  View [dbo].[v_sa_2_3efg_Lukio_ja_amm_koulutuksen_opiskelijat]    Script Date: 5.6.2026 15.22.54 ******/
SET ANSI_NULLS ON
GO
...
SELECT
      ...
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY f.tilv)
FROM [TK_H9098_CSC].[dbo].[TK_K2_4h_sopv_26] f
LEFT JOIN TK_H9098_CSC.dbo.TK_6_7_sopv_26 d on d.kunta = tilvaskun --päivitä vuosi kaikkiin: tietolahde, f, d
