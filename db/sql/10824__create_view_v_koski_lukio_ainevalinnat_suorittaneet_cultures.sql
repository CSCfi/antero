...
CREATE OR ALTER VIEW [dw].[v_koski_lukio_ainevalinnat_suorittaneet_cultures] AS

--Huom. jos lisätään oppiaine-/kurssimuuttujia, nämä huomioitava lukion oppimäärän suorittaneiden mittarin all-ehdoissa
