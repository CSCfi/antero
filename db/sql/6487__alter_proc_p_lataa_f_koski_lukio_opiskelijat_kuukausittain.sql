USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_lukio_opiskelijat_kuukausittain]    Script Date: 21.9.2022 16:39:10 ******/
SET ANSI_NULLS ON
GO
...
WHERE (
	ps.suorituksen_tyyppi IN ('ibtutkinto', 'preiboppimaara', 'lukionoppiaineenoppimaara', 'lukionoppimaara', 'diatutkintovaihe', 'luva', 'diavalmistavavaihe', 'internationalschooldiplomavuosiluokka')
	OR tuva_jarjestamislupa = 'lukio'
	OR (ps.suorituksen_tyyppi = 'internationalschoolmypvuosiluokka' AND ps.koulutusmoduuli_koodiarvo IN ('10', '11', '12'))
)
AND oo.sisaltyy_opiskeluoikeuteen_oid IS NULL
