...
/****** Object:  Table [api].[korkeakoulutus_kv_liikkuvuus]    Script Date: 22.3.2024 12:31:22 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[api].[korkeakoulutus_kv_liikkuvuus]') AND type in (N'U'))
DROP TABLE [api].[korkeakoulutus_kv_liikkuvuus]
GO
...
CREATE TABLE [api].[korkeakoulutus_kv_liikkuvuus](
	...
	[tietojoukkoPaivitettyPvm] [date] NOT NULL,
