...
GO
ALTER TABLE [dbo].[rahoituslahde_amm] DROP CONSTRAINT IF EXISTS [DF__rahoituslahde_amm__tietolahde]
GO
ALTER TABLE [dbo].[rahoituslahde_amm] DROP CONSTRAINT IF EXISTS [DF__rahoituslahde_amm__paattyy]
GO
ALTER TABLE [dbo].[rahoituslahde_amm] DROP CONSTRAINT IF EXISTS [DF__rahoituslahde_amm__alkaa]
GO
/****** Object:  Table [dbo].[rahoituslahde_amm]    Script Date: 22.12.2020 20:07:04 ******/
...
GO
INSERT [dbo].[rahoituslahde_amm] ([id], [luotu], [alkaa], [paattyy], [rahoituslahde_amm_koodi], [rahoituslahde_amm], [rahoituslahde_amm_SV], [rahoituslahde_amm_EN], [jarjestys], [virhetilanne], [poistettu], [tietolahde], [kommentti]) VALUES (11, CAST(N'2020-12-22' AS Date), CAST(N'1900-01-01' AS Date), CAST(N'9999-01-01' AS Date), N'11', N'Ammatillisen osaamisen pilotit 2019', N'Piloter inom yrkeskompetens 2019', N'Ammatillisen osaamisen pilotit 2019', N'1110', N'E', N' ', N'Manuaalinen', N'CSC Juha')
GO
INSERT [dbo].[rahoituslahde_amm] ([id], [luotu], [alkaa], [paattyy], [rahoituslahde_amm_koodi], [rahoituslahde_amm], [rahoituslahde_amm_SV], [rahoituslahde_amm_EN], [jarjestys], [virhetilanne], [poistettu], [tietolahde], [kommentti]) VALUES (12, CAST(N'2020-12-22' AS Date), CAST(N'1900-01-01' AS Date), CAST(N'9999-01-01' AS Date), N'12', N'Ammatillisen osaamisen pilotit 2019 (työvoimakoulutus)', N'Piloter inom yrkeskompetens 2019 (arbetskraftsutbildning)', N'Ammatillisen osaamisen pilotit 2019 (työvoimakoulutus)', N'1120', N'E', N' ', N'Manuaalinen', N'CSC Juha')
GO
