USE [VipunenTK_DW]
GO
/****** Object:  StoredProcedure [dbo].[p_lataa_f_koulutukseen_sijoittuneet_6v]    Script Date: 29.3.2018 10:25:02 ******/
SET ANSI_NULLS ON
GO
...
SELECT
	  ...
	  ,opisk_amm_kyllaei_id = coalesce(d30.id,-1)
...
LEFT JOIN VipunenTK..d_kylla_ei AS d30 ON d30.kylla_ei_koodi = f.opisk_amm
