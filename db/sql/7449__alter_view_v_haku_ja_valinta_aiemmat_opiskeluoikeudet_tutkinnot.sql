...
/****** Object:  View [dw].[v_haku_ja_valinta_aiemmat_opiskeluoikeudet_tutkinnot]    Script Date: 7.3.2023 13:48:43 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	...
	,[Ensikertaisena kohdeltava hakija] =	
		case 
			when f.op_oikeus_tai_tutkinto=1 then 'Ei ensikertainen hakija' 
	...
	/* Järjestys-kentät */
	,d90.jarjestys as 'Valintatapajonon tyyppi järjestys'
...
LEFT JOIN dw.d_organisaatioluokitus d33a ON d33a.id=f.d_aloitussykli_1_hakukohde_id
LEFT JOIN dw.d_tutkinnon_aloitussykli_kk d33b ON d33b.id=f.d_organisaatioluokitus_1_hakukohde_id
--2
...
LEFT JOIN dw.d_organisaatioluokitus d35a ON d35a.id=f.d_aloitussykli_2_hakukohde_id
LEFT JOIN dw.d_tutkinnon_aloitussykli_kk d35b ON d35b.id=f.d_organisaatioluokitus_2_hakukohde_id
--3
...
LEFT JOIN dw.d_organisaatioluokitus d37a ON d37a.id=f.d_aloitussykli_3_hakukohde_id
LEFT JOIN dw.d_tutkinnon_aloitussykli_kk d37b ON d37b.id=f.d_organisaatioluokitus_3_hakukohde_id
--4
...
LEFT JOIN dw.d_organisaatioluokitus d39a ON d39a.id=f.d_aloitussykli_4_hakukohde_id
LEFT JOIN dw.d_tutkinnon_aloitussykli_kk d39b ON d39b.id=f.d_organisaatioluokitus_4_hakukohde_id
--5
...
LEFT JOIN dw.d_organisaatioluokitus d41a ON d41a.id=f.d_aloitussykli_5_hakukohde_id
LEFT JOIN dw.d_tutkinnon_aloitussykli_kk d41b ON d41b.id=f.d_organisaatioluokitus_5_hakukohde_id
--6
...
LEFT JOIN dw.d_organisaatioluokitus d43a ON d43a.id=f.d_aloitussykli_6_hakukohde_id
LEFT JOIN dw.d_tutkinnon_aloitussykli_kk d43b ON d43b.id=f.d_organisaatioluokitus_6_hakukohde_id
...
LEFT JOIN dw.f_haku_ja_valinta_korkea_aste_valintatapajonot f3 on f3.haku_oid = f.henkilo_oid and f3.d_hakukohde_id = f.d_hakukohde_id
