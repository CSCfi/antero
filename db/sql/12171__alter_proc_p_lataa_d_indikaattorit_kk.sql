...
/****** Object:  StoredProcedure [dw].[p_lataa_d_indikaattorit_kk]    Script Date: 3.9.2026 13.52.01 ******/
SET ANSI_NULLS ON
GO
...
('kv_yj', 'Kansainväliset yhteisjulkaisut', 'Tutkimusindikaattorit', 37, 2, 'osuus', 'ETL: p_lataa_d_indikaattorit_kk'),
('avoimet_julk', 'Avoimet julkaisut', 'Tutkimusindikaattorit', 38, 2, 'osuus', 'ETL: p_lataa_d_indikaattorit_kk'),
('yj_yritykset', 'Yhteisjulkaisut yritysten kanssa', 'Tutkimusindikaattorit', 39, 2, 'osuus', 'ETL: p_lataa_d_indikaattorit_kk'),
('tutkimusmenot_liikevaihto', 'Tutkimusmenot suhteessa liikevaihtoon', 'Tutkimusindikaattorit', 40, 2, 'osuus', 'ETL: p_lataa_d_indikaattorit_kk'), 
('koti_ulkom_yritykset_tk', 'Kotimaisten ja ulkomaisten yritysten tk-rahoitus', 'Tutkimusindikaattorit', 41, 2, 'luku', 'ETL: p_lataa_d_indikaattorit_kk'), 
('ulkop_rahoitus_opetus_tutkimus_htv', 'Ulkopuolinen tutkimusrahoitus per opetus- ja tutkimushenkilöstön htv', 'Tutkimusindikaattorit', 42, 2, 'luku', 'ETL: p_lataa_d_indikaattorit_kk'), 
('erc_rahoitus', 'ERC-rahoitukset', 'Tutkimusindikaattorit', 43, 2, 'luku', 'ETL: p_lataa_d_indikaattorit_kk'),
('top10', 'Top-10 indikaattori (WoS)', 'Tutkimusindikaattorit', 44, 2, 'suhde', 'ETL: p_lataa_d_indikaattorit_kk'),
('rakennerah', 'Rakennerahastojen osuus täydentävästä rahoituksesta', 'Tutkimusindikaattorit', 45, 2, 'osuus', 'ETL: p_lataa_d_indikaattorit_kk'),
('ulkop_tk_rahoitus', 'Ulkopuolisen tk-rahoituksen määrä (miljoonaa euroa)', 'Tutkimusindikaattorit', 46, 2, 'luku', 'ETL: p_lataa_d_indikaattorit_kk')