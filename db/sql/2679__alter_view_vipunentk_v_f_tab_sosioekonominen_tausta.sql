...
/****** Object:  View [dbo].[v_f_tab_sosioekonominen_tausta]    Script Date: 5.12.2019 16:27:16 ******/
SET ANSI_NULLS ON
GO
...
,[Sosioekonominen tausta 0-6] =
	Case when d2.koulutusaste2002_koodi in ('71', '72', '73', '81', '82') then 1 else 0 end
	+ Case when d3.koulutusaste2002_koodi in ('71', '72', '73', '81', '82') then 1 else 0 end
