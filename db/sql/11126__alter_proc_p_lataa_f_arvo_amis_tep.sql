...
/****** Object:  StoredProcedure [dw].[p_lataa_f_arvo_amis_tep]    Script Date: 1.9.2025 20.11.24 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN Arvo_SA.sa.sa_arvo_kyselykerrat kk ON kk.kyselyid = k_tpk.kyselyid
LEFT JOIN (
	SELECT DISTINCT
	...
	LEFT JOIN Arvo_SA.sa.sa_arvo_kyselykerrat kk ON kk.kyselyid = k_tpok.kyselyid
...
FROM (
	...
	LEFT JOIN Arvo_SA.sa.sa_arvo_kyselykerrat f5 on f5.kyselyid = f2.kyselyid
