...
ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__tutkinnon_suoritusvuosi__d_kausi]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__tutkinnon_suorituskuukausi__d_kausi]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__syntymavuosi__d_kausi]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__syntymakuukausi__d_kausi]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__oppisopimuskoulutuksen_jarjestaja__d_oppilaitoksen_taustatiedot_historia]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__oppisopimuskoulutuksen_jarjestaja__d_oppilaitoksen_taustatiedot]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__oppilaitos_kunta__d_alueluokitus_historia]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__oppilaitos_kunta__d_alueluokitus]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__oppilaitos__d_oppilaitoksen_taustatiedot_historia]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__oppilaitos__d_oppilaitoksen_taustatiedot]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__koulutusluokitus__d_koulutusluokitus_historia]
GO
...
ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__koulutuksen_jarjestaja_kunta__d_alueluokitus_historia]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__koulutuksen_jarjestaja_kunta__d_alueluokitus]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__koulutuksen_jarjestaja__d_oppilaitoksen_taustatiedot_historia]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__koulutuksen_jarjestaja__d_oppilaitoksen_taustatiedot]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__kirjoihintulovuosi__d_kausi]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__kirjoihintulokausi__d_kausi]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__ika_1v_d_ika]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__d_tutkinnon_toteuma]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__d_sukupuoli]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__d_opetussuunnitelmaperusteinen_koulutus_nayttotutkintoon_valmistava_koulutus]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__d_opetushallinnon_koulutus]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__d_nuorten_aikuisten_koulutus]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__d_lahde]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__d_koulutussektori]
GO
...
ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__d_ammatillinen_peruskoulutus_lisakoulutus]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__d_aineisto_OTV]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__d_aineisto]
GO

ALTER TABLE [dbo].[f_OTV_3_15_Lukio_ja_ammatillisen_koulutuksen_tutkintojen_mediaani_iat] DROP CONSTRAINT IF EXISTS [FK__3_15__d_aidinkieli_versio1]
GO
