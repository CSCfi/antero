...
/****** Object:  Table [dbo].[f_TUVA_osallistuneet_ja_suorittaneet_2_24]    Script Date: 18.9.2024 15:33:06 ******/
SET ANSI_NULLS ON
GO
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[f_TUVA_osallistuneet_ja_suorittaneet_2_24]') AND type in (N'U'))
BEGIN
