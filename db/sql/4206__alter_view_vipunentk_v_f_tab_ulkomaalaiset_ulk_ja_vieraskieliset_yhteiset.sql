...
/****** Object:  View [dbo].[v_f_tab_ulkomaalaiset_ulk_ja_vieraskieliset_yhteiset]    Script Date: 31.12.2020 13:58:43 ******/
SET ANSI_NULLS ON
GO
...
AND NOT (erikoislaakarikoulutus_id NOT IN (1, 2) AND d21.koulutusala2002_koodi = 9 AND d19.koulutussektori_koodi IN ('4', '5'))     -- rajataan muu koulutus pois kk-puolelta
