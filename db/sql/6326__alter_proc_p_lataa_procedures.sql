...
/****** Object:  StoredProcedure [dw].[p_lataa_procedures]    Script Date: 29.7.2022 12:58:27 ******/
SET ANSI_NULLS ON
GO
...
declare databases_ cursor for SELECT DISTINCT name FROM sys.databases WHERE name not in ('master', 'tempdb', 'model', 'msdb', 'testi', 'Suorat', 'SSISDB', 'AdminDB', 'Olli_Bibliometriikka')
