...
/****** Object:  View [dbo].[v_sa_2_4efg_Lukio_ja_amm_koulutuksen_tutkinnot]    Script Date: 5.9.2022 20:43:23 ******/
SET ANSI_NULLS ON
GO
...
SELECT
      ...
      ,koso = null
	  ,opso = null
	  ,[ika2] = null --HUOM! Tarkista aineiston saapuessa; ainakin sopv21 vielä mukana.
      ,[lkm]
      ,[aikoul]
      ,[tutalv] = NULL
      ,[tutklaja] = NULL
...
left join VipunenTK.dbo.d_oppilaitoksen_taustatiedot d on d.oppilaitos_avain = coalesce(nullif(coalesce(nullif(jarj, '-1'), opjarj), '-1'), '-1')
