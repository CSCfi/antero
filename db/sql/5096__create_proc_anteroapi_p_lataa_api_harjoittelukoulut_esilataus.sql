...
DROP PROCEDURE IF EXISTS [dw].[p_lataa_api_harjoittelukoulut_esilataus]
GO
...
CREATE PROCEDURE [dw].[p_lataa_api_harjoittelukoulut_esilataus] AS
...
SELECT 
	  ...
	  ,f.Henkilöstöryhmä as henkilostoryhma
	  ...
	  ,f.[Koodit Henkilöstöryhmä] as koodit_henkilostoryhma
FROM (
	SELECT
		 [Tilastovuosi] = vuosi
