...
/****** Object:  View [dw].[v_arvo_avop]    Script Date: 15.10.2019 15:48:28 ******/
SET ANSI_NULLS ON
GO
...
, case 
	when d4.kysymys_fi = 'Missä määrin opiskelijoiden palaute mielestäsi huomioitiin opintojen kehittämisessä? Palaute huomioitiin' then
		case
