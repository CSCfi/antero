...
/****** Object:  Table [dw].[f_varda_jarjestamismuoto]    Script Date: 19.8.2024 12:29:58 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dw].[f_varda_jarjestamismuoto]') AND type in (N'U'))
