...
GO
/****** Object:  StoredProcedure [dbo].[ETL_tyhjenna_ja_lataa_VipunenTK_DW_dimensiot]    Script Date: 21.6.2017 13:06:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ETL_tyhjenna_ja_lataa_VipunenTK_DW_dimensiot]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[ETL_tyhjenna_ja_lataa_VipunenTK_DW_dimensiot] AS' 
END
GO
...
TRUNCATE TABLE VipunenTK_DW..d_aidinkieli_versio1;
INSERT INTO VipunenTK_DW..d_aidinkieli_versio1
...
TRUNCATE TABLE VipunenTK_DW..d_valtio;  -- oli tyhjä
