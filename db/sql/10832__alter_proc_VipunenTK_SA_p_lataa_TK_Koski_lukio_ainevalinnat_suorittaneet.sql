...
DECLARE @kurssit nvarchar(max) = '
		SELECT
			...
			,[kurssi_pakollinen_0_1] = cast(koulutusmoduuli_pakollinen as int)
			...
			,[kurssit_laajuus_all_suorituskieli] = 
				...
				over (partition by ylempi_osasuoritus_id, koulutusmoduuli_paikallinen, koulutusmoduuli_pakollinen, kurssin_tyyppi_koodiarvo)
