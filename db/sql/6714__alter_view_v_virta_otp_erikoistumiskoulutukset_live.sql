...
/****** Object:  View [dw].[v_virta_otp_erikoistumiskoulutukset_live]    Script Date: 1.12.2022 12:43:09 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dw].[v_virta_otp_erikoistumiskoulutukset_live] AS
...
FROM ANTERO.dw.f_virta_otp_erikoistumiskoulutukset_live f 
