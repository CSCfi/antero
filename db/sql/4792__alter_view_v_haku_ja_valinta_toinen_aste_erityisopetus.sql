...
/****** Object:  View [dw].[v_haku_ja_valinta_toinen_aste_erityisopetus]    Script Date: 21.8.2021 16:04:03 ******/
SET ANSI_NULLS ON
GO
...
where  f.koulutuksen_alkamisvuosi>2013 and d25.korkeakouluhaku=0 and d25.hakuryhma_koodi = '3'  
...
WHERE d1.korkeakouluhaku=0 and f.koulutuksen_alkamisvuosi>2013 and d1.hakuryhma_koodi = '3'
