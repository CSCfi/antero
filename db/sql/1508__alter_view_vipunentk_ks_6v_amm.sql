...
/****** Object:  View [dbo].[v_f_tab_koulutukseen_sijoittuneet_6v_ammatillinen]    Script Date: 29.3.2018 17:10:28 ******/
SET ANSI_NULLS ON
GO
...
,d32.kylla_ei as 'Opiskellut ammatillisessa koulutuksessa'--opisk_amm_kyllaei_id
...
FROM            dbo.f_koulutukseen_sijoittuneet_6v
	...
	LEFT JOIN d_kylla_ei d32 on d32.id = opisk_amm_kyllaei_id
