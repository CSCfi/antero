...
/****** Object:  View [dbo].[v_sa_4_6ab_Tyovoimatutkimus_tyolliset_ja_tyottomat]    Script Date: 9.5.2023 13:07:45 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
	  ...
	  ,[amm2001] = NULL
      ,[lkm]
	  ,[tietolahde]='R4_6a_sopv_22'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
  FROM [TK_H9098_CSC].[dbo].[TK_R4_6a_sopv_22]
union all
--b
SELECT [tilv]
      ,[tyovoima]
	  ...
	  ,[amm2001] = NULL
      ,[lkm]
	  ,[tietolahde]='R4_6b_sopv_22'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
  FROM [TK_H9098_CSC].[dbo].[TK_R4_6b_sopv_22]
...
SELECT [tilv]
	  ...
	  ,[amm2001] = NULL
      ,[lkm]
	  ,[tietolahde]='R4_6a_sopv_23'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
  FROM [TK_H9098_CSC].[dbo].[TK_R4_6a_sopv_23]
union all
--b
SELECT [tilv]
      ,[tyovoima]
	  ...
	  ,[amm2001] = NULL
      ,[lkm]
	  ,[tietolahde]='R4_6b_sopv_23'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
  FROM [TK_H9098_CSC].[dbo].[TK_R4_6b_sopv_23]
