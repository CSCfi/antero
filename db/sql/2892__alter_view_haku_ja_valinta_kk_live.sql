...
/****** Object:  View [dw].[v_haku_ja_valinta_kk_live]    Script Date: 16.3.2020 20:31:06 ******/
SET ANSI_NULLS ON
GO
...
SELECT --top 10
	  ...
	  ,[Hakuaika] = 
		coalesce(
			case 
				when d31.selite_fi not in ('Haku 1 / Hakuaika 1','Haku 2 / Hakuaika 2') then ''
				else d31.selite_fi 
			end
		,'')
...
--Apusarakkeet mittareille	    
	  ...
	  ,[Hakuaika järjestys] = case when d31.selite_fi IN ('Haku 1 / Hakuaika 1','Haku 2 / Hakuaika 2') then 1 else 2 end
...
Select distinct --top 0
	  ...
	  ,[Hakuaika] = coalesce(case when d13.selite_fi not in ('Haku 1 / Hakuaika 1','Haku 2 / Hakuaika 2') then '' else d13.selite_fi end,'')
	  ...
	  ,[Hakuaika järjestys] = case when d13.selite_fi IN ('Haku 1 / Hakuaika 1','Haku 2 / Hakuaika 2') then 1 else 2 end
