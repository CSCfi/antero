...
/****** Object:  StoredProcedure [dw].[p_lataa_api_korkeakoulutus_kv_liikkuvuus_esilataus]    Script Date: 25.3.2024 8:29:25 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
  ...
  d10.liikkuvuudensuunta_fi,d11.liikkuvuudenkesto_fi,d1.organisaatio_koodi,d3.koulutusluokitus_koodi, d5.liikkuvuudentyyppi_fi
