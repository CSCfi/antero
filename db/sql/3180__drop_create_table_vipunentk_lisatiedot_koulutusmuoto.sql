...
GO
ALTER TABLE [dbo].[koulutusmuoto] DROP CONSTRAINT [DF__koulutusmuoto__tietolahde]
GO
ALTER TABLE [dbo].[koulutusmuoto] DROP CONSTRAINT [DF__koulutusmuoto__paattyy]
GO
ALTER TABLE [dbo].[koulutusmuoto] DROP CONSTRAINT [DF__koulutusmuoto__alkaa]
GO
/****** Object:  Table [dbo].[koulutusmuoto]    Script Date: 21.7.2020 22:16:23 ******/
