...
/****** Object:  View [sa].[v_amos_oiva_tutkinto_oikeudet]    Script Date: 10.2.2023 12:05:55 ******/
SET ANSI_NULLS ON
GO
...
FROM (
	...
	FROM (
		...
		SELECT 
			...
			,generoitu = 0
		FROM [ANTERO].[sa].[sa_oiva_luvat] sa
		WHERE 1=1
		and koulutustyyppi = '5' 
		and koulutusmuodonPaasivunOtsikko = 'Ammatillinen koulutus'
