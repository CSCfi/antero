...
/****** Object:  View [dbo].[v_f_tab_korkeakouluopiskelijoiden_aikaisempi_koulutus_yhteiset]    Script Date: 9.4.2021 1:15:04 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_f_tab_korkeakouluopiskelijoiden_aikaisempi_koulutus_yhteiset] AS
...
WHERE (d21.Koulutusaste_taso2_koodi not in ('73', '81', '82') or d21.koulutusaste2002_koodi not in ('73', '81', '82'))
