...
/****** Object:  View [dbo].[v_K3_12_Perusk_paattaneet_amm_tutk_suorittaneet]    Script Date: 4.10.2022 4:39:22 ******/
SET ANSI_NULLS ON
GO
...
suorv = (CASE 
			WHEN NOT EXISTS (SELECT TOP 1 1 
								...
								WHERE t.name = 'TK_K3_12_sopv_22' and p.rows > 0) 
			THEN '2019'
		 END)
and suorlk = '1'
