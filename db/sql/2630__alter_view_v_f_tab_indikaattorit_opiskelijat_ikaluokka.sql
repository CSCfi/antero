...
/****** Object:  View [dbo].[v_f_tab_indikaattorit_opiskelijat_ikäluokka]    Script Date: 12.11.2019 14:02:46 ******/
SET ANSI_NULLS ON
GO
...
where aloittaneet is not null and d1.maakunta<>'Tuntematon' and (d8.koulutuslaji_okm_avain in ('13','14','15','16') or (d8.koulutuslaji_okm_avain = '17' and d9.opintoala1995 in ('Hammaslääketieteell. koulutus','Eläinlääketieteell. koulutus','Lääketieteellinen koulutus'))) and aineisto='L'
