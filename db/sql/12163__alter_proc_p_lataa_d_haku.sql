...
/****** Object:  StoredProcedure [dw].[p_lataa_d_haku]    Script Date: 31.8.2026 8.23.43 ******/
SET ANSI_NULLS ON
GO
...
UPDATE ANTERO.dw.d_haku
SET 
	haun_nimi_sv = CASE WHEN haun_nimi_sv is null THEN COALESCE(haun_nimi_fi, haun_nimi_en) ELSE haun_nimi_sv END,
	haun_nimi_en = CASE WHEN haun_nimi_en is null THEN COALESCE(haun_nimi_fi, haun_nimi_sv) ELSE haun_nimi_en END
WHERE (haun_nimi_sv is null OR haun_nimi_en is null)