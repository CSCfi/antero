...
/****** Object:  StoredProcedure [dw].[p_lataa_f_arvo_amk_uraseuranta]    Script Date: 5.10.2022 14:29:11 ******/
SET ANSI_NULLS ON
GO
...
INSERT INTO dw.f_arvo_amk_uraseuranta (
	...
	SELECT DISTINCT
		...
		WHERE oppilaitoskoodi is not null and kk.tyyppi = 'amk-uraseuranta' and kk.kyselykerta_vuosi is not null and d4.id not in (SELECT DISTINCT d_arvokyselykerta_id FROM ANTERO.dw.f_arvo_amk_uraseuranta)
