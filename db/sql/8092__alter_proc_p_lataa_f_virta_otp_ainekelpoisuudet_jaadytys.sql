...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_ainekelpoisuudet_jaadytys]    Script Date: 26.9.2023 13:46:01 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	' WHERE (f.kelpoisuuden_vuosi = ' + @alkuVuosi + ') or (' + @alkuVuosi + ' = 2022 and f.kelpoisuuden_vuosi <= 2022)'
