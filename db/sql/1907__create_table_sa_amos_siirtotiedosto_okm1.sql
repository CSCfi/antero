...
BEGIN
	ALTER TABLE [sa].[sa_amos_siirtotiedosto_okm1] DROP  CONSTRAINT [DF__sa_amos_siirtotiedosto_okm1__loadtime];
	ALTER TABLE [sa].[sa_amos_siirtotiedosto_okm1] DROP  CONSTRAINT [DF__sa_amos_siirtotiedosto_okm1__username];
