...
/****** Object:  View [dw].[v_arvo_amk_uraseuranta]    Script Date: 14.11.2019 15:11:29 ******/
SET ANSI_NULLS ON
GO
...
,Case when d4.kysymysid in (7801,7833,7835) then (f.numerovalinta+1) else f.numerovalinta END	AS 'numerovalinta' -- L (Miten tyytyväinen olet kokonaisuudessaan vuonna 2013 suorittamaasi tutkintoon työurasi kannalta?/Pystyn hyödyntämään ammattikorkeakoulussa hankkimaani osaamista nykyisessä työssäni hyvin./Työni vastaa tällä hetkellä vaativuustasoltaan hyvin ammattikorkeakoulutustani.
