...
/****** Object:  View [dbo].[v_f_tab_keskeytaneet_yliopisto]    Script Date: 24.11.2021 20:45:08 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_f_tab_keskeytaneet_yliopisto] AS
...
where d16.koulutusaste2002_koodi in ('63','72','73','81','82') or d16.Koulutusaste_taso2_koodi in ('63','72','73','81','82') 
