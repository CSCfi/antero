...
/****** Object:  View [dw].[v_virta_otp_55_jaahdytetty_2023]    Script Date: 18.9.2026 15.26.51 ******/
SET ANSI_NULLS ON
GO
...
ALTER    VIEW  [dw].[v_virta_otp_55_jaahdytetty_2023] 
AS
...
FROM ANTERO.sa.sa_virta_otp_viisviis_2023 f
...
INNER JOIN ANTERO.dbo.view_salt vs on vs.[view] = 'v_virta_otp_55_jaahdytetty_2023'