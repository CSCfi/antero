...
/****** Object:  Table [sa].[sa_virta_otp_tk_opisk_ennakko_2025]    Script Date: 25.9.2026 12.28.27 ******/
SET ANSI_NULLS ON
GO
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[sa].[sa_virta_otp_tk_opisk_ennakko_2026]') AND type in (N'U'))

CREATE TABLE [sa].[sa_virta_otp_tk_opisk_ennakko_2026](
