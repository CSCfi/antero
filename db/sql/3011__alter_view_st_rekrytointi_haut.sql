...
/****** Object:  View [dw].[v_st_rekrytointi_haut]    Script Date: 23.4.2020 10:34:13 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dw].[v_st_rekrytointi_haut] AS
 ...
 SELECT 
	...
	,[Korkeakoulu] = d1b.organisaatio_fi
	...
	,f1.[hakunumero]
	,[Hakuavain] = CONCAT(f1.hakunumero, d1b.organisaatio_nykyinen_koodi, vuosi) --, sukupuoli_koodi) --, d3.kytkin_koodi, coalesce(nullif(d4.maanosat0_koodi, -1),1))
	...
	,[jarjestys kansalaisuus maanosa] = 
		case
			when d3.kytkin_koodi=1 then 1
			when d4.maanosat0_koodi = 1 then 2
			else 9
		end

 FROM dw.f_amk_rekrytointihaut f1
 JOIN dw.d_amk d1 ON d1.id=f1.d_korkeakoulu_id
 JOIN dw.d_organisaatioluokitus d1b on d1b.organisaatio_koodi = d1.amk_tunnus
 ...
 GROUP BY f1.vuosi,d1b.organisaatio_fi,d2.kytkin_fi,d6.kytkin_fi,d7.kytkin_fi,d5.sukupuoli_fi,d3.kytkin_fi,d4.maanosat0_fi,f1.hakunumero,d1b.organisaatio_nykyinen_koodi,d2.jarjestys_kytkin_koodi,d6.jarjestys_kytkin_koodi,d7.jarjestys_kytkin_koodi,d5.jarjestys_sukupuoli_koodi,d3.jarjestys_kytkin_koodi,d3.kytkin_koodi,d4.jarjestys_maanosat0_koodi,d4.maanosat0_koodi
 ,sukupuoli_koodi
 ...
 SELECT
	...
	,f2.[hakunumero]
	,[Hakuavain] = CONCAT(f2.hakunumero, d1b.organisaatio_nykyinen_koodi, vuosi) --, sukupuoli_koodi) --, d3.kytkin_koodi, coalesce(nullif(d4.maanosat0_koodi, -1),1))
 ...
 JOIN dw.d_organisaatioluokitus d1b on d1b.organisaatio_koodi = d1.yo_tunnus
 ...
 --)
 GROUP BY f2.vuosi,d1b.organisaatio_fi,d2.kytkin_fi,d6.kytkin_fi,d7.kytkin_fi,d5.sukupuoli_fi,d3.kytkin_fi,d4.maanosat0_fi,f2.hakunumero,d1b.organisaatio_nykyinen_koodi,d2.jarjestys_kytkin_koodi,d6.jarjestys_kytkin_koodi,d7.jarjestys_kytkin_koodi,d5.jarjestys_sukupuoli_koodi,d3.jarjestys_kytkin_koodi,d3.kytkin_koodi,d4.maanosat0_koodi,d4.jarjestys_maanosat0_koodi
 ,sukupuoli_koodi
