...
/****** Object:  StoredProcedure [dw].[p_lataa_f_indikaattorit_kk_tutkinnon_suorittaneet_vaihdossa]    Script Date: 17.4.2024 12:52:01 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dw].[p_lataa_f_indikaattorit_kk_tutkinnon_suorittaneet_vaihdossa] as
...
USING (
	...
	FROM (
		...
		and d2.koulutusastetaso2_koodi in ('62', '72')  and d1.oppilaitostyyppi_koodi in ('41','42')
		GROUP BY f.tilastointivuosi, d1.organisaatio_nykyinen_koodi, d1.oppilaitostyyppi_koodi, d2.koulutusastetaso2_koodi
	) f
	LEFT JOIN (
		SELECT   
			f.tilastovuosi,
		...
		(d2.koulutusastetaso2_koodi in ('62','72')) and d1.oppilaitostyyppi_koodi in ('41','42')
		GROUP BY f.tilastovuosi, d1.organisaatio_nykyinen_koodi, d1.oppilaitostyyppi_koodi, d2.koulutusastetaso2_koodi
	...
	OUTER APPLY (
		...
		WHERE (d2b.koulutusastetaso2_koodi in ('62','72')) and d1b.oppilaitostyyppi_koodi in ('41','42') 
	...
	OUTER APPLY (
		...
		WHERE d2b.koulutusastetaso2_koodi in ('62', '72') 
