...
/****** Object:  View [dbo].[v_f_K2_17_ulkomaalaistaustaiset_opisk_ja_tutk]    Script Date: 30.10.2017 16:29:23 ******/
SET ANSI_NULLS ON
GO
...
/*** johdetut mittarit ***/
	  ...
	  ,hallinnonala2 = 
			case
				when ophal=1 then '1'
				when ophal=2 and al.maakunta_koodi<>'21' and kl.opintoala2002_koodi not in ('902','903','904') then '2'
				when ophal=2 then '3'
				else '-1'
			end
