...
/****** Object:  View [dbo].[v_f_tab_ulkomaalaiset_ulk_ja_vieraskieliset_yhteiset]    Script Date: 3.5.2021 22:25:17 ******/
SET ANSI_NULLS ON
GO
...
,d55.jarjestys2 as jarj_koulutusryhma
,d55.jarjestys as jarj_koulutusryhmaII
...
/*** rajausehtoa varten ***/  
	  ,-1 AS erikoislaakarikoulutus_id
...
/*** yhteiset mittarit ***/
      ...
      ,[aloittaneet] = case when koulutusluokitus not like '8%' then aloittaneet else 0 end --lääkärit pois lopun rajausehdossa
      ,[opiskelijat]
      ,NULL AS [tutkinnot]
...
AND NOT erikoislaakarikoulutus_id IN (1, 2) --2015 alkaen otv
