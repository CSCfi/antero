...
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_amm_opiskelijat_ja_tutkinnot_yhdistetty]    Script Date: 22.12.2022 16:12:06 ******/
DROP PROCEDURE IF EXISTS [dw].[p_lataa_f_koski_amm_opiskelijat_ja_tutkinnot_yhdistetty]
GO
...
CREATE PROCEDURE [dw].[p_lataa_f_koski_amm_opiskelijat_ja_tutkinnot_yhdistetty] AS
...
DROP TABLE IF EXISTS dw.f_koski_amm_opiskelijat_ja_tutkinnot_yhdistetty
...
SELECT 
	...
	,opiskelijavuodet = 0
	,ryhma = 'opiskelijat'
INTO dw.f_koski_amm_opiskelijat_ja_tutkinnot_yhdistetty
