...
/****** Object:  Table [dbo].[koulutusala_vst]    Script Date: 17.4.2026 16.26.14 ******/
SET ANSI_NULLS ON
GO
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[koulutusala_vst]') AND type in (N'U'))

CREATE TABLE [dbo].[koulutusala_vst](
	[id] [int] NULL,
	[luotu] [date] NULL,
	[alkaa] [date] NULL,
	[paattyy] [date] NULL,
