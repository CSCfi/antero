...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dw].[f_koski_amm_opiskelijat_TK_1_22_sopv_24_amm]') AND type in (N'U'))

CREATE TABLE [dw].[f_koski_amm_opiskelijat_TK_1_22_sopv_24_amm](
