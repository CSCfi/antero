-- Extra vipusen jäähdytetty 2016 datanäkymä
 
IF NOT EXISTS ( SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'dw.v_virta_otp_55_jaahdytetty_2016') )
	EXEC dbo.sp_executesql @statement = N'CREATE VIEW dw.v_virta_otp_55_jaahdytetty_2016 AS select 1 AS a'
GO
