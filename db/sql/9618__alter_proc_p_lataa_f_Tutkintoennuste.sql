...
/****** Object:  StoredProcedure [dbo].[p_lataa_f_Tutkintoennuste]    Script Date: 16.2.2024 10:34:22 ******/
SET ANSI_NULLS ON
GO
...
-- Määrittelyt: https://wiki.eduuni.fi/pages/viewpage.action?pageId=364592639
	...
	WHERE aineisto <> 'R' and tilastointivuosi >= 2018 and d18.ika_int between 25 and 49 and (Koulutusaste_taso2_koodi in (32,33,41,62,72,73) or (Koulutusaste_taso2_koodi = 63 and iscfi2013_koodi in ('0112', '0916')))
	...
	FROM (
		...
		WHERE d1.tarkastelujakso_koodi = '7' and suorv >= 2010 and (d3.Koulutusaste_taso2_koodi in ('32', '62', '72') or (d3.Koulutusaste_taso2_koodi = '63' and d3.iscfi2013_koodi in ('0112','0916')))
