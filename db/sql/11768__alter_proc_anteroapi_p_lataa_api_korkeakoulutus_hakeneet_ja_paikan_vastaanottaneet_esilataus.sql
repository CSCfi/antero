...
/****** Object:  StoredProcedure [dw].[p_lataa_api_korkeakoulutus_hakeneet_ja_paikan_vastaanottaneet_esilataus]    Script Date: 16.2.2026 8.15.51 ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT
	...
	,CASE WHEN f.valittu = 1 THEN NULL ELSE f.pisteet end kokonaispisteet
