...
/****** Object:  View [dbo].[v_sa_7_15_Taiteen_perusopetuksen_opettajat_kelpoisuus_aine]    Script Date: 17.11.2020 19:36:40 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_sa_7_15_Taiteen_perusopetuksen_opettajat_kelpoisuus_aine] AS
...
SELECT [tilv] = CAST(kaikkivuodet.tilv as nvarchar(4))
  ...
  FROM [TK_H9098_CSC].[dbo].[TK_K7_15_vos_sopv_19]
