...
ALTER PROCEDURE [sa].[p_lataa_ammatillisen_koulutuksen_sopimusjaksot_siivottu2] AS
...
FROM (
	...
	FROM(
		SELECT 
			...
			,[ytunnus]
			,[sijainti]
		FROM [sa].[sa_ammatillisen_koulutuksen_sopimusjaksot_siivottu2_valitaulu] sj
