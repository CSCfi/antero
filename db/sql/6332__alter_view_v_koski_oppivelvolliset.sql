...
/****** Object:  View [dw].[v_koski_oppivelvolliset]    Script Date: 2.8.2022 16:52:04 ******/
SET ANSI_NULLS ON
GO
...
SELECT --top 1000
	...
	,d18.vuosi as 'Perusopetuksen suoritusvuosi'
...
LEFT JOIN [ANTERO].[dw].[d_koski_koulutusmuoto] d19 on d19.koodi = replace(f.koulutusmuoto,'Tieto puuttuu', '-1')
