...
/****** Object:  StoredProcedure [dbo].[p_lataa_f_koulutukseen_sijoittuneet_8v_ensimmainen_laskenta]    Script Date: 22.10.2024 16:05:05 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dbo].[p_lataa_f_koulutukseen_sijoittuneet_8v_ensimmainen_laskenta] AS

TRUNCATE TABLE [VipunenTK_DW].[dbo].[_f_koulutukseen_sijoittuneet_8v_tarkastelu]

INSERT INTO [VipunenTK_DW].[dbo].[_f_koulutukseen_sijoittuneet_8v_tarkastelu]
(
aineistorivinumero,
tarkastelujakso,
tilv, 
...
FROM 
		(
		select * from [VipunenTK_DW].[dbo].[_koulutukseen_sijoittuneet_8v_tarkastelu]
		) as l
