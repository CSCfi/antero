...
/****** Object:  View [dbo].[v_sa_3_8_tutkinnon_suorittaneiden_osuus_aloittaneista_erityisopiskelijat]    Script Date: 2.12.2022 12:28:27 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
      ...
      ,[suoropmala] = NULL
	  ,[suoriscfibroad2013]
      ,coalesce([suortutk],'3') --korjaus tulossa, mutta muuten ok niin viedään jo tuotantoon tällä tulkinnalla. JS 2.12.2022
      ,[lkm]
      ,[luontipvm]
