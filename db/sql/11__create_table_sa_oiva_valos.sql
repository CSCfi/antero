IF NOT EXISTS (select * from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA='sa' and TABLE_NAME='sa_oiva_valos') BEGIN

CREATE TABLE sa.sa_oiva_valos(
...
ALTER TABLE sa.sa_oiva_valos ADD  CONSTRAINT DF__sa_oiva_valos__loadtime  DEFAULT (getdate()) FOR loadtime
;
ALTER TABLE sa.sa_oiva_valos ADD  CONSTRAINT DF__sa_oiva_valos__username  DEFAULT (suser_name()) FOR username
;
