...
/****** Object:  View [dw].[v_virta_otp_opettajakelpoisuudet]    Script Date: 13.7.2022 11:53:30 ******/
SET ANSI_NULLS ON
GO
...
SELECT		
	...
	,CASE 
		WHEN d3a.selite_fi = 'Ruotsinkielinen ammatillinen opettaja' THEN 'Ammattikorkeakoulut'
		ELSE d5.oppilaitostyyppi_fi
	END as raportti
