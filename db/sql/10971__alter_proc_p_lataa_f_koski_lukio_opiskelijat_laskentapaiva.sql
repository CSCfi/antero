...
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_lukio_opiskelijat_laskentapaiva]    Script Date: 30.7.2025 10.43.00 ******/
SET ANSI_NULLS ON
GO
...
FROM (
	...
	FROM (
		...
		LEFT JOIN Koski_SA.sa.temp_amm_opisk_alkamispaivat d6
			ON d6.master_oid = oo.master_oid
		...
		LEFT JOIN Koski_SA.sa.sa_oppivelvolliset ov on ov.master_oid = oo.master_oid and paivays between ov.alkuPvm and ov.loppuPvm
