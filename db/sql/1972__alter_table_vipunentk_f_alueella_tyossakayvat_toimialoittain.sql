...
ALTER TABLE [dbo].[f_alueella_tyossakayvat_toimialoittain] DROP CONSTRAINT [FK_f_alueella_tyossakayvat_toimialoittain_d_toimiala_tk]
GO

ALTER TABLE [dbo].[f_alueella_tyossakayvat_toimialoittain] DROP CONSTRAINT [FK_f_alueella_tyossakayvat_toimialoittain_d_mitenna_toimiala]
GO

ALTER TABLE [dbo].[f_alueella_tyossakayvat_toimialoittain] DROP CONSTRAINT [FK_f_alueella_tyossakayvat_toimialoittain_d_mitenna_ammatti]
GO

ALTER TABLE [dbo].[f_alueella_tyossakayvat_toimialoittain] DROP CONSTRAINT [FK_f_alueella_tyossakayvat_toimialoittain_d_ika]
GO

ALTER TABLE [dbo].[f_alueella_tyossakayvat_toimialoittain] DROP CONSTRAINT [FK_f_alueella_tyossakayvat_toimialoittain_d_ammatillisen_koulutuksen_koulutuslaji]
GO

ALTER TABLE [dbo].[f_alueella_tyossakayvat_toimialoittain] DROP CONSTRAINT [FK_f_alueella_tyossakayvat_toimialoittain_d_alueluokitus_tyopaikka_historia]
GO

ALTER TABLE [dbo].[f_alueella_tyossakayvat_toimialoittain] DROP CONSTRAINT [FK_f_alueella_tyossakayvat_toimialoittain_d_alueluokitus_tyopaikka]
GO

/****** Object:  Table [dbo].[f_alueella_tyossakayvat_toimialoittain]    Script Date: 15.11.2018 14:05:22 ******/
DROP TABLE [dbo].[f_alueella_tyossakayvat_toimialoittain]
GO
