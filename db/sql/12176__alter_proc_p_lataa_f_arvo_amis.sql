...
/*
Tekijä: 
Alkuperäinen tiketti:
Osio: Ammatillinen - Rahoitusperusteet ja kustannukset, Ammatillinen - Opiskelijapalaute
Raportit: 
Kuutiot: 
Näkymät: 
Käytetään: 
...
Muokattu:
Muokkaaja: kohojoha
Muokkauksen tiketti: CSCVIPUNEN-4326
Lisätietoja: Muokattu Arvon API 2.0 siirtymään. Haetaan uuden rajapinnan tiedoista vastaajatunnuksen alkupäivämäärän perusteella 1.7.2021 alkaen ja vanhan rajapinnan tiedoista sitä ennen. 
*/
...
SELECT DISTINCT
	...
	f.d_arvovastaus_koulutustausta_id,
	f.osaamisalat_avain,
	'ETL: p_lataa_f_arvo_amis' as source
