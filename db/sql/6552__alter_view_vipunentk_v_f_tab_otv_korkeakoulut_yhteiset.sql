...
/****** Object:  View [dbo].[v_f_tab_otv_korkeakoulut_yhteiset]    Script Date: 7.10.2022 23:19:21 ******/
SET ANSI_NULLS ON
GO
...
,d45.kylla_ei as 'Kansainvälinen opiskelija'
...
SELECT [tilastointivuosi] as Tilastovuosi
  ...
  FROM [dbo].[f_OTV_4_9_Vaestorakenne_kunnittain]
	...
	LEFT JOIN [dbo].d_kylla_ei d45 ON d45.id = f.kvopisk_id
