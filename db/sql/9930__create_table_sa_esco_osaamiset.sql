...
ALTER TABLE [sa].[sa_esco_osaamiset] DROP CONSTRAINT [DF__sa_esco_osaamiset__username]
GO

ALTER TABLE [sa].[sa_esco_osaamiset] DROP CONSTRAINT [DF__sa_esco_osaamiset__loadtime]
GO
