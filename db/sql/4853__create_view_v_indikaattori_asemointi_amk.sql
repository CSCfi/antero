...
/****** Object:  View [dw].[v_indikaattori_asemointi_amk]    Script Date: 15.9.2021 8:12:03 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dw].[v_indikaattori_asemointi_amk] as
...
SELECT
 ...
 Where (aineisto = 'L' or (aineisto = 'E' and tilastointivuosi=YEAR(GETDATE())-1)) and tilastointivuosi > 2010 AND koulutusaste2002_koodi in ('62','71','63','72','82') and d50.organisaatio_koodi not in ('02358', '01740', '01742', '01717', '02557') and d50.oppilaitostyyppi_koodi = '41'
...
and d50.organisaatio_koodi not in ('02358', '01740', '01742', '01717', '02557') and d50.oppilaitostyyppi_koodi = '41' 
...
left join VipunenTK.dbo.d_koulutusluokitus d60 on d2.koulutusluokitus_koodi=d60.koulutusluokitus_avain
 ...
 left join VipunenTK.dbo.d_tieteenala d90 on d90.tieteenala_avain=d59.tieteenala_avain
where f.vuosi>2010 and d1.organisaatio_koodi not in ('02358', '01740', '01742', '01717')  and  d1.oppilaitostyyppi_koodi = '41'
...
SELECT   [tilastointivuosi]
 ...
 left join VipunenTK.dbo.d_tieteenala d90 on d90.tieteenala_avain=d59.tieteenala_avain
 Where aineisto = 'L' and tilastointivuosi > 2010 and d2.koulutusaste2002_koodi in ('62','71') and d50.organisaatio_koodi not in('02358', '01740', '01742', '01717', '02557') and d50.oppilaitostyyppi_koodi = '41'
...
SELECT   f.koulutuksen_alkamisvuosi
	...
	where d12.koulutussektori_koodi in (5,4) and d3.organisaatio_koodi not in ('02358', '01740', '01742', '01717', '02557') and d3.oppilaitostyyppi_koodi = '41'
