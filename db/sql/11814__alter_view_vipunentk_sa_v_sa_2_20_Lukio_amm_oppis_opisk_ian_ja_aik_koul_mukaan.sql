...
/****** Object:  View [dbo].[v_sa_2_20_Lukio_amm_oppis_opisk_ian_ja_aik_koul_mukaan]    Script Date: 25.3.2026 14.01.30 ******/
SET ANSI_NULLS ON
GO
...
UNION ALL
  ...
  SELECT [tilv]
      ...
      ,[syntv]
      ,[lkm]
      ,[tietolahde]='TK_2_20_sopv_26'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
  FROM [TK_H9098_CSC].[dbo].[TK_K2_20_sopv_26]
  --WHERE lahde != '91'
