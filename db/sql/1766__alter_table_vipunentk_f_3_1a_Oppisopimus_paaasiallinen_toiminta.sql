...
ALTER TABLE [dbo].[f_3_1a_Oppisopimus_paaasiallinen_toiminta]  WITH CHECK ADD  CONSTRAINT [FK_3_1a_d_koulutusluokitus_koulutusala_taso_1] FOREIGN KEY([koulutusala_taso_1_id])
REFERENCES [dbo].[d_koulutusluokitus] ([id])
GO

ALTER TABLE [dbo].[f_3_1a_Oppisopimus_paaasiallinen_toiminta] CHECK CONSTRAINT [FK_3_1a_d_koulutusluokitus_koulutusala_taso_1]
GO
