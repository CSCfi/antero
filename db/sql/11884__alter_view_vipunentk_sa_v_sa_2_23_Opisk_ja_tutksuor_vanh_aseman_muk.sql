...
/****** Object:  View [dbo].[v_sa_2_23_Opisk_ja_tutksuor_vanh_aseman_muk]    Script Date: 2.4.2026 10.32.42 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
 ...
 SELECT [tilv]
      ...
      ,(CASE WHEN [opisk] = '' THEN NULL else [opisk] end )as opisk
      ,(CASE WHEN [tutk] = '' THEN NULL else [tutk] end )as tutk
      ,[tietolahde]='2_23_sopv_26'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv) 
  FROM [TK_H9098_CSC].[dbo].[TK_K2_23_sopv_26]
