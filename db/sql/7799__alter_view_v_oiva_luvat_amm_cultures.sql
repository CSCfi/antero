...
/****** Object:  View [dw].[v_oiva_luvat_amm_cultures]    Script Date: 29.6.2023 15:46:51 ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT--TOP 100000
	...
	,[osaamisala_rajoite_fi] = coalesce(nullif(d4.selite_fi,ca.puuttuu_fi),'Ei m‰‰ritelty')
	...
	,[osaamisala_rajoite_sv] = coalesce(nullif(d4.selite_sv,ca.puuttuu_sv), 'Ej angivet')
