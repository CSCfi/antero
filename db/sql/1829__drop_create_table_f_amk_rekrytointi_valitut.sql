USE [ANTERO]
IF EXISTS
	(SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='dw' AND TABLE_NAME='f_amk_rekrytointi_valitut')
BEGIN
	ALTER TABLE [dw].[f_amk_rekrytointi_valitut] DROP  CONSTRAINT [DF_f_amk_rekrytointi_valitut_loadtime];
	ALTER TABLE [dw].[f_amk_rekrytointi_valitut] DROP  CONSTRAINT [DF_f_amk_rekrytointi_valitut_username];
...
CREATE TABLE [dw].[f_amk_rekrytointi_valitut](
	...
	[tohtorintutkinnon_suoritusvuosi] [nvarchar](5),
