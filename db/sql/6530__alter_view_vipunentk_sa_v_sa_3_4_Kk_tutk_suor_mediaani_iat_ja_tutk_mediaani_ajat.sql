...
/****** Object:  View [dbo].[v_sa_3_4_Kk_tutk_suor_mediaani_iat_ja_tutk_mediaani_ajat]    Script Date: 4.10.2022 4:38:37 ******/
SET ANSI_NULLS ON
GO
...
SELECT
	...
	,[tietolahde]='3_4_sopv_21'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
FROM [TK_H9098_CSC].[dbo].[TK_K3_4_sopv_21]
...
SELECT
	...
	,[tietolahde]='3_4_sopv_21'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
FROM [TK_H9098_CSC].[dbo].[TK_K3_4_sopv_22]
