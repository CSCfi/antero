...
--aputaulut
	...
	,[aine] = --kielet luokitellaan "vähimmäislaajuuden" mukaan
		case 
			...
			when (aine = 'B1' AND ((aine_laajuus_yksikko = '4' and aine_laajuus < 5 and kurssit_lkm_total < 5)
									OR (aine_laajuus_yksikko = '2' and aine_laajuus < 10))
				 ) 
				 OR 
				 (aine <> 'B1' AND ((aine_laajuus_yksikko = '4' and aine_laajuus < 6 and kurssit_lkm_total < 6)
