...
/****** Object:  View [dbo].[v_f_tab_koulutukseen_sijoittuneet_2v_yhteiset]    Script Date: 15.7.2019 10:58:57 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_f_tab_koulutukseen_sijoittuneet_2v_yhteiset] AS
...
WHERE --(d24.opetussuunnitelmaperusteinen_koulutus_nayttotutkintoon_valmistava_koulutus_koodi in (1, -1)) AND 
d15.vuosiselite <> '2008'
