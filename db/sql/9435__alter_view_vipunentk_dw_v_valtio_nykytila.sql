...
/****** Object:  View [dbo].[v_valtio_nykytila]    Script Date: 22.12.2023 14:00:07 ******/
SET ANSI_NULLS ON
GO
...
SELECT
	...
	v.maa_SV,
	v.maa_EN,
	coalesce(nullif(v.eumaa_koodi, ''), v2.eumaa_koodi),
	coalesce(nullif(v.eumaa, ''), v2.eumaa),
	coalesce(nullif(v.eumaa_SV, ''), v2.eumaa_SV),
	coalesce(nullif(v.eumaa_EN, ''), v2.eumaa_EN),
	coalesce(nullif(v.etamaa_koodi, ''), v2.etamaa_koodi),
	coalesce(nullif(v.etamaa, ''), v2.etamaa),
	coalesce(nullif(v.etamaa_SV, ''), v2.etamaa_SV),
	coalesce(nullif(v.etamaa_EN, ''), v2.etamaa_EN),
	coalesce(nullif(v.maanosa_koodi, ''), v2.maanosa_koodi),
	v.maanosa,
	v.maanosa_SV,
	v.maanosa_EN,
	coalesce(nullif(v.maanosa2_koodi, ''), v2.maanosa2_koodi),
	coalesce(nullif(v.maanosa2, ''), v2.maanosa2),
	coalesce(nullif(v.maanosa2_SV, ''), v2.maanosa2_SV),
	coalesce(nullif(v.maanosa2_EN, ''), v2.maanosa2_EN),
	coalesce(nullif(v.maanosa3_koodi, ''), v2.maanosa3_koodi),
	coalesce(nullif(v.maanosa3, ''), v2.maanosa3),
	coalesce(nullif(v.maanosa3_SV, ''), v2.maanosa3_SV),
	coalesce(nullif(v.maanosa3_EN, ''), v2.maanosa3_EN),
	...
	coalesce(nullif(v.jarjestys_eumaa, ''), v2.jarjestys_eumaa),
	coalesce(nullif(v.jarjestys_etamaa, ''), v2.jarjestys_etamaa),
	v.jarjestys_maanosa,
	coalesce(nullif(v.jarjestys_maanosa2, ''), v2.jarjestys_maanosa2),
	coalesce(nullif(v.jarjestys_maanosa3, ''), v2.jarjestys_maanosa3),
	v.virhetilanne,
	v.poistettu,
	v.tietolahde,
	v.kommentti 
