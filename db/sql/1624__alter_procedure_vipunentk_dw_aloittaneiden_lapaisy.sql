USE [VipunenTK_DW]
GO
/****** Object:  StoredProcedure [dbo].[p_lataa_f_aloittaneiden_lapaisy]    Script Date: 11.5.2018 13:59:52 ******/
SET ANSI_NULLS ON
GO
...
set @maxrow = (SELECT max(rivinumero) from _aloittaneiden_lapaisy_tiivistetty_ja_lasketut_sarakkeet)
--set @maxrow = 10000000
set @fromrow = 1
...
where f.rivinumero between @fromrow and @torow	
