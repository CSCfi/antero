USE [Koski_SA]
GO
/****** Object:  StoredProcedure [sa].[p_lataa_opiskelijavuodet_paallekkaiset_opiskeluoikeudet]    Script Date: 22.10.2019 20:33:36 ******/
SET ANSI_NULLS ON
GO
...
;with ed_jaksot as (
	...
	JOIN Koski_SA.sa.temp_opiskelijavuodet_opiskeluoikeus_oidit ooo ON ooo.oppija_oid = oo.oppija_oid
)
