...
/****** Object:  View [dbo].[v_sa_R4_23_Tyollisten_ammattisiirtymat]    Script Date: 1.12.2022 9:18:42 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
      ...
      ,[amm2010_m2_s] = [amm2010_m2_2019]
      ,[opmast_2_s] = null
	  ,[kaste_t2_2_2019]
      ,[opmopa_s] = null
	  ,[iscfinarrow2013_s] = [iscfinarrow2013_2019]
      ,[tutklaja_s] = [tutklaja_2019]
      ,[opkelp_s] = [opkelp_2019]
	  ,[erik_s] = [erik_2019]
	  ,[erik_amk_s] = [amk_erik_2019]
	  ,[erik_yo_s] = [yo_erik_2019]
      ,[lkm]
      ,[suhteellinen_ajankohta_avain] =  
		CASE 
...
FROM [TK_H9098_CSC].[dbo].[TK_K4_23_sopv_21]
...
SELECT 
      ...
      ,[amm2010_m2_s] = [amm2010_m2_2020]
      ,[opmast_2_s] = null
	  ,[kaste_t2_2_2020]
      ,[opmopa_s] = null
	  ,[iscfinarrow2013_s] = [iscfinarrow2013_2020]
      ,[tutklaja_s] = [tutklaja_2020]
      ,[opkelp_s] = [opkelp_2020]
	  ,[erik_s] = [erik_2020]
	  ,[erik_amk_s] = [amk_erik_2020]
	  ,[erik_yo_s] = [yo_erik_2020]
      ,[lkm]
      ,[suhteellinen_ajankohta_avain] =  
		CASE 
...
FROM [TK_H9098_CSC].[dbo].[TK_K4_23_sopv_22]
