...
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_lukio_opiskelijat_kuukausittain]    Script Date: 11.8.2023 7:35:42 ******/
SET ANSI_NULLS ON
GO
...
FROM (
	...
	WHERE ooa.tila = 'lasna' AND sisaltyy_opiskeluoikeuteen_oid IS NULL
