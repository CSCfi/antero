...
/****** Object:  View [dw].[v_arvo_amk_uraseuranta]    Script Date: 5.10.2022 12:59:00 ******/
SET ANSI_NULLS ON
GO
...
,CASE 
	WHEN f.vastaajaid is null and CAST(CONCAT(f.tilastovuosi,'-11-30') AS date) > CAST(GETDATE() AS date) THEN 0
...
LEFT JOIN dw.f_arvo_luodut_vastaajatunnukset f2 ON f2.kyselykertaid = d5.kyselykertaid and 
												   ...
												   YEAR(f2.kuukausi) = f.tilastovuosi
