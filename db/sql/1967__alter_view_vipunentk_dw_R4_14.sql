...
/****** Object:  View [dbo].[v_f_R4_14_Alueella_tyossakayvat_toimialan_ammryhm_ja_koul_mukaan]    Script Date: 15.11.2018 13:42:40 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_f_R4_14_Alueella_tyossakayvat_toimialan_ammryhm_ja_koul_mukaan] AS
...
SELECT [tilv]
	  ...
	  ,[koulutusaste_taso2_id]=ISNULL(d5b.id,-2)
      ,[tutklaja]
