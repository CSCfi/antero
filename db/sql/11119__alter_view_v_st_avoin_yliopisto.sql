...
/****** Object:  View [dw].[v_st_avoin_yliopisto]    Script Date: 29.8.2025 12.55.57 ******/
SET ANSI_NULLS ON
GO
...
from (
	...
	select 
		...
		,apusarake_tutkinto_opiskelija = d4.kytkin_koodi
	...
	select 
		...
		,[Jarjestys_Ohjauksenala] = d2.jarjestys_ohjauksenala_koodi
		,apusarake_tutkinto_opiskelija = -1
	...
	select  
		...
		,[Jarjestys_Ohjauksenala] = d2.jarjestys_ohjauksenala_koodi
		,apusarake_tutkinto_opiskelija = 0
