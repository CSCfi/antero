...
/****** Object:  View [dbo].[v_f_tab_yli_15-v_koul_kielen_ja_askunnan_mukaan]    Script Date: 22.2.2018 10:47:33 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv] AS Tilastovuosi
	  ...
	  ,d8.Koulutusaste_taso2_SV AS 'Utbildningsnivå, nivå 2'
	  ,d8.iscle2011_SV AS 'Utbildningsnivå, nivå 1'
