...
/****** Object:  View [dbo].[v_f_koulutukseen_sijoittuneet_8v_tarkastelu]    Script Date: 22.10.2024 15:52:17 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER  VIEW [dbo].[v_f_koulutukseen_sijoittuneet_8v_tarkastelu] AS
SELECT [aineistorivinumero]
  ...
  FROM [VipunenTK_DW].[dbo].[_f_koulutukseen_sijoittuneet_8v_tarkastelu]
