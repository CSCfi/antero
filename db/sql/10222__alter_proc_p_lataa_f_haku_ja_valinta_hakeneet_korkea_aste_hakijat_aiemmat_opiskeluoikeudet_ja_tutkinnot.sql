...
/****** Object:  StoredProcedure [dw].[p_lataa_f_haku_ja_valinta_hakeneet_korkea_aste_hakijat_aiemmat_opiskeluoikeudet_ja_tutkinnot]    Script Date: 15.10.2024 8:00:58 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN (
	...
	LEFT JOIN ANTERO.dw.d_koulutusluokitus d1 on t.tutkinto = d1.koulutusluokitus_koodi
	WHERE d1.koulutusastetaso1_koodi <> '9'
) AS TU ON TU.henkilo_oid = f.henkilo_oid AND TU.tutk_suoritusPvm <= coalesce(d4b.alkuPvm,d4.alkuPvm) and OP.aiempi_oo = 1
