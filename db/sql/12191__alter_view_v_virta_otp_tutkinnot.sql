...
/****** Object:  View [dw].[v_virta_otp_tutkinnot]    Script Date: 18.9.2026 13.45.54 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	...
	, [H_koodi] = HASHBYTES('SHA2_256', vs.salt + opiskelijaavain+opintosuoritusavain+d1.organisaatio_koodi)	
...
INNER JOIN ANTERO.dbo.view_salt vs on vs.[view] = 'v_virta_otp_tutkinnot'