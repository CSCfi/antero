...
CREATE or ALTER VIEW [dw].[v_varda_varhaiskasvatustiedot] AS
	...
	case when sukup.sukupuoli_koodi = 1 then 'Male'
	  ...
	  tunti_ast.nimi_fi as tuntimäärä_asteikko_fi,
	  tunti_ast.nimi_en as tuntimäärä_asteikko_en,
	  tunti_ast.nimi_sv as tuntimäärä_asteikko_sv,
	  vaka.vakasuhde_id,
	  vaka.lapsi_id,
	  ...
	  --tp.alkamis_pvm,
	  --tp.paattymis_pvm,
	  tunti_ast.jarj_nro as tuntimäärä_asteikko_jarj,
	  ikar.jarj_nro as ikäryhmä_jarj,
...
select
	...
	null as	  tuntimäärä_asteikko_fi,
	null as   tuntimäärä_asteikko_en,
	null as   tuntimäärä_asteikko_sv,
