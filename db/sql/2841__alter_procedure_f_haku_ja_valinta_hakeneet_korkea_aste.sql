...
/****** Object:  StoredProcedure [dw].[p_lataa_f_haku_ja_valinta_hakeneet_korkea_aste]    Script Date: 10.2.2020 19:39:00 ******/
SET ANSI_NULLS ON
GO
...
left join (
	...
	and f.HakutoiveNumero = 1) d35 on d35.HenkiloOID = f.HenkiloOID and d35.HakuOid = f.HakuOid and f.HakemusOid = d35.HakemusOid
left join (
	SELECT
		f.HenkiloOID,
		f.HakuOid,
