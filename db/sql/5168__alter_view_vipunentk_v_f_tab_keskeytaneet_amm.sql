...
/****** Object:  View [dbo].[v_f_tab_keskeytaneet_amm]    Script Date: 24.11.2021 18:27:13 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_f_tab_keskeytaneet_amm] AS
...
--uudet
,d0_33.opintojen_kulku_kaste_t2en_mukaan AS '1a Opintojen kulku, koul.aste taso 2'
,d0_34.opintojen_kulku_kaste_t2en_mukaan AS '1b Opintojen kulku, koul.aste taso 2'
...
,d1_39.opintojen_kulku_kala_t1n_mukaan AS '2a Opintojen kulku, koul.ala taso 1'
,d1_40.opintojen_kulku_kala_t1n_mukaan AS '2b Opintojen kulku, koul.ala taso 1'
...
,d2_39.opintojen_kulku_kala_t2n_mukaan AS '2a Opintojen kulku, koul.ala taso 2'
,d2_40.opintojen_kulku_kala_t2n_mukaan AS '2b Opintojen kulku, koul.ala taso 2'
...
,d3_39.opintojen_kulku_kala_t3n_mukaan AS '2a Opintojen kulku, koul.ala taso 3'
,d3_40.opintojen_kulku_kala_t3n_mukaan AS '2b Opintojen kulku, koul.ala taso 3'
...
,d0_33.opintojen_kulku_kaste_t2en_mukaan_SV AS 'Studieförlopp (utb.nivå 2)'
,d1_39.opintojen_kulku_kala_t1n_mukaan_SV AS 'Studieförlopp (utb.område 1)'
,d2_39.opintojen_kulku_kala_t2n_mukaan_SV AS 'Studieförlopp (utb.område 2)'
,d3_39.opintojen_kulku_kala_t3n_mukaan_SV AS 'Studieförlopp (utb.område 3)'
...
,d0_33.opintojen_kulku_kaste_t2en_mukaan_EN AS 'Progress of studies (level of ed. 2)'
,d1_39.opintojen_kulku_kala_t1n_mukaan_EN AS 'Progress of studies (field of ed. 1)'
,d2_39.opintojen_kulku_kala_t2n_mukaan_EN AS 'Progress of studies (field of ed. 2)'
,d3_39.opintojen_kulku_kala_t3n_mukaan_EN AS 'Progress of studies (field of ed. 3)'
...
FROM dbo.f_keskeyttaneet
	...
	JOIN d_hallinnonala2 d19b ON d19b.id=hallinnonala2_id
	...
	--uudet
	JOIN d_opintojen_kulku_kaste_t2en_mukaan d0_33 ON d0_33.id = [1a_opiskelijoiden_opintojen_kulku_kaste_t2_mukaan_id]
	JOIN d_opintojen_kulku_kaste_t2en_mukaan d0_34 ON d0_34.id = [1b_opiskelijoiden_opintojen_kulku_kaste_t2_mukaan_id]
	JOIN d_tutkinto_alkuperaisella_kaste_t2ella d0_35 ON d0_35.id = [1c_tutkinto_alkuperaisella_kaste_t2ella_id]
	JOIN d_tutkinto_muulla_kaste_t2ella d0_36 ON d0_36.id = [1d_tutkinto_muulla_kaste_t2ella_id]
	JOIN d_jatkaa_opiskelua_alkuperaisella_kaste_t2ella d0_37 ON d0_37.id = [1e_jatkaa_opiskelua_alkuperaisella_kaste_t2ella_id]
	JOIN d_jatkaa_opiskelua_muulla_kaste_t2ella d0_38 ON d0_38.id = [1f_jatkaa_opiskelua_muulla_kaste_t2ella_id]

	JOIN d_opintojen_kulku_kala_t1n_mukaan d1_39 ON d1_39.id = [2a_opiskelijoiden_opintojen_kulku_kala_t1_mukaan_id]
	JOIN d_opintojen_kulku_kala_t1n_mukaan d1_40 ON d1_40.id = [2b_opiskelijoiden_opintojen_kulku_kala_t1_mukaan_id]
	JOIN d_tutkinto_alkuperaisella_kala_t1lla d1_41 ON d1_41.id = [2c_tutkinto_alkuperaisella_kala_t1lla_id]
	JOIN d_tutkinto_muulla_kala_t1lla d1_42 ON d1_42.id = [2d_tutkinto_muulla_kala_t1lla_id]
	JOIN d_jatkaa_opiskelua_alkuperaisella_kala_t1lla d1_43 ON d1_43.id = [2e_jatkaa_opiskelua_alkuperaisella_kala_t1lla_id]
	JOIN d_jatkaa_opiskelua_muulla_kala_t1lla d1_44 ON d1_44.id = [2f_jatkaa_opiskelua_muulla_kala_t1lla_id]

	JOIN d_opintojen_kulku_kala_t2n_mukaan d2_39 ON d2_39.id = [2a_opiskelijoiden_opintojen_kulku_kala_t2_mukaan_id]
	JOIN d_opintojen_kulku_kala_t2n_mukaan d2_40 ON d2_40.id = [2b_opiskelijoiden_opintojen_kulku_kala_t2_mukaan_id]
	JOIN d_tutkinto_alkuperaisella_kala_t2lla d2_41 ON d2_41.id = [2c_tutkinto_alkuperaisella_kala_t2lla_id]
	JOIN d_tutkinto_muulla_kala_t2lla d2_42 ON d2_42.id = [2d_tutkinto_muulla_kala_t2lla_id]
	JOIN d_jatkaa_opiskelua_alkuperaisella_kala_t2lla d2_43 ON d2_43.id = [2e_jatkaa_opiskelua_alkuperaisella_kala_t2lla_id]
	JOIN d_jatkaa_opiskelua_muulla_kala_t2lla d2_44 ON d2_44.id = [2f_jatkaa_opiskelua_muulla_kala_t2lla_id]

	JOIN d_opintojen_kulku_kala_t3n_mukaan d3_39 ON d3_39.id = [2a_opiskelijoiden_opintojen_kulku_kala_t3_mukaan_id]
	JOIN d_opintojen_kulku_kala_t3n_mukaan d3_40 ON d3_40.id = [2b_opiskelijoiden_opintojen_kulku_kala_t3_mukaan_id]
	JOIN d_tutkinto_alkuperaisella_kala_t3lla d3_41 ON d3_41.id = [2c_tutkinto_alkuperaisella_kala_t3lla_id]
	JOIN d_tutkinto_muulla_kala_t3lla d3_42 ON d3_42.id = [2d_tutkinto_muulla_kala_t3lla_id]
	JOIN d_jatkaa_opiskelua_alkuperaisella_kala_t3lla d3_43 ON d3_43.id = [2e_jatkaa_opiskelua_alkuperaisella_kala_t3lla_id]
	JOIN d_jatkaa_opiskelua_muulla_kala_t3lla d3_44 ON d3_44.id = [2f_jatkaa_opiskelua_muulla_kala_t3lla_id]
	--vanhat
...
WHERE d16.koulutusaste2002_koodi = 32 or d16.Koulutusaste_taso2_koodi in ('32','33','41') 
