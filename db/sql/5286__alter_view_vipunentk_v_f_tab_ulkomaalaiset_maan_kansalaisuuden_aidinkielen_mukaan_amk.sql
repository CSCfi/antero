...
/****** Object:  View [dbo].[v_f_tab_ulkomaalaiset_maan_kansalaisuuden_aidinkielen_mukaan_amk]    Script Date: 30.12.2021 14:36:10 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_f_tab_ulkomaalaiset_maan_kansalaisuuden_aidinkielen_mukaan_amk] AS
SELECT 
...
WHERE (d2.koulutusaste2002_koodi in (62,71) or d2.Koulutusaste_taso2_koodi in (62,71)) 
