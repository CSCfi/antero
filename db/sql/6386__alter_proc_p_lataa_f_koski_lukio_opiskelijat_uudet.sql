USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_lukio_opiskelijat_uudet]    Script Date: 2.9.2022 9:03:37 ******/
SET ANSI_NULLS ON
GO
...
FROM (
	...
	FROM (
		...
		SELECT oo.[opiskeluoikeus_oid]
		  ...
		  WHERE (
			ps.suorituksen_tyyppi IN ('ibtutkinto', 'preiboppimaara', 'lukionoppiaineenoppimaara', 'lukionoppimaara', 'diatutkintovaihe', 'luva', 'internationalschooldiplomavuosiluokka')
