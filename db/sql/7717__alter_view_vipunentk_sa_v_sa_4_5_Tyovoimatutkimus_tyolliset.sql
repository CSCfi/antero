...
/****** Object:  View [dbo].[v_sa_4_5_Tyovoimatutkimus_tyolliset]    Script Date: 9.5.2023 11:17:39 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
      ...
      ,[sp]
      ,[lkm]
	  ,[tietolahde]='R4_5_sopv_22'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
  FROM [TK_H9098_CSC].[dbo].[TK_R4_5_sopv_22]
union all
SELECT [tilv]
	  ,NULL AS [amm2001] 
      ,[amm2010]
      ...
      ,[sp]
      ,[lkm]
	  ,[tietolahde]='R4_5_sopv_23'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
  FROM [TK_H9098_CSC].[dbo].[TK_R4_5_sopv_23]
) as kaikkivuodet
