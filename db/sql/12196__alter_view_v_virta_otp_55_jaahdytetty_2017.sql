...
/****** Object:  View [dw].[v_virta_otp_55_jaahdytetty_2017]    Script Date: 18.9.2026 14.20.27 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW  [dw].[v_virta_otp_55_jaahdytetty_2017] 
AS
...
INNER JOIN ANTERO.dbo.view_salt vs on vs.[view] = 'v_virta_otp_55_jaahdytetty_2017'