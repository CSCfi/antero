...
/****** Object:  View [dw].[v_arvo_amk_uraseuranta]    Script Date: 21.9.2021 13:59:00 ******/
SET ANSI_NULLS ON
GO
...
,CASE	
	WHEN YEAR(GETDATE()) > f.tilastovuosi THEN 1
	ELSE 0
END											AS 'Vuosi_suodatin'									
...
and vastaustyyppi <> 'luku'
-- and f.vastaajaid not in (285338, 287470, 299778, 300064, 300373, 300679) --taustatiedot tyhjät
