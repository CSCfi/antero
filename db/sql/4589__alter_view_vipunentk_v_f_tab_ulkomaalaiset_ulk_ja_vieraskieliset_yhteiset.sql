...
/****** Object:  View [dbo].[v_f_tab_ulkomaalaiset_ulk_ja_vieraskieliset_yhteiset]    Script Date: 5.5.2021 20:05:15 ******/
SET ANSI_NULLS ON
GO
...
/*** yhteiset mittarit ***/
	...
	--lääkärien erikoistumiskoulutus 2015- poistetaan rajausehdossa
      ,[aloittaneet] = 
		case 
			when koulutusluokitus not like '8%' 
			  or koulutusluokitus not in ('775101','775201') 
			then aloittaneet 
			else 0 
		end 
      ,[opiskelijat]
