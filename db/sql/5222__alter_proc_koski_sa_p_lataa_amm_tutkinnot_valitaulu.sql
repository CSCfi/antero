USE [Koski_SA]
GO
/****** Object:  StoredProcedure [dbo].[p_lataa_amm_tutkinnot_valitaulu]    Script Date: 14.12.2021 14:17:49 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	AND NOT EXISTS (select 1 from sa.sa_koski_opiskeluoikeus sa where koulutusmuoto = 'ammatillinenkoulutus' and sa.sisaltyy_opiskeluoikeuteen_oid is not null and sa.sisaltyy_opiskeluoikeuteen_oid = oo.opiskeluoikeus_oid)
