...
/****** Object:  View [dw].[v_amos_opiskelijapalaute_uusi]    Script Date: 4.9.2025 9.45.45 ******/
SET ANSI_NULLS ON
GO
...
JOIN (select 2021 as min_vuosi) v ON v.min_vuosi < right(f.rahoituskausi, 4)
...
LEFT JOIN (
	...
	WHERE 1=1
	AND d3.paivays between '2021-07-01' and eomonth(dateadd(month, -3, getdate())) 
