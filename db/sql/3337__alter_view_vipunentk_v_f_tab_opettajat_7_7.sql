...
/****** Object:  View [dbo].[v_f_tab_opettajat_7_7]    Script Date: 21.2.2020 22:02:49 ******/
SET ANSI_NULLS ON
GO
...
ALTER view [dbo].[v_f_tab_opettajat_7_7] as
...
Select
      ...
      ,[Kelpoisuus: muu (esim. vapaa sivistystyö)] = d16.kylla_ei
      ...
      ,[Muu kelpoisuus: muu (esim. vapaa sivistystyö)] = d46.kylla_ei
...
LEFT JOIN dbo.d_opettajat_koulutusaste_amm d5 on d5.id=f.pääasiallinen_koulutusaste_id
...
LEFT JOIN dbo.d_koulutuksen_jarjestajan_koko d27a on d27a.id=f.koul_jarj_koko
