...
SELECT        
    ...
    d_koulutusluokitus.jarjestys_koulutusalataso3_koodi AS jarj_koulutusala_taso3, d_kytkin_oppisopimuskoulutus.kytkin_fi AS Oppisopimuskoulutus, 
    ...
    d_majoitus.majoitus_nimi_fi AS Majoitus, d_majoitus.majoitus_nimi_sv AS Inkvartering, d_majoitus.majoitus_nimi_en AS Accommodation, d_kytkin_vankilaopetus.kytkin_fi AS Vankilaopetus, 
    d_kytkin_vankilaopetus.kytkin_sv AS FängELSEundervisning, d_kytkin_vankilaopetus.kytkin_en AS [Prison education], d_kytkin_henkilostokoulutus.kytkin_fi AS Henkilöstokoulutus, 
    d_kytkin_henkilostokoulutus.kytkin_sv AS Personalutbildning, d_kytkin_henkilostokoulutus.kytkin_en AS [Personnel training], d_kytkin_tyovoimakoulutus.kytkin_fi AS Työvoimakoulutus, 
