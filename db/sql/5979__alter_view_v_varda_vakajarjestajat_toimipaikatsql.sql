...
/****** Object:  View [dw].[v_varda_vakajarjestajat_toimipaikat]    Script Date: 2.3.2022 16.36.34 ******/
SET ANSI_NULLS ON
GO
...
ALTER   VIEW [dw].[v_varda_vakajarjestajat_toimipaikat] AS
	  ...
	  left join dw.d_alueluokitus alue2 on alue2.id = d_alueluokitus_vakajarjestaja_kunta_id
