...
CREATE VIEW [dw].[v_st_rekrytointi_valitut] AS
 ...
 SELECT
	...
	,[Kansalaisuus (maanosa)] = d17.maanosa_fi
	,[Äidinkieli] = d18.kieli_fi
	,[Ikä] = d19.ika_fi
	...
	,[Tohtorintutkinnon suoritusvuosi] = tohtorintutkinnon_suoritusvuosi
	...
	*/
	...
	,[Koodit Äidinkieli] = d18.kieli_koodi
 ...
 FROM (
	...
	select 	
		...
		,'-1' as tohtorintutkinnon_organisaatiotunnus
		,d_amk_toimipisteen_toimipaikka_id
		,NULL AS tohtorintutkinnon_suoritusvuosi
 ...
 LEFT JOIN dw.d_amk_kelpoisuus d8 ON d8.id=f.d_amk_kelpoisuus_opettajankoulutusi_d
