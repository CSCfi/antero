...
/****** Object:  StoredProcedure [dw].[p_lataa_f_oiva_luvat_amm]    Script Date: 29.6.2023 15:47:10 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dw].[p_lataa_f_oiva_luvat_amm] @vuosi as int = 2018 AS
...
BEGIN 
	...
	BEGIN
		...
		BEGIN
			delete from dw.f_oiva_luvat_amm where tarkasteluvuosi=@vuosi2;
