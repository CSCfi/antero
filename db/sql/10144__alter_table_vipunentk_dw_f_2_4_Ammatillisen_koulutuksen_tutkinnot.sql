...
/****** Object:  Table [dbo].[f_2_4_Ammatillisen_koulutuksen_tutkinnot]    Script Date: 25.9.2024 15:13:28 ******/
SET ANSI_NULLS ON
GO
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[f_2_4_Ammatillisen_koulutuksen_tutkinnot]') AND type in (N'U')) DROP TABLE [dbo].[f_2_4_Ammatillisen_koulutuksen_tutkinnot]
GO
