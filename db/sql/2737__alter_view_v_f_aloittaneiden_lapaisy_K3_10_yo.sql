...
/****** Object:  View [dbo].[v_f_aloittaneiden_lapaisy_K3_10_yo]    Script Date: 27.12.2019 15:34:29 ******/
SET ANSI_NULLS ON
GO
...
SELECT  f.lkm_int AS lkm_int2, 
		...
		d5.jarjestys_ika, 
		d5.jarjestys_ika5v, 
		d5b.jarjestys_ikaryhma2 as [Ikaryhma jarj],
...
FROM     dbo.f_aloittaneiden_lapaisy f LEFT JOIN
			...
			[ANTERO].[dw].[d_ika] as d5b on d5b.ika_avain = d5.ika 
												LEFT JOIN
