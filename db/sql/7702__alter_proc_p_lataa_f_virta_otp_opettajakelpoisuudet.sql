...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_opettajakelpoisuudet]    Script Date: 10.5.2023 13:08:50 ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT 
	...
	case when p.kelpoisuus in ('JA', 'JB', 'JC', 'IX') and YEAR(p.pvm) < YEAR(tutk.paivamaara) then null else tutk.paivamaara end as tutk_pvm,
