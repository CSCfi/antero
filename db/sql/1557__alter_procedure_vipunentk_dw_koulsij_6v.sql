USE [VipunenTK_DW]
GO
/****** Object:  StoredProcedure [dbo].[p_lataa_f_koulutukseen_sijoittuneet_6v]    Script Date: 19.4.2018 14:28:03 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN VipunenTK..d_ika AS d28b ON d28b.ika_avain = f.ika_1v_suorv
