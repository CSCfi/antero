-- Extra vipusen live datanäkymä
 
IF NOT EXISTS ( SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'dw.v_virta_otp_55_extra') )
	EXEC dbo.sp_executesql @statement = N'CREATE VIEW dw.v_virta_otp_55_extra AS select 1 AS a'
GO
