USE [VipunenTK_DW]
GO
/****** Object:  StoredProcedure [dbo].[p_lataa_OTV_f_2_4]    Script Date: 9.8.2021 22:15:37 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN VipunenTK..d_ika AS d19 ON d19.ika_avain=f.ika_1v
LEFT JOIN VipunenTK..d_ika AS d19b ON d19b.ika_avain='kirikar1'+coalesce(f.ika_5v,'')
