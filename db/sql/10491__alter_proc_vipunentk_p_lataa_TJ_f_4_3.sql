...
/****** Object:  StoredProcedure [dbo].[p_lataa_TJ_f_4_3]    Script Date: 13.1.2025 15.38.54 ******/
SET ANSI_NULLS ON
GO
...
SELECT
	...
	,rahoituslahde_v2
	,rahoituslahde_v2_id = coalesce(d24.id,-1)
...
LEFT JOIN VipunenTK..d_rahoituslahde_versio2 d24 ON d24.[rahoituslahde_koodi] = f.rahoituslahde_v2

EXEC ANTERO.dw.p_lataa_f_indikaattorit_kk_tutkinnon_suorittaneiden_tyollistyminen
