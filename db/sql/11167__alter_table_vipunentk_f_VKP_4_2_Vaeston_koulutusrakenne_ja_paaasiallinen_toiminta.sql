...
/****** Object:  Table [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta]    Script Date: 5.9.2025 15.30.07 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta](
	...
	[koulutusluokitus_korkein_viimeisin_aloitettu_ka_id] [int] NOT NULL,
	[koulutusluokitus_korkein_viimeisin_aloitettu_ta] [nvarchar](6) NULL,
	[koulutusluokitus_korkein_viimeisin_aloitettu_ta_id] [int] NOT NULL,
	[aloittanut_ka_koulutuksen] [nvarchar](1) NULL,
	[aloittanut_ka_koulutuksen_id] [int] NOT NULL,
	[aloittanut_ta_koulutuksen] [nvarchar](1) NULL,
	[aloittanut_ta_koulutuksen_id] [int] NOT NULL,
	...
	[d_kylla_ei_koulutusluokitus_korkein_viimeisin_aloitettu_sama_ka_id] [int] NOT NULL,
	[d_kylla_ei_koulutusluokitus_korkein_viimeisin_aloitettu_sama_ta_id] [int] NOT NULL,
...
ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta]  WITH CHECK ADD  CONSTRAINT [FK_4_2_viimeisin_aloitettu_ka_d_koulutusluokitus] FOREIGN KEY([koulutusluokitus_korkein_viimeisin_aloitettu_ka_id])
REFERENCES [dbo].[d_koulutusluokitus] ([id])
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] CHECK CONSTRAINT [FK_4_2_viimeisin_aloitettu_ka_d_koulutusluokitus]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta]  WITH CHECK ADD  CONSTRAINT [FK_4_2_viimeisin_aloitettu_ta_d_koulutusluokitus] FOREIGN KEY([koulutusluokitus_korkein_viimeisin_aloitettu_ta_id])
REFERENCES [dbo].[d_koulutusluokitus] ([id])
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] CHECK CONSTRAINT [FK_4_2_viimeisin_aloitettu_ta_d_koulutusluokitus]
GO
