...
/****** Object:  View [dw].[v_eter]    Script Date: 29.7.2026 14.52.07 ******/
SET ANSI_NULLS ON
GO
...
SELECT
	...
	CASE
		WHEN coalesce([English Institution Name], f1.[Institution Name]) = '0'
		THEN [ETER ID]
		ELSE coalesce([English Institution Name], f1.[Institution Name])
	END as 'Higher education institution',
	...
	-- Indicators
	,coalesce(f10.[Share of women academic staff], CASE WHEN f8.[Academic personnel - women (HC)] = 0 THEN 0 ELSE f8.[Academic personnel - women (HC)] / f8.[Total academic personnel (HC)] END) as 'Share of women academic staff'
	...
	,coalesce(f10.[Share of foreigners students ISCED 6], CASE WHEN f9.[Total students enrolled at ISCED 6] = 0 THEN NULL WHEN  f9.[Students enrolled at ISCED 6 - foreigner] = 0 THEN 0 ELSE f9.[Students enrolled at ISCED 6 - foreigner] / f9.[Total students enrolled at ISCED 6] END) as 'Share of foreigners students ISCED 6'
	,coalesce(f10.[Share of foreigners students ISCED 7], CASE WHEN f9.[Total students enrolled at ISCED 7] = 0 THEN NULL WHEN  f9.[Students enrolled at ISCED 7 - foreigner] = 0 THEN 0 ELSE f9.[Students enrolled at ISCED 7 - foreigner] / f9.[Total students enrolled at ISCED 7] END) as 'Share of foreigners students ISCED 7'
