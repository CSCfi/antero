...
/****** Object:  StoredProcedure [dbo].[p_lataa_tutkinnot_ja_tutkinnonosat_valitaulu_tasot_yhdistetty_luvat]    Script Date: 28.9.2023 15:02:36 ******/
SET ANSI_NULLS ON
GO
...
(
	case 
		when (d1.tutkintotyyppi_koodi = '02' and q.alkamispaiva >= '2018-08-01') 
			or (d1.tutkintotyyppi_koodi in ('19','20') and q.alkamispaiva >= '2019-01-01') then 1
		else 0
	end
)
