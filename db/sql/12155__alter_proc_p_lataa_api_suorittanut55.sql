...
/****** Object:  StoredProcedure [dw].[p_lataa_api_suorittanut55]    Script Date: 25.8.2026 12.23.39 ******/
SET ANSI_NULLS ON
GO
...
IF ((((	select count (*) from (
		select	[oppilaitos_koodi],[oppilaitos],[okm_ohjauksen_ala_koodi],[okm_ohjauksen_ala],[koulutusaste(taso2)_koodi],[koulutusaste(taso2)],
				...
				[koulutusala(taso3)],[koulutus_koodi],[koulutusnimike],[koulutustyyppi],[vuosi],[suorittanut_55],[suorittanut_55ilman_pankkia],[suorittanut_55pankin_avulla],
				[suorittanut_27]
