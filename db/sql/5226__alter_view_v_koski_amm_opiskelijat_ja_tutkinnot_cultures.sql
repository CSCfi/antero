...
/****** Object:  View [dw].[v_koski_amm_opiskelijat_ja_tutkinnot_cultures]    Script Date: 3.12.2021 3:27:33 ******/
SET ANSI_NULLS ON
GO
...
SELECT --TOP 1000
	...
	,[tutkintotyyppi_fi] = 
		case 
			when valma1_telma2 = 1 then 'VALMA' 
			when valma1_telma2 = 2 then 'TELMA' 
	...
	,case when valma1_telma2 = 1 then '97' when valma1_telma2 = 2 then '98' when d24.kytkin_koodi = 1 then '99' /*(select distinct jarjestys_tutkintotyyppi_koodi from [ANTERO].[dw].[d_koulutusluokitus] where tutkintotyypin_ryhma_koodi='09')*/ else d4.jarjestys_tutkintotyyppi_koodi end as jarjestys_tutkintotyyppi
...
/*tehdään tarvittaessa rajaus faktalatauksissa suoraan/apusarakkeella, ainakin yhdessä kuution ja näkymän getdatet sekä union all jumittivat*/
