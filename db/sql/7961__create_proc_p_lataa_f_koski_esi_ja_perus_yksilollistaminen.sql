...
FROM Koski_SA.dbo.esi_ja_perus_yksilollistaminen_perusjoukko_ja_aidinkielen_oppimaara t1
LEFT JOIN Koski_SA.dbo.esi_ja_perus_yksilollistaminen_oppiainesuoritukset t2 ON t2.paatason_suoritus_id = t1.paatason_suoritus_id
