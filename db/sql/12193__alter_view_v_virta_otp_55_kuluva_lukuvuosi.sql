...
/****** Object:  View [dw].[v_virta_otp_55_kuluva_lukuvuosi]    Script Date: 18.9.2026 13.58.05 ******/
SET ANSI_NULLS ON
GO
...
SELECT  
	...
	HASHBYTES('SHA2_256', vs.salt + f.henkilo_koodi) as Henkilo_koodi,
	...
	d8.kieli_fi as 'Koulutuksen kieli',
	d9.kunta_fi as 'Koulutuksen kunta',
	d9.maakunta_fi as 'Koulutuksen maakunta',
	d10.rahoituslahde_nimi_fi as 'Rahoituslähde',
	d11.koulutustyyppi as Koulutustyyppi,
	...
	d7.maanosa6_fi as 'Kansalaisuus',
	...
	d7.jarjestys_maanosa6_koodi as 'Kansalaisuus jarj',
	d9.jarjestys_kunta_koodi as 'Koulutuksen kunta jarj',
	d9.jarjestys_maakunta_koodi as 'Koulutuksen maakunta jarj',
	d10.jarjestys_rahoituslahde_koodi as 'Rahoituslähde jarj',
	d11.jarjestys as 'Koulutustyyppi jarj'
...
LEFT JOIN VipunenTK.dbo.d_koulutustyyppi d11 on d11.id = f.d_tk_koulutustyyppi_id
INNER JOIN ANTERO.dbo.view_salt vs on vs.[view] = 'v_virta_otp_55_kuluva_lukuvuosi'