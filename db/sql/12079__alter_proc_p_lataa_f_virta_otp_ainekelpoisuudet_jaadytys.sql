...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_ainekelpoisuudet_jaadytys]    Script Date: 27.5.2026 10.25.18 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	WHERE (f.kelpoisuuden_vuosi = ' + @alkuVuosi + ') or (' + @alkuVuosi + ' = 2025 and f.kelpoisuuden_vuosi <= 2025)'
