...
/****** Object:  View [dw].[v_koski_oppivelvollisten_opintojen_kulku_cultures]    Script Date: 15.1.2024 8:42:34 ******/
SET ANSI_NULLS ON
GO
...
DROP VIEW IF EXISTS [dw].[v_koski_oppivelvollisten_opintojen_kulku]
...
SELECT 
	...
	d28.kytkin_fi as ei_opiskeluoikeutta_oppivelvollisuuden_suorittamiseen_kelpaavassa_koulutuksessa_ei_paatosta_oppivelvollisuuden_suorittamisen_keskeyttamisesta_fi,
	d28.kytkin_sv as ei_opiskeluoikeutta_oppivelvollisuuden_suorittamiseen_kelpaavassa_koulutuksessa_ei_paatosta_oppivelvollisuuden_suorittamisen_keskeyttamisesta_sv,
	d29.kytkin_fi as opiskeluoikeus_oppivelvollisuuden_suorittamiseen_kelpaavassa_koulutuksessa_paatos_oppivelvollisuuden_suorittamisen_keskeyttamisesta_fi,
	d29.kytkin_sv as opiskeluoikeus_oppivelvollisuuden_suorittamiseen_kelpaavassa_koulutuksessa_paatos_oppivelvollisuuden_suorittamisen_keskeyttamisesta_sv,
	...
	d31.kytkin_fi as ei_opiskeluoikeutta_oppivelvollisuuden_suorittamiseen_kelpaavassa_koulutuksessa_paatos_oppivelvollisuuden_suorittamisen_keskeyttamisesta_fi,
	d31.kytkin_sv as ei_opiskeluoikeutta_oppivelvollisuuden_suorittamiseen_kelpaavassa_koulutuksessa_paatos_oppivelvollisuuden_suorittamisen_keskeyttamisesta_sv,
	...
	d28.jarjestys_kytkin_koodi as jarjestys_ei_opiskeluoikeutta_oppivelvollisuuden_suorittamiseen_kelpaavassa_koulutuksessa_ei_paatosta_oppivelvollisuuden_suorittamisen_keskeyttamisesta,
	d29.jarjestys_kytkin_koodi as jarjestys_opiskeluoikeus_oppivelvollisuuden_suorittamiseen_kelpaavassa_koulutuksessa_paatos_oppivelvollisuuden_suorittamisen_keskeyttamisesta,
	d30.jarjestys_kytkin_koodi as jarjestys_oppivelvollisuuden_suorittamiseen_kelpaavassa_koulutuksessa,
	d31.jarjestys_kytkin_koodi as jarjestys_ei_opiskeluoikeutta_oppivelvollisuuden_suorittamiseen_kelpaavassa_koulutuksessa_paatos_oppivelvollisuuden_suorittamisen_keskeyttamisesta
...
LEFT JOIN ANTERO.dw.d_kytkin d31 on d31.id = f.d_kytkin_kesk_ov_suor_val_valpas_id
LEFT JOIN ANTERO.dw.d_kytkin d30 on d30.kytkin_koodi = CASE WHEN d17.kytkin_koodi + d18.kytkin_koodi + d21.kytkin_koodi + d22.kytkin_koodi + d24.kytkin_koodi + d26.kytkin_koodi + d29.kytkin_koodi > 0 THEN 1 ELSE 0 END
