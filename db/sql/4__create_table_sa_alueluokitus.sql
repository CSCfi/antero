...
ALTER TABLE sa.sa_alueluokitus ADD  CONSTRAINT DF__sa_alueluokitus__loadtime  DEFAULT (getdate()) FOR loadtime
;
ALTER TABLE sa.sa_alueluokitus ADD  CONSTRAINT DF__sa_alueluokitus__username  DEFAULT (suser_name()) FOR username
;
