...
/****** Object:  Table [dw].[f_haku_ja_valinta_hakeneet_korkea_aste_hakijat]    Script Date: 17.11.2023 16:57:47 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dw].[f_haku_ja_valinta_hakeneet_korkea_aste_hakijat]') AND type in (N'U'))
