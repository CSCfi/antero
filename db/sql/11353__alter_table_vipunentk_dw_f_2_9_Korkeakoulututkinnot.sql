...
/****** Object:  Table [dbo].[f_2_9_Korkeakoulututkinnot]    Script Date: 5.11.2025 10.26.21 ******/
SET ANSI_NULLS ON
GO
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[f_2_9_Korkeakoulututkinnot]') AND type in (N'U'))
