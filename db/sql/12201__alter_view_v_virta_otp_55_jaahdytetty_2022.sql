...
/****** Object:  View [dw].[v_virta_otp_55_jaahdytetty_2022]    Script Date: 18.9.2026 14.28.35 ******/
SET ANSI_NULLS ON
GO
...
ALTER   VIEW  [dw].[v_virta_otp_55_jaahdytetty_2022] 
AS
...
FROM ANTERO.sa.sa_virta_otp_viisviis_2022 f
...
INNER JOIN ANTERO.dbo.view_salt vs on vs.[view] = 'v_virta_otp_55_jaahdytetty_2022'