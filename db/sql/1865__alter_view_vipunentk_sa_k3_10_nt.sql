...
/****** Object:  View [dbo].[v_sa_K3_10_Tutk_suor_osuus_aloittaneista_korkeakoulut_nykytila]    Script Date: 2.10.2018 12:18:06 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_sa_K3_10_Tutk_suor_osuus_aloittaneista_korkeakoulut_nykytila] AS
...
-- UUSI VUOSI
   ...
   ,[lkm]
      ,[tietolahde]='K3_10_sopv_18'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv, alvv, allk)
      ,[aineistorivinumero] = ROW_NUMBER() OVER(ORDER BY tilv, alvv, allk)
  FROM [TK_H9098_CSC].[dbo].[TK_K3_10_sopv_18_1] f1
  inner join [TK_H9098_CSC].[dbo].[TK_K3_10_sopv_18_2] as f2 on f1.rivinro=f2.rivinro 
