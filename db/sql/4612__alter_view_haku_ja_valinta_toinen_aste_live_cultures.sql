...
/****** Object:  View [dw].[v_haku_ja_valinta_toinen_aste_live_cultures]    Script Date: 18.5.2021 18:29:44 ******/
SET ANSI_NULLS ON
GO
...
--Suomi
	...
	,[pohjakoulutuksen_paattovuosi_fi] = case when f.pohjakoulutuksen_paattovuosi is null or f.pohjakoulutuksen_paattovuosi='0' then 'Tieto puuttuu' else cast(f.pohjakoulutuksen_paattovuosi as char(4)) end 
...
/* Jarjestykset */
	...
	,[jarjestys_koulutuksen_alkamiskausi] = d2.jarjestys
