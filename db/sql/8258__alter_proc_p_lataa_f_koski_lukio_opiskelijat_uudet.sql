...
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_lukio_opiskelijat_uudet]    Script Date: 2.11.2023 21:54:36 ******/
SET ANSI_NULLS ON
GO
...
FROM (
	...
	FROM (
		...
		SELECT oo.[opiskeluoikeus_oid]
			...
			--select distinct YEAR(CASE WHEN ooa.tila_alkanut > lps.alku THEN ooa.tila_alkanut ELSE lps.alku END) - YEAR(henk.syntymaaika)
