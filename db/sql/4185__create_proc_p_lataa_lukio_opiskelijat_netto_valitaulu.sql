...
DROP PROCEDURE IF EXISTS [dbo].[p_lataa_lukio_opiskelijat_netto_valitaulu]
GO

/****** Object:  StoredProcedure [dbo].[p_lataa_lukio_opiskelijat_netto_valitaulu]    Script Date: 14.12.2020 16:47:16 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[p_lataa_lukio_opiskelijat_netto_valitaulu] AS
