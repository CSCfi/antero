USE [VipunenTK]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__tutkintooikeusvuosi__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__syntymavuosi__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__oppilaitos__d_oppilaitoksen_taustatiedot_historia]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__oppilaitos__d_oppilaitoksen_taustatiedot]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__oppilaitos__d_alueluokitus_historia]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__oppilaitos__d_alueluokitus]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__opiskelijan_olo_tamm__d_opiskelijan_olo]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__opiskelijan_olo_syys__d_opiskelijan_olo]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__koulutusluokitus__d_koulutusluokitus_historia]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__koulutuslaji_OKM_id]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__koulutuksen_kunta__d_alueluokitus_historia]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__koulutuksen_kunta__d_alueluokitus]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__koulutuksen_kieli__d_kieli]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__koulutuksen_jarjestaja_kunta__d_alueluokitus_historia]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__koulutuksen_jarjestaja_kunta__d_alueluokitus]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__koulutuksen_jarjestaja__d_oppilaitoksen_taustatiedot_historia]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__koulutuksen_jarjestaja__d_oppilaitoksen_taustatiedot]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__kotikunta2x__d_alueluokitus_historia]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__kotikunta2x__d_alueluokitus]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__kotikunta1x__d_alueluokitus_historia]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__kotikunta1x__d_alueluokitus]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__kotikunta__d_alueluokitus_historia]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__kotikunta__d_alueluokitus]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__kirjoihinvuosi_kirjoihintulovuosi_korkeakoulusektori_lasnaoleva__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__kirjoihintulovuosi_tutkinto__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__kirjoihintulovuosi_sektori_lasnaoleva__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__kirjoihintulovuosi_sektori__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__kirjoihintulovuosi_opintoala_lasnaoleva__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__kirjoihintulovuosi_opintoala__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__kirjoihintulovuosi_korkeakoulu_lasnaoleva__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__kirjoihintulovuosi_korkeakoulu__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__kirjoihintulovuosi_kirjoihintulovuosi_korkeakoulusektori__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__kirjoihintulovuosi__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__kirjoihintulokausi_tutkinto__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__kirjoihintulokausi__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_yliopisto]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_vahintaan_55_op_suorittanut]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_uusi_vanha_opiskelija]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_tutkinto_yo]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_tutkinto_amk]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_tilauskoulutuksen_sijaintimaa]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_tiedekunta_yo]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_suuntautumisvaihtoehto_amk]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_sukupuoli]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_rahoituslahde]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_opiskelumuoto]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_opiskelijan_fte_tieto]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_opetushallinnon_koulutus]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_opettajankelpoisuus]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_lahde]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_koulutustyyppi]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_koulutussektori]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_koulutusohjelma_amk]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_koulutuslaji_OKM]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_kansalaisuus_versio2]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_ika]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_ensisijainen_opintooikeus]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_avoinvayla]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_aineisto_OTV]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_aineisto]
GO
ALTER TABLE [dbo].[f_OTV_2_8_Korkeakouluopiskelijat] DROP CONSTRAINT [FK__2_8__d_aidinkieli_versio1]
GO
/****** Object:  Table [dbo].[f_OTV_2_8_Korkeakouluopiskelijat]    Script Date: 12.3.2019 15:11:17 ******/
