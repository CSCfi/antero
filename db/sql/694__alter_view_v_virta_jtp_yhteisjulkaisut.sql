...
,[Koodit Julkaisun p‰‰luokka]
,[Julkaisun p‰‰luokka]
,[Julkaisun p‰‰luokkaSV]
,[Julkaisun p‰‰luokkaEN]
,[Koodit Julkaisutyyppi]
,[Julkaisutyyppi]
,[JulkaisutyyppiSV]
,[JulkaisutyyppiEN]
,[Koodit Julkaisun kansainv‰lisyys]
,[Julkaisun kansainv‰lisyys]
,[Julkaisun kansainv‰lisyysSV]
,[Julkaisun kansainv‰lisyysEN]
,[Koodit Kansainv‰linen yhteisjulkaisu]
,[Kansainv‰linen yhteisjulkaisu]
,[Kansainv‰linen yhteisjulkaisuSV]
,[Kansainv‰linen yhteisjulkaisuEN]
,case [Koodit P‰‰tieteenala] when -1 then 9 else [Koodit P‰‰tieteenala] end as [Koodit P‰‰tieteenala]
,[P‰‰tieteenala]
,[P‰‰tieteenalaSV]
,[P‰‰tieteenalaEN]
...
SELECT f.tilastovuosi AS "Tilastovuosi"
  ...
  ,d4.julkaisunpaaluokka_koodi as 'Koodit Julkaisun p‰‰luokka'
  ,d4.julkaisunpaaluokka_nimi_fi as 'Julkaisun p‰‰luokka'
  ,d4.julkaisunpaaluokka_nimi_sv as 'Julkaisun p‰‰luokkaSV'
  ,d4.julkaisunpaaluokka_nimi_en as 'Julkaisun p‰‰luokkaEN'
  ...
  ,d6.julkaisun_kansainvalisyys_koodi as 'Koodit Julkaisun kansainv‰lisyys'
  ,d6.julkaisun_kansainvalisyys_fi as 'Julkaisun kansainv‰lisyys'
  ,d6.julkaisun_kansainvalisyys_sv as 'Julkaisun kansainv‰lisyysSV'
  ,d6.julkaisun_kansainvalisyys_en as 'Julkaisun kansainv‰lisyysEN'
  ,d7.kansainvalinen_yhteisjulkaisu_koodi as 'Koodit Kansainv‰linen yhteisjulkaisu'
  ,d7.kansainvalinen_yhteisjulkaisu_fi as 'Kansainv‰linen yhteisjulkaisu'
  ,d7.kansainvalinen_yhteisjulkaisu_sv as 'Kansainv‰linen yhteisjulkaisuSV'
  ,d7.kansainvalinen_yhteisjulkaisu_en as 'Kansainv‰linen yhteisjulkaisuEN'
  ,d1.paatieteenala_koodi as 'Koodit P‰‰tieteenala'
  ,d1.paatieteenala_nimi_fi as 'P‰‰tieteenala'
  ,d1.paatieteenala_nimi_sv as 'P‰‰tieteenalaSV'
  ,d1.paatieteenala_nimi_en as 'P‰‰tieteenalaEN'
...
,NULL --[Koodit Julkaisun p‰‰luokka]
,NULL --[Julkaisun p‰‰luokka]
,NULL --[Julkaisun p‰‰luokkaSV]
,NULL --[Julkaisun p‰‰luokkaEN]
,NULL --[Koodit Julkaisutyyppi]
,NULL --[Julkaisutyyppi]
,NULL --[JulkaisutyyppiSV]
,NULL --[JulkaisutyyppiEN]
,NULL --[Koodit Julkaisun kansainv‰lisyys]
,NULL --[Julkaisun kansainv‰lisyys]
,NULL --[Julkaisun kansainv‰lisyysSV]
,NULL --[Julkaisun kansainv‰lisyysEN]
,NULL --[Koodit Kansainv‰linen yhteisjulkaisu]
,NULL --[Kansainv‰linen yhteisjulkaisu]
,NULL --[Kansainv‰linen yhteisjulkaisuSV]
,NULL --[Kansainv‰linen yhteisjulkaisuEN]
,[Koodit P‰‰tieteenala]=d21.paatieteenala_koodi
,[P‰‰tieteenala]=d21.paatieteenala_nimi_fi
,[P‰‰tieteenalaSV]=d21.paatieteenala_nimi_sv
,[P‰‰tieteenalaEN]=d21.paatieteenala_nimi_en
,NULL --case [Koodit Tieteenala] when -1 then 9999 else [Koodit Tieteenala] end as [Koodit Tieteenala]
,NULL --[Tieteenala]
,NULL --[TieteenalaSV]
,NULL --[TieteenalaEN]
,NULL --case [Koodit OKM ohjauksen ala] when -1 then 99 else [Koodit OKM ohjauksen ala] end as [Koodit OKM ohjauksen ala]
...
,NULL --[lukumaara]
,case when d22.koodi in ('1','2') then henkilotyovuosi else 0 end as 'Ammattikorkeakoulu_HTV_opetustki'
...
,case when d23.id<>'-1' then henkilotyovuosi else 0 end as 'YO_HTV_opetusTKI'
