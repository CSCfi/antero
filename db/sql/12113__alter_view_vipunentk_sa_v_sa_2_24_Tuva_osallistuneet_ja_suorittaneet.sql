...
/****** Object:  View [dbo].[v_sa_2_24_Tuva_osallistuneet_ja_suorittaneet]    Script Date: 15.6.2026 16.33.50 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
      ...
      ,[tilvasmaakx]
      ,[lkm]
	  ,[tietolahde]='2_24_sopv_26'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
FROM [TK_H9098_CSC].[dbo].[TK_K2_24_sopv_26]
