IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'api.julkaisut'))
EXEC dbo.sp_executesql @statement = N'
CREATE VIEW api.julkaisut AS
SELECT 1 AS a
'
GO

-- copy from: dw.v_virta_jtp_tilasto
