...
/****** Object:  View [dbo].[v_sa_7_17_Taiteen_perusopetuksen_opettajat_osallistuminen_täydennyskoulutukseen]    Script Date: 17.11.2020 19:41:04 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_sa_7_17_Taiteen_perusopetuksen_opettajat_osallistuminen_täydennyskoulutukseen] AS
...
FROM (
  ...
  FROM [TK_H9098_CSC].[dbo].[TK_7_17_vos_sopv_19]
