...
/****** Object:  StoredProcedure [dw].[p_lataa_f_amk_henkilon_tyo]    Script Date: 8.4.2026 12.58.12 ******/
SET ANSI_NULLS ON
GO
...
FROM ANTERO.sa.sa_suorat_amk1_henkilokunta  s1
LEFT JOIN  [VirtaSiirto].[sa].[sa_virta_otp_rekrytohtorit] s2 on s1.Henkilönumero = s2.henkilonumero and s1.VUOSI = s2.tilastovuosi and s1.Ammattikorkeakoulu = s2.rekrykorkeakoulu
WHERE s1.VUOSI >= 2021
