...
/****** Object:  View [dbo].[v_sa_4_1_Perusopetuksen_lisäopetuksen_päättäneiden_sijoittuminen]    Script Date: 13.3.2024 12:08:10 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
      ...
      ,[lkm]
      ,[luontipvm]
      ,[tietolahde]='TK_4_1_sopv_24'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
FROM [TK_H9098_CSC].[dbo].[TK_4_1_sopv_24]
