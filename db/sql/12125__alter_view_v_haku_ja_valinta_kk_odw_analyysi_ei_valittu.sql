...
/****** Object:  View [dw].[v_haku_ja_valinta_kk_odw_analyysi_ei_valittu]    Script Date: 27.7.2026 12.14.08 ******/
SET ANSI_NULLS ON
GO
...
ALTER   VIEW [dw].[v_haku_ja_valinta_kk_odw_analyysi_ei_valittu] AS
...
WHERE f.valittu = 0 and  f.valittu_hakukerralla = 0