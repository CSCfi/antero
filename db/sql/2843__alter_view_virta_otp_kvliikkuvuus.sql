...
/****** Object:  View [dw].[v_virta_otp_kvliikkuvuus]    Script Date: 17.2.2020 17:47:48 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	...
	,case 
		when cast((cast((f.tilastovuosi + 1) as varchar(4)) + '-03-20') as date) <= convert(date, getdate()) then 1
	    else 0
