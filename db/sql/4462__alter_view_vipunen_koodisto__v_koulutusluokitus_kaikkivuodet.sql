...
/****** Object:  View [dbo].[_v_koulutusluokitus_kaikkivuodet]    Script Date: 5.3.2021 19:42:09 ******/
SET ANSI_NULLS ON
GO
...
SELECT [koulutuskoodi] = [koulk]
	   ...
	   ,[kastenimi] = NULL
	   ,[kastenimi_r] = NULL
	   ,[opmala] = (select opmala FROM TK_H9098_CSC.dbo.TK_6_5_sopv_20 viimevuosi where viimevuosi.koulk = f.koulk) --temp kunnes etl-ketjut päivitetty
	   ,[opmalani] = (select opmalani FROM TK_H9098_CSC.dbo.TK_6_5_sopv_20 viimevuosi where viimevuosi.koulk = f.koulk) --temp kunnes etl-ketjut päivitetty
	   ,[opmalalni] = NULL
	   ,[opmopa] = (select opmopa FROM TK_H9098_CSC.dbo.TK_6_5_sopv_20 viimevuosi where viimevuosi.koulk = f.koulk) --temp kunnes etl-ketjut päivitetty
	   ,[opmopani] = (select opmopani FROM TK_H9098_CSC.dbo.TK_6_5_sopv_20 viimevuosi where viimevuosi.koulk = f.koulk) --temp kunnes etl-ketjut päivitetty
	   ,[opmopalni] = NULL
	   ,[opmast] = (select opmast FROM TK_H9098_CSC.dbo.TK_6_5_sopv_20 viimevuosi where viimevuosi.koulk = f.koulk) --temp kunnes etl-ketjut päivitetty
	   ,[opmastni] = (select opmastni FROM TK_H9098_CSC.dbo.TK_6_5_sopv_20 viimevuosi where viimevuosi.koulk = f.koulk) --temp kunnes etl-ketjut päivitetty
	   ,[opmastlni] = NULL
	   ,[opm95ala] = NULL
	   ,[opm95alani] = NULL
	   ,[opm95alalni] = NULL
