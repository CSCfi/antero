...
/****** Object:  StoredProcedure [dbo].[p_lataa_f_koulutukseen_sijoittuneet_6v_1_5_tarkastelujakso]    Script Date: 7.2.2024 9:54:11 ******/
SET ANSI_NULLS ON
GO
...
-- Oppilaitos 1
	...
	-- lukiokoulutuksen oppilaitos ja ammatillisen koulutuksen oppilaitos, merkit‰‰n lukiokoulutuksen oppilaitos _3
	when l.suorlk = '2' and l.luopisktunn_3 <> '' and l.ammopisktunn_3 <> '' and
	l.amkopisktunn_3 = '' and l.yoopisktunn_3 = '' then l.luopisktunn_3
	...
	-- ammattikorkeakoulutus ja yliopistokoulutus oppilaitos, merkit‰‰n ammattikorkeakoulutus _3  
	when l.suorlk = '2' and l.amkopisktunn_3 <> '' and l.yoopisktunn_3  <> '' and
	l.luopisktunn_3 = '' and l.ammopisktunn_3 = ''  then l.amkopisktunn_3 
...
-- Koulutus 2
(case
   -- jos lukiokoulutuksessa vain niin j‰tet‰‰n tyhj‰ksi _3
	when l.suorlk = '2' and l.luopiskkoulk_3 <> '' and l.ammopiskkoulk_3 = '' and
	l.amkopiskkoulk_3 = '' and l.yoopiskkoulk_3 = '' then ''
	-- jos ammattikoulutuksessa vain  j‰tet‰‰n tyhj‰ksi _3 
	when l.suorlk = '2' and l.luopiskkoulk_3 = '' and l.ammopiskkoulk_3 <> '' and
	l.amkopiskkoulk_3 ='' and l.yoopiskkoulk_3 = ''  then ''
	-- jos lukiokoulutksessa ja ammattikoulutuksessa merkit‰‰n ammattikoulutus _3 
	when l.suorlk = '2' and l.luopiskkoulk_3 <> '' and l.ammopiskkoulk_3 <> '' and
	l.amkopiskkoulk_3 = '' and l.yoopiskkoulk_3 = '' then l.ammopiskkoulk_3 
	...
	when l.suorlk = '2' and l.amkopiskkoulk_3 = '' and l.yoopiskkoulk_3 <> '' and 
	l.luopiskkoulk_3 = '' and l.ammopiskkoulk_3 = ''   then ''
	-- jos ammattikorkeakoulutuksessa ja yliopistokoulutuksessa merkit‰‰n yliopistokoulutus _3
	when l.suorlk = '2' and l.amkopiskkoulk_3 <> '' and l.yoopiskkoulk_3  <> '' and
	l.luopiskkoulk_3 = '' and l.ammopiskkoulk_3 = ''  then l.yoopiskkoulk_3
...
(case
	...
	-- ammatillisen koulutuksen oppilaitos _3 merkit‰‰n tyhj‰ksi
	when l.suorlk = '2' and l.luopisktunn_3 = '' and l.ammopisktunn_3 <> '' and
	l.amkopisktunn_3 ='' and l.yoopisktunn_3 = ''  then '' 
	-- lukiokoulutuksen ja ammatillisen koulutuksen oppilaitos merkit‰‰n ammatillisen koulutuksen oppilaitos _3
	when l.suorlk = '2' and l.luopisktunn_3 <> '' and l.ammopisktunn_3 <> '' and
	l.amkopisktunn_3 = '' and l.yoopisktunn_3 = '' then l.ammopisktunn_3 
	-- ammattikorkeakoulutksen oppilaitos vain merkit‰‰n tyhj‰ksi _3
	when l.suorlk = '2' and l.amkopisktunn_3  <> '' and l.yoopisktunn_3  = '' and
	l.luopisktunn_3 = '' and l.ammopisktunn_3 = '' then ''
	-- yliopistokoulutksen oppilaitos vain merkit‰‰n tyhj‰ksi _3
	when l.suorlk = '2' and l.amkopisktunn_3 = '' and l.yoopisktunn_3 <> '' and 
	l.luopisktunn_3 = '' and l.ammopisktunn_3 = ''   then ''  
	--  ammattikorkeakoulutksen oppilaitos ja yliopistokoulutuksen oppilaitos, merkit‰‰n yliopistokoulutuksen oppilaitos _3
	when l.suorlk = '2' and l.amkopisktunn_3 <> '' and l.yoopisktunn_3  <> '' and
	l.luopisktunn_3 = '' and l.ammopisktunn_3 = ''  then l.yoopisktunn_3 
...
-- Koulutuksen j‰rjest‰j‰ 2
	(case
	-- lukiokoulutuksen j‰rjest‰j‰ vain _3, merkit‰‰n tyhj‰ksi
	when l.suorlk = '2' and l.luopiskjarj_3  <> '' and l.ammopiskjarj_3 = '' and
	l.amkopiskjarj_3 = '' and l.yoopiskjarj_3 = '' then ''
	-- ammatillisen koulutuksen j‰rjest‰j‰ vain _3, merkit‰‰n tyhj‰ksi
	when l.suorlk = '2' and l.luopiskjarj_3 = '' and l.ammopiskjarj_3 <> '' and
	l.amkopiskjarj_3 ='' and l.yoopiskjarj_3 = ''  then ''
	-- lukiokoulutuksen ja ammatillisen koulutuksen j‰rjest‰j‰, merkit‰‰n ammatillisen koulutuksen j‰rjest‰j‰ _3
	when l.suorlk = '2' and l.luopiskjarj_3 <> '' and l.ammopiskjarj_3 <> '' and
	l.amkopiskjarj_3 = '' and l.yoopiskjarj_3 = '' then l.ammopiskjarj_3 
	...
	when l.suorlk = '2' and l.amkopiskjarj_3  = '' and l.yoopiskjarj_3  <> '' and 
	l.luopiskjarj_3  = '' and l.ammopiskjarj_3 = ''   then ''
	-- ammattikorkeakoulutuksen ja yliopistokoulutuksen j‰rjest‰j‰ merkit‰‰n yliopistokoulutuksen j‰rjet‰j‰ _3
	when l.suorlk = '2' and l.amkopiskjarj_3  <> '' and l.yoopiskjarj_3   <> '' and
	l.luopiskjarj_3  = '' and l.ammopiskjarj_3  = ''  then l.yoopiskjarj_3 
...
-- Koulutuksen maakunta 2
	(case
	-- vain lukiokoulutuksen maakunta _3, j‰tet‰‰n tyhj‰ksi
	when l.suorlk = '2' and l.luopiskmaak_3   <> '' and l.ammopiskmaak_3  = '' and
	l.amkopiskmaak_3  = '' and l.yoopiskmaak_3  = '' then ''
	-- vain ammatillisen koulutuksen maakunta _3, j‰tet‰‰n tyhj‰ksi   
	when l.suorlk = '2' and l.luopiskmaak_3  = '' and l.ammopiskmaak_3  <> '' and
	l.amkopiskmaak_3  ='' and l.yoopiskmaak_3  = ''  then ''  
	-- lukiokoulutuksen ja ammatillisen koulutuksen maakunta, merkit‰‰n ammatillisen koulutuksen maakunta _3
	when l.suorlk = '2' and l.luopiskmaak_3  <> '' and l.ammopiskmaak_3  <> '' and
	l.amkopiskmaak_3  = '' and l.yoopiskmaak_3  = '' then l.ammopiskmaak_3 
	-- vain ammattikorkeakoulutuksen maakunta _3, j‰tet‰‰n tyhj‰ksi
	when l.suorlk = '2' and l.amkopiskmaak_3   <> '' and l.yoopiskmaak_3   = '' and
	l.luopiskmaak_3 = '' and l.ammopiskmaak_3 = '' then '' 
	-- vain yliopistokoulutuksen maakunta _3, merkit‰‰n tyhj‰ksi
	when l.suorlk = '2' and l.amkopiskmaak_3  = '' and l.yoopiskmaak_3  <> '' and 
	l.luopiskmaak_3  = '' and l.ammopiskmaak_3 = ''   then '' 
	-- ammattikorkeakoulutuksen ja yliopistokoulutuksen maakunta _3, merkit‰‰n yliopistokoulutuksen maakunta _3
	when l.suorlk = '2' and l.amkopiskmaak_3  <> '' and l.yoopiskmaak_3   <> '' and
	l.luopiskjarj_3  = '' and l.ammopiskmaak_3  = ''  then l.yoopiskmaak_3
...
,case
	when  l.suorlk = '2' and (l.monihaku_1 in (2,3,5,0,8,9) or l.monihaku_2 in (2,3,5,0,8,9) or l.monihaku_3 in (2,3,5,0,8,9)) then 1
...
,case
	when  l.suorlk = '2' and (l.monihaku_1 in (4,6,0,8) or l.monihaku_2 in (4,6,0,8) or l.monihaku_3 in (4,6,0,8)) then 1
...
,case
	when  l.suorlk = '2' and (l.monihaku_1 in (6,7,0,9) or l.monihaku_2 in (6,7,0,9) or l.monihaku_3 in (6,7,0,9)) then 1
...
,case 
	when  l.suorlk = '2' and (monihaku_1 in (4,5,6,7,0,8,9) or monihaku_2 in (4,5,6,7,0,8,9) or monihaku_3 in (4,5,6,7,0,8,9)) and l.amkopiskkoulk_1 = '' and l.yoopiskkoulk_1 = '' and l.amkopiskkoulk_2 = '' and l.yoopiskkoulk_2 = '' and l.amkopiskkoulk_3 = '' and l.yoopiskkoulk_3 = '' then 1
