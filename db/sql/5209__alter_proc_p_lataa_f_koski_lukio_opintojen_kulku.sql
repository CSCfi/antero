...
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_lukio_opintojen_kulku]    Script Date: 7.10.2021 5:58:31 ******/
SET ANSI_NULLS ON
GO
...
--JUHAN TESTI, LISÄTTY OPPIMÄÄRÄ KAIKKIIN EDELTÄVIIN POIMINTOIHIN JA YLEISSIV. PÄÄTTELYIHIN, MUUTETTU MYÖS d15-JOIN
LEFT JOIN (
	SELECT DISTINCT 
		opiskeluoikeus_oid, 
		/*oppimaara = 
...
LEFT JOIN ANTERO.dw.d_opintojen_kulku_keskiarvot d17 ON d17.keskiarvo_koodi = q.[peruskoulu_keskiarvo_kategoria_koodi] AND d17.tyyppi='keskiarvo'
LEFT JOIN ANTERO.dw.d_opintojen_kulku_keskiarvot d18 ON d18.keskiarvo_koodi = q.[peruskoulu_keskiarvo_lukuaineet_kategoria] AND d18.tyyppi='keskiarvo' 
