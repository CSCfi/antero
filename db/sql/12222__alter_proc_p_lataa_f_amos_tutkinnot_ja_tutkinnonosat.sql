...
/****** Object:  StoredProcedure [dw].[p_lataa_f_amos_tutkinnot_ja_tutkinnonosat]    Script Date: 25.9.2026 15.23.12 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN dw.d_organisaatioluokitus d1a on d1a.organisaatio_oid = COALESCE(d1d.oid_amos_spl, d1d.oid_avain) -- CSCVIPUNEN-3358: Taustatiedot uusimman varainhoitovuoden järjestäjärakenteen mukaan. JK
