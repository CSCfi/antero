...
/****** Object:  View [dbo].[v_K3_13_Perusk_paattaneet_amm_tutk_suorittaneet]    Script Date: 4.9.2020 20:14:37 ******/
SET ANSI_NULLS ON
GO
...
--kopio koodi alta, päivitä tietolähteen ja lähdetaulun lisäksi vuodet lähdemateriaalin mukaan REPLACE-toiminnolla, esim. TK_K3_13_sopv_18 VUOSI1 -> 2011, ja lisää ylle
/*
UNION ALL
...
SELECT
	  ...
	  ,[lkm]
	  ,[pohjkoul]
      ,[tietolahde]='K3_13_sopv_XX'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
FROM [TK_H9098_CSC].[dbo].[TK_K3_13_sopv_XX]
