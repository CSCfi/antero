...
/****** Object:  View [dbo].[v_f_R4_14b_Alueella_tyossakayvat_tilastokeskuksen_toimialan_mukaan]    Script Date: 14.11.2018 17:40:11 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
	  ...
	  ,[koulutusala_taso2_id]=ISNULL(d11b.id,-2)
      ,[tmaak]
