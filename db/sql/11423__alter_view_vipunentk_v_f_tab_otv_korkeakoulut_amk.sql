...
/****** Object:  View [dbo].[v_f_tab_otv_korkeakoulut_amk]    Script Date: 18.11.2025 15.41.01 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_f_tab_otv_korkeakoulut_amk] AS
...
,d45.patevyyteen_tahtaavat_opinnot as 'Pätevyyteen tähtäävät opinnot'
...
,d9c.oppilaitos as 'Ammattikorkeakoulu (tilastovuosi)'
...
,coalesce(d21a.koulutusaste2002_fi, 'Tieto puuttuu') as "Koulutusaste (2002)"
,coalesce(d21a.koulutusala2002_fi, 'Tieto puuttuu') as "Koulutusala (2002)"
,coalesce(d21a.opintoala1995_fi, 'Tieto puuttuu') as "Koulutusala (1995)"
,coalesce(d21a.opintoala2002_fi, 'Tieto puuttuu') as "Opintoala (2002)"
,coalesce(d21a.koulutusluokitus_fi, 'Tieto puuttuu') as Koulutusnimike
...
,d45.jarjestys as jarj_patevyyteen_tahtaavat_opinnot
...
,coalesce(d21a.jarjestys_koulutusaste2002_koodi, '99999') as jarjestys_koulutusaste2002
,coalesce(d21a.jarjestys_koulutusala2002_koodi, '99999') as jarjestys_koulutusala2002
,coalesce(d21a.jarjestys_opintoala1995_koodi, '99999') as jarjestys_opintoala1995
,coalesce(d21a.jarjestys_opintoala2002_koodi, '99999') as jarjestys_opintoala2002
,coalesce(d21.jarjestys, '998') as jarj_koulnimike
...
,coalesce(d21a.koulutusaste2002_koodi, '-1') as 'Koodit Koulutusaste 2002'
,coalesce(d21a.koulutusala2002_koodi, '-1') as 'Koodit Koulutusala 2002'
,coalesce(d21a.opintoala1995_koodi, '-1') as 'Koodit Koulutusala 1995'
,coalesce(d21a.opintoala2002_koodi, '-1') as 'Koodit Opintoala 2002'
,coalesce(d21a.koulutusluokitus_koodi, '-1') as 'Koodit Koulutusnimike'
...
,d16.kieli_SV as "Utbildningens språk"
...
,coalesce(d21a.koulutusaste2002_SV, 'Information saknas') as "Utbildningsnivå (2002)"
,coalesce(d21a.koulutusala2002_SV, 'Information saknas') as "Utbildningsområde (2002)"
,coalesce(d21a.opintoala1995_SV, 'Information saknas') as "Utbildningsområde (1995)"
,coalesce(d21a.opintoala2002_SV, 'Information saknas') as "Studieområde (2002)"
,coalesce(d21a.koulutusluokitus_SV, 'Information saknas') as Utbildningsbenämning
...
,d16.kieli_EN as "Language of education"
...
,coalesce(d21a.koulutusaste2002_EN, 'Missing data') as "Level of education (2002)"
,coalesce(d21a.koulutusala2002_EN, 'Missing data') as "Field of education (2002)"
,coalesce(d21a.opintoala1995_EN, 'Missing data') as "Field of education (1995)"
,coalesce(d21a.opintoala2002_EN, 'Missing data') as "Subfield of ed. (2002)"
,coalesce(d21a.koulutusluokitus_EN, 'Missing data') as "Name of education"
...
--isced
,coalesce(d21a.koulutusastetaso1_fi, 'Tieto puuttuu') as "Koulutusaste, taso 1"
,coalesce(d21a.koulutusastetaso2_fi, 'Tieto puuttuu') as "Koulutusaste, taso 2"
,coalesce(d21a.koulutusalataso1_fi, 'Tieto puuttuu') as "Koulutusala, taso 1"
,coalesce(d21a.koulutusalataso2_fi, 'Tieto puuttuu') as "Koulutusala, taso 2"
,coalesce(d21a.koulutusalataso3_fi, 'Tieto puuttuu') as "Koulutusala, taso 3"
,coalesce(d21a.okmohjauksenala_fi, 'Tieto puuttuu') as "OKM ohjauksen ala, korkeak."
,coalesce(d21a.koulutusastetaso1_sv, 'Information saknas') as "Utbildn.nivå, nivå 1"
,coalesce(d21a.Koulutusastetaso2_SV, 'Information saknas') as "Utbildn.nivå, nivå 2"
,coalesce(d21a.koulutusalataso1_sv, 'Information saknas') as "Utbildn.område, nivå 1"
,coalesce(d21a.koulutusalataso2_sv, 'Information saknas') as "Utbildn.område, nivå 2"
,coalesce(d21a.koulutusalataso3_sv, 'Information saknas') as "Utbildn.område, nivå 3"
,coalesce(d21a.okmohjauksenala_sv, 'Information saknas') as "UKM-styrningsområde, högskolor"
,coalesce(d21a.koulutusastetaso1_en, 'Missing data') as "Level of ed., tier 1"
,coalesce(d21a.Koulutusastetaso2_EN, 'Missing data') as "Level of ed., tier 2"
,coalesce(d21a.koulutusalataso1_en, 'Missing data') as "Field of education, tier 1"
,coalesce(d21a.koulutusalataso2_en, 'Missing data') as "Field of education, tier 2"
,coalesce(d21a.koulutusalataso3_en, 'Missing data') as "Field of education, tier 3"
,coalesce(d21a.okmohjauksenala_en, 'Missing data') as "Field of ed., HE steering"
,coalesce(d21a.jarjestys_koulutusastetaso1_koodi, '99999') as jarj_isced_koulast1
,coalesce(d21a.jarjestys_koulutusastetaso2_koodi, '99999') as jarj_isced_koulast2
,coalesce(d21a.jarjestys_koulutusalataso1_koodi, '99999') as jarj_isced_koulala1
,coalesce(d21a.jarjestys_koulutusalataso2_koodi, '99999') as jarj_isced_koulala2
,coalesce(d21a.jarjestys_koulutusalataso3_koodi, '99999') as jarj_isced_koulala3
,coalesce(d21a.jarjestys_okmohjauksenala_koodi, '99999') as jarj_isced_okmohjaus1
,coalesce(d21a.koulutusastetaso1_koodi, '-1') as "Koodit Koulutusaste, taso 1"
,coalesce(d21a.Koulutusastetaso2_koodi, '-1') as "Koodit Koulutusaste, taso 2"
,coalesce(d21a.koulutusalataso1_koodi, '-1') as "Koodit Koulutusala, taso 1"
,coalesce(d21a.koulutusalataso2_koodi, '-1') as "Koodit Koulutusala, taso 2"
,coalesce(d21a.koulutusalataso3_koodi, '-1') as "Koodit Koulutusala, taso 3"
,coalesce(d21a.okmohjauksenala_koodi, '-1') as "Koodit OKM ohjauksen ala, korkeak."
--rahoitusmallialat
,d21.OKM_ohjauksen_ala_amk_tav as 'Rahoitusmallialat amk 2017-2020'
,d21.OKM_ohjauksen_ala_amk_tav as 'Rahoitusmallialat amk 2021-2024'
,d21.jarjestys_OKM_ohjauksen_ala_amk_tav as jarj_rahoitusala2016_amk
--Lukumäärämuuttujat
,[Opisk2]
,[Aloit2] = case when d21a.Koulutusastetaso2_koodi in(62,71) then Aloit2 else 0 end
...
,[op_amk_yleissiv_amm_opplait_osuus]
,[op_amk_muualla_osuus]
,[op_amk_muu_amk_osuus]
,[op_amk_yliopistoissa_osuus]
,[op_amk_ulkomailla_osuus]
,[op_amk_ei_oma_amk_yht_osuus]
...
SELECT [tilastointivuosi] as Tilastovuosi
	  ...
	  ,tutkinto_yo_id
	  ,koulutustyyppi_id
	  ,patevyyteen_tahtaavat_opinnot_id
	  ...
	  ,[op_amk_yleissiv_amm_opplait_osuus] = null
	  ,[op_amk_muualla_osuus] = null
	  ,[op_amk_muu_amk_osuus] = null
	  ,[op_amk_yliopistoissa_osuus] = null
	  ,[op_amk_ulkomailla_osuus] = null
	  ,[op_amk_ei_oma_amk_yht_osuus] = null
...
SELECT [tilastointivuosi] as Tilastovuosi
	  ...
	  ,[op_amk_yleissiv_amm_opplait_osuus] = case when op_amk_yhteensa = 0 then 0.0 when op_amk_yhteensa is null then null else cast((cast(op_amk_yleissiv_amm_opplait as decimal) / cast(op_amk_yhteensa as decimal)) as decimal(10,7)) end
	  ,[op_amk_muualla_osuus] = case when op_amk_yhteensa = 0 then 0.0 when op_amk_yhteensa is null then null else cast((cast(op_amk_muualla as decimal) / cast(op_amk_yhteensa as decimal)) as decimal(10,7)) end
      ,[op_amk_muu_amk_osuus] = case when op_amk_yhteensa = 0 then 0.0 when op_amk_yhteensa is null then null else cast((cast(op_amk_muu_amk as decimal) / cast(op_amk_yhteensa as decimal)) as decimal(10,7)) end
	  ,[op_amk_yliopistoissa_osuus] = case when op_amk_yhteensa = 0 then 0.0 when op_amk_yhteensa is null then null else cast((cast(op_amk_yliopistoissa as decimal) / cast(op_amk_yhteensa as decimal)) as decimal(10,7)) end
	  ,[op_amk_ulkomailla_osuus] = case when op_amk_yhteensa = 0 then 0.0 when op_amk_yhteensa is null then null else cast((cast(op_amk_ulkomailla as decimal) / cast(op_amk_yhteensa as decimal)) as decimal(10,7)) end
	  ,[op_amk_ei_oma_amk_yht_osuus] = case when op_amk_yhteensa = 0 then 0.0 when op_amk_yhteensa is null then null else cast((cast((op_amk_yleissiv_amm_opplait + op_amk_muualla + op_amk_muu_amk + op_amk_yliopistoissa + op_amk_ulkomailla) as decimal) / cast(op_amk_yhteensa as decimal)) as decimal(10,7)) end
...
SELECT [tilastointivuosi] as Tilastovuosi
	  ...
	  ,tutkinto_yo_id = -1
	  ,koulutustyyppi_id = -1
	  ,patevyyteen_tahtaavat_opinnot_id = -1
  ...
  FROM [dbo].[f_OTV_4_9_Vaestorakenne_kunnittain]
	...
	LEFT JOIN [dbo].d_patevyyteen_tahtaavat_opinnot_amk d45 on d45.id = f.patevyyteen_tahtaavat_opinnot_id
...
AND*/ 
d10.lahde_koodi in ('-1','41','42') AND d9.oppilaitoskoodi NOT IN ('02557','10031','02358')
AND coalesce(d9.oppilaitoksen_korvaavakoodi,d9.oppilaitoskoodi) not in ('01029','01569','10102') --ahvenanmaan oppilaitokset pois
--and Koulutusaste_taso2 <> 'Ammatillinen peruskoulutus'
