...
FROM (
	...
	SELECT DISTINCT
		...
		,sa.hankintakoulutuksen_toimipiste_oid
		,sa.hankintakoulutuksen_oppilaitos_oid
...
LEFT JOIN d_organisaatioluokitus d12b ON d12b.organisaatio_oid = k.hankintakoulutuksen_oppilaitos_oid
...
LEFT JOIN d_organisaatioluokitus d18b ON d18b.organisaatio_oid = k.hankintakoulutuksen_toimipiste_oid
