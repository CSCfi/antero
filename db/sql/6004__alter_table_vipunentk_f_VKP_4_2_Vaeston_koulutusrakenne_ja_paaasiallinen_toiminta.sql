...
ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_vaeston_ika_5v_d_ika]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_vaeston_ika_1v_d_ika]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_tutkinnon_suoritusvuosi_d_kausi]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_tutkinnon_suoritusmaakunta_historia_d_alueluokitus_historia]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_tutkinnon_suoritusmaakunta_d_alueluokitus]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_tutkinnon_suoritusika_1v_d_ika]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_tutkinnon_ika_1v_d_ika]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_syntymavuosi_d_kausi]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_sukupuoli_d_sukupuoli]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_pohjoismaa_d_pohjoismaa]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_paaasiallinen_toiminta_versio6_d_paaasiallinen_toiminta]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_oppisopimuskoulutus_d_oppisopimuskoulutus]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_koulutusmuoto_d_koulutusmuoto]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_koulutusluokitus_historia_d_koulutusluokitus_historia]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_kansalaisuus_versio1_d_kansalaisuus_versio1]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_eumaa_d_valtio]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_etamaa_d_valtio]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_d_tyossakayntitilaston_tyonantajasektori]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_asuinmaakunta_historia_d_alueluokitus_historia]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_asuinmaakunta_d_alueluokitus]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_ammattiluokitus_2010_d_ammattiluokitus_2010]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_ammattiluokitus_2001_d_ammattiluokitus_2001]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_aineisto_d_aineisto]
GO

ALTER TABLE [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta] DROP CONSTRAINT [FK_4_2_aidinkieli_versio1_d_aidinkieli_versio1]
GO

/****** Object:  Table [dbo].[f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta]    Script Date: 7.3.2022 0:21:02 ******/
