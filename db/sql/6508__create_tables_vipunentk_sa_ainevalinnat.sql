...
/****** Object:  Table [dbo].[TK_Koski_lukio_ainevalinnat_kurssit_2022]    Script Date: 4.10.2022 0:58:50 ******/
SET ANSI_NULLS ON
GO
...
IF OBJECT_ID(N'dbo.TK_Koski_lukio_ainevalinnat_suorittaneet_2022', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'dbo.TK_Koski_lukio_ainevalinnat_kurssit_2022', N'U') IS NULL
BEGIN
CREATE TABLE [dbo].[TK_Koski_lukio_ainevalinnat_kurssit_2022](
	[Tilastovuosi] [int] NOT NULL,
	[paatason_suoritus_id] [bigint] NOT NULL,
	[lukionoppimaara] [nvarchar](255) NULL,
...
IF OBJECT_ID(N'dbo.TK_Koski_perusopetus_ainevalinnat_2022', N'U') IS NULL
BEGIN
CREATE TABLE [dbo].[TK_Koski_perusopetus_ainevalinnat_2022](
