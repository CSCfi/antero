...
ALTER TABLE [dw].[f_virta_otp_opintopiste_pvm_yo] DROP CONSTRAINT IF EXISTS [DF__f_virta_otp_opintopiste_pvm_yo__username]
GO

ALTER TABLE [dw].[f_virta_otp_opintopiste_pvm_yo] DROP CONSTRAINT IF EXISTS [DF__f_virta_otp_opintopiste_pvm_yo__loadtime]
GO

/****** Object:  Table [dw].[f_virta_otp_opintopiste_pvm_yo]    Script Date: 21.4.2021 20:10:44 ******/
DROP TABLE IF EXISTS [dw].[f_virta_otp_opintopiste_pvm_yo]
GO
