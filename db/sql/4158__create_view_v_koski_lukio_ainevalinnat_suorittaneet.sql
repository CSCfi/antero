...
/****** Object:  View [dw].[v_koski_lukio_ainevalinnat_suorittaneet]    Script Date: 2.12.2020 0:16:00 ******/
DROP VIEW IF EXISTS [dw].[v_koski_lukio_ainevalinnat_suorittaneet]
GO
...
CREATE VIEW [dw].[v_koski_lukio_ainevalinnat_suorittaneet] AS
...
FROM 
(
	SELECT * FROM /*DWIVIPUARCH.*/ANTERO.dw.f_koski_lukio_ainevalinnat_suorittaneet --ANTERO_jäädytyspvm1
