...
/****** Object:  StoredProcedure [dw].[p_lataa_f_varda_vuokrattu_henkilosto]    Script Date: 19.8.2024 12:40:55 ******/
SET ANSI_NULLS ON
GO
...
FROM varda_sa.sa.sa_varda_vuokrattuhenkilosto s
LEFT JOIN [Varda_SA].[sa].[sa_varda_organisaatio] s2 on s.vakajarjestaja_id = s2.id
--LEFT JOIN [Varda_SA].[sa].[sa_varda_toimipaikka] s3 on s.vakajarjestaja_id = s3.vakajarjestaja_id 
