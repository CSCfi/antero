...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[api].[amm_rahoitus_tutkinnot_ja_osaamispisteet]') AND type in (N'U'))
DROP TABLE [api].[amm_rahoitus_tutkinnot_ja_osaamispisteet]
GO
