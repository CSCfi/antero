...
/****** Object:  View [dbo].[v_f_tab_ulkomaalaiset_maan_kansalaisuuden_aidinkielen_mukaan_lukio]    Script Date: 30.12.2021 13:47:44 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_f_tab_ulkomaalaiset_maan_kansalaisuuden_aidinkielen_mukaan_lukio] AS
SELECT 
...
WHERE d2.Koulutusaste_taso2_koodi = '31' AND d13.opiskelijan_olo_koodi <> '-1' 
