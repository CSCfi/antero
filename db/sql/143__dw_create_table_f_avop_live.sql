IF NOT EXISTS (select * from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA='dw' and TABLE_NAME='f_avop_live') BEGIN
...
ALTER TABLE dw.f_avop_live ADD  CONSTRAINT PK__f_avop_live PRIMARY KEY CLUSTERED (id ASC)
;

ALTER TABLE dw.f_avop_live ADD  CONSTRAINT DF__f_avop_live__loadtime  DEFAULT (getdate()) FOR loadtime
;
ALTER TABLE dw.f_avop_live ADD  CONSTRAINT DF__f_avop_live__username  DEFAULT (suser_sname()) FOR username
;
