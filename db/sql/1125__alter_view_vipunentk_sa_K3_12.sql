...
/****** Object:  View [dbo].[v_K3_12_Perusk_paattaneet_amm_tutk_suorittaneet]    Script Date: 22.12.2017 14:06:05 ******/
SET ANSI_NULLS ON
GO
...
/* uudessa aineistossa kentät nimetty väärin, pitäisi olla vuosi+1 */
UNION ALL
...
(CASE WHEN [ammopisktunn_2014] = 'BBBBBB' THEN ''
      ...
      when [ammopisktunn_2014]  = '90006' AND [tilv] = '2010' THEN ''
      when [ammopisktunn_2014]  = '90006' AND [tilv] = '2011' THEN ''
        when [ammopisktunn_2014] = '90018' AND [tilv] = '2014' THEN ''
      ELSE [ammopisktunn_2014] END)AS ammopisktunn2014,
ammopiskjarj_2014, 
(CASE WHEN [ammopiskmaak_2014] = '99' THEN ''ELSE [ammopiskmaak_2014] END) as ammopiskmaak2014, 
amkopiskkoulk_2014, 
