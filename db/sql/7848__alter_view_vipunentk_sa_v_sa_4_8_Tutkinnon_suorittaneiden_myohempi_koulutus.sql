...
/****** Object:  View [dbo].[v_sa_4_8_Tutkinnon_suorittaneiden_myohempi_koulutus]    Script Date: 10.7.2023 15:18:39 ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT [suorv]
      ...
      ,[lkm]
      ,[luontipvm]
	  ,tilv = (select max(lusuorv) FROM [TK_H9098_CSC].[dbo].[TK_K4_8_sopv_23])
      ,[tietolahde]='TK_4_8_sopv_23'
      --,[rivinumero] = ROW_NUMBER() OVER(ORDER BY koulk)
FROM [TK_H9098_CSC].[dbo].[TK_K4_8_sopv_23]
