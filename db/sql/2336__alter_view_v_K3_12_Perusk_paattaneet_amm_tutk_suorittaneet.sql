...
/****** Object:  View [dbo].[v_K3_12_Perusk_paattaneet_amm_tutk_suorittaneet]    Script Date: 1.8.2019 7:30:30 ******/
SET ANSI_NULLS ON
GO
...
--Sopimusvuoden 2019 aineiston tultua poista edellinen select-lause kommentteineen sekä tämä kommentti kokonaan ja alta vain kommenttiviivat.
--SELECT
--tilv, 
--CAST(tilv + '0101' AS date) AS tilv_date,
--tutkryh,
