...
/****** Object:  View [dw].[v_koski_lukio_opiskelijat_kuukausittain]    Script Date: 10.6.2021 7:30:45 ******/
SET ANSI_NULLS ON
GO
...
-- KOULUTUSMUUTTUJAT
	...
	,d17.kieliryhma1_fi AS [Suorituskieliryhmä]
--	,d15.kieli_fi AS Suorituskieli
    ,d17.kieli_fi AS Suorituskieli
-- HENKILÖMUUTTUJAT
	,case
...
-- JÄRJESTYSMUUTTUJAT
	...
	,d17.jarjestys_kieliryhma1 AS jarj_suorituskieliryhma
...
--  LEFT JOIN ANTERO.dw.d_koulutusluokitus AS d5 ON f.koulutusmoduuli_koodiarvo = d5.koulutusluokitus_koodi
  ...
  LEFT JOIN ANTERO.dw.d_kieli AS d17 ON d8.oppilaitoksenopetuskieli_koodi = d17.kieli_koodi
