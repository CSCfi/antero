...
/****** Object:  StoredProcedure [dw].[p_lataa_f_haku_ja_valinta_hakeneet_korkea_aste]    Script Date: 28.10.2020 9:34:50 ******/
SET ANSI_NULLS ON
GO
...
SELECT
	...
	d33.JonoNimi,
	CASE 
		WHEN coalesce(d33.Kokonaispisteet,0) >= coalesce(d33.HakukohdeAlinLaskettuValintapistemaara,0) THEN d33.Kokonaispisteet
		ELSE d33.HakukohdeAlinLaskettuValintapistemaara
