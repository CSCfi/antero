...
/****** Object:  StoredProcedure [dw].[p_lataa_f_arvo_yo_uraseuranta_2018]    Script Date: 15.5.2020 16:40:24 ******/
SET ANSI_NULLS ON
GO
...
SELECT  
      ...
      ,cast(left(f2.koulutusalakoodi, 7) as int) as [Koodit Koulutus]
...
,'V  Kiitos paljon vastauksistasi!'
,'VII Kiitos paljon vastauksistasi!') 
and kysymykset.vastaustyyppi<>'vapaateksti' OR f1.Kysymysnumero in (8240, 8242, 8254, 6923, 6921, 6935)
