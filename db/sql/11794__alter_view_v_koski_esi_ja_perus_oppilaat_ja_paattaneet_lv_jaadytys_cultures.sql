...
/****** Object:  View [dw].[v_koski_esi_ja_perus_oppilaat_ja_paattaneet_lv_jaadytys_cultures]    Script Date: 30.1.2026 17.14.22 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dw].[v_koski_esi_ja_perus_oppilaat_ja_paattaneet_lv_jaadytys_cultures] AS
...
SELECT --top 1000
  ...
  --FI
	...
	,kansalaisuus_ryhma_fi = d22.maanosa6_fi
	...
	,kuljetusetuus_fi = d31.kytkin_fi
	,majoitusetuus_fi = d31b.kytkin_fi
	...
	,vuosiluokkiin_sitomaton_opetus_fi = case when tutk > 0 or tilastopaiva_1_0 = 1 then d35.kytkin_fi else 'Tieto puuttuu' end
	...
	,oppilaitoksen_kunta_fi = coalesce(d10.kunta_fi, d10b.kunta_fi)
	,oppilaitoksen_maakunta_fi = coalesce(d10.maakunta_fi, d10b.maakunta_fi)
	,oppilaitoksen_avi_fi = coalesce(d10.avi_fi, d10b.avi_fi)
	,oppilaitoksen_ely_fi = coalesce(d10.ely_fi, d10b.ely_fi)
  ...
  --SV
	...
	,kansalaisuus_ryhma_sv = d22.maanosa6_sv
	...
	,kuljetusetuus_sv = d31.kytkin_sv
	,majoitusetuus_sv = d31b.kytkin_sv
	...
	,vuosiluokkiin_sitomaton_opetus_sv = case when tutk > 0 or tilastopaiva_1_0 = 1 then d35.kytkin_sv else 'Information saknas' end
	...
	,oppilaitoksen_kunta_sv = coalesce(d10.kunta_sv, d10b.kunta_sv)
	,oppilaitoksen_maakunta_sv = coalesce(d10.maakunta_sv, d10b.maakunta_sv)
	,oppilaitoksen_avi_sv = coalesce(d10.avi_sv, d10b.avi_sv)
	,oppilaitoksen_ely_sv = coalesce(d10.ely_sv, d10b.ely_sv)
	,opetuksen_jarjestaja_sv = d11.organisaatio_sv
	,opetuksen_jarjestajan_yritysmuoto_sv = d11.koulutuksen_jarjestajan_yritysmuoto
  ...
  --JARJESTYS
	...
	,jarjestys_kansalaisuus_ryhma = d22.jarjestys_maanosa6_koodi
	...
	,jarjestys_oppilaitoksen_maakunta = coalesce(d10.jarjestys_maakunta_koodi, d10b.jarjestys_maakunta_koodi)
	,jarjestys_oppilaitoksen_ely = coalesce(d10.jarjestys_ely_koodi, d10b.jarjestys_ely_koodi)
	,jarjestys_oppilaitoksen_avi = coalesce(d10.jarjestys_avi_koodi, d10b.jarjestys_avi_koodi)
...
FROM [dw].[f_koski_esi_ja_perus_oppilaat_ja_paattaneet_lukuvuosittain_jaadytys] f
...
LEFT JOIN dw.d_alueluokitus d10 ON d10.kunta_koodi = nullif(d5.kunta_koodi, '-1')
LEFT JOIN dw.d_alueluokitus d10b ON d10b.kunta_koodi = f.oppilaitos_kotipaikka --jos organisaatiotieto ei luokituksessa
