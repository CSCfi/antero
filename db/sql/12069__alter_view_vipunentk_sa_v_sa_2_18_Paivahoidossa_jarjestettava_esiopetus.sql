...
/****** Object:  View [dbo].[v_sa_2_18_Paivahoidossa_jarjestettava_esiopetus]    Script Date: 7.5.2026 10.58.55 ******/
SET ANSI_NULLS ON
GO
...
SELECT f.[tilv]
      ...
      ,[jmamueo4] = NULL
      ,[jmamueo4n] = NULL
FROM [TK_H9098_CSC]..[TK_K2_22b_sopv_26] f
LEFT JOIN TK_H9098_CSC..[TK_6_2_sopv_26] d on d.jarj = f.jarj
WHERE f.esi = '1' and f.oppilas = '1'
