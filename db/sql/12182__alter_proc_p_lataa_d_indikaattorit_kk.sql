...
/****** Object:  StoredProcedure [dw].[p_lataa_d_indikaattorit_kk]    Script Date: 14.9.2026 8.15.32 ******/
SET ANSI_NULLS ON
GO
...
('ulk_amk', 'Kv-opiskelijoiden suorittamien amk-tutkintojen osuus', 'Koulutusindikaattorit', 12, 1, 'osuus', 'ETL: p_lataa_d_indikaattorit_kk'),
...
('avoin_vayla', 'Avoimen väylän kautta paikan vastaanottaneiden osuus', 'Koulutusindikaattorit', 22, 1, 'osuus', 'ETL: p_lataa_d_indikaattorit_kk'),
...
('toht_otki_osuus', 'Tohtorintutkinnon suorittaneiden osuus opetus- ja TKI-henkilöstössä', 'Tutkimusindikaattorit', 36, 2, 'osuus', 'ETL: p_lataa_d_indikaattorit_kk'),
('kv_toht', 'Kansainvälisten tohtoritutkinto-opiskelijoiden osuus', 'Tutkimusindikaattorit', 37, 2, 'osuus', 'ETL: p_lataa_d_indikaattorit_kk'),
('kv_yj', 'Kansainväliset yhteisjulkaisut', 'Tutkimusindikaattorit', 38, 2, 'osuus', 'ETL: p_lataa_d_indikaattorit_kk'),
('avoimet_julk', 'Avoimet julkaisut', 'Tutkimusindikaattorit', 39, 2, 'osuus', 'ETL: p_lataa_d_indikaattorit_kk'),
('yj_yritykset', 'Yhteisjulkaisut yritysten kanssa', 'Tutkimusindikaattorit', 40, 2, 'osuus', 'ETL: p_lataa_d_indikaattorit_kk'),
('tutkimusmenot_liikevaihto', 'Tutkimusmenot suhteessa liikevaihtoon', 'Tutkimusindikaattorit', 41, 2, 'osuus', 'ETL: p_lataa_d_indikaattorit_kk'), 
('koti_ulkom_yritykset_tk', 'Kotimaisten ja ulkomaisten yritysten tk-rahoitus', 'Tutkimusindikaattorit', 42, 2, 'luku', 'ETL: p_lataa_d_indikaattorit_kk'), 
('ulkop_rahoitus_opetus_tutkimus_htv', 'Ulkopuolinen tutkimusrahoitus per opetus- ja tutkimushenkilöstön htv', 'Tutkimusindikaattorit', 43, 2, 'luku', 'ETL: p_lataa_d_indikaattorit_kk'), 
('erc_rahoitus', 'ERC-rahoitukset', 'Tutkimusindikaattorit', 44, 2, 'luku', 'ETL: p_lataa_d_indikaattorit_kk'),
('top10', 'Top-10 indikaattori (WoS)', 'Tutkimusindikaattorit', 45, 2, 'suhde', 'ETL: p_lataa_d_indikaattorit_kk'),
('rakennerah', 'Rakennerahastojen osuus täydentävästä rahoituksesta', 'Tutkimusindikaattorit', 46, 2, 'osuus', 'ETL: p_lataa_d_indikaattorit_kk'),
('ulkop_tk_rahoitus', 'Ulkopuolisen tk-rahoituksen määrä (miljoonaa euroa)', 'Tutkimusindikaattorit', 47, 2, 'luku', 'ETL: p_lataa_d_indikaattorit_kk')