...
/****** Object:  View [dw].[v_koski_lukio_ainevalinnat_suorittaneet]    Script Date: 4.12.2020 19:53:31 ******/
SET ANSI_NULLS ON
GO
...
--lisää jäädytetyn faktalatauksen tuottama uusi taulu alle
--jos lisätään oppiaine-/kurssimuuttujia, vastaavat lisättävä mittarin "Oppimäärän suorittaneet" all-ehtoihin
...
(
	SELECT [Tilastovuosi]
      ...
      ,[kurssit_laajuus_all_suorituskieli]
      ,[kurssit_S_arvosanat_laajuus] 
	  FROM dw.f_koski_lukio_ainevalinnat_suorittaneet--_pvm
