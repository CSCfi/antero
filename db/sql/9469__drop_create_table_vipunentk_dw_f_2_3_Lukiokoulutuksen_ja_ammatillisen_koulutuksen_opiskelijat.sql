...
/****** Object:  Table [dbo].[f_2_3_Lukiokoulutuksen_ja_ammatillisen_koulutuksen_opiskelijat]    Script Date: 10.1.2024 14:20:31 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[f_2_3_Lukiokoulutuksen_ja_ammatillisen_koulutuksen_opiskelijat]') AND type in (N'U'))
