USE [ANTERO]
GO
/****** Object:  Table [dw].[f_amos_tutkinnot_ja_tutkinnonosat_painotetut]    Script Date: 29.10.2019 10:09:16 ******/
DROP TABLE IF EXISTS [dw].[f_amos_tutkinnot_ja_tutkinnonosat_painotetut]
GO
/****** Object:  Table [dw].[f_amos_tutkinnot_ja_tutkinnonosat]    Script Date: 29.10.2019 10:09:16 ******/
DROP TABLE IF EXISTS [dw].[f_amos_tutkinnot_ja_tutkinnonosat]
GO
/****** Object:  Table [dw].[f_amos_opiskelijavuodet_painotetut]    Script Date: 29.10.2019 10:09:16 ******/
DROP TABLE IF EXISTS [dw].[f_amos_opiskelijavuodet_painotetut]
GO
/****** Object:  Table [dw].[f_amos_opiskelijavuodet]    Script Date: 29.10.2019 10:09:16 ******/
...
CREATE TABLE [dw].[f_amos_tutkinnot_ja_tutkinnonosat_painotetut](
	...
	[painottamaton_osaamispisteet] [decimal](20, 10) NULL,
	[painottamaton_osaamispisteet_summa] [decimal](20, 10) NULL,
	[painotettu_tutkinnot_pt_kr_pk] [decimal](20, 10) NULL,
	[painotettu_tutkinnot_at_eat_kr_pk] [decimal](20, 10) NULL,
	[painotettu_tutkinnot_erityistuki] [decimal](20, 10) NULL,
	[painotettu_tutkinnon_osien_osaamispisteet_pt_kr] [decimal](20, 10) NULL,
	[painotettu_tutkinnon_osien_osaamispisteet_at_eat_kr] [decimal](20, 10) NULL,
	[painotettu_tutkinnon_osien_osaamispisteet_erityistuki] [decimal](20, 10) NULL,
	[painotettu_tutkinnot_yht] [decimal](20, 10) NULL,
	[painotettu_tutkinnon_osien_osaamispisteet_yht] [decimal](20, 10) NULL
) ON [PRIMARY]
END
