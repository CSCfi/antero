...
/****** Object:  View [dw].[v_koski_amm_opiskelijat_ja_tutkinnot_cultures]    Script Date: 30.1.2026 17.13.10 ******/
SET ANSI_NULLS ON
GO
...
SELECT --top 1000
	...
	,[kansalaisuus_fi] = d22.maanosa6_fi
	...
	,[hankintakoulutuksen_toimipiste_fi] = d21b.organisaatio_fi
	,[oppilaitos_fi] = d5.organisaatio_fi
	,[hankintakoulutuksen_oppilaitos_fi] = d5b.organisaatio_fi
	...
	,[kansalaisuus_sv] = d22.maanosa6_sv
	...
	,[hankintakoulutuksen_toimipiste_sv] = d21b.organisaatio_sv
	,[oppilaitos_sv] = d5.organisaatio_sv
	,[hankintakoulutuksen_oppilaitos_sv] = d5b.organisaatio_sv
	...
	,[kansalaisuus_en] = d22.maanosa6_en
	...
	,[hankintakoulutuksen_toimipiste_en] = d21b.organisaatio_en
	,[oppilaitos_en] = d5.organisaatio_en
	,[hankintakoulutuksen_oppilaitos_en] = d5b.organisaatio_en
	...
	,apusarake_uusi_opiskelija_rahoitus = 0 --uudet_opiskelijat_rahoitus
	...
	,[koodit_hankintakoulutuksen_jarjestaja] = d11b.organisaatio_koodi 
	,[koodit_oppilaitos] = coalesce(nullif(d5.organisaatio_koodi, ''), '-1')
	,[koodit_hankintakoulutuksen_oppilaitos] = coalesce(nullif(d5b.organisaatio_koodi, ''), '-1')
	,[koodit_toimipiste_oid] = d21.organisaatio_oid 
	,[koodit_hankintakoulutuksen_toimipiste_oid] = d21b.organisaatio_oid 
	...
	,d22.jarjestys_maanosa6_koodi as jarjestys_kansalaisuus
...
LEFT JOIN dw.d_organisaatioluokitus d5b ON d5b.id = f.d_organisaatioluokitus_hk_oppilaitos_id
...
LEFT JOIN dw.d_organisaatioluokitus d21b ON d21b.id = f.d_organisaatioluokitus_hk_toimipiste_id
