...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_opiskeluoikeudet]    Script Date: 15.2.2024 12:49:57 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dw].[p_lataa_f_virta_otp_opiskeluoikeudet] AS
