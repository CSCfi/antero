...
/****** Object:  View [dw].[v_arvo_amis_tep_cultures]    Script Date: 27.6.2022 22:40:01 ******/
SET ANSI_NULLS ON
GO
...
--SV
	...
	,coalesce(d13.toimiala_2008_SV,'Information saknas') AS 'tyopaikan_toimiala_sv' --tyopaikan -> yrityksen_yhteison
...
--EN
	...
	,coalesce(d13.toimiala_2008_EN,'Missing data') AS 'tyopaikan_toimiala_en' --tyopaikan -> yrityksen_yhteison
	...
	,coalesce(case when d13.toimiala_2008_avain not in ('X','-1') then d13.taso end, 999999) AS 'jarjestys_tyopaikan_toimiala' --tyopaikan -> yrityksen_yhteison
