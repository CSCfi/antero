...
/****** Object:  View [dbo].[v_f_tab_otv_korkeakoulut_amk]    Script Date: 23.2.2023 3:34:27 ******/
SET ANSI_NULLS ON
GO
...
,d46.kylla_ei as 'Kansainvälinen opiskelija'
...
SELECT [tilastointivuosi] as Tilastovuosi
  ...
  FROM [dbo].[f_OTV_4_9_Vaestorakenne_kunnittain]
	...
	LEFT JOIN [dbo].d_kylla_ei d46 ON d46.id = f.kvopisk_id
