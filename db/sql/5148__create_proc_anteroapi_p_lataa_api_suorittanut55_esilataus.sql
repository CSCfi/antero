...
DROP PROCEDURE IF EXISTS [dw].[p_lataa_api_suorittanut55_esilataus]
GO
...
CREATE PROCEDURE [dw].[p_lataa_api_suorittanut55_esilataus] AS
...
SELECT
	...
	,d1.organisaatio_koodi AS 'oppilaitos_koodi'
  ...
  LEFT JOIN ANTERO.dw.d_organisaatio d1 ON d1.id=f.d_organisaatio_id
