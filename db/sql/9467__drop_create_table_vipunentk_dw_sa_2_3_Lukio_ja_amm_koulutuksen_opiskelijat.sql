...
/****** Object:  Table [dbo].[sa_2_3_Lukio_ja_amm_koulutuksen_opiskelijat]    Script Date: 10.1.2024 14:12:29 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sa_2_3_Lukio_ja_amm_koulutuksen_opiskelijat]') AND type in (N'U'))
