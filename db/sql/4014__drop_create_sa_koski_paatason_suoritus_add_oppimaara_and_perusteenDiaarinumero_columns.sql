...
GO
IF NOT EXISTS(
SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'sa_koski_paatason_suoritus' AND TABLE_SCHEMA = 'sa' AND (COLUMN_NAME = 'perusteenDiaarinumero' OR COLUMN_NAME = 'oppimaara')
)
BEGIN
