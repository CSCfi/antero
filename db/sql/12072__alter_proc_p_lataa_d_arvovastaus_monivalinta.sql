...
/****** Object:  StoredProcedure [dw].[p_lataa_d_arvovastaus_monivalinta]    Script Date: 25.5.2026 11.49.31 ******/
SET ANSI_NULLS ON
GO
		...
		OUTER APPLY (
			SELECT 
				CASE
					...
					WHEN d3.paiva = 4 THEN '4 hieman samaa mieltä'
...
UPDATE ANTERO.dw.d_arvovastaus_monivalinta
	SET koodi = koodi + 1
WHERE kysymysid in (10119,8366,2924,6805,8252,8345) 
