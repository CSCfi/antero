...
/****** Object:  View [dw].[v_amos_opiskelijavuodet_uusi_rahoitusperusteet]    Script Date: 25.9.2026 15.55.28 ******/
SET ANSI_NULLS ON
GO
...
--LEFT JOIN dw.d_organisaatioluokitus d11 ON d11.id = f.d_organisaatioluokitus_jarj_id  CSCVIPUNEN-3358: Taustatiedot uusimman varainhoitovuoden järjestäjärakenteen mukaan. JK
...
LEFT JOIN dw.d_amos_spl_jarjestaja_linkki d34 ON d34.id = f.d_amos_spl_jarjestaja_linkki_id 
