IF NOT EXISTS (select * from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA='dw' and TABLE_NAME='d_julkaisutyyppi') BEGIN

CREATE TABLE dw.d_julkaisutyyppi(
...
ALTER TABLE dw.d_julkaisutyyppi ADD  CONSTRAINT DF__d_julkaisutyyppi__loadtime  DEFAULT (getdate()) FOR loadtime
;
ALTER TABLE dw.d_julkaisutyyppi ADD  CONSTRAINT DF__d_julkaisutyyppi__username  DEFAULT (suser_sname()) FOR username
;
