...
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_lukio_opiskelijat_kuukausittain]    Script Date: 22.2.2024 8:23:09 ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT
	...
	,CASE
		WHEN ov.alkuPvm <= DATEFROMPARTS(vt.vuosi, vt.kuukausi, 1) and ov.loppuPvm >  DATEFROMPARTS(vt.vuosi, vt.kuukausi, 1) THEN 1
		ELSE 0
