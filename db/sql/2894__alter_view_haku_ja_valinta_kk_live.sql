...
/****** Object:  View [dw].[v_haku_ja_valinta_kk_live]    Script Date: 16.3.2020 23:07:22 ******/
SET ANSI_NULLS ON
GO
...
SELECT --top 10
	  ...
	  ,[Hakuaika] = 
		coalesce(
			case 
				when d25.hakutapa_koodi = '01' and d31.selite_fi in ('Haku 1 / Hakuaika 1','Haku 2 / Hakuaika 2') then d31.selite_fi 
				else ''
			end
		,'')
...
Select distinct --top 0
	  ...
	  ,[Hakuaika] = coalesce(
			case 
				when d1.hakutapa_koodi = '01' and d13.selite_fi in ('Haku 1 / Hakuaika 1','Haku 2 / Hakuaika 2') then d13.selite_fi 
				else ''
			end
		,'')
