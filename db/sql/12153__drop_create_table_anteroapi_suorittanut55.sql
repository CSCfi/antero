...
/****** Object:  Table [api].[suorittanut55]    Script Date: 25.8.2026 12.18.44 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[api].[suorittanut55]') AND type in (N'U'))
