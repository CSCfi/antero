...
/****** Object:  StoredProcedure [dw].[p_lataa_d_oppivelvollisen_toiminta]    Script Date: 5.3.2026 12.06.21 ******/
SET ANSI_NULLS ON
GO
...
('6','Suorittaa oppivelvollisuutta','Utför läroplikt','Suorittaa oppivelvollisuutta EN*','Suorittaa perusopetuksen oppimäärää', 'Avlägger lärokursen för den grundläggande utbildningen','Suorittaa perusopetuksen oppimäärää EN*',2,5,'manuaalinen'),
