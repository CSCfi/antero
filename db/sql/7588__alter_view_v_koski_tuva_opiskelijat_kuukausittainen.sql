...
/****** Object:  View [dw].[v_koski_tuva_opiskelijat_kuukausittainen]    Script Date: 11.4.2023 10:55:37 ******/
SET ANSI_NULLS ON
GO
...
SELECT --top 1000
	...
	,d4.kieliryhma2_fi as 'Äidinkieli (ryhmä)'
	...
	end as 'Järjestys Kansalaisuusryhmä'
	,case
		when d4.kieliryhma2_koodi = '-1' then '99'
		else d4.kieliryhma2_koodi
	end as 'Järjestys Äidinkieliryhmä'
