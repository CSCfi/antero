USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_d_ika]    Script Date: 20.12.2022 13:05:04 ******/
SET ANSI_NULLS ON
GO
...
,ikaryhma5_fi = 
	CASE 
		when ika_avain >= 0 and ika_avain < 19 then '18–vuotiaat ja sitä nuoremmat'
		when ika_avain between 19 and 29 then ika_fi
		when ika_avain >= 30 and ika_avain <= 34 then '30–34-vuotiaat'
		when ika_avain >= 35 and ika_avain <= 39 then '35–39-vuotiaat'
		when ika_avain >= 40 and ika_avain <= 44 then '40–44-vuotiaat'
		when ika_avain >= 45 and ika_avain <= 49 then '45–49-vuotiaat'
...
,ikaryhma5_sv = 
	CASE 
		when ika_avain >= 0 and ika_avain < 19 then '18 år eller yngre'
		when ika_avain between 19 and 29 then ika_sv
		when ika_avain >= 30 and ika_avain <= 34 then '30–34 år'
		when ika_avain >= 35 and ika_avain <= 39 then '35–39 år'
		when ika_avain >= 40 and ika_avain <= 44 then '40–44 år'
		when ika_avain >= 45 and ika_avain <= 49 then '45–49 år'
...
,ikaryhma5_en = 
	CASE
		when ika_avain >= 0 and ika_avain < 19 then 'Aged 18 or under'
		when ika_avain between 19 and 29 then ika_en
		when ika_avain >= 30 and ika_avain <= 34 then 'Aged 30–34'
		when ika_avain >= 35 and ika_avain <= 39 then 'Aged 35–39'
		when ika_avain >= 40 and ika_avain <= 44 then 'Aged 40–44'
		when ika_avain >= 45 and ika_avain <= 49 then 'Aged 45–49'
...
,jarjestys_ikaryhma5 =
	CASE
		when ika_avain >= 0 and ika_avain < 19 then '18'
		when ika_avain between 19 and 29 then ika_avain
		when ika_avain >= 30 and ika_avain <= 34 then '30'
		when ika_avain >= 35 and ika_avain <= 39 then '35'
		when ika_avain >= 40 and ika_avain <= 44 then '40'
		when ika_avain >= 45 and ika_avain <= 49 then '45'
...
,ikaryhma6_fi = 
	CASE 
		when ika_avain >= 0 and ika_avain < 15 then 'alle 15-vuotiaat'
		when ika_avain between 15 and 70 then ika_fi
		when ika_avain > 70 then 'yli 70-vuotiaat'
		else 'Tieto puuttuu'
	END 

,ikaryhma6_sv = 
	CASE 
		when ika_avain >= 0 and ika_avain < 15 then 'under 15 år'
		when ika_avain between 15 and 70 then ika_sv
		when ika_avain > 70 then 'över 70 år'
		else 'Information saknas'
	END 

,ikaryhma6_en = 
	CASE 
		when ika_avain >= 0 and ika_avain < 15 then 'under 15 years'
		when ika_avain between 15 and 70 then ika_en
		when ika_avain > 70 then 'over 70 years'
		else 'Tieto puuttuu'
	END 
...
,ikaryhma7_fi = 
	CASE 
		when ika_avain >= 0 and ika_avain < 3 then 'Alle 3 vuotta'
		when ika_avain between 3 and 5 then '3 - 5 vuotta'
		when ika_avain = 6 then '6 vuotta'
		when ika_avain > 6 then '7 vuotta ja yli'
		else 'Tieto puuttuu'
	END 

,ikaryhma7_sv = 
	CASE 
		when ika_avain >= 0 and ika_avain < 3 then 'Under 3 år'
		when ika_avain between 3 and 5 then '3 - 5 år'
		when ika_avain = 6 then '6 år'
		when ika_avain > 6 then '7 år och över'
		else 'Information saknas'
	END 

,ikaryhma7_en = 
	CASE 
		when ika_avain >= 0 and ika_avain < 3 then 'Younger than 3 years'
		when ika_avain between 3 and 5 then '3 - 5 years'
		when ika_avain = 6 then '6 years'
		when ika_avain > 6 then 'Older than 6 years'
		else 'Tieto puuttuu'
	END 

,jarjestys_ikaryhma7 =
	CASE 
		when ika_avain >= 0 and ika_avain < 3 then '1'
		when ika_avain between 3 and 5 then '2'
		when ika_avain = 6 then '3'
		when ika_avain > 6 then '4'
		else '999'
	END

,ikaryhma8_fi = 
	CASE 
		when ika_avain >= 0 and ika_avain <= 29 then 'alle 30–vuotiaat'
		when ika_avain >= 30 and ika_avain <= 34 then '30–34-vuotiaat'
		when ika_avain >= 35 and ika_avain <= 39 then '35–39-vuotiaat'
		when ika_avain >= 40 and ika_avain <= 44 then '40–44-vuotiaat'
		when ika_avain >= 45 and ika_avain <= 49 then '45–49-vuotiaat'
...
,ikaryhma8_sv = 
	CASE 
		when ika_avain >= 0 and ika_avain <= 29 then '30 år eller yngre'
		when ika_avain >= 30 and ika_avain <= 34 then '30–34 år'
		when ika_avain >= 35 and ika_avain <= 39 then '35–39 år'
		when ika_avain >= 40 and ika_avain <= 44 then '40–44 år'
		when ika_avain >= 45 and ika_avain <= 49 then '45–49 år'
...
,ikaryhma8_en = 
	CASE 
		when ika_avain >= 0 and ika_avain <= 29 then 'Aged 30 or under'	
		when ika_avain >= 30 and ika_avain <= 34 then 'Aged 30–34'
		when ika_avain >= 35 and ika_avain <= 39 then 'Aged 35–39'
		when ika_avain >= 40 and ika_avain <= 44 then 'Aged 40–44'
		when ika_avain >= 45 and ika_avain <= 49 then 'Aged 45–49'
...
,jarjestys_ikaryhma8 =
	CASE
		when ika_avain >= 0 and ika_avain <= 29 then '29'
		when ika_avain >= 30 and ika_avain <= 34 then '30'
		when ika_avain >= 35 and ika_avain <= 39 then '35'
		when ika_avain >= 40 and ika_avain <= 44 then '40'
		when ika_avain >= 45 and ika_avain <= 49 then '45'
