...
/****** Object:  View [dw].[v_virta_otp_55_jaahdytetty_2025]    Script Date: 18.9.2026 15.30.02 ******/
SET ANSI_NULLS ON
GO
...
INNER JOIN ANTERO.dbo.view_salt vs on vs.[view] = 'v_virta_otp_55_jaahdytetty_2025'