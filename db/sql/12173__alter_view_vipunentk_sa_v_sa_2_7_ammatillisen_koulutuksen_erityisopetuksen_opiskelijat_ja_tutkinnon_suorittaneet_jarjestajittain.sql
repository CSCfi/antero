...
/****** Object:  View [dbo].[v_sa_2_7_ammatillisen_koulutuksen_erityisopetuksen_opiskelijat_ja_tutkinnon_suorittaneet_jarjestajittain]    Script Date: 2.9.2026 12.16.20 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
      ...
      ,[olosyys]
      ,[luontipvm]
	  ,tietolahde = '2_7_sopv_24'
FROM [TK_H9098_CSC].[dbo].[TK_K2_7_sopv_24]
...
SELECT [tilv]
      ...
      ,[olosyys]
      ,[luontipvm]
	  ,tietolahde = '2_7_sopv_25'
FROM [TK_H9098_CSC].[dbo].[TK_K2_7_sopv_25]
...
SELECT [tilv]
      ...
      ,[olosyys]
      ,[luontipvm]
	  ,tietolahde = '2_7_sopv_26'
FROM [TK_H9098_CSC].[dbo].[TK_K2_7_sopv_26]
