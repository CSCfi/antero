...
/****** Object:  View [dw].[v_haku_ja_valinta_toinen_aste_valmistava]    Script Date: 25.2.2026 12.46.40 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dw].[v_haku_ja_valinta_toinen_aste_valmistava] AS
...
WHERE f.koulutuksen_alkamisvuosi > 2013 and f.koulutuksen_alkamisvuosi < 2022 and 
d25.korkeakouluhaku = 0 and d25.hakuryhma_koodi = '2'