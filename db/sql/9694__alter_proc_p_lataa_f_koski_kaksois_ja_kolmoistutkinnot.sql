...
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_kaksois_ja_kolmoistutkinnot]    Script Date: 11.3.2024 8:30:00 ******/
SET ANSI_NULLS ON
GO
...
DROP PROCEDURE IF EXISTS [sa].[p_lataa_temp_lukio_kurssit]
...
WHERE os.koulutusmoduuli_koodisto in ('lukionkurssit','lukionkurssitops2003nuoret','lukionkurssitops2004aikuiset','moduulikoodistolops2021') and 
os.suorituksen_tyyppi in ('lukionkurssi', 'lukionvaltakunnallinenmoduuli') and os.arviointi_hyvaksytty = 1
