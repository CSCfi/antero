...
/****** Object:  StoredProcedure [sa].[p_lataa_temp_koski_opintojen_kulku_2a_valmistumiset]    Script Date: 31.7.2023 16:35:14 ******/
SET ANSI_NULLS ON
GO
...
WHERE ps.suorituksen_tyyppi IN ('ammatillinentutkinto', 'lukionoppimaara', 'ibtutkinto', 'internationalschooldiplomavuosiluokka', 'diatutkintovaihe', 'ebtutkinto', 'europeanschoolofhelsinkivuosiluokkasecondaryupper')
