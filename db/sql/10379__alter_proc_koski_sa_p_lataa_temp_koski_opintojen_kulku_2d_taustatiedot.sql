...
/****** Object:  StoredProcedure [sa].[p_lataa_temp_koski_opintojen_kulku_2d_taustatiedot]    Script Date: 13.11.2024 14:01:11 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN sa.temp_koski_perusaste_keskiarvot ka ON ka.oppija_oid = k1.oppija_oid
...
CROSS APPLY (
	...
	WHERE oppija_oid = k1.oppija_oid
