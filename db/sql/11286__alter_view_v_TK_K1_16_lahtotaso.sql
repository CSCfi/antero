...
ALTER VIEW [dw].[v_TK_K1_16_lahtotaso] AS 
...
SELECT 
	...
	,opv_kerroin_kaikki = cast(
		cast(
			...
			over (partition by rahoituskausi, tarkastelukausi)
			as decimal(18,12)
		)
		/ 
		cast(sum(sum([opiskelijavuodet])) over (partition by rahoituskausi, tarkastelukausi) as decimal(18,12))
		as decimal(20,19)
	)
