...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_opettajakelpoisuudet_jaadytys]    Script Date: 27.5.2026 10.23.17 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	WHERE p.Vuosi = ' + @alkuVuosi + ' or (' + @alkuVuosi + ' = 2025 and p.Vuosi <= 2025)'
