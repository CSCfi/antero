USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_haku_ja_valinta_hakeneet_korkea_aste]    Script Date: 16.2.2021 16:30:17 ******/
SET ANSI_NULLS ON
GO
...
SELECT
	...
	coalesce(d0.id,'-1') as sa_haku_ja_valinta_vuosikello_korkea_aste_id,
	...
	d33.JonoNimi,
	CASE 
		WHEN coalesce(d33.Kokonaispisteet,0) >= coalesce(d33.ValintatapaJononAlinHyvaksyttyPistemaara,0) THEN d33.Kokonaispisteet
		ELSE d33.ValintatapaJononAlinHyvaksyttyPistemaara
...
--
left join sa.sa_odw_valintatapajono d33 on d33.HakukohdeOID = f.HakukohdeOID and d33.HenkiloOID = f.HenkiloOID
