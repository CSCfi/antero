...
ALTER TABLE [sa].[sa_oef_esco_ammattiavain] DROP CONSTRAINT [DF__sa_oef_esco_ammattiavain__username]
GO

ALTER TABLE [sa].[sa_oef_esco_ammattiavain] DROP CONSTRAINT [DF__sa_oef_esco_ammattiavain__loadtime]
GO
