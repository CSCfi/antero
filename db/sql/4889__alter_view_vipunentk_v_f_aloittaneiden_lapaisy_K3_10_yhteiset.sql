...
/****** Object:  View [dbo].[v_f_aloittaneiden_lapaisy_K3_10_yhteiset]    Script Date: 20.9.2021 22:57:34 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
		...
		Case 
			when d7.koulutusaste2002_koodi='63' or d7.Koulutusaste_taso2_koodi='63'
			  Or ((d7.koulutusaste2002_koodi='72' or d7.Koulutusaste_taso2_koodi='72') and d7.koulutus_koodi in ('772101', '772201')) 
			  Or (d7.koulutusaste2002_koodi='62' or d7.Koulutusaste_taso2_koodi='62') 
			  then 'Aloitus I syklin tutkinnossa' 
			when d7.koulutusaste2002_koodi='71' Or d7.koulutusaste2002_koodi='72' or d7.Koulutusaste_taso2_koodi='71' or d7.Koulutusaste_taso2_koodi='72' 
			  then 'Aloitus II syklin tutkinnossa'  
			else 'Tuntematon' 
		...
		Case 
			when d7.koulutusaste2002_koodi='63' or d7.Koulutusaste_taso2_koodi='63'
			  Or ((d7.koulutusaste2002_koodi='72' or d7.Koulutusaste_taso2_koodi='72') and d7.koulutus_koodi in ('772101', '772201')) 
			  Or (d7.koulutusaste2002_koodi='62' or d7.Koulutusaste_taso2_koodi='62') 
			  then 'Påbörjande i I-skedets examen' 
			when d7.koulutusaste2002_koodi='71' Or d7.koulutusaste2002_koodi='72' or d7.Koulutusaste_taso2_koodi='71' or d7.Koulutusaste_taso2_koodi='72' 
			  then 'Påbörjande i II-skedets examen'  
			else 'Okänt' 
		end AS [Startskede], 
		...
		Case 
			...
			when d7.koulutusaste2002_koodi='71' Or d7.koulutusaste2002_koodi='72' or d7.Koulutusaste_taso2_koodi='71' or d7.Koulutusaste_taso2_koodi='72' 
				then 'Beginning of studies in cycle II degree'  
			else 'Unknown' 
