USE [Koski_SA]
GO
/****** Object:  StoredProcedure [sa].[p_lataa_opiskelijavuodet_paallekkaiset_opiskeluoikeudet]    Script Date: 7.10.2019 16:41:47 ******/
SET ANSI_NULLS ON
GO
	...
	FROM (
		...
		inner join (
			...
			select 
				...
				,opintojen_rahoitus_vos = coalesce(d1.sisaltyy_okm_perusrahoitus,1) --jos opintojen_rahoitus puuttuu, oletetaan vos
