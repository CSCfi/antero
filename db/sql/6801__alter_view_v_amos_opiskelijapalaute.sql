...
/****** Object:  View [dw].[v_amos_opiskelijapalaute]    Script Date: 21.12.2022 21:29:19 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN dw.f_amos_opiskelijapalaute_vastausosuudet_kertoimet f3 ON f3.rahoituskausi = f.rahoituskausi_amm AND f3.ytunnus = f.ytunnus_amos_spl and f3.kysely_tarkenne = f.kyselypohja_tarkenne_fi
