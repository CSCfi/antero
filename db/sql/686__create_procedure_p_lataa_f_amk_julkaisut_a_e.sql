DROP PROCEDURE IF EXISTS [dw].[p_lataa_f_amk_julkaisut_a_e]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dw].[p_lataa_f_amk_julkaisut_a_e]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dw].[p_lataa_f_amk_julkaisut_a_e] AS' 
END
GO
