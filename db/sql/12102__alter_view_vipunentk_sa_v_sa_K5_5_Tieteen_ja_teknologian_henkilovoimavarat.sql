...
/****** Object:  View [dbo].[v_sa_K5_5_Tieteen_ja_teknologian_henkilovoimavarat]    Script Date: 5.6.2026 14.51.08 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
      ...
      ,[lkm]
      ,[luontipvm]
      ,[tietolahde]='TK_K5_5_sopv_26'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv, svalt, sp, koulk)
FROM [TK_H9098_CSC].[dbo].[TK_K5_5_sopv_26]
WHERE tilv = '2023'
