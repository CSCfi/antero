...
/****** Object:  View [dbo].[_v_aloittaneiden_lapaisy_sarakeryhmat_nykytila]    Script Date: 6.5.2020 22:08:10 ******/
SET ANSI_NULLS ON
GO
...
SELECT --TOP 0
	  ...
	  ,koulutuslaji2 = (select	
		  case 
			...
			-- Lisätty koulk 751204 käsittely, jolle ei tilastovuonna vielä koodia luokituksessa
			when (alo.klaji = '51' and alo.koulk = '751204') then '51b'
			when (alo.klaji = '51' and alo.koulk != '751204') then
