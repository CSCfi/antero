...
/****** Object:  StoredProcedure [dw].[p_lataa_f_indikaattorit_kk_julkaisutiedot]    Script Date: 12.8.2026 11.38.00 ******/
SET ANSI_NULLS ON
GO
...
USING (
	...
	FROM (
		...
		and d1.organisaatio_koodi <> '02557'
	...
	OUTER APPLY (
		...
		and d1b.organisaatio_koodi <> '02557'
	) s
) AS src
