...
/****** Object:  View [dw].[v_koski_esi_ja_perus_oppilaat_ja_paattaneet_kuukausittain]    Script Date: 11.1.2022 19:59:58 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dw].[v_koski_esi_ja_perus_oppilaat_ja_paattaneet_kuukausittain] AS
  ...
  --aika
	...
	,[Lukuvuosi] = d14.lukuvuosi 
	,[Lukukausi] = d14.lukukausi_fi 
  ...
  --koulutus
	...
	,[Suorituskieli] = d23.suorituskieli_yleissivistava_fi
	,[Muu suorituskieli] = d23b.suorituskieli_yleissivistava_fi
	,[Kielikylpykieli] = d23c.suorituskieli_yleissivistava_fi
  ...
  --Järjestykset
	...
	,d14.jarjestys_lukukausi_reverse AS jarj_lukukausi 
