...
/****** Object:  View [dw].[v_amos_opiskelijavuodet]    Script Date: 27.10.2020 17:20:37 ******/
SET ANSI_NULLS ON
GO
...
SELECT --TOP 100   
	...
	,[Tutkintotyypin ryhmä] = case when d18.koodi = 'muu' then 'Muu ammatillinen koulutus' else d4.tutkintotyypin_ryhma_fi end
    ,[Tutkintotyyppi] = case when d18.koodi = 'muu' then 'Muu ammatillinen koulutus' else d4.tutkintotyyppi_fi end
	...
	,case when d18.koodi = 'muu' then '90' else d4.jarjestys_tutkintotyypin_ryhma_koodi end AS jarj_tutkintotyypin_ryhma
	,case when d18.koodi = 'muu' then '90' else d4.jarjestys_tutkintotyyppi_koodi end AS jarj_tutkintotyyppi
