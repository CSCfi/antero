...
/****** Object:  View [dbo].[v_f_tab_tyollisten_ammattisiirtymat_cultures]    Script Date: 2.1.2024 9:39:49 ******/
SET ANSI_NULLS ON
GO
...
DROP VIEW IF EXISTS [dbo].[v_f_tab_tyollisten_ammattisiirtymat]
DROP VIEW IF EXISTS [dbo].[v_f_tab_vaeston_toimiala_ja_ammattisiirtymat]
GO

CREATE OR ALTER VIEW [dbo].[v_f_tab_tyollisten_ammattisiirtymat_cultures] AS
