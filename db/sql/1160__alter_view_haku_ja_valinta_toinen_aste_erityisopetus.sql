...
/****** Object:  View [dw].[v_haku_ja_valinta_toinen_aste_erityisopetus]    Script Date: 16.1.2018 10:57:27 ******/
SET ANSI_NULLS ON
GO
...
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dw].[v_haku_ja_valinta_toinen_aste_erityisopetus]'))
...
CREATE VIEW [dw].[v_haku_ja_valinta_toinen_aste_erityisopetus] AS
