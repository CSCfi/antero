...
/****** Object:  View [dbo].[v_tab_tietoja_maakunnista]    Script Date: 4.5.2021 19:16:52 ******/
SET ANSI_NULLS ON
GO
...
where (d1.Koulutusaste_taso2_koodi in ('62','63','71','72','82') or d1.koulutusaste2002_koodi in ('62','63','71','72','82'))
AND (d3.oppilaitoskoodi NOT IN ('02557','10031','02358') AND coalesce(d3.oppilaitoksen_korvaavakoodi,d3.oppilaitoskoodi) not in ('01029','01569','10102'))
...
Where d1.Koulutusaste_taso2_koodi in ('31','32','33','41','62','63','71','72','82')
or d1.koulutusaste2002_koodi in ('31','32','62','63','71','72','82')
