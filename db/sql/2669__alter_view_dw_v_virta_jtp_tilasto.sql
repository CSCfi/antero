...
/****** Object:  View [dw].[v_virta_jtp_tilasto]    Script Date: 4.12.2019 17:48:57 ******/
SET ANSI_NULLS ON
GO
...
SELECT f.tilastovuosi AS "Tilastovuosi"
  ...
  ,case when d3.oppilaitostyyppi_sv = 'Yrkeshögskolor' then d3.organisaatio_sv else NULL end as 'Yrkeshögskola'
  ,case when d3.oppilaitostyyppi_en = 'Polytechnics' then d3.organisaatio_en else NULL end as 'University of applied sciences'
  ...
  ,case when d3.oppilaitostyyppi_sv = 'Universitet' then d3.organisaatio_sv else NULL end as 'Universitet'
  ,case when d3.oppilaitostyyppi_en = 'Universities' then d3.organisaatio_en else NULL end as 'University'
...
SELECT f.vuosi AS "Tilastovuosi"
  ...
  ,d3.yo_nimi_sv as 'Universitet'
  ,d3.yo_nimi_en as 'University'
  ,d5.julkaisufoorumitaso_koodi as 'Koodit Julkaisufoorumitaso'
  ,d5.julkaisufoorumitaso_fi as 'Julkaisufoorumitaso'
...
SELECT f.vuosi AS "Tilastovuosi"
  ...
  ,d3.amk_nimi_sv as 'Yrkeshögskola'
  ,d3.amk_nimi_en as 'University of applied sciences'
