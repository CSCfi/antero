...
/****** Object:  View [dbo].[v_f_aloittaneiden_lapaisy_K3_9_ammatillinen]    Script Date: 21.7.2020 14:24:12 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_f_aloittaneiden_lapaisy_K3_9_ammatillinen]
AS
SELECT 
...
WHERE (f.aineistokoodi = 'K3.9') AND (d10.lahde_koodi in (31, 33, 34, 35)) AND (d17.tarkastelujakso <> '0,5 vuotta') 
