USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_d_rahoitusryhma]    Script Date: 15.11.2022 12:54:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dw].[p_lataa_d_rahoitusryhma]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dw].[p_lataa_d_rahoitusryhma] AS' 
END
GO


ALTER PROCEDURE [dw].[p_lataa_d_rahoitusryhma] AS
