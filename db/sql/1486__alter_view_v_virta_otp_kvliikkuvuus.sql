...
SELECT d1.organisaatio_koodi AS 'Oppilaitos Koodi'
	...
	,case when organisaatio_koodi = '01901' and year(f.tilannepvm) = '2018' and month(f.tilannepvm) = 3 and day(f.tilannepvm) = 13 then 1
	      when organisaatio_koodi = '01901' and year(f.tilannepvm) = '2018' and month(f.tilannepvm) = 3 and day(f.tilannepvm) = 1 then 0
	      when MONTH(f.tilannepvm)=3 AND DAY(f.tilannepvm)=1 then 1 
