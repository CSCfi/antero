...
/****** Object:  View [dbo].[v_sa_4_10_Väestörakenne_äidinkielen_mukaan_maakunnittain]    Script Date: 7.5.2026 10.03.55 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
      ...
      ,[lkm]
      ,[luontipvm]
      ,[tietolahde]='TK_4_10_sopv_26'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv, asmaak, aikielir3)
FROM [TK_H9098_CSC].[dbo].[TK_K4_10_sopv_26]
