-- Extra vipusen jäähdytetty 2017 datanäkymä
 
IF NOT EXISTS ( SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'dw.v_virta_otp_55_jaahdytetty_2017') )
	EXEC dbo.sp_executesql @statement = N'CREATE VIEW dw.v_virta_otp_55_jaahdytetty_2017 AS select 1 AS a'
GO
