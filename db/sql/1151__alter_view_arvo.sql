...
/****** Object:  View [dw].[v_arvo]    Script Date: 12.1.2018 10:40:51 ******/
SET ANSI_NULLS ON
GO
...
,case taustakysymys_pohjakoulutus
	...
	when 'Ammattikorkeakoulututkinto' then 5
	when 'Korkeakoulututkinto' then 6
	when 'Ylempi korkeakoulututkinto' then 6
	when 'Ulkomailla suoritettu tutkinto' then 7
	when 'Ei peruskoulun jälkeistä tutkintoa' then 8
	when 'Muu' then 9
	else 99
