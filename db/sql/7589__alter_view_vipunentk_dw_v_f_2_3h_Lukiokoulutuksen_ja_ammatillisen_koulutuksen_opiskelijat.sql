...
/****** Object:  View [dbo].[v_f_2_3h_Lukiokoulutuksen_ja_ammatillisen_koulutuksen_opiskelijat]    Script Date: 11.4.2023 11:41:22 ******/
SET ANSI_NULLS ON
GO
...
left join VipunenTK.dbo.d_alueluokitus d2 on d2.alueluokitus_avain = f.tilvaskun
left join VipunenTK.dbo.d_alueluokitus d3 on d3.alueluokitus_avain = f.tilvaskunx
