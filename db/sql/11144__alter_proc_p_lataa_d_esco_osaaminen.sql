...
/****** Object:  StoredProcedure [dw].[p_lataa_d_esco_osaaminen]    Script Date: 5.9.2025 7.33.32 ******/
SET ANSI_NULLS ON
GO
...
ALTER   PROCEDURE [dw].[p_lataa_d_esco_osaaminen]
AS
...
WHEN NOT MATCHED BY source and id != '-1' and (select count(*) from sa.sa_esco_osaamiset) > 0 THEN DELETE;
