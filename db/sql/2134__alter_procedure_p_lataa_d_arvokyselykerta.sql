...
/****** Object:  StoredProcedure [dw].[p_lataa_d_arvokyselykerta]    Script Date: 28.2.2019 15:58:49 ******/
SET ANSI_NULLS ON
GO
...
WHEN NOT MATCHED THEN
	  ...
	  VALUES (
		...
		src.kyselykertaid, src.kyselykerta,src.kyselypohja,src.kyselypohja_tarkenne_fi,kyselypohja_tarkenne_sv,kyselypohja_tarkenne_en,src.vuosi,
		src.source
	);