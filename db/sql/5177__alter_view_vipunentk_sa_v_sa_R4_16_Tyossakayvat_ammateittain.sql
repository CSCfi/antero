...
/****** Object:  View [dbo].[v_sa_R4_16_Tyossakayvat_ammateittain]    Script Date: 1.12.2021 21:36:11 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
      ...
      ,[lkm]
      ,[tietolahde]='R4_16_2011_sopv_20'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
      ,[tmaak]
      ,[amm2010_nim]
FROM [TK_H9098_CSC].[dbo].[TK_K4_16_sopv_20]
...
SELECT [tilv]
      ...
      ,[lkm]
      ,[tietolahde]='R4_16_2011_sopv_21'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
      ,[tmaak]
      ,[amm2010_nim]
FROM [TK_H9098_CSC].[dbo].[TK_K4_16_sopv_21]
