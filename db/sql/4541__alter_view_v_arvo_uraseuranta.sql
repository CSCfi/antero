...
/****** Object:  View [dw].[v_arvo_uraseuranta]    Script Date: 19.4.2021 9:05:30 ******/
SET ANSI_NULLS ON
GO
...
--Apusarakkeet
,CASE WHEN d_arvokyselykerta.vuosi < YEAR(GETDATE())-1	THEN 1 ELSE 1 END	AS vuosi_tilasto --Muutettu 1, jotta raportit toimii
...
SELECT  --TOP 1
	...
	,CASE 
     ...
     --ENGLANTI
      ...
      ,[Name of education]
      ,CASE WHEN [Kyselyvuosi] < YEAR(GETDATE())-1 THEN 1 ELSE 1 END AS vuosi_tilasto
      ,[ura_amk]
      ,[ura_yamk]
      ,[ura_kandi]
      ,[ura_maisteri]
