USE [Koski_SA]
GO
/****** Object:  Table [sa].[temp_opiskelijavuodet_samana_paivana_alkaneet_hylattavat]    Script Date: 12.9.2019 15:50:05 ******/
DROP TABLE IF EXISTS [sa].[temp_opiskelijavuodet_samana_paivana_alkaneet_hylattavat]
GO
/****** Object:  Table [sa].[temp_opiskelijavuodet_paatason_suoritus]    Script Date: 12.9.2019 15:50:05 ******/
DROP TABLE IF EXISTS [sa].[temp_opiskelijavuodet_paatason_suoritus]
GO
/****** Object:  Table [sa].[temp_opiskelijavuodet_paallekkaiset_opiskeluoikeudet]    Script Date: 12.9.2019 15:50:05 ******/
DROP TABLE IF EXISTS [sa].[temp_opiskelijavuodet_paallekkaiset_opiskeluoikeudet]
GO
/****** Object:  Table [sa].[temp_opiskelijavuodet_osatutkinnot_kustannusryhma]    Script Date: 12.9.2019 15:50:05 ******/
DROP TABLE IF EXISTS [sa].[temp_opiskelijavuodet_osatutkinnot_kustannusryhma]
GO
/****** Object:  Table [sa].[temp_opiskelijavuodet_opiskeluoikeus_oidit]    Script Date: 12.9.2019 15:50:05 ******/
DROP TABLE IF EXISTS [sa].[temp_opiskelijavuodet_opiskeluoikeus_oidit]
GO
/****** Object:  Table [sa].[temp_opiskelijavuodet_opiskeluoikeus_aikajakso_opva]    Script Date: 12.9.2019 15:50:05 ******/
DROP TABLE IF EXISTS [sa].[temp_opiskelijavuodet_opiskeluoikeus_aikajakso_opva]
GO
/****** Object:  Table [sa].[temp_opiskelijavuodet_opiskeluoikeus_aikajakso_loma]    Script Date: 12.9.2019 15:50:05 ******/
DROP TABLE IF EXISTS [sa].[temp_opiskelijavuodet_opiskeluoikeus_aikajakso_loma]
GO
/****** Object:  Table [sa].[temp_opiskelijavuodet_opiskeluoikeus_aikajakso_lasna_valmistunut]    Script Date: 12.9.2019 15:50:05 ******/
DROP TABLE IF EXISTS [sa].[temp_opiskelijavuodet_opiskeluoikeus_aikajakso_lasna_valmistunut]
GO
/****** Object:  Table [sa].[osasuoritus_kustannusryhma]    Script Date: 12.9.2019 15:50:05 ******/
DROP TABLE IF EXISTS [sa].[osasuoritus_kustannusryhma]
GO
/****** Object:  Table [sa].[opiskelijavuodet_valitaulu_unpivot]    Script Date: 12.9.2019 15:50:05 ******/
DROP TABLE IF EXISTS [sa].[opiskelijavuodet_valitaulu_unpivot]
GO
/****** Object:  Table [sa].[opiskelijavuodet_valitaulu]    Script Date: 12.9.2019 15:50:05 ******/
...
CREATE TABLE [sa].[temp_opiskelijavuodet_samana_paivana_alkaneet_hylattavat](
	...
	[opiskeluoikeus_oid_hyvaksytaan] [varchar](max) NULL
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
END
GO
USE [ANTERO]