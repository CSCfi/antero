USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_amos_tutkinnot_ja_tutkinnonosat_tabular_painotetut]    Script Date: 17.9.2019 16:33:23 ******/
DROP PROCEDURE IF EXISTS [dw].[p_lataa_f_amos_tutkinnot_ja_tutkinnonosat_tabular_painotetut]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_amos_tutkinnot_ja_tutkinnonosat_tabular_painotetut]    Script Date: 17.9.2019 16:33:23 ******/
SET ANSI_NULLS ON
GO
...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dw].[p_lataa_f_amos_tutkinnot_ja_tutkinnonosat_tabular_painotetut]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dw].[p_lataa_f_amos_tutkinnot_ja_tutkinnonosat_tabular_painotetut] AS' 
END
GO
...
FROM (
	...
	SELECT
	  ...
	  left join ANTERO.sa.sa_amos_tutk_pohjakoul_2017 d4 on d4.ytunnus = d3.organisaatio_koodi and d4.kr = d2.koodi and d4.tutktyyppi = (case when d1.tutkintotyyppi_koodi in ('19','20') then '19_20' else tutkintotyyppi_koodi end)
