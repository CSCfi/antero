...
/****** Object:  View [dw].[v_st_avoin_yliopisto]    Script Date: 8.11.2019 14:24:27 ******/
SET ANSI_NULLS ON
GO
...
join antero.dw.d_yo d6 on d6.yo_tunnus=f2.yliopisto_tunnus
...
select  vuosi
	   ...
	   ,d6.yo_nimi_fi
	   ,[OKM ohjauksen ala] = d2.ohjauksenala_nimi_fi 
	   ,[Koodit Koulutusalakoodi] = d4.selite_fi
--mittarit
       ,'0' as suorittaneiden_lkm
...
select		 vuosi
	   ...
	   ,d6.yo_nimi_fi
	   ,[OKM ohjauksen ala] = d2.ohjauksenala_nimi_fi 
	   ,[Koodit Koulutusalakoodi] = d3.selite_fi
--mittarit
       ,'0' as suorittaneiden_lkm
	   ,'0' as Opiskelijamäärä_Brutto
	   ,'0' as Suoritetut_lkm
...
join antero.dw.d_yo d6 on d6.yo_tunnus=f4.yliopisto_tunnus
join antero.dw.d_sukupuoli d1 on d1.id='-1'
join [dw].[d_ohjauksenala] d2 on d2.id = '-1'
