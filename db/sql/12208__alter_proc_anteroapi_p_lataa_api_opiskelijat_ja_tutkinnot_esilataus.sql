...
SELECT	
	...
	--mittarit
	,[Tutkinnot]			= sum(tutk)
	,[Opiskelijat]			= sum(opisk)
	,[opiskelijatFte]		= sum(fte)
	,[Uudet opiskelijat]	= sum(uusi)
...
GROUP BY
	f.tilv
	,COALESCE(d0.aineistotyyppi_nimi_fi,'Tuntematon')
	,COALESCE(d5.koulutussektori,'Tuntematon')
	,COALESCE(d1.organisaatio_fi,'Tuntematon')
	,COALESCE(d2.koulutusluokitus_fi,'Tuntematon')
	,COALESCE(d4.sukupuoli_fi,'Tuntematon')
	,COALESCE(d2.koulutusastetaso1_fi,'Tuntematon')
	,COALESCE(d2.Koulutusastetaso2_fi,'Tuntematon')
	,COALESCE(d2.koulutusalataso1_fi,'Tuntematon')
	,COALESCE(d2.koulutusalataso2_fi,'Tuntematon')
	,COALESCE(d2.koulutusalataso3_fi,'Tuntematon')
	,COALESCE(d2.okmohjauksenala_fi,'Tuntematon')
	,COALESCE(d3.Ammattikorkeakoulut_tutkintotavoitteet,'Tuntematon')
	,COALESCE(d3.Ammattikorkeakoulut_tutkintotavoitteet,'Tuntematon')
	,COALESCE(d3.Yliopistot_tutkintotavoitteet,'Tuntematon')
	,COALESCE(d3.Yliopistot_tutkintotavoitteet2021,'Tuntematon')
	,COALESCE(d6.rahoituslahde,'Tuntematon')
	,d16.opiskelijan_olo_tamm
	,d17.opiskelijan_olo
	,d18.maakunta
	,f.sektori
