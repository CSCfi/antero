USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_haku_ja_valinta_hakeneet_toinen_aste]    Script Date: 16.2.2021 19:21:00 ******/
SET ANSI_NULLS ON
GO
...
coalesce(d0.id,'-1') as sa_haku_ja_valinta_vuosikello_toinen_aste_id,
...
case when f.PohjakoulutuksenSuoritusvuosi = '0' or f.PohjakoulutuksenSuoritusvuosi is null then 'Tieto puuttuu' else cast(f.PohjakoulutuksenSuoritusvuosi as nvarchar) end as pohjakoulutuksen_paattovuosi,
