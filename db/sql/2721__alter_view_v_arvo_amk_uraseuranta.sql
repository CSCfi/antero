...
/****** Object:  View [dw].[v_arvo_amk_uraseuranta]    Script Date: 13.12.2019 12:18:38 ******/
SET ANSI_NULLS ON
GO
...
, d7.koulutusastetaso1_sv					AS 'Utbildnings, nivå 1'
, d7.koulutusastetaso2_sv					AS 'Utbildnings, nivå 2'
, d7.okmohjauksenala_sv						AS 'UKM-styrninggsområde'
, d9b.kieli_sv		  						AS 'Utförande språk'			--GOOGLEKÄÄNNÖS
...
, o2.organisaatio_en						AS 'Organisation'

, d7.koulutusluokitus_en					AS 'Name of education'									
, d7.koulutusalataso1_en					AS 'Field of education 1'
, d7.koulutusalataso2_en					AS 'Field of education 2'
, d7.koulutusalataso3_en					AS 'Field of education 3'
, d7.koulutusastetaso1_en					AS 'Level of education 1'
, d7.koulutusastetaso2_en					AS 'Level of education 2'
, d7.okmohjauksenala_en						AS 'Field of education, HE steering'
, d9b.kieli_en		  						AS 'Studying Language'						--TARKISTETTAVA
...
-----------------------------------------------------------RUOTSI---------------------------------------------------------------------
, d8.sukupuoli_fi							AS 'Kön'	
, d9.kieliryhma1_fi							AS 'Modersmål'
, vt.ikaryhma3_fi							AS 'Åldersgroupp'
, vt.ikaryhma2_fi							AS 'ÅldersgrouppII'
, d10.vastaus_fi							AS 'Grundutbildning'
, d11.vastaus_fi							AS 'Arbetslivserfarenhet'   --TARKISTETTAVA
----------------------------------------------------------ENGLANTI---------------------------------------------------------------------
, d8.sukupuoli_fi							AS 'Gender'	
, d9.kieliryhma1_fi							AS 'Native language'
, vt.ikaryhma3_fi							AS 'Age groupp'
, vt.ikaryhma2_fi							AS 'Age grouppII'
, d10.vastaus_fi							AS 'Prior education'
, d11.vastaus_fi							AS 'Work experience'
														--MUUT
, d5.kyselyid
, d5.kyselykertaid
, d4.kysymysid
