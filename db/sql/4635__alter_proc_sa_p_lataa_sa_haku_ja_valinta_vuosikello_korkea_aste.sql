USE [ANTERO]
GO
/****** Object:  StoredProcedure [sa].[p_lataa_sa_haku_ja_valinta_vuosikello_korkea_aste]    Script Date: 8.6.2021 22:28:14 ******/
SET ANSI_NULLS ON
GO
...
select [haku]
	...
	--viimeisin päivityspvm (käynnistysehtona "tänään", yleisemmin ehtona raporteille pääsyyn)
	...
	--seuraava tuleva päivityspvm (tiedoksi)
	  ,[seuraava_kaynnistys] = 
		coalesce(
