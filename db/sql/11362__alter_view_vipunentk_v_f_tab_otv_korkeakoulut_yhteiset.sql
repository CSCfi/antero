...
/****** Object:  View [dbo].[v_f_tab_otv_korkeakoulut_yhteiset]    Script Date: 5.11.2025 15.47.24 ******/
SET ANSI_NULLS ON
GO
...
,d45.kvopiskelija as 'Kansainvälinen opiskelija'
...
,d45.jarjestys as jar_kvopiskelija
,d48.jarjestys as jar_tutkinnon_suoritusmaa
...
SELECT [tilastointivuosi] as Tilastovuosi
  ...
  FROM [dbo].[f_OTV_4_9_Vaestorakenne_kunnittain]
	...
	LEFT JOIN [dbo].d_kvopiskelija d45 ON d45.id = f.kvopisk_id
