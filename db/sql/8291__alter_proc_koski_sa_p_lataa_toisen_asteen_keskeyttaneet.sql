...
/****** Object:  StoredProcedure [dbo].[p_lataa_toisen_asteen_keskeyttaneet]    Script Date: 1.11.2023 17:00:26 ******/
SET ANSI_NULLS ON
GO
...
FROM (
	...
	LEFT JOIN (SELECT * FROM sa.sa_koski_opiskeluoikeus_aikajakso WHERE tila IN ('lasna', 'loma')) ooa ON oo.opiskeluoikeus_oid = ooa.opiskeluoikeus_oid
