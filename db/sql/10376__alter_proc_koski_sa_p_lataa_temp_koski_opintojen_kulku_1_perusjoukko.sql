...
/****** Object:  StoredProcedure [sa].[p_lataa_temp_koski_opintojen_kulku_1_perusjoukko]    Script Date: 13.11.2024 14:17:40 ******/
SET ANSI_NULLS ON
GO
...
FROM (
	...
	SELECT 
		...
		oppimaara = 
			...
			END,
		rnk = rank() over (
			partition by perus.oppija_oid, koulutus_kytkin, case when koulutus_kytkin='ammatillinen' then ps.suorituksen_tyyppi end, kal.kohortti_vp 
