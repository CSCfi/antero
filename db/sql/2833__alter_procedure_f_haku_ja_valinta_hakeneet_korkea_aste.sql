...
/****** Object:  StoredProcedure [dw].[p_lataa_f_haku_ja_valinta_hakeneet_korkea_aste]    Script Date: 10.2.2020 11:49:02 ******/
SET ANSI_NULLS ON
GO
...
left join (
	...
	FROM sa.sa_odw_hakeneet f
	WHERE f.ValinnanTila in ('HYVAKSYTTY','VARASIJALTA_HYVAKSYTTY','PERUNUT')
	GROUP BY f.HenkiloOID, f.HakuOid) d36 on d36.HenkiloOID = f.HenkiloOID and d36.HakuOid = f.HakuOid
