...
/****** Object:  View [dw].[v_virta_otp_opettajakelpoisuudet]    Script Date: 23.5.2023 8:44:23 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN ANTERO.dw.d_kytkin d20 on d20.id = f.d_kytkin_paatelty_tutkinnosta_id
