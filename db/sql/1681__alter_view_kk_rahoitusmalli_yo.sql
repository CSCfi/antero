...
OR (tarkastelujakso= '7,5' and  koulutussektori= 'Yiopistokoulutus' ) and d50.organisaatio_koodi not in ('02358', '01740', '01742', '01717') and d1.oppilaitostyyppikoodi='42'
...
left join VipunenTK.dbo.d_koulutusluokitus d60 on d2.koulutusluokitus_koodi=d60.koulutusluokitus_avain
 ...
 left join VipunenTK.dbo.d_tieteenala d90 on d90.tieteenala_avain=d59.tieteenala_avain
where vuosi>2010 and d1.organisaatio_koodi not in ('02358', '01740', '01742', '01717') and d1.oppilaitostyyppi_koodi='42'
...
--Hakijat--
 ...
 where d1.julkaisunpaaluokka_koodi in ('A', 'B', 'C', 'D', 'E', 'F', 'I') and tilastovuosi>2010 and d3.organisaatio_koodi not in ('02358', '01740', '01742', '01717') and d3.oppilaitostyyppi_koodi='42'
...
--Hakijat--
 ...
 where d1.rahoituslahde in ('Suomen Akatemia', 'Tekes', 'EU-puiteohjelmarahoitus') and d3.organisaatio_koodi not in ('02358', '01740', '01742', '01717') and d3.oppilaitostyyppi_koodi='42'
...
SELECT
 ...
 where d14.kysymysryhmaid  <('14') or d14.kysymysryhmaid between 117 and 124 and  kyselypohja in ('KANDIPALAUTE','AVOP-AMK') and 
 d3.oppilaitostyyppi_koodi='42' and 
 d3.organisaatio_koodi not in ('02358', '01740', '01742', '01717') 
...
--Hakijat--
  ...
  ,NULL as 'Talouserittely'
	...
	where d12.koulutussektori_koodi=5  and d3.organisaatio_koodi not in ('02358', '01740', '01742', '01717') 
