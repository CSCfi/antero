...
/****** Object:  StoredProcedure [dbo].[p_lataa_f_koulutukseen_sijoittuneet_8v]    Script Date: 22.10.2024 17:03:41 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dbo].[p_lataa_f_koulutukseen_sijoittuneet_8v] AS

exec VipunenTK_SA.dbo.p_lataa_koulutukseen_sijoittuneet_8v;

exec p_prosessoi_3_13b;

truncate table vipunentk.dbo.[f_koulutukseen_sijoittuneet_8v];

insert into vipunentk.dbo.[f_koulutukseen_sijoittuneet_8v]
SELECT
	  ...
	  ,[tj0_koul_luokitus_id]
	   FROM [VipunenTK_DW].[dbo].[v_f_koulutukseen_sijoittuneet_8v_tarkastelu] AS f
