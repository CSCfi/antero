...
/****** Object:  View [dw].[v_arvo_amis_tep_cultures]    Script Date: 10.9.2026 17.24.09 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dw].[v_arvo_amis_tep_cultures] AS

--Tee muutokset tarvittaessa myös näkymään v_arvo_amis_tep_cultures_pbi, jossa mukana koodit_tyopaikka ( = koodit_yritys_yhteiso); muuttujaa ei saa julkaista tai viedä kuutioon. JS 4.2.2025
...
--FI
	...
	,CASE
		WHEN f.numerovalinta is null and d4.kysymysid = '18542' THEN 'Ei kokemusta' 
		ELSE COALESCE(NULLIF(d6.vastaus_fi,'Tieto puuttuu'),cast(numerovalinta as varchar(10)),vaihtoehto) 
	END AS 'monivalintavaihtoehto_fi'
	...
	,a2.ely_fi									AS 'oppilaitoksen_ely_fi'
															...
															--TOIMIPISTE
	,o1.organisaatio_fi							AS 'toimipiste_fi'
	,a1.kunta_fi								AS 'toimipisteen_kunta_fi'
	,a1.maakunta_fi								AS 'toimipisteen_maakunta_fi'
	...
	,d10.suorituskieli_ammatillinen_fi			AS 'suorituskieli_fi'
...
--SV
	...
	--ei-monivalintakysymyksissa naytetaan numerovalinta
	,CASE
		WHEN f.numerovalinta is null and d4.kysymysid = '18542' THEN 'Ingen erfarenhet' 
		ELSE COALESCE(NULLIF(d6.vastaus_sv,'Information saknas'),cast(numerovalinta as varchar(10))) 
	END AS 'monivalintavaihtoehto_sv'
	...
	,a2.ely_sv									AS 'oppilaitoksen_ely_sv'
												...
												--TOIMIPISTE
	,o1.organisaatio_sv							AS 'toimipiste_sv'
	,a1.kunta_sv								AS 'toimipisteen_kunta_sv'
	,a1.maakunta_sv								AS 'toimipisteen_maakunta_sv'
	...
	,d10.suorituskieli_ammatillinen_sv			AS 'suorituskieli_sv'
...
--EN
	...
	--ei-monivalintakysymyksissa naytetaan numerovalinta
	,CASE
		WHEN f.numerovalinta is null and d4.kysymysid = '18542' THEN 'No experience' 
		ELSE COALESCE(NULLIF(d6.vastaus_en,'Missing data'),cast(numerovalinta as varchar(10))) 
	END AS 'monivalintavaihtoehto_en'
	...
	,a2.ely_en									AS 'oppilaitoksen_ely_en'
												...
												--TOIMIPISTE
	,o1.organisaatio_en							AS 'toimipiste_en'
	,a1.kunta_en								AS 'toimipisteen_kunta_en'
	,a1.maakunta_en								AS 'toimipisteen_maakunta_en'
	...
	,d10.suorituskieli_ammatillinen_en			AS 'suorituskieli_en'
	...
	,a1.jarjestys_maakunta_koodi				AS 'jarjestys_toimipisteen_maakunta'
	...
	,d15.koodi						            AS 'jarjestys_vastaajan_tyotehtava'
	...
	,f.d_arvokysely_id						    AS 'apusarake_kyselykertaid'
...
LEFT JOIN dw.d_alueluokitus a1 ON a1.id=f.d_alueluokitus_toimipiste_id
...
LEFT JOIN dw.d_arvovastaus_monivalinta d15 ON d15.id = f.d_arvovastaus_taustakysymys_tehtava_id
