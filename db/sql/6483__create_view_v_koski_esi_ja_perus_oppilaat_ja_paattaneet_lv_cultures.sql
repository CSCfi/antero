...
/****** Object:  View [dw].[v_koski_esi_ja_perus_oppilaat_ja_paattaneet_lukuvuosittain_cultures]    Script Date: 14.9.2022 18:02:43 ******/
SET ANSI_NULLS ON
GO
...
--exec [dbo].[tarkista_kaannokset2] 'v_koski_esi_ja_perus_oppilaat_ja_paattaneet_lv_cultures'

CREATE OR ALTER VIEW [dw].[v_koski_esi_ja_perus_oppilaat_ja_paattaneet_lv_cultures] AS
