USE [Koski_SA]
GO
/****** Object:  StoredProcedure [sa].[p_lataa_temp_koski_opintojen_kulku_3a_ammatillinen]    Script Date: 1.9.2022 15:37:34 ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT
 ...
 ,priorisoitu_tilanne_amm = 
	CASE
		...
		WHEN priorisoitu_tilanne_amm_koodi = 5 THEN 'Jatkaa amm. valmentavassa koulutuksessa'
