...
/****** Object:  View [dw].[v_amos_netto_opiskelijat_cultures]    Script Date: 6.10.2023 23:53:48 ******/
SET ANSI_NULLS ON
GO
...
/*
Käytetään raportilla: Oppisopimuksen koulutuskorvauksen lisärahoituksen seurantaraportti (Live)
Huom. 
Nyt vastaavan jäädytetyn raportin lähteenä on [dw].[v_koski_amm_opiskelijat_ja_tutkinnot_cultures_jaadytys], joka korvattaneen s23 jäädytyksen yhteydessä vastaavasti.
