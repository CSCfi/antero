USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_api_koulutuksenkustannukset_esilataus]    Script Date: 7.5.2021 3:48:26 ******/
SET ANSI_NULLS ON
GO
...
--generoidaan oletusjärjestys kohdetaulussa
...
UNPIVOT
  (summa FOR menolajitoiminto IN
    ...
    LEFT JOIN dw.d_organisaatio d1 ON RIGHT(coalesce(nullif(ytunnus,''),'-1'),9)=organisaatio_koodi
