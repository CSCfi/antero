...
/****** Object:  StoredProcedure [dw].[p_lataa_d_oppivelvollisen_toiminta]    Script Date: 9.5.2022 15:11:34 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dw].[p_lataa_d_oppivelvollisen_toiminta] AS
...
('7','Ei suorita oppivelvollisuutta','SV*','EN*','Tutkintoon johtamattomassa koulutuksessa (kelpaa oppivelvollisuuden suorittamiseen)','SV*','EN*',3,7,'manuaalinen'),
