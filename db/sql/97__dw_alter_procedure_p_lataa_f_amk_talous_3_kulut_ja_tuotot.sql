ALTER PROCEDURE dw.p_lataa_f_amk_talous_3_kulut_ja_tuotot AS

TRUNCATE TABLE dw.f_amk_talous_3_kulut_ja_tuotot

INSERT INTO dw.f_amk_talous_3_kulut_ja_tuotot
           (d_amk_id
           ,d_toiminto_id
           ,tilikausi
           ,tuotot_yhteensa
...
SELECT d1.id AS d_amk_id
  ...
  FROM sa.sa_SUORAT_AMK_TALOUS_3_tuloslaskelman_toiminnot f
  INNER JOIN dw.d_amk d1 ON f.AMK_koodi = d1.amk_tunnus
  INNER JOIN dw.d_toiminto d2 ON f.PTTOIMINTO = d2.toiminto