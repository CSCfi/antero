USE [ANTERO]
GO
/****** Object:  View [dw].[v_st_rekrytointi_valitut]    Script Date: 7.12.2018 16:34:15 ******/
DROP VIEW IF EXISTS [dw].[v_st_rekrytointi_valitut]
GO
/****** Object:  View [dw].[v_st_rekrytointi_haut]    Script Date: 7.12.2018 16:34:15 ******/
DROP VIEW IF EXISTS [dw].[v_st_rekrytointi_haut]
GO
/****** Object:  View [dw].[v_st_rekrytointi_haut]    Script Date: 7.12.2018 16:34:15 ******/
SET ANSI_NULLS ON
GO
...
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dw].[v_st_rekrytointi_haut]'))
...
CREATE VIEW [dw].[v_st_rekrytointi_haut] AS
 ...
 GROUP BY f1.vuosi,d1.amk_nimi_fi,d2.kytkin_fi,d6.kytkin_fi,d7.kytkin_fi,d5.sukupuoli_fi,d3.kytkin_fi,d4.maanosat0_fi,f1.hakunumero,d1.amk_tunnus,d2.jarjestys_kytkin_koodi,d6.jarjestys_kytkin_koodi,d7.jarjestys_kytkin_koodi,d5.jarjestys_sukupuoli_koodi,d3.jarjestys_kytkin_koodi,d3.kytkin_koodi,d4.jarjestys_maanosat0_koodi,d4.maanosat0_koodi
 ...
 SELECT
	...
	,f2.[hakunumero]
	,[Hakuavain] = f2.hakunumero+d1.yo_tunnus
 ...
 --)
 GROUP BY f2.vuosi,d1.yo_nimi_fi,d2.kytkin_fi,d6.kytkin_fi,d7.kytkin_fi,d5.sukupuoli_fi,d3.kytkin_fi,d4.maanosat0_fi,f2.hakunumero,d1.yo_tunnus,d2.jarjestys_kytkin_koodi,d6.jarjestys_kytkin_koodi,d7.jarjestys_kytkin_koodi,d5.jarjestys_sukupuoli_koodi,d3.jarjestys_kytkin_koodi,d3.kytkin_koodi,d4.maanosat0_koodi,d4.jarjestys_maanosat0_koodi
...
CREATE VIEW [dw].[v_st_rekrytointi_valitut] AS
 ...
 SELECT
	...
	*/
	...
	,case when d1.organisaatio_koodi=d30.organisaatio_koodi and d1.organisaatio_koodi!=''-1'' then 1 else 0 end as tohtori_sama_yo
	,case when d1.organisaatio_koodi!=d30.organisaatio_koodi and d1.organisaatio_koodi!=''-1'' and d30.organisaatio_koodi!=''-1'' then 1 else 0 end as tohtori_eri_yo
	,case when d13.maatjavaltiot2_koodi not in (''-1'',''246'') then 1 else 0 end as tohtori_ulk_yo
 ...
 --SELECT DISTINCT Hakunumero+amk_nykyinen_tunnus FROM ANTERO.dw.f_amk_rekrytointihaut JOIN dw.d_amk d1 ON d1.id=d_korkeakoulu_id WHERE hakijat_lkm > 0
 --UNION ALL
 --SELECT DISTINCT Hakunumero+yo_nykyinen_tunnus FROM ANTERO.dw.f_yo_rekrytointihaut JOIN dw.d_yo d1 ON d1.id=d_yliopisto_id WHERE hakijat_lkm > 0
 --)
