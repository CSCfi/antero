...
/****** Object:  StoredProcedure [dbo].[p_lataa_esi_ja_perus_oppilaat_ja_paattaneet_valitaulu]    Script Date: 24.5.2023 15:07:50 ******/
SET ANSI_NULLS ON
GO
			...
			,opiskelee_toiminta_alueittain =
				case 
					...
					when et.opiskelee_toiminta_alueittain = 1
						...
						and coalesce(et.loppu, '9999-12-31') >= ooa.alku 
					then 1
					else 0
				end
