...
IF EXISTS (
  ...
  and COLUMN_NAME='SivunumeroTeksti' and DATA_TYPE='varchar'
)  BEGIN
...
IF EXISTS (
  select * from INFORMATION_SCHEMA.COLUMNS
  where TABLE_SCHEMA='sa' and TABLE_NAME='sa_virta_jtp_tkjulkaisut'
  and COLUMN_NAME='JufoTunnus' and DATA_TYPE='varchar'
)  BEGIN
...
IF EXISTS (
  select * from INFORMATION_SCHEMA.COLUMNS
  where TABLE_SCHEMA='sa' and TABLE_NAME='sa_virta_jtp_tkjulkaisut'
  and COLUMN_NAME='JulkaisumaaKoodi' and DATA_TYPE='varchar'
)  BEGIN
...
IF EXISTS (
  select * from INFORMATION_SCHEMA.COLUMNS
  where TABLE_SCHEMA='sa' and TABLE_NAME='sa_virta_jtp_tkjulkaisut'
  and COLUMN_NAME='VolyymiTeksti' and DATA_TYPE='varchar'
)  BEGIN
...
IF EXISTS (
  select * from INFORMATION_SCHEMA.COLUMNS
  where TABLE_SCHEMA='sa' and TABLE_NAME='sa_virta_jtp_tkjulkaisut'
  and COLUMN_NAME='LehdenNumeroTeksti' and DATA_TYPE='varchar'
)  BEGIN
...
IF EXISTS (
  select * from INFORMATION_SCHEMA.COLUMNS
  where TABLE_SCHEMA='sa' and TABLE_NAME='sa_virta_jtp_tkjulkaisut'
  and COLUMN_NAME='JulkaisunKieliKoodi' and DATA_TYPE='varchar'
)  BEGIN
...
IF EXISTS (
  select * from INFORMATION_SCHEMA.COLUMNS
  where TABLE_SCHEMA='sa' and TABLE_NAME='sa_virta_jtp_tkjulkaisut'
  and COLUMN_NAME='Lataus_ID' and DATA_TYPE='varchar'
)  BEGIN
