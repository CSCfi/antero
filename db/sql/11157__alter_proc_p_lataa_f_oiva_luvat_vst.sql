...
/****** Object:  StoredProcedure [dw].[p_lataa_f_oiva_luvat_vst]    Script Date: 9.9.2025 10.32.04 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	FROM (
		SELECT DISTINCT 
			...
			,vsttyypit = l.oppilaitostyyppi --siirrytään käyttämään oppilaitostyyppiä 8.7.2025
			,vsttyypit_selite = k11.nimi    --varmista mihin tätä tarvitaan
