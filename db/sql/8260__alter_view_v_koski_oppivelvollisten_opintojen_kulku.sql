...
/****** Object:  View [dw].[v_koski_oppivelvollisten_opintojen_kulku]    Script Date: 3.11.2023 9:10:30 ******/
SET ANSI_NULLS ON
GO
...
ALTER    VIEW [dw].[v_koski_oppivelvollisten_opintojen_kulku] AS 
...
SELECT 
	...
	d30.kytkin_fi as 'Oppivelv. suorittamiseen kelpaavassa koulutuksessa', 
...
LEFT JOIN ANTERO.dw.d_kytkin d30 on d30.kytkin_koodi = CASE WHEN d17.kytkin_koodi + d18.kytkin_koodi + d21.kytkin_koodi + d22.kytkin_koodi + d23.kytkin_koodi + d24.kytkin_koodi + d26.kytkin_koodi > 0 THEN 1 ELSE 0 END
