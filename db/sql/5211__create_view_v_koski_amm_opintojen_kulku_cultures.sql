...
DROP VIEW IF EXISTS [dw].[v_koski_amm_opintojen_kulku_cultures]


/****** Object:  View [dw].[v_koski_amm_opintojen_kulku_cultures]    Script Date: 6.10.2021 22:12:06 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dw].[v_koski_amm_opintojen_kulku_cultures] AS
