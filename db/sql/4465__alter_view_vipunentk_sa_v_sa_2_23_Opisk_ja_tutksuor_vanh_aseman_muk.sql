...
/****** Object:  View [dbo].[v_sa_2_23_Opisk_ja_tutksuor_vanh_aseman_muk]    Script Date: 5.3.2021 17:32:04 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
 ...
 SELECT DISTINCT --kaikki rivit tuplana -jsyrjala 5.3.20
	  [tilv]
      ,[sp]
      ,[syntv] = (CASE left([syntv],3) WHEN '   ' THEN '9999' WHEN '190' THEN 100+[syntv] else syntv end)
      ,[aikielir1x]
      ...
      ,[rivinumero] = -1 --ROW_NUMBER() OVER(ORDER BY tilv) --kaikki rivit tuplana -jsyrjala 5.3.20
