...
/****** Object:  View [dbo].[v_f_tab_otv_korkeakoulut_yhteiset]    Script Date: 13.10.2020 16:27:57 ******/
SET ANSI_NULLS ON
GO
...
--
,case 
	when f.oppilaitos = '10122' then 'Tampereen yliopisto'
...
as Yliopisto
,case coalesce(d9.oppilaitoksen_korvaavakoodi,d9.oppilaitoskoodi)
...
,d9c.oppilaitos as 'Oppilaitos (tilastovuosi)'
...
--
,case 
	when f.oppilaitos = '10122' then 'Tammerfors universitet'
	when coalesce(d9.oppilaitoksen_korvaavakoodi,d9.oppilaitoskoodi) = '10118' then 'Kaakkois-Suomen ammattikorkeakoulu' 
...
--
,case 
	when f.oppilaitos = '10122' then 'University of Tampere'
...
as University
,case coalesce(d9.oppilaitoksen_korvaavakoodi,d9.oppilaitoskoodi)
	when '10118' then 'South-Eastern Finland University of Applied Sciences' 
	else d9.oppilaitos_EN end
as Polytechnic
...
--Lukumäärämuuttujat
,[Opisk2]
,[Aloit2] = case when d21a.Koulutusastetaso2_koodi in(62,63,71,72) then Aloit2 else 0 end
,[Aloit3] = [Aloit2]
