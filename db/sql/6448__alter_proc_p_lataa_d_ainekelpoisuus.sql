...
/****** Object:  StoredProcedure [dw].[p_lataa_d_ainekelpoisuus]    Script Date: 20.9.2022 12:10:13 ******/
SET ANSI_NULLS ON
GO
...
USING (
	SELECT DISTINCT
		...
		CASE 
			...
			WHEN d.patevyys_fi like '%äidinkieli%' THEN 'Äidinkieli'
...
VALUES
('Musiikkipedagogiikka', '*SV', '*EN', 'Muut aineet', '*SV', '*EN', 'Musiikkipedagogiikka', '*SV', '*EN', getdate(), user_name(), 'ETL: p_lataa_d_ainekelpoisuus'),
('Teatteri- ja tanssipedagogiikka', '*SV', '*EN', 'Muut aineet', '*SV', '*EN', 'Teatteri- ja tanssipedagogiikka', '*SV', '*EN', getdate(), user_name(), 'ETL: p_lataa_d_ainekelpoisuus')
