...
/****** Object:  StoredProcedure [dbo].[p_lataa_amm_opiskelijat_paivittain]    Script Date: 6.7.2023 13:44:48 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dbo].[p_lataa_amm_opiskelijat_paivittain] @alku as date = '2021-01-01', @loppu as date = null, @kk as int = 1   AS
