...
/****** Object:  StoredProcedure [dw].[p_lataa_f_amos_opiskelijapalaute_vastausosuudet_kertoimet_generoitu]    Script Date: 7.4.2026 14.50.09 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dw].[p_lataa_f_amos_opiskelijapalaute_vastausosuudet_kertoimet_generoitu] AS
...
FROM (
	...
	FROM (
		...
		GROUP BY 
			coalesce(jl.ytunnus_amos_spl, d1.organisaatio_koodi)
			,jl.nimi_amos_spl
