...
/****** Object:  View [dw].[v_horizon]    Script Date: 25.10.2021 9:04:33 ******/
SET ANSI_NULLS ON
GO
...
SELECT
	...
	coalesce(d5.Pilari, 'Unknwon') AS 'Pillar',
	...
	coalesce(projectRcn, '-1') AS 'Project RCN',
	coalesce(projectID, '-1') AS 'Project ID',
