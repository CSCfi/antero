...
/****** Object:  View [dw].[v_virta_otp_55_jaahdytetty_2018]    Script Date: 18.9.2026 14.22.33 ******/
SET ANSI_NULLS ON
GO
...
FROM ANTERO.sa.sa_virta_otp_viisviis_2018 f
...
INNER JOIN ANTERO.dbo.view_salt vs on vs.[view] = 'v_virta_otp_55_jaahdytetty_2018'