...
/****** Object:  View [dw].[v_koski_ammatillinen_koulutus_tutkinnon_osat_ja_naytot_cultures]    Script Date: 27.5.2026 14.31.35 ******/
SET ANSI_NULLS ON
GO
...
ALTER   VIEW [dw].[v_koski_ammatillinen_koulutus_tutkinnon_osat_ja_naytot_cultures] as
