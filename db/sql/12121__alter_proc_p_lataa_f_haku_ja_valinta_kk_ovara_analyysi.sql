...
/****** Object:  StoredProcedure [dw].[p_lataa_f_haku_ja_valinta_kk_ovara_analyysi]    Script Date: 27.7.2026 10.40.24 ******/
SET ANSI_NULLS ON
GO
...
ALTER   PROCEDURE [dw].[p_lataa_f_haku_ja_valinta_kk_ovara_analyysi] AS
