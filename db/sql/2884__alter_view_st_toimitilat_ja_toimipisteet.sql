...
/****** Object:  View [dw].[v_st_toimitilat_ja_toimipisteet]    Script Date: 13.3.2020 16:19:04 ******/
SET ANSI_NULLS ON
GO
...
select
	...
	,Statistikår = f.vuosi
	,Universitet = NULL
	,Yrkeshögskola = d1.amk_nimi_sv
	,Högskola = d1.amk_nimi_sv
