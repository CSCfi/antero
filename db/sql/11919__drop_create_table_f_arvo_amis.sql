...
/****** Object:  Table [dw].[f_arvo_amis]    Script Date: 7.4.2026 10.20.58 ******/
...
CREATE TABLE [dw].[f_arvo_amis](
	...
	[koulutustoimija] [varchar](255) NOT NULL,
	[d_organisaatio_toimipiste_id] [int] NOT NULL,
	...
	[d_alueluokitus_toimipiste_id] [int] NULL,
	...
	[oppisopimuksen_perustat] [nvarchar](50) NULL,
