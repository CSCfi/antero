...
/****** Object:  Table [dbo].[amm_opiskelijat_netto_valitaulu]    Script Date: 21.2.2024 14:30:30 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[amm_opiskelijat_netto_valitaulu]') AND type in (N'U'))
