...
/****** Object:  StoredProcedure [dbo].[p_lataa_esi_ja_perus_oppilaat_ja_paattaneet_valitaulu_jaadytys]    Script Date: 26.4.2022 22:34:29 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dbo].[p_lataa_esi_ja_perus_oppilaat_ja_paattaneet_valitaulu_jaadytys] AS

/*
Jäädytyksen jälkeen:
- ajetaan tämä arkistopalvelimella
- päivitetään vastaava näkymä SQL-palvelimella
- ajetaan Jenkins-transform (kun myös ainevalintojen sa-näkymät päivitetty)
*/
...
WHILE @alkuPvm <= EOMONTH(@tilastoPvm)
