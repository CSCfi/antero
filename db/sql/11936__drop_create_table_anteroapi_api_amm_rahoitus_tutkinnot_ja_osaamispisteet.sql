...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dw].[api_amm_rahoitus_tutkinnot_ja_osaamispisteet]') AND type in (N'U'))
DROP TABLE [dw].[api_amm_rahoitus_tutkinnot_ja_osaamispisteet]
GO
...
CREATE TABLE [dw].[api_amm_rahoitus_tutkinnot_ja_osaamispisteet](
	...
	[toteuma_estimaatti] [varchar](10) NOT NULL,
	...
	[tutkinnon_osat_lkm] [decimal](30, 20) NULL,
