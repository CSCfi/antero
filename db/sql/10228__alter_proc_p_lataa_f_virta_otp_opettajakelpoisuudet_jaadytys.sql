...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_opettajakelpoisuudet_jaadytys]    Script Date: 16.10.2024 7:56:16 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	WHERE p.Vuosi = ' + @alkuVuosi + ' or (' + @alkuVuosi + ' = 2023 and p.Vuosi <= 2023)'
