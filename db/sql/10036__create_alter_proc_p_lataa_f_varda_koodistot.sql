...
/****** Object:  StoredProcedure [dw].[p_lataa_varda_koodistot]    Script Date: 19.8.2024 12:41:25 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER procedure [dw].[p_lataa_varda_koodistot] as 
...
select
      ...
      ,[alkupvm]
      ,[loppupvm]
	  ,Case when koodi = '43525' then 1
			when koodi = '64212' then 2
			when koodi = '77826' then 3
			when koodi = '84053' then 4
			when koodi = '84724' then 5
			when koodi = '39407' then 6
			when koodi = '41712' then 7
			when koodi = '81787' then 8
			else NULL end as jarjestys
	  ,'p_lataa_varda_koodistot' as [Source]
  FROM [ANTERO].[sa].[sa_varda_koodistot]
