...
/****** Object:  View [dw].[v_virta_otp_55_jaahdytetty_2024]    Script Date: 18.9.2026 15.28.16 ******/
SET ANSI_NULLS ON
GO
...
ALTER    VIEW  [dw].[v_virta_otp_55_jaahdytetty_2024] 
AS
...
FROM ANTERO.sa.sa_virta_otp_viisviis_2024 f
...
INNER JOIN ANTERO.dbo.view_salt vs on vs.[view] = 'v_virta_otp_55_jaahdytetty_2024'