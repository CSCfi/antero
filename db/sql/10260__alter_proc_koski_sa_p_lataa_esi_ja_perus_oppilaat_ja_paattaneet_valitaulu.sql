...
/****** Object:  StoredProcedure [dbo].[p_lataa_esi_ja_perus_oppilaat_ja_paattaneet_valitaulu]    Script Date: 21.10.2024 8:11:39 ******/
SET ANSI_NULLS ON
GO
	...
	FROM (
		...
		OUTER APPLY (
			...
			select top 1 
				...
				kielikylpykieli = ps.kielikylpykieli_koodi, 
				ps.toimipiste_oid,
				max_vuosiluokka = ps.koulutusmoduuli_koodiarvo
			from sa.sa_koski_paatason_suoritus ps 
