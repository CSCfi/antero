...
/****** Object:  View [dbo].[v_f_tab_otv_korkeakoulut_yliopisto]    Script Date: 28.8.2019 16:17:08 ******/
SET ANSI_NULLS ON
GO
...
--Lukumäärämuuttujat
,[Opisk2]
,[Aloit2] = case when d21.Koulutusaste_taso2_koodi in (63,72,73,81,82,91) then Aloit2 else 0 end
