USE [Koski_SA]
GO
/****** Object:  StoredProcedure [dbo].[p_lataa_esi_ja_perus_oppilaat_ja_paattaneet_valitaulu]    Script Date: 14.12.2021 16:06:21 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[p_lataa_esi_ja_perus_oppilaat_ja_paattaneet_valitaulu]
AS
...
- Kotiopetus-, ulkomailla- sekä tehostetun tuen jaksot katsotaan kuukausitasolla ja oo:n aikajaksokohtaisesti (1 jaksojen leikatessa, muuten 0).
  Voivat siis näkyä 1-ryhmässä myös siltä osin kuin eivät ole kk:n aikana leikkaavan aikajakson aikana ko. kk:na voimassa, toisin kuin muut jaksotiedot. 
  Näistä kuitenkin vain kotiopetus on käytössä raportilla.
*/
