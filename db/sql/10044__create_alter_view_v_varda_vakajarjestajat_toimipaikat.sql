...
/****** Object:  View [dw].[v_varda_vakajarjestajat_toimipaikat]    Script Date: 19.8.2024 12:44:55 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER VIEW [dw].[v_varda_vakajarjestajat_toimipaikat] AS
		...
		SELECT
			...
			alue3.kuntaryhma_fi as toimipaikan_kuntaryhma_fi,
			alue3.kuntaryhma_en as toimipaikan_kuntaryhma_en,
			alue3.kuntaryhma_sv as toimipaikan_kuntaryhma_sv,
			...
			coalesce(kk.nimi_en, 'No emphasis') as toimipaikan_kielipainotus_en,
			coalesce(kk.nimi_sv, 'ingen språk som betonas') as toimipaikan_kielipainotus_sv,
		...
		WHERE tp.tilastovuosi between 2021 and 2023 -- = 2021
