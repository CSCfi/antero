...
/****** Object:  View [dbo].[v_sa_4_3b_Tutkinnon_suorittaneiden_paaasiallinen_toiminta_syntyperan_mukaan]    Script Date: 23.4.2026 15.20.57 ******/
SET ANSI_NULLS ON
GO
...
FROM (
  ...
  SELECT 
    ...
    ,[amas]
    ,[lkm]
    ,[tietolahde]='K4_3b_sopv_26'
    ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
  FROM [TK_H9098_CSC].[dbo].[TK_K4_3b_sopv_26]
