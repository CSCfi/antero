...
/****** Object:  View [dbo].[v_f_2_20_Lukio_amm_oppis_opisk_ian_ja_koul_mukaan]    Script Date: 21.7.2020 20:57:22 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
      ...
      (
		case [nayttox]
			when '1' then 'Aikaisempi ammatillinen peruskoulutus näyttötutkintona'
			when '2' then 'Ei aikaisempaa ammatillista peruskoulutusta näyttötutkintona'
			else 'Tuntematon' --2018 alkaen ei mukana
		end
	   ) as nvarchar(100))
