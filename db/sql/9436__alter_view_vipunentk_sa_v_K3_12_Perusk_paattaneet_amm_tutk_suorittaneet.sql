...
/****** Object:  View [dbo].[v_K3_12_Perusk_paattaneet_amm_tutk_suorittaneet]    Script Date: 21.12.2023 21:57:27 ******/
SET ANSI_NULLS ON
GO
...
and luontipvm != '2023-10-27' --vanha ajokerta. JS 21.12.2023
...
where suorv = 
	CASE 
		WHEN NOT EXISTS (
			...
			WHERE t.name = 'TK_K3_12_sopv_23' and p.rows > 0
		) 
		THEN '2020'
	END
and suorlk = '1'
