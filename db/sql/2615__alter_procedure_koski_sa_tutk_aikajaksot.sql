USE [Koski_SA]
GO
/****** Object:  StoredProcedure [sa].[p_lataa_tutkinnot_ja_tutkinnonosat_aikajaksot]    Script Date: 5.11.2019 16:35:28 ******/
SET ANSI_NULLS ON
GO
...
;WITH cte AS (
	SELECT
		...
		,loppu
		,opintojen_rahoitus
	FROM [Koski_SA_31102019].[sa].[sa_koski_opiskeluoikeus_aikajakso] ooa
	--JOIN Koski_SA_31102019.sa.sa_koski_opiskeluoikeus oo ON oo.opiskeluoikeus_oid = ooa.opiskeluoikeus_oid
