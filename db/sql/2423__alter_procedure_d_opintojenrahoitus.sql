USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_d_opintojenrahoitus]    Script Date: 19.9.2019 12:09:20 ******/
SET ANSI_NULLS ON
GO
...
USING (
	...
	CASE WHEN koodi IN (1,10,11) THEN 1 ELSE 0 END AS sisaltyy_okm_perusrahoitus,
	CASE WHEN koodi IN (1,2,3,7,8,9,10,11) THEN 1 ELSE 0 END AS sisaltyy_okm_suoritusrahoitus,
