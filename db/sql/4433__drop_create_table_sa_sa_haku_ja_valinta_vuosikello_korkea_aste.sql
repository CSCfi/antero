USE [ANTERO]
GO
/****** Object:  Table [sa].[sa_haku_ja_valinta_vuosikello_korkea_aste]    Script Date: 17.2.2021 22:51:21 ******/
...
GO
INSERT [sa].[sa_haku_ja_valinta_vuosikello_korkea_aste] ([id], [haku], [haku_oid], [koulutuksen_alkamiskausi], [aloituspaikat], [hakijat], [valitut], [vastaanottaneet], [aloittaneet]) VALUES (3, N'Erillishaku', NULL, N'20152', NULL, CAST(N'2015-11-26' AS Date), CAST(N'2015-11-26' AS Date), CAST(N'2015-11-26' AS Date), CAST(N'2015-11-26' AS Date))
GO
...
GO
INSERT [sa].[sa_haku_ja_valinta_vuosikello_korkea_aste] ([id], [haku], [haku_oid], [koulutuksen_alkamiskausi], [aloituspaikat], [hakijat], [valitut], [vastaanottaneet], [aloittaneet]) VALUES (6, N'Erillishaku', NULL, N'20161', NULL, CAST(N'2016-02-29' AS Date), CAST(N'2016-02-29' AS Date), CAST(N'2016-02-29' AS Date), CAST(N'2016-02-29' AS Date))
GO
...
GO
SET IDENTITY_INSERT [sa].[sa_haku_ja_valinta_vuosikello_korkea_aste] OFF
GO
