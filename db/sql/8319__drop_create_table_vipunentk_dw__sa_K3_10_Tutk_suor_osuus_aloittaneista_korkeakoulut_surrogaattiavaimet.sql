...
/****** Object:  Table [dbo].[_sa_K3_10_Tutk_suor_osuus_aloittaneista_korkeakoulut_surrogaattiavaimet]    Script Date: 24.11.2023 16:01:14 ******/
SET ANSI_NULLS ON
GO
...
DROP TABLE [dbo].[_sa_K3_10_Tutk_suor_osuus_aloittaneista_korkeakoulut_surrogaattiavaimet]
...
CREATE TABLE [dbo].[_sa_K3_10_Tutk_suor_osuus_aloittaneista_korkeakoulut_surrogaattiavaimet](
	...
	[tk_2018] [int] NULL,
	[muuta_2018] [int] NULL,
	[amkopisk_2018] [int] NULL,
	[ylamkopisk_2018] [int] NULL,
	[alkkopisk_2018] [int] NULL,
	[ylkkopisk_2018] [int] NULL,
	[tkopisk_2018] [int] NULL,
	[muutaopisk_2018] [int] NULL,
	...
	[tk_2019] [int] NULL,
	[muuta_2019] [int] NULL,
	[amkopisk_2019] [int] NULL,
	[ylamkopisk_2019] [int] NULL,
	[alkkopisk_2019] [int] NULL,
	[ylkkopisk_2019] [int] NULL,
	[tkopisk_2019] [int] NULL,
	[muutaopisk_2019] [int] NULL,
	...
	[tk_2020] [int] NULL,
	[muuta_2020] [int] NULL,
	[amkopisk_2020] [int] NULL,
	[ylamkopisk_2020] [int] NULL,
	[alkkopisk_2020] [int] NULL,
	[ylkkopisk_2020] [int] NULL,
	[tkopisk_2020] [int] NULL,
	[muutaopisk_2020] [int] NULL,
	...
	[tk_2021] [int] NULL,
	[muuta_2021] [int] NULL,
	[amkopisk_2021] [int] NULL,
	[ylamkopisk_2021] [int] NULL,
	[alkkopisk_2021] [int] NULL,
	[ylkkopisk_2021] [int] NULL,
	[tkopisk_2021] [int] NULL,
	[muutaopisk_2021] [int] NULL,
