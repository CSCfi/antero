...
/*
- tuotannon sql-yliheiton jälkeen voi vapauttaa alun importin
- tab-yliheiton jälkeen täytyy poistaa vuosipäätteen korvaaminen (ympäristö kerrallaan)
*/
N'' + case when @sqlServer like '%22' then 'Import-Module SqlServer' else '' end + '
[string]$server = "' + replace(replace(@sqlServer, 'sql', 'tab'), '22', '16') + '"
