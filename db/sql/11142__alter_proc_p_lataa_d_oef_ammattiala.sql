...
/****** Object:  StoredProcedure [dw].[p_lataa_d_oef_ammattiala]    Script Date: 5.9.2025 7.24.30 ******/
SET ANSI_NULLS ON
GO
...
ALTER   PROCEDURE [dw].[p_lataa_d_oef_ammattiala]
AS
...
WHEN NOT MATCHED BY source and id != '-1' and (select count(*) from sa.sa_koodistot where koodisto = 'ammattialaluokitusoeftaso1') > 0 THEN DELETE;
