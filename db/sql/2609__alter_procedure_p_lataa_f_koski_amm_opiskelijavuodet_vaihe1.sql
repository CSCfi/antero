...
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_amm_opiskelijavuodet_vaihe1]    Script Date: 4.11.2019 10:33:00 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	SELECT 
		...
		,ika = YEAR(@startDate)-YEAR(replace(h.syntymaaika, 190, 200)) --vaihdetaan 1900-1909 syntymäajat vuoteen 2000-2009
