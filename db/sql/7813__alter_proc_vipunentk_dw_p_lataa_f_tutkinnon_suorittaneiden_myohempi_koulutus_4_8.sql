...
/****** Object:  StoredProcedure [dbo].[p_lataa_f_tutkinnon_suorittaneiden_myohempi_koulutus_4_8]    Script Date: 26.6.2023 18:53:13 ******/
SET ANSI_NULLS ON
GO
...
--Lisätty viimeisen vaiheen lähtötauluun id-sarake sekä sille clustered-indeksi, ja siirrytty käyttämättään tätä luupissa rivinumeron sijaan. JS 30.6.2023
