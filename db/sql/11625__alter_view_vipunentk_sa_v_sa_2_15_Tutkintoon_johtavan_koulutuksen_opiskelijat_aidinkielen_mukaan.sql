...
/****** Object:  View [dbo].[v_sa_2_15_Tutkintoon_johtavan_koulutuksen_opiskelijat_aidinkielen_mukaan]    Script Date: 23.1.2026 9.49.08 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
      ...
      ,[lkm]
      ,[luontipvm]
      ,[tietolahde]='TK_2_15_sopv_25'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY aikieli, koulk, alvv)
  FROM [TK_H9098_CSC].[dbo].[TK_K2_15_sopv_25]
