...
ALTER PROCEDURE [dw].[p_lataa_api_amm_rahoitus_tutkinnot_ja_osaamispisteet_esilataus] AS
...
SELECT
	...
	,varainhoitovuosi
	,toteuma_estimaatti = [Toteuma/Estimaatti]
	,rahoituskausi
	,tilastokausi
	,tilastovuosi
	...
	,tutkinnon_osat_lkm = [painottamaton_osatutkinnot]
...
OUTER APPLY (
	...
	FROM [dw].[api_amm_rahoitus_tutkinnot_ja_osaamispisteet] t2
	
	WHERE 1=1
	AND t2.varainhoitovuosi = t.varainhoitovuosi
	AND t2.toteuma_estimaatti = t.toteuma_estimaatti
