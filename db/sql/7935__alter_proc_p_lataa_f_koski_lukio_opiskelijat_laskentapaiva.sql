...
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_lukio_opiskelijat_laskentapaiva]    Script Date: 8.8.2023 9:30:03 ******/
SET ANSI_NULLS ON
GO
...
FROM (
	...
	FROM (
		...
		WHERE (
			ps.suorituksen_tyyppi IN ('ibtutkinto', 'preiboppimaara', 'lukionoppiaineenoppimaara', 'lukionoppimaara', 'diatutkintovaihe', 'diavalmistavavaihe', 'luva', 'internationalschooldiplomavuosiluokka', 'europeanschoolofhelsinkivuosiluokkasecondaryupper')
