...
/****** Object:  View [dbo].[v_sa_1_21_1_22_Jatkuva_oppiminen_uudet_opiskelijat]    Script Date: 21.10.2022 19:05:52 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER VIEW [dbo].[v_sa_2_8f_2_9d_Korkeakouluopiskelijat_ja_tutkinnot_syntyperan_mukaan] AS
...
FROM (
	...
	--HUOM! Sisältää kaksi (2) aineistoa.
