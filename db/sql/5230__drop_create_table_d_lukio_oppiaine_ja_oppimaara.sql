USE [ANTERO]
GO
/****** Object:  Table [dw].[d_lukio_oppiaine_ja_oppimaara]    Script Date: 17.12.2021 11:25:37 ******/
...
GO
INSERT [dw].[d_lukio_oppiaine_ja_oppimaara] ([id], [koodisto], [koodi], [nimi], [nimi_sv], [nimi_en], [jarjestys], [ryhma_koodi], [ryhma_nimi], [ryhma_nimi_sv], [ryhma_nimi_en], [jarjestys_ryhma]) VALUES (58, N'koskioppiaineetyleissivistava', N'KT', N'Uskonto', N'Religion', NULL, 5510, N'hum', N'Humanistis-yhteiskunnalliset aineet', NULL, NULL, 5)
GO
INSERT [dw].[d_lukio_oppiaine_ja_oppimaara] ([id], [koodisto], [koodi], [nimi], [nimi_sv], [nimi_en], [jarjestys], [ryhma_koodi], [ryhma_nimi], [ryhma_nimi_sv], [ryhma_nimi_en], [jarjestys_ryhma]) VALUES (59, N'koskioppiaineetyleissivistava', N'ET', N'Elämänkatsomustieto', N'Livsåskådningskunskap', NULL, 5520, N'hum', N'Humanistis-yhteiskunnalliset aineet', NULL, NULL, 5)
GO
...
GO
INSERT [dw].[d_lukio_oppiaine_ja_oppimaara] ([id], [koodisto], [koodi], [nimi], [nimi_sv], [nimi_en], [jarjestys], [ryhma_koodi], [ryhma_nimi], [ryhma_nimi_sv], [ryhma_nimi_en], [jarjestys_ryhma]) VALUES (95, N'koskioppiaineetyleissivistava', N'KT/ET', N'Uskonto, Elämänkatsomustieto', N'Religion, Livsåskådningskunskap', NULL, 5500, N'hum', N'Humanistis-yhteiskunnalliset aineet', NULL, NULL, 5)
GO
