...
LEFT JOIN [dw].[d_maatjavaltiot2] s7 ON s1.[Tutkinnon suoritusmaa] = s7.maatjavaltiot2_koodi
...
LEFT JOIN [dw].[d_yo_nimitystapa] s12 ON s1.[Nimitystapa (työsuhteen vakituisuus / määräaikaisuus)] = s12.koodi
