...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dw].[f_amk_julkaisut_a_e]') AND type in (N'U'))
ALTER TABLE [dw].[f_amk_julkaisut_a_e] DROP CONSTRAINT IF EXISTS [DF_f_amk_kotimaiset_julkaisut_ae_username]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dw].[f_amk_julkaisut_a_e]') AND type in (N'U'))
ALTER TABLE [dw].[f_amk_julkaisut_a_e] DROP CONSTRAINT IF EXISTS [DF_f_amk_kotimaiset_julkaisut_ae_loadtime]
GO
/****** Object:  Table [dw].[f_amk_julkaisut_a_e]    Script Date: 28.7.2017 14:48:08 ******/
DROP TABLE IF EXISTS [dw].[f_amk_julkaisut_a_e]
GO
/****** Object:  Table [dw].[f_amk_julkaisut_a_e]    Script Date: 28.7.2017 14:48:08 ******/
SET ANSI_NULLS ON
GO
...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dw].[f_amk_julkaisut_a_e]') AND type in (N'U'))
BEGIN
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dw].[DF_f_amk_kotimaiset_julkaisut_ae_loadtime]') AND type = 'D')
BEGIN
ALTER TABLE [dw].[f_amk_julkaisut_a_e] ADD  CONSTRAINT [DF_f_amk_kotimaiset_julkaisut_ae_loadtime]  DEFAULT (getdate()) FOR [loadtime]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dw].[DF_f_amk_kotimaiset_julkaisut_ae_username]') AND type = 'D')
BEGIN
