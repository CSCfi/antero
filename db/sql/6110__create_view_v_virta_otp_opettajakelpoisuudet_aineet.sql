...
SELECT		
	...
	,[Opettajakelpoisuudet] = d3b.selite_fi
	,[Opettajakelpoisuus] = d3b.selite_fi
	,[Aine] = LEFT(d14.patevyys_fi,LEN(d14.patevyys_fi)-CHARINDEX(',',REVERSE(d14.patevyys_fi)))
	,[Laajuus] = coalesce(nullif(f.laajuus,''),'Tieto puuttuu')
	,[1 kelpoisuus] =
		CASE 
			WHEN f.kelpoisuuksien_maara like '1%' THEN d3b.selite_fi
			ELSE 'Muu kuin 1 kelpoisuus'
		END
	,[2 kelpoisuutta] =
		CASE 
			WHEN f.kelpoisuuksien_maara like '2%' THEN d3b.selite_fi
			ELSE 'Muu kuin 2 kelpoisuutta'
		END
	,[3 kelpoisuutta] =
		CASE 
			WHEN f.kelpoisuuksien_maara like '3%' THEN d3b.selite_fi
			ELSE 'Muu kuin 3 kelpoisuutta'
		END
	,[4 kelpoisuutta] =
		CASE 
			WHEN f.kelpoisuuksien_maara like '4%' THEN d3b.selite_fi 	
			ELSE 'Muu kuin 4 kelpoisuutta'
		END
	,[5 kelpoisuutta] =
		CASE 
			WHEN f.kelpoisuuksien_maara like '5%' THEN d3b.selite_fi
			ELSE 'Muu kuin 5 kelpoisuutta'
		END
	,[Ainekelpoisuuksien määrä] = f.kelpoisuuksien_maara
	...
	,f.patevyysryhma as patevyys_ryhma
	,lkm
	...
	,[jarjestys Opettajakelpoisuudet] = d3b.jarjestys_koodi
	...
	,[jarjestys 1 kelpoisuus] =
		CASE 
			WHEN f.kelpoisuuksien_maara like '1%' THEN d3b.jarjestys_koodi
			ELSE 99
		END
	,[jarjestys 2 kelpoisuutta] =
		CASE 
			WHEN f.kelpoisuuksien_maara like '2%' THEN d3b.jarjestys_koodi
			ELSE 99
		END
	,[jarjestys 3 kelpoisuutta] =
		CASE 
			WHEN f.kelpoisuuksien_maara like '3%' THEN d3b.jarjestys_koodi
			ELSE 99
		END
	,[jarjestys 4 kelpoisuutta] =
		CASE 
			WHEN f.kelpoisuuksien_maara like '4%' THEN d3b.jarjestys_koodi
			ELSE 99
		END
	,[jarjestys 5 kelpoisuutta] =
		CASE 
			WHEN f.kelpoisuuksien_maara like '5%' THEN d3b.jarjestys_koodi
			ELSE 99
		END
...
WHERE f.patevyysryhma = 'opettajaaineet'
