...
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_lukio_amm_opiskelijat_pbi]    Script Date: 22.10.2025 8.54.45 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN [ANTERO].[dbo].[amm_luvat] o2 on o2.vuosi = f.tilastovuosi and o2.jarjestajaOid = d2.organisaatio_oid
WHERE (d2.organisaatio_koodi != '0763403-0' OR (d2.organisaatio_koodi = '0763403-0' AND tilastovuosi < 2022)) and coalesce(o1.vuosi,o2.vuosi) is not null
GROUP BY tilastovuosi, d14.kuukausi_fi, d2.organisaatio_fi, d1.organisaatio_fi, d10.kieli_fi, d4.maakunta_fi, d5.maakunta_fi, d6.maakunta_fi, d4.kunta_fi, d5.kunta_fi, d6.kunta_fi,
...
d11.koulutusalataso2_fi, d11.koulutusalataso3_fi, d_ika_id, d1.postinumero, d2.postinumero, d3.postinumero, d1.katuosoite, d2.katuosoite, d3.katuosoite, d1.oppilaitoksenopetuskieli_fi) f
