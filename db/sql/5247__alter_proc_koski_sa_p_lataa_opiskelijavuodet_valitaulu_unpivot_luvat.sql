USE [Koski_SA]
GO
/****** Object:  StoredProcedure [dbo].[p_lataa_opiskelijavuodet_valitaulu_unpivot_luvat]    Script Date: 20.12.2021 20:50:50 ******/
SET ANSI_NULLS ON
GO
...
--VAATINEE PYSYVÄMMÄN RATKAISUN; TAUSTALLA KANNAN TK_H9098_CSC AINEISTOT 6.5, HUOM. KANNAN RESTORET ARKISIN @..SQL16 n. klo 23 / CSC Juha 20.12.2021
LEFT JOIN VipunenTK_DW.dbo.d_koulutusluokitus d11a_hist ON d11a_hist.koulutusluokitus_avain = q.koulk and (tilv_date between d11a_hist.alkaa and d11a_hist.paattyy)
LEFT JOIN VipunenTK_DW.dbo.d_koulutusluokitus d11b_hist ON d11b_hist.koulutusluokitus_avain = q.koulk_pihvi and (tilv_date between d11b_hist.alkaa and d11b_hist.paattyy)
--
...
LEFT JOIN ANTERO.sa.sa_amos_oiva_tutkinto_oikeudet v1 ON (tilv_date between v1.alkupvm and coalesce(v1.siirtymapaattyy,v1.loppupvm)) 
	and (
		coalesce(nullif(d11b.koulutusluokitus_fi,'Tieto puuttuu'),d11a.koulutusluokitus_fi) in (v1.tutkinto_nimi1, v1.tutkinto_nimi2, v1.tutkinto_nimi3, v1.tutkinto_nimi4, v1.tutkinto_nimi5) 
		--VAATINEE PYSYVÄMMÄN RATKAISUN; TAUSTALLA KANNAN TK_H9098_CSC AINEISTOT 6.5, HUOM. KANNAN RESTORET ARKISIN @..SQL16 n. klo 23 / CSC Juha 20.12.2021
		or coalesce(nullif(d11b_hist.koulutus,'Tieto puuttuu'),d11a_hist.koulutus) in (v1.tutkinto_nimi1, v1.tutkinto_nimi2, v1.tutkinto_nimi3, v1.tutkinto_nimi4, v1.tutkinto_nimi5)
	)
