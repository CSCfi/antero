USE [VipunenTK]
GO
/****** Object:  View [dbo].[v_f_tab_koulutukseen_sijoittuneet_6v_yhteiset]    Script Date: 19.4.2018 17:27:24 ******/
DROP VIEW [dbo].[v_f_tab_koulutukseen_sijoittuneet_6v_yhteiset]
GO
/****** Object:  View [dbo].[v_f_tab_koulutukseen_sijoittuneet_6v_peruskoulu]    Script Date: 19.4.2018 17:27:24 ******/
DROP VIEW [dbo].[v_f_tab_koulutukseen_sijoittuneet_6v_peruskoulu]
GO
/****** Object:  View [dbo].[v_f_tab_koulutukseen_sijoittuneet_6v_lukio]    Script Date: 19.4.2018 17:27:24 ******/
DROP VIEW [dbo].[v_f_tab_koulutukseen_sijoittuneet_6v_lukio]
GO
/****** Object:  View [dbo].[v_f_tab_koulutukseen_sijoittuneet_6v_ammatillinen]    Script Date: 19.4.2018 17:27:24 ******/
DROP VIEW [dbo].[v_f_tab_koulutukseen_sijoittuneet_6v_ammatillinen]
GO
/****** Object:  View [dbo].[v_f_tab_koulutukseen_sijoittuneet_2v_yhteiset]    Script Date: 19.4.2018 17:27:24 ******/
DROP VIEW [dbo].[v_f_tab_koulutukseen_sijoittuneet_2v_yhteiset]
GO
/****** Object:  View [dbo].[v_f_tab_koulutukseen_sijoittuneet_2v_peruskoulu]    Script Date: 19.4.2018 17:27:24 ******/
DROP VIEW [dbo].[v_f_tab_koulutukseen_sijoittuneet_2v_peruskoulu]
GO
/****** Object:  View [dbo].[v_f_tab_koulutukseen_sijoittuneet_2v_lukio]    Script Date: 19.4.2018 17:27:24 ******/
DROP VIEW [dbo].[v_f_tab_koulutukseen_sijoittuneet_2v_lukio]
GO
/****** Object:  View [dbo].[v_f_tab_koulutukseen_sijoittuneet_2v_ammatillinen]    Script Date: 19.4.2018 17:27:24 ******/
DROP VIEW [dbo].[v_f_tab_koulutukseen_sijoittuneet_2v_ammatillinen]
GO
/****** Object:  View [dbo].[v_f_tab_koulutukseen_sijoittuneet_2v_ammatillinen]    Script Date: 19.4.2018 17:27:24 ******/
SET ANSI_NULLS ON
GO
...
,d5c.ika5v AS 'Ikäryhmä tutkinnon suoritusvuonna'
...
,d32a.kylla_ei as 'Opiskellut lukiokoulutuksessa'--opisk_lu_kyllaei_id
,d32b.kylla_ei as 'Opiskellut ammatillisessa peruskoulutuksessa'--opisk_amm_pk_kyllaei_id
,d32c.kylla_ei as 'Opiskellut ammattitutkintokoulutuksessa'--opisk_amm_at_kyllaei_id
,d32d.kylla_ei as 'Opiskellut erikoisammattitutkintokoulutuksessa'--opisk_amm_eat_kyllaei_id
...
,d5.jarjestys_ika
,d5b.jarjestys_ika5v
,d5c.jarjestys_ika5v as jarjestys_ika5v_suorv
...
WHERE tutkintoryhma_koodi IN (3,31,32,33) AND (d24.opetussuunnitelmaperusteinen_koulutus_nayttotutkintoon_valmistava_koulutus_koodi in (1, -1)) AND d15.vuosiselite <> '2008'
...
FROM            dbo.f_koulutukseen_sijoittuneet_6v
    ...
    LEFT JOIN d_kylla_ei d57 on d57.id = haku_amk_kyllaei_id
    LEFT JOIN d_kylla_ei d58 on d58.id = haku_yo_kyllaei_id
WHERE tutkintoryhma_koodi IN (3,31,32,33) AND (d24.opetussuunnitelmaperusteinen_koulutus_nayttotutkintoon_valmistava_koulutus_koodi in (1, -1))
