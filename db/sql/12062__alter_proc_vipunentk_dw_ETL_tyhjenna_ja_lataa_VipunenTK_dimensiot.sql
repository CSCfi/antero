...
/****** Object:  StoredProcedure [dbo].[ETL_tyhjenna_ja_lataa_VipunenTK_dimensiot]    Script Date: 29.4.2026 14.42.47 ******/
SET ANSI_NULLS ON
GO
...
DELETE FROM VipunenTK..d_kieli_vst;
INSERT INTO VipunenTK..d_kieli_vst
	SELECT * FROM VipunenTK_DW.[dbo].[v_kieli_vst];

--DELETE FROM VipunenTK..d_koulutuksen_jarjestaja;
--INSERT INTO VipunenTK..d_koulutuksen_jarjestaja
--	SELECT * FROM VipunenTK_DW.[dbo].[v_koulutuksen_jarjestaja];
...
DELETE FROM VipunenTK..d_koulutusala_vst;
INSERT INTO VipunenTK..d_koulutusala_vst
	SELECT * FROM VipunenTK_DW.[dbo].[v_koulutusala_vst];
...
DELETE FROM VipunenTK..d_koulutustausta_vst;
INSERT INTO VipunenTK..d_koulutustausta_vst
	SELECT * FROM VipunenTK_DW.[dbo].[v_koulutustausta_vst];
...
DELETE FROM VipunenTK..d_oppimaara_vst;
INSERT INTO VipunenTK..d_oppimaara_vst
	SELECT * FROM VipunenTK_DW.[dbo].[v_oppimaara_vst];
...
--DELETE FROM VipunenTK..d_oppilaitos_vst;
--INSERT INTO VipunenTK..d_oppilaitos_vst
--	SELECT * FROM VipunenTK_DW.[dbo].[v_oppilaitos_vst];
...
DELETE FROM VipunenTK..d_paaasiallinen_toiminta_vst;
INSERT INTO VipunenTK..d_paaasiallinen_toiminta_vst
	SELECT * FROM VipunenTK_DW.[dbo].[v_paaasiallinen_toiminta_vst];
