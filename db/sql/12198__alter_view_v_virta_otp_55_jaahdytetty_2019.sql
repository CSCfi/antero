...
/****** Object:  View [dw].[v_virta_otp_55_jaahdytetty_2019]    Script Date: 18.9.2026 14.23.51 ******/
SET ANSI_NULLS ON
GO
...
INNER JOIN ANTERO.dbo.view_salt vs on vs.[view] = 'v_virta_otp_55_jaahdytetty_2019'