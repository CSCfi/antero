IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'api.ytl_arvosanat'))
EXEC dbo.sp_executesql @statement = N'create view api.ytl_arvosanat as select 1 as a'
GO
...
when '2017K' then 'Kevät 2017' end as 'Tutkintokerta'
