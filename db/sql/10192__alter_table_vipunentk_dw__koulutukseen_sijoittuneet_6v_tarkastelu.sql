...
/****** Object:  Table [dbo].[_koulutukseen_sijoittuneet_6v_tarkastelu]    Script Date: 10.10.2024 12:17:07 ******/
SET ANSI_NULLS ON
GO
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[_koulutukseen_sijoittuneet_6v_tarkastelu]') AND type in (N'U')) DROP TABLE [dbo].[_koulutukseen_sijoittuneet_6v_tarkastelu]
GO
