...
/****** Object:  StoredProcedure [dw].[p_lataa_api_opiskelijat_ja_tutkinnot_esilataus]    Script Date: 30.6.2023 21:56:33 ******/
SET ANSI_NULLS ON
GO
				...
				,uusi	=
					case --mukaillen VipunenTK_DW.dbo.v_f_2_8_Korkeakouluopiskelijat
						when lahde = 41
							...
							/*sopv23 ensisop tyhjänä toistaiseksi, sopv22 rajasi muiden ehtojen vallitessa yhteensä vain 20 opiskelijaa. JS 30.6.2023*/
							and (ensisop = 1 or tilv != 2022)
						then lkm  
