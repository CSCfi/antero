...
/****** Object:  View [dbo].[v_f_5_4_Sektoritutkimuslaitosten_tutkimus_ja_kehitys_tutkimushenkilokunta_tutkintotasoittain]    Script Date: 30.3.2026 12.24.35 ******/
SET ANSI_NULLS ON
GO
...
ALTER view [dbo].[v_f_5_4_Sektoritutkimuslaitosten_tutkimus_ja_kehitys_tutkimushenkilokunta_tutkintotasoittain] as
...
SELECT 
	  ...
	  ,sukupuoli_avain = '1' --mies
	  ,lkm_tutkimushenkilokunta_tutkintotasoittain = INSLKM - Nyhtlkm
      ,[tietolahde]
      ,[rivinumero]
FROM [VipunenTK_DW].[dbo].[sa_5_4_Sektoritutkimuslaitosten_tutkimus_ja_kehitys] 
...
SELECT 
      ...
      ,tutkintotaso_avain = '60' --amk-tutkinto
	  ,sukupuoli_avain = '2' --nainen
	  ,lkm_tutkimushenkilokunta_tutkintotasoittain = Nyhtlkm
      ,[tietolahde]
      ,[rivinumero]
FROM [VipunenTK_DW].[dbo].[sa_5_4_Sektoritutkimuslaitosten_tutkimus_ja_kehitys] 
