...
/****** Object:  View [dbo].[v_f_aloittaneiden_lapaisy_K3_10_yo]    Script Date: 21.10.2020 11:48:53 ******/
SET ANSI_NULLS ON
GO
...
SELECT  f.lkm_int AS lkm_int2, 
		...
		Case 
			when d7.koulutusaste2002_koodi='63' 
		...
		Case 
			...
			when d7.koulutusaste2002_koodi='72' then 'Påbörjande i II-skedets examen'  
			else 'Okänt' 
		end AS [Startskede], 
		...
		Case 
			...
			when d7.koulutusaste2002_koodi='72' then 'Beginning of studies in cycle II degree'
			else 'Unknown' 
