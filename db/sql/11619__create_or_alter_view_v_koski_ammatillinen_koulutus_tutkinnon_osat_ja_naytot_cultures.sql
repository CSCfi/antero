...
/****** Object:  View [dw].[v_koski_ammatillinen_koulutus_tutkinnon_osat_ja_naytot_cultures]    Script Date: 27.1.2026 17.01.07 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	...
	YEAR(f.vahvistus_paiva) as tutkinnon_suoritusvuosi,
	...
	case when f.vahvistus_paiva is not null and d8.selite_fi = 'Ammatillinen tutkinto' then 1 else 0 end as apusarake_suorittanut_tutkinnon,
	...
	d19.kieli_fi as suorituskieli_fi,
	d19.kieli_sv as suorituskieli_sv,
	...
	d24.[Toiminnanohjauksen kokeilu] as toiminnanohjauksen_kokeilu_fi,
	d24.[Toiminnanohjauksen kokeilu] as toiminnanohjauksen_kokeilu_sv,
	...
	d24.[jarjestys Toiminnanohjauksen kokeilu] as jarjestys_toiminnanohjauksen_kokeilu
...
LEFT JOIN ANTERO.dw.d_amos_spl_jarjestaja_linkki d24 on d24.id = f.d_amos_spl_jarjestaja_linkki_id
GO
