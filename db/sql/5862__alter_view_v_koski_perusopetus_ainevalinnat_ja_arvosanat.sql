...
/****** Object:  View [dw].[v_koski_perusopetus_ainevalinnat_ja_arvosanat]    Script Date: 31.1.2022 15:23:03 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dw].[v_koski_perusopetus_ainevalinnat_ja_arvosanat] AS
...
SELECT 
  ...
  --jarj
	...
	,[jarj_oppiaineryhma_II] = d17.jarjestys_ryhma2
