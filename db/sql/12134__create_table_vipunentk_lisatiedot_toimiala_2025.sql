...
/****** Object:  Table [dbo].[toimiala_2025]    Script Date: 12.8.2026 16.46.56 ******/
SET ANSI_NULLS ON
GO
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[toimiala_2025]') AND type in (N'U'))

CREATE TABLE [dbo].[toimiala_2025](
	[id] [int] NOT NULL,
	[luotu] [date] NULL,
	[alkaa] [date] NULL,
	[paattyy] [date] NULL,
