...
/****** Object:  View [dbo].[v_f_aloittaneiden_lapaisy_K3_10_yo]    Script Date: 20.9.2021 23:53:03 ******/
SET ANSI_NULLS ON
GO
...
SELECT  f.lkm_int AS lkm_int2, 
		...
		--f.[9e Aloittaneista alkuperäisen koulutusalan, taso 1 tutkinnon suorittaneet koulutusalan mukaan] AS [Tutkinto tavoitet. koul.alalla, taso 1], 
		...
		--f.[10e Aloittaneista alkuperäisen koulutusalan, taso 2 tutkinnon suorittaneet koulutusalan mukaan] AS [Tutkinto tavoitet. koul.alalla, taso 2], 
		...
		--f.[11e Aloittaneista alkuperäisen koulutusalan, taso 3 tutkinnon suorittaneet koulutusalan mukaan] AS [Tutkinto tavoitet. koul.alalla, taso 3], 
		...
		Case 
			...
			when d7.koulutusaste2002_koodi='72' or d7.Koulutusaste_taso2_koodi='72' then 'Påbörjande i II-skedets examen'  
			else 'Okänt' 
		end AS [Startskede], 
