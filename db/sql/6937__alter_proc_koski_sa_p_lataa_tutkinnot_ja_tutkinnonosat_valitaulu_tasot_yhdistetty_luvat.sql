USE [Koski_SA]
GO
/****** Object:  StoredProcedure [dbo].[p_lataa_tutkinnot_ja_tutkinnonosat_valitaulu_tasot_yhdistetty_luvat]    Script Date: 23.1.2023 18:51:54 ******/
SET ANSI_NULLS ON
GO
...
--tutkinto-oikeudet
--Fuusioiden huomioinnista aiheutui päällekkäisiä jaksotietoja. JS 23.1.2023
OUTER APPLY (
...
/*
left join ANTERO.sa.sa_amos_oiva_tutkinto_oikeudet v1 on (ca1.tilv between v1.alkupvm and coalesce(v1.siirtymapaattyy,v1.loppupvm))  
												and v1.jarjestajaYtunnus = ca2.jarj
												and d12.nimi_fi in (v1.tutkinto_nimi1, v1.tutkinto_nimi2, v1.tutkinto_nimi3, v1.tutkinto_nimi4, v1.tutkinto_nimi5)	
*/
