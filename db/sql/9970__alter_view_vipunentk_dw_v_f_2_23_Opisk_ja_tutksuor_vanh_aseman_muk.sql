...
/****** Object:  View [dbo].[v_f_2_23_Opisk_ja_tutksuor_vanh_aseman_muk]    Script Date: 17.7.2024 13:10:09 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
      ...
      (
		...
		when [ophal] = '3' then '1' --luokka 3 sopv24- rahoitus-muuttujan luokka 10 = työvoimakoulutus, OKM-rahoitus
		else [ophal]
		end
	  )
		as nvarchar(6))
