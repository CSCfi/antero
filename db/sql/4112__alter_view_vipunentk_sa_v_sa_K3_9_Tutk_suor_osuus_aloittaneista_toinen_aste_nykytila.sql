...
/****** Object:  View [dbo].[v_sa_K3_9_Tutk_suor_osuus_aloittaneista_toinen_aste_nykytila]    Script Date: 2.10.2020 17:33:37 ******/
SET ANSI_NULLS ON
GO
...
--2017
      ...
      ,[lusuorv_2017]
      ,[lusuorlk_2017]
   ,[lututkmaak_2017] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[lututkmaak_2017]), [lututkmaak_2017])
      ,[lututkjarj_2017] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[lututkjarj_2017]), [lututkjarj_2017])
   ,[lututkkoulk_2017] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutusluokitus_nykytila] WHERE koulutus_koodi=[lututkkoulk_2017]), [lututkkoulk_2017])
      ,[amptsuorv_2017]
      ,[amptsuorlk_2017]
   ,[ampttutkmaak_2017] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[ampttutkmaak_2017]), [ampttutkmaak_2017])
      ,[ampttutkjarj_2017] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[ampttutkjarj_2017]), [ampttutkjarj_2017])
   ,[ampttutkkoulk_2017] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutusluokitus_nykytila] WHERE koulutus_koodi=[ampttutkkoulk_2017]), [ampttutkkoulk_2017])
      ,[amlksuorv_2017]
      ,[amlksuorlk_2017]
   ,[amlktutkmaak_2017] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[amlktutkmaak_2017]), [amlktutkmaak_2017])
      ,[amlktutkjarj_2017] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[amlktutkjarj_2017]), [amlktutkjarj_2017])
   ,[amlktutkkoulk_2017] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutusluokitus_nykytila] WHERE koulutus_koodi=[amlktutkkoulk_2017]), [amlktutkkoulk_2017])
      ,[muukksuorv_2017]
      ,[muukksuorlk_2017]
   ,[muukktutkmaak_2017] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[muukktutkmaak_2017]), [muukktutkmaak_2017])
      ,[muukktutkjarj_2017] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[muukktutkjarj_2017]), [muukktutkjarj_2017])
   ,[muukktutkkoulk_2017] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutusluokitus_nykytila] WHERE koulutus_koodi=[muukktutkkoulk_2017]), [muukktutkkoulk_2017])
   ,[luopiskkoulk_2017] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutusluokitus_nykytila] WHERE koulutus_koodi=[luopiskkoulk_2017]), [luopiskkoulk_2017])
      ,[luopiskjarj_2017] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[luopiskjarj_2017]), [luopiskjarj_2017])
   ,[lukmaak_2017] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[lukmaak_2017]), [lukmaak_2017])
   ,[amptopiskkoulk_2017] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutusluokitus_nykytila] WHERE koulutus_koodi=[amptopiskkoulk_2017]), [amptopiskkoulk_2017])
      ,[amptopiskjarj_2017] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[amptopiskjarj_2017]), [amptopiskjarj_2017])
   ,[amptkmaak_2017] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[amptkmaak_2017]), [amptkmaak_2017])
   ,[amlkopiskkoulk_2017] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutusluokitus_nykytila] WHERE koulutus_koodi=[amlkopiskkoulk_2017]), [amlkopiskkoulk_2017])
      ,[amlkopiskjarj_2017] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[amlkopiskjarj_2017]), [amlkopiskjarj_2017])
   ,[amlkkmaak_2017] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[amlkkmaak_2017]), [amlkkmaak_2017])
   ,[muukkopiskkoulk_2017] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutusluokitus_nykytila] WHERE koulutus_koodi=[muukkopiskkoulk_2017]), [muukkopiskkoulk_2017])
      ,[muukkopiskjarj_2017] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[muukkopiskjarj_2017]), [muukkopiskjarj_2017])
   ,[muukkkmaak_2017] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[muukkkmaak_2017]), [muukkkmaak_2017])
      ,[ptoim1r5_2017]
      ,[amas_2017]
...
--2018
      ...
      ,[lusuorv_2018]
      ,[lusuorlk_2018]
   ,[lututkmaak_2018] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[lututkmaak_2018]), [lututkmaak_2018])
      ,[lututkjarj_2018] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[lututkjarj_2018]), [lututkjarj_2018])
   ,[lututkkoulk_2018] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutusluokitus_nykytila] WHERE koulutus_koodi=[lututkkoulk_2018]), [lututkkoulk_2018])
      ,[amptsuorv_2018]
      ,[amptsuorlk_2018]
   ,[ampttutkmaak_2018] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[ampttutkmaak_2018]), [ampttutkmaak_2018])
      ,[ampttutkjarj_2018] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[ampttutkjarj_2018]), [ampttutkjarj_2018])
   ,[ampttutkkoulk_2018] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutusluokitus_nykytila] WHERE koulutus_koodi=[ampttutkkoulk_2018]), [ampttutkkoulk_2018])
      ,[amlksuorv_2018]
      ,[amlksuorlk_2018]
   ,[amlktutkmaak_2018] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[amlktutkmaak_2018]), [amlktutkmaak_2018])
      ,[amlktutkjarj_2018] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[amlktutkjarj_2018]), [amlktutkjarj_2018])
   ,[amlktutkkoulk_2018] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutusluokitus_nykytila] WHERE koulutus_koodi=[amlktutkkoulk_2018]), [amlktutkkoulk_2018])
      ,[muukksuorv_2018]
      ,[muukksuorlk_2018]
   ,[muukktutkmaak_2018] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[muukktutkmaak_2018]), [muukktutkmaak_2018])
      ,[muukktutkjarj_2018] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[muukktutkjarj_2018]), [muukktutkjarj_2018])
   ,[muukktutkkoulk_2018] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutusluokitus_nykytila] WHERE koulutus_koodi=[muukktutkkoulk_2018]), [muukktutkkoulk_2018])
   ,[luopiskkoulk_2018] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutusluokitus_nykytila] WHERE koulutus_koodi=[luopiskkoulk_2018]), [luopiskkoulk_2018])
      ,[luopiskjarj_2018] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[luopiskjarj_2018]), [luopiskjarj_2018])
   ,[lukmaak_2018] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[lukmaak_2018]), [lukmaak_2018])
   ,[amptopiskkoulk_2018] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutusluokitus_nykytila] WHERE koulutus_koodi=[amptopiskkoulk_2018]), [amptopiskkoulk_2018])
      ,[amptopiskjarj_2018] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[amptopiskjarj_2018]), [amptopiskjarj_2018])
   ,[amptkmaak_2018] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[amptkmaak_2018]), [amptkmaak_2018])
   ,[amlkopiskkoulk_2018] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutusluokitus_nykytila] WHERE koulutus_koodi=[amlkopiskkoulk_2018]), [amlkopiskkoulk_2018])
      ,[amlkopiskjarj_2018] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[amlkopiskjarj_2018]), [amlkopiskjarj_2018])
   ,[amlkkmaak_2018] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[amlkkmaak_2018]), [amlkkmaak_2018])
   ,[muukkopiskkoulk_2018] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutusluokitus_nykytila] WHERE koulutus_koodi=[muukkopiskkoulk_2018]), [muukkopiskkoulk_2018])
      ,[muukkopiskjarj_2018] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[muukkopiskjarj_2018]), [muukkopiskjarj_2018])
   ,[muukkkmaak_2018] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_9_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[muukkkmaak_2018]), [muukkkmaak_2018])
      ,[ptoim1r5_2018]
      ,[amas_2018]
