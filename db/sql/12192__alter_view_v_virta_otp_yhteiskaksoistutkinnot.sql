...
/****** Object:  View [dw].[v_virta_otp_yhteiskaksoistutkinnot]    Script Date: 18.9.2026 13.54.10 ******/
SET ANSI_NULLS ON
GO
...
INNER JOIN ANTERO.dbo.view_salt vs on vs.[view] = 'v_virta_otp_yhteiskaksoistutkinnot'