...
/****** Object:  View [dw].[v_koski_esi_ja_perus_yksilollistaminen_cultures]    Script Date: 24.8.2023 23:43:27 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER VIEW [dw].[v_koski_esi_ja_perus_yksilollistaminen_cultures] AS
