...
/****** Object:  View [dbo].[v_sa_R2_22_Oppilaitostason_oppil_ja_opisk]    Script Date: 1.9.2021 21:22:23 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
      ...
      ,[lykk] = sum(case when oppilas = '1' and luokka = '01' and lykk = '1' then lkm else 0 end)
      ,[lykkn] = sum(case when oppilas = '1' and luokka = '01' and lykk = '1' and sp = '2' then lkm else 0 end)
