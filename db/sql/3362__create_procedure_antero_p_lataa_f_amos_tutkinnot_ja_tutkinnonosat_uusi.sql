...
DROP PROCEDURE IF EXISTS [dw].[p_lataa_f_amos_tutkinnot_ja_tutkinnonosat_uusi]
GO

/****** Object:  StoredProcedure [dw].[p_lataa_f_amos_tutkinnot_ja_tutkinnonosat_uusi]    Script Date: 15.9.2020 8:31:28 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dw].[p_lataa_f_amos_tutkinnot_ja_tutkinnonosat_uusi] AS
...
LEFT JOIN dw.d_ammatillisen_tutkinnon_kustannusryhma d7 on d7.koodi = tt.kustannusryhma_koodi_uusi
