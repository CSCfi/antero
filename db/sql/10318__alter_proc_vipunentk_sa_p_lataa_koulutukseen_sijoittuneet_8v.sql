...
/****** Object:  StoredProcedure [dbo].[p_lataa_koulutukseen_sijoittuneet_8v]    Script Date: 25.10.2024 13:23:58 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[p_lataa_koulutukseen_sijoittuneet_8v] AS
...
-- Prosessoidaan ensin tilannetiedot. Opiskelemattomien tilannetiedot (opiskellut korkeakouluissa tai ei) pohjautuvat aiempien vuosien tiedoille
EXEC [VipunenTK_SA].[dbo].p_lataa_f_koulutukseen_sijoittuneet_8v_visualisointi_tilanne;
-- seuraava prosessointi hyödyntää myös edellä laskettuja tilanetietoja
EXEC [VipunenTK_SA].[dbo].[p_lataa_f_koulutukseen_sijoittuneet_8v_visualisointi_lahde_kohde]
