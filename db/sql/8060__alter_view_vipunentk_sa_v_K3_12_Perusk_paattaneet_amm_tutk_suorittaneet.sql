...
/****** Object:  View [dbo].[v_K3_12_Perusk_paattaneet_amm_tutk_suorittaneet]    Script Date: 14.9.2023 15:01:57 ******/
SET ANSI_NULLS ON
GO
...
WHERE suorv = '2019 ' and (suorlk = '1' or suorlk= '2')
...
WHERE suorv = '2020 ' and (suorlk = '1' or suorlk= '2')
