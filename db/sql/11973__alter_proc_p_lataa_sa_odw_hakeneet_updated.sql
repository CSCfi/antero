...
/****** Object:  StoredProcedure [sa].[p_lataa_sa_odw_hakeneet_updated]    Script Date: 13.4.2026 13.18.36 ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT
    ...
    ,h.ensikertalainen
    ,cast(h.KotikuntaKoodi as varchar) as kotikunta
    ,h.SukupuoliKoodi as sukupuoli
    ,h.AidinkieliKoodi as aidinkieli
    ,cast(h.KansalaisuusKoodi as varchar) as kansalaisuus
    ,h.Ika
