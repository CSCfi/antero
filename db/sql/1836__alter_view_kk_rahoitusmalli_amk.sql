...
/****** Object:  View [dw].[v_kk_rahoitusmalli_amk]    Script Date: 12.9.2018 15:41:51 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	 f.tilikausi as 'Tilastointivuosi'
	  ...
	  ,case when d5.tili_taso2_fi IN ('Suomen Akatemia','Tekes','Kotimaiset yritykset','Ulkomaiset yritykset') then arvo else 0 end AS 'Kilpailtu tutkimusrahoitus rah_malli'
...
SELECT
	...
	/* (d14.kysymysryhmaid  <('14') or d14.kysymysryhmaid between 117 and 124 and  */kyselypohja in ('KANDIPALAUTE','AVOP-AMK','AVOP-YAMK') and rahoitusmallikysymys='1'
