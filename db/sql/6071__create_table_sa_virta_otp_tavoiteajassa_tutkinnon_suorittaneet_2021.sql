...
/****** Object:  Table [sa].[sa_virta_otp_tavoiteajassa_tutkinnon_suorittaneet_2021]    Script Date: 31.3.2022 8:05:30 ******/
SET ANSI_NULLS ON
GO
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[sa].[sa_virta_otp_tavoiteajassa_tutkinnon_suorittaneet_2021]') AND type in (N'U'))

BEGIN

CREATE TABLE [sa].[sa_virta_otp_tavoiteajassa_tutkinnon_suorittaneet_2021](
