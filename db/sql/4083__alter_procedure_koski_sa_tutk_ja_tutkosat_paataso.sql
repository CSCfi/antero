USE [Koski_SA]
GO
/****** Object:  StoredProcedure [sa].[p_lataa_tutkinnot_ja_tutkinnonosat_paatason_suoritukset]    Script Date: 31.10.2020 20:56:49 ******/
SET ANSI_NULLS ON
GO
...
FROM   (
	...
	SELECT distinct
		...
		koulutustoimija_oid_hist = coalesce(so.vanha_koulutustoimija_oid, oo.vanha_koulutustoimija_oid),
