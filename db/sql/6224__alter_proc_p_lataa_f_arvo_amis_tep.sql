USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_arvo_amis_tep]    Script Date: 19.5.2022 13:14:31 ******/
SET ANSI_NULLS ON
GO
...
--taustakysymykset AS (
	...
	where taustakysymyksen_tyyppi in ('toimipaikan_kunta','toimipaikan_maa','toimipaikan_suomessa','tehtava_tyonantajalla')
--)
...
FROM (
	...
	AND (tyopaikkajakson_loppupvm > '2021-06-30' or tiedonkeruu_alkupvm > '2021-06-30')
...
----yhdistämisen jälkeen taustakysymysten ja ei-valtakunnallisten kysymysten poisto (siirretty käsittely pääkyselyyn, jotta kohteita ei poistu / JS)
--DELETE f 
--FROM dw.f_arvo_amis_tep f
