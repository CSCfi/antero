...
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_lukio_amm_opiskelijat_pbi]    Script Date: 25.4.2023 15:31:20 ******/
SET ANSI_NULLS ON
GO
...
DROP PROCEDURE IF EXISTS [dw].[p_lataa_f_koski_lukio_amm_opiskelijat_pbi]
GO


CREATE PROCEDURE [dw].[p_lataa_f_koski_lukio_amm_opiskelijat_pbi] AS
