...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_tutkinnon_suorittaneet_vaihdossa]    Script Date: 17.4.2024 13:13:37 ******/
SET ANSI_NULLS ON
GO
...
WHERE (sa.tutkinnonsuoritusvuosi BETWEEN 2017 and 2020) or 
...
WHERE f.liikkuvuuden_kesto_id not in ('-1', '-2') and d3.koulutusastetaso2_koodi in ('62', '63', '71', '72') 
