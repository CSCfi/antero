...
BEGIN
ALTER TABLE sa.sa_arvo_uraseuranta DROP  CONSTRAINT DF__sa_uraseuranta__loadtime
;
ALTER TABLE sa.sa_arvo_uraseuranta DROP  CONSTRAINT DF__sa_uraseuranta__username
;
DROP TABLE sa.sa_uraseuranta
END
IF NOT EXISTS (
