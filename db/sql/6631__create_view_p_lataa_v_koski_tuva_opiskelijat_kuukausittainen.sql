...
/****** Object:  View [dw].[v_koski_tuva_opiskelijat_kuukausittainen]    Script Date: 10.11.2022 14:14:27 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER VIEW [dw].[v_koski_tuva_opiskelijat_kuukausittainen] AS
...
SELECT --top 1000
	...
	,CASE
		WHEN f.[tuva_jarjestamislupa] = 'ammatillinen' THEN 'Ammatillisen koulutuksen järjestämislupa (TUVA)'
		WHEN f.[tuva_jarjestamislupa] = 'lukio' THEN 'Lukiokoulutuksen järjestämislupa (TUVA)'
		WHEN f.[tuva_jarjestamislupa] = 'perusopetus' THEN 'Perusopetuksen järjestämislupa (TUVA)' END
		as 'TUVA-järjestämislupa'
