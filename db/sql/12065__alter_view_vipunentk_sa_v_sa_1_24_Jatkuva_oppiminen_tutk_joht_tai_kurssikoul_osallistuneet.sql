...
/****** Object:  View [dbo].[v_sa_1_24_Jatkuva_oppiminen_tutk_joht_tai_kurssikoul_osallistuneet]    Script Date: 7.5.2026 10.11.39 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_sa_1_24_Jatkuva_oppiminen_tutk_joht_tai_kurssikoul_osallistuneet] AS
  ...
  SELECT [tilv]
      ...
      ,[Opisk_kurssi_osuus] = [Opisk_kurssi_osuus_vaesto]
      ,[aineisto] = '1.24a'
  FROM [TK_H9098_CSC].[dbo].[TK_1_24a_sopv_26]
  ...
  SELECT [tilv]
      ...
      ,[Opisk_kurssi_osuus] = [Opisk_kurssi_osuus_vaesto]
      ,[aineisto] = '1.24b'
  FROM [TK_H9098_CSC].[dbo].[TK_1_24b_sopv_26]
  ...
  SELECT [tilv]
      ...
      ,[Opisk_kurssi_osuus] = [Opisk_kurssi_osuus_vaesto]
      ,[aineisto] = '1.24c'
  FROM [TK_H9098_CSC].[dbo].[TK_1_24c_sopv_26]
  ...
  SELECT [tilv]
      ...
      ,[Opisk_kurssi_osuus] = [Opisk_kurssi_osuus_vaesto]
      ,[aineisto] = '1.24d'
  FROM [TK_H9098_CSC].[dbo].[TK_1_24d_sopv_26]
  ...
  SELECT [tilv]
      ...
      ,[Opisk_kurssi_osuus] = [Opisk_kurssi_osuus_tyol]
      ,[aineisto] = '1.24e'
  FROM [TK_H9098_CSC].[dbo].[TK_1_24e_sopv_26]
  ...
  SELECT [tilv]
      ...
      ,[Opisk_kurssi_osuus] = [Opisk_kurssi_osuus_tyol]
      ,[aineisto] = '1.24f'
  FROM [TK_H9098_CSC].[dbo].[TK_1_24f_sopv_26]
  ...
  SELECT [tilv]
      ...
      ,[Opisk_kurssi_osuus] = [Opisk_kurssi_osuus_palks]
      ,[aineisto] = '1.24g'
  FROM [TK_H9098_CSC].[dbo].[TK_1_24g_sopv_26]
