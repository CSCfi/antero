USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_arvo_amis_generoi_tyhjat_kuukaudet]    Script Date: 27.12.2022 11:35:28 ******/
SET ANSI_NULLS ON
GO
...
WHERE (d2.kyselykertaid is null or coalesce(nullif(d4.organisaatio_koodi,'-1'), d4a.organisaatio_koodi) is null or d3.koulutusluokitus_koodi is null or d1.vuosi is null or d1.kuukausi is null)
--poistettu  edellisen rivin lopusta ks. CSCVIPUNEN-3260
--or d4b.koodi is null)
