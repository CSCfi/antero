...
BEGIN
  ...
  INSERT INTO ' + @taulu + '
	...
	(
	  ...
	  --henkilö
		,[sukupuoli_koodi] = h.sukupuoli --coalesce(h2.sukupuoli, ''-1'')
	  ...
	  --_pvm
		...
		--LEFT JOIN Koski_SA_31102021.sa.[sa_koski_henkilo] h2 on h2.[oppija_oid] = oo.[oppija_oid] --hetuttomille sukupuoli-tieto purettu vasta 2021
