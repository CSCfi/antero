USE [Koski_SA]
GO
/****** Object:  StoredProcedure [sa].[p_lataa_tutkinnot_ja_tutkinnonosat_tutkinnon_osien_suoritukset]    Script Date: 20.7.2022 14:42:33 ******/
SET ANSI_NULLS ON
GO
...
FROM   (
	...
	OUTER APPLY (
		SELECT 
			...
			,osaamisalat = nullif(concat(min(ca.osaamisala),'|',avg(ca.osaamisala),'|',max(ca.osaamisala)),'')
