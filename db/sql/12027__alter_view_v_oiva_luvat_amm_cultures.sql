...
/****** Object:  View [dw].[v_oiva_luvat_amm_cultures]    Script Date: 31.3.2026 15.26.09 ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT --TOP 1000
	...
	,[koul_jarjestajan_pilke_alue_kokeilu_fi] = d15.[Koul. järjestäjän PILKE-alue (kokeilu)]
	...
	,[toiminnanohjauksen_kokeilu_sv] = CASE d15.[Toiminnanohjauksen kokeilu]
		WHEN 'Mukana toiminnanohjauksen kokeilussa' THEN 'Deltar i försöket med verksamhetsstyrning'
		WHEN 'Ei mukana toiminnanohjauksen kokeilussa' THEN 'Inte deltar i försöket med verksamhetsstyrning'
		ELSE d15.[Toiminnanohjauksen kokeilu]
	END
	,[koul_jarjestajan_pilke_alue_kokeilu_sv] = CASE d15.[Koul. järjestäjän PILKE-alue (kokeilu)]
		WHEN 'Alue P' THEN 'Norra området'
		WHEN 'Alue I' THEN 'Östra området'
		WHEN 'Alue L' THEN 'Västra området'
		WHEN 'Alue K' THEN 'Mellerstra området'
		WHEN 'Alue E' THEN 'Södra området'
		ELSE d15.[Koul. järjestäjän PILKE-alue (kokeilu)]
	END
	...
	,[koul_jarjestajan_pilke_alue_kokeilu_en] = d15.[Koul. järjestäjän PILKE-alue (kokeilu)]
	...
	,[jarjestys_koul_jarjestajan_pilke_alue_kokeilu] = d15.[jarjestys Koul. järjestäjän PILKE-alue (kokeilu)]
