USE [VipunenTK_DW]
GO
/****** Object:  StoredProcedure [dbo].[p_lataa_f_tutkinnon_suorittaneiden_myohempi_koulutus_4_8]    Script Date: 25.7.2018 14:00:11 ******/
SET ANSI_NULLS ON
GO
...
SELECT --top 0
      ...
      --,[ylamklkm]
      ,[ylamklkm_henkiloiden_lkm] = Case when lulkm > 0 then henkiloiden_lkm else 0 end
      ,[ylamkkoulk]
