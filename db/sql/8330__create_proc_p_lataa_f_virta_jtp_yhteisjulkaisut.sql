...
/****** Object:  StoredProcedure [dw].[p_lataa_f_yo_julkaisut_f_i_tieteenalat]    Script Date: 27.11.2023 13:12:25 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER  PROCEDURE [dw].[p_lataa_f_virta_jtp_yhteisjulkaisut]
AS
...
LEFT JOIN ANTERO.dw.d_yo d20 on d20.id = f.d_yliopisto_id
...
LEFT JOIN antero.dw.d_amk d20 on d20.id=f.d_amk_id
