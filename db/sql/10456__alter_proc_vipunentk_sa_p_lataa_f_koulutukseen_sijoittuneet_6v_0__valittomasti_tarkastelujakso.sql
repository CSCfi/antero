...
/****** Object:  StoredProcedure [dbo].[p_lataa_f_koulutukseen_sijoittuneet_6v_0__valittomasti_tarkastelujakso]    Script Date: 9.1.2025 10.15.00 ******/
SET ANSI_NULLS ON
GO
...
-- Koulutuksen maakunta 2
 ...
 l.tietolahde,
 'K3.13',
 l.opintotuki_ulkom_1 as opintotuki_ulkom,   -- ei-kumulatiivinen ja kumulatiivinen ovat ensim. tarkastelujaksolla efektiivisesti samoja
 -- Lukiokoulutuksessa
 (case
...
(
	...
	Kumulatiivisista muuttujista toimii vain ne, jotka eivät koske välitöntä ammatillista opiskelua tai opiskelemattomuutta.
