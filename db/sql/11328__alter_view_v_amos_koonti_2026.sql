...
ALTER VIEW [dw].[v_amos_koonti_2026] AS

/*
Vuoden 2027 tietoja lisättäessä tai muiden kehitystarpeiden ilmetessä voi harkita partitioinnin purkamista (nykyään nopeampi) ja näkymien yhdistämistä.
Toisaalta ennen käännösten muodostamista voi olla parempi pidättäytyä, jos leventämisen myötä hidastuu merkittävästi (ja voisi olla parin vuoden päästä joka tapauksessa partitiointi edessä).
