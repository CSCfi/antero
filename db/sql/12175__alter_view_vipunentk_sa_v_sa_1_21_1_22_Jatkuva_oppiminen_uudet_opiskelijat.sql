...
/****** Object:  View [dbo].[v_sa_1_21_1_22_Jatkuva_oppiminen_uudet_opiskelijat]    Script Date: 2.9.2026 12.20.08 ******/
SET ANSI_NULLS ON
GO
...
FROM (
	...
	SELECT [tilv]
	  ...
	  ,[aineisto] = '1.21b' --käytetään piilosuodattimena
      ,[luontipvm]
	FROM [TK_H9098_CSC].[dbo].[TK_K1_21b_sopv_25]
	...
	SELECT [tilv]
	  ...
	  ,[aineisto] = '1.22b' --käytetään piilosuodattimena
      ,[luontipvm]
	FROM [TK_H9098_CSC].[dbo].[TK_K1_22b_sopv_25]
