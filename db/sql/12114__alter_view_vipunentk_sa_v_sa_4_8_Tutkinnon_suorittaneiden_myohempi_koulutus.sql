...
/****** Object:  View [dbo].[v_sa_4_8_Tutkinnon_suorittaneiden_myohempi_koulutus]    Script Date: 15.6.2026 16.34.34 ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT [suorv]
      ...
      ,[lkm]
      ,[luontipvm]
	  ,tilv = (select max(lusuorv) FROM [TK_H9098_CSC].[dbo].[TK_K4_8_sopv_26])
      ,[tietolahde]='TK_4_8_sopv_26'
      --,[rivinumero] = ROW_NUMBER() OVER(ORDER BY koulk)
FROM [TK_H9098_CSC].[dbo].[TK_K4_8_sopv_26]
