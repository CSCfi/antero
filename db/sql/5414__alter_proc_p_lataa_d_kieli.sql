USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_d_kieli]    Script Date: 11.1.2022 19:21:53 ******/
SET ANSI_NULLS ON
GO
...
WHEN NOT MATCHED THEN
  ...
  UPDATE k
  SET k.suorituskieli_yleissivistava_fi = case when kieli_koodi in ('-1', 'EN', 'FR', 'RI', 'SV', 'SE', 'DE', 'FI', 'RU', 'VK') then k.kieli_fi else ca.kieli_fi end,
  ...
  UPDATE k
  SET suorituskieli_yleissivistava_fi = 'saame',
    suorituskieli_ammatillinen_fi = 'saame'
  FROM dw.d_kieli k
