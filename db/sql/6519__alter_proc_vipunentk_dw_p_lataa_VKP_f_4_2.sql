USE [VipunenTK_DW]
GO
/****** Object:  StoredProcedure [dbo].[p_lataa_VKP_f_4_2]    Script Date: 20.1.2023 13:10:02 ******/
SET ANSI_NULLS ON
GO
...
--Uusi rinnakkaisaineisto 4.2d suppeampi, aja tarvittaessa erikseen (ei vaadi aineistomuunnos-latausta). JS 20.1.2023
...
SELECT
	...
	,f.koulutusluokitus_korkein_viimeisin_aloitettu
	,koulutusluokitus_korkein_viimeisin_aloitettu_id = coalesce(d24.id,-1)
...
LEFT JOIN VipunenTK..d_koulutusluokitus AS d24 ON d24.koulutusluokitus_avain=f.koulutusluokitus_korkein_viimeisin_aloitettu
