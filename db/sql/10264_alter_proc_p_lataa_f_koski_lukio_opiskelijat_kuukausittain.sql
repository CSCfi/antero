...
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_lukio_opiskelijat_kuukausittain]    Script Date: 21.10.2024 8:32:06 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN Koski_SA.sa.temp_amm_opisk_alkamispaivat d6 ON d6.oppija_oid = oo.oppija_oid AND d6.aloitusvuosi = YEAR(oo.alkamispaiva)
--poistettaneen, kun CSCVIPUNEN-2602 valmis
...
LEFT JOIN Koski_SA.sa.sa_oppivelvolliset ov ON ov.oppija_oid = oo.oppija_oid and DATEFROMPARTS(vt.vuosi, vt.kuukausi, 1) BETWEEN ov.alkuPvm and ov.loppuPvm
