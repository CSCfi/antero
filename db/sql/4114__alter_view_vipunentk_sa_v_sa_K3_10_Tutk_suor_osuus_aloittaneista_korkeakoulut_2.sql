...
/****** Object:  View [dbo].[v_sa_K3_10_Tutk_suor_osuus_aloittaneista_korkeakoulut_2]    Script Date: 21.10.2020 11:19:06 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_sa_K3_10_Tutk_suor_osuus_aloittaneista_korkeakoulut_2] AS

--Lisätty amas-ohjaus ettei ptoim-tietoja tipu myöhemmin nullien takia. Tietoa ei taideta tällä hetkellä käyttää. / jsyrjala 21.10.2020
...
/*      ,[kkun]
      ...
      ,[muutaolosyys_2009]
	  ,[ptoim1r5_2000]
      ,[amas_2000] = coalesce([amas_2000],'9')
      ,[ptoim1r5_2001]
      ,[amas_2001] = coalesce([amas_2001],'9')
      ,[ptoim1r5_2002]
      ,[amas_2002] = coalesce([amas_2002],'9')
      ,[ptoim1r5_2003]
      ,[amas_2003] = coalesce([amas_2003],'9')
      ,[ptoim1r5_2004]
      ,[amas_2004] = coalesce([amas_2004],'9')
      ,[ptoim1r5_2005]
      ,[amas_2005] = coalesce([amas_2005],'9')
      ,[ptoim1r5_2006]
      ,[amas_2006] = coalesce([amas_2006],'9')
      ,[ptoim1r5_2007]
      ,[amas_2007] = coalesce([amas_2007],'9')
      ,[ptoim1r5_2008]
      ,[amas_2008] = coalesce([amas_2008],'9')
      ,[ptoim1r5_2009]
      ,[amas_2009] = coalesce([amas_2009],'9')
...
--2010
      ...
      ,[muutaolosyys_2010]
      ,[ptoim1r5_2010]
      ,[amas_2010] = coalesce([amas_2010],'9')
...
--2011
      ...
      ,[muutaolosyys_2011]
      ,[ptoim1r5_2011]
      ,[amas_2011] = coalesce([amas_2011],'9')
...
--2012
      ...
      ,[muutaolosyys_2012]
      ,[ptoim1r5_2012]
      ,[amas_2012] = coalesce([amas_2012],'9')
--2013
      ,[amksuorv_2013]
      ,[amksuorlk_2013]
      ,[amktutkkmaak_2013]
      ...
      ,[muutaolosyys_2013]
      ,[ptoim1r5_2013]
      ,[amas_2013] = coalesce([amas_2013],'9')
...
-- 2014
      ...
      ,[muutaolosyys_2014]
      ,[ptoim1r5_2014]
      ,[amas_2014] = coalesce([amas_2014],'9')
...
--2015
      ...
      ,[tkolotamm_2015]
      ,[tkolosyys_2015]
      ,[muutaopiskkoulk_2015]
      ,[muutaopiskjarj_2015]
      ,[muutakmaak_2015]
      ,[muutaolotamm_2015]
      ,[muutaolosyys_2015]
      ,[ptoim1r5_2015]
      ,[amas_2015] = coalesce([amas_2015],'9')
*/
...
--2016
      ...
      ,[tkolotamm_2016]
      ,[tkolosyys_2016]
      ,[muutaopiskkoulk_2016]
      ,[muutaopiskjarj_2016]
      ,[muutakmaak_2016]
      ,[muutaolotamm_2016]
      ,[muutaolosyys_2016]
      ,[ptoim1r5_2016]
      ,[amas_2016] = coalesce([amas_2016],'9')
...
--2017
      ...
      ,[tkolotamm_2017]
      ,[tkolosyys_2017]
      ,[muutaopiskkoulk_2017]
      ,[muutaopiskjarj_2017]
      ,[muutakmaak_2017]
      ,[muutaolotamm_2017]
      ,[muutaolosyys_2017]
      ,[ptoim1r5_2017]
      ,[amas_2017] = coalesce([amas_2017],'9')
...
--2018
      ...
      ,[tkolotamm_2018]
      ,[tkolosyys_2018]
      ,[muutaopiskkoulk_2018]
      ,[muutaopiskjarj_2018]
      ,[muutakmaak_2018]
      ,[muutaolotamm_2018]
      ,[muutaolosyys_2018]
      ,[ptoim1r5_2018]
      ,[amas_2018] = coalesce([amas_2018],'9')
...
-- lisää sarakkeet ylle ja päivitä tietolähde sekä lähdetaulut alle
  ...
  left join [TK_H9098_CSC].[dbo].[TK_K3_10_sopv_20_2] as f2 on f1.rivinro=f2.rivinro
 
  --28.8.2013 Poistetaan maanpuolustuskoulutus ja muut 999999-alkuiset
