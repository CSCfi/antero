...
/****** Object:  View [dw].[v_valos_koulutuksenkustannukset]    Script Date: 1.3.2022 15:18:56 ******/
SET ANSI_NULLS ON
GO
...
UNPIVOT
	(summa FOR menolajitoiminto IN
	  ...
	  LEFT JOIN dw.d_organisaatioluokitus d1 ON coalesce(nullif(ytunnus,''),'-1')=organisaatio_koodi
