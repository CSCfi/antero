...
/****** Object:  View [dbo].[v_sa_2_8f_2_9d_Korkeakouluopiskelijat_ja_tutkinnot_syntyperan_mukaan]    Script Date: 22.9.2026 15.14.07 ******/
SET ANSI_NULLS ON
GO
...
SELECT
	...
	,[suormaa] = cast(coalesce(nullif(kaikkivuodet.suormaa,''),'-1') as nvarchar(2))
...
FROM (
	...
	SELECT [tilv]
      ...
      ,aineisto = '2.8f'
      ,[luontipvm]
	FROM [TK_H9098_CSC].[dbo].[TK_K2_8f_sopv_26]
	...
	SELECT [tilv]
      ...
      ,aineisto = '2.9d'
      ,[luontipvm]
	FROM [TK_H9098_CSC].[dbo].[TK_K2_9d_sopv_26]
