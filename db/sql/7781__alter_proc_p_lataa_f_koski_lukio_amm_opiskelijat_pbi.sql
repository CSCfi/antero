...
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_lukio_amm_opiskelijat_pbi]    Script Date: 9.6.2023 10:03:55 ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT Tilastovuosi = vuosi
	...
	,f.oppija_oid
	,opiskelijat = null
	,opiskelija_20_9 = (SELECT MAX([tilastopaiva_20_9]) FROM [ANTERO].[dw].[f_koski_lukio_opiskelijat_laskentapaiva] f1 WHERE f1.tilastovuosi = f.vuosi AND f1.oppija_oid = f.oppija_oid AND f1.opiskeluoikeus_oid = f.opiskeluoikeus_oid)
	,raportti = 'perus'
