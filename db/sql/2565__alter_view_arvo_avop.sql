...
/****** Object:  View [dw].[v_arvo_avop]    Script Date: 24.10.2019 14:58:50 ******/
SET ANSI_NULLS ON
GO
...
,case 
	when d2.organisaatio_koodi = '02557' then 'Annan än utbildning som är underställd utbildningsförvaltningen' 
...
,case 
	when d2.organisaatio_koodi = '02557' then 'Oher than education under the education administration' 
