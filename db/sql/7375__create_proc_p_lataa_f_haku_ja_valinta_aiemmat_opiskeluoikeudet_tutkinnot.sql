...
/****** Object:  StoredProcedure [dw].[p_lataa_f_haku_ja_valinta_aiemmat_opiskeluoikeudet_tutkinnot]    Script Date: 20.2.2023 8:29:11 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dw].[p_lataa_f_haku_ja_valinta_aiemmat_opiskeluoikeudet_tutkinnot] AS
...
SELECT
	...
	MAX(CASE WHEN d20.koulutusalataso1_koodi = d53.koulutusalataso1_koodi THEN 1 ELSE 0 END)
		OVER (
				PARTITION BY f.henkilo_oid, f.hakemus_oid, d10.id, coalesce(d5.loppuPvm, d5b.loppuPvm)) as muu_oo_koulutusala_taso_1_sama_kuin_hakukohde,
	MAX(CASE WHEN d20.koulutusalataso2_koodi = d53.koulutusalataso2_koodi THEN 1 ELSE 0 END)
		OVER (
				PARTITION BY f.henkilo_oid, f.hakemus_oid, d10.id, coalesce(d5.loppuPvm, d5b.loppuPvm)) as muu_oo_koulutusala_taso_2_sama_kuin_hakukohde,
	MAX(CASE WHEN d20.koulutusalataso3_koodi = d53.koulutusalataso3_koodi THEN 1 ELSE 0 END)
		OVER (
				PARTITION BY f.henkilo_oid, f.hakemus_oid, d10.id, coalesce(d5.loppuPvm, d5b.loppuPvm)) as muu_oo_koulutusala_taso_3_sama_kuin_hakukohde,
	MAX(CASE WHEN d20.koulutusastetaso2_koodi = d53.koulutusastetaso2_koodi THEN 1 ELSE 0 END)
		OVER (
				PARTITION BY f.henkilo_oid, f.hakemus_oid, d10.id, coalesce(d5.loppuPvm, d5b.loppuPvm)) as muu_oo_koulutusaste_taso_2_sama_kuin_hakukohde,
	MAX(CASE WHEN d20.koulutusluokitus_koodi = d53.koulutusluokitus_koodi THEN 1 ELSE 0 END)
		OVER (
				PARTITION BY f.henkilo_oid, f.hakemus_oid, d10.id, coalesce(d5.loppuPvm, d5b.loppuPvm)) as muu_oo_tavoitetutkinto_sama_kuin_hakukohde,
	MAX(CASE WHEN d16b.organisaatio_nykyinen_koodi = d51.organisaatio_nykyinen_koodi THEN 1 ELSE 0 END)
		OVER (
				PARTITION BY f.henkilo_oid, f.hakemus_oid, d10.id, coalesce(d5.loppuPvm, d5b.loppuPvm)) as muu_oo_korkeakoulu_sama_kuin_hakukohde,

	MAX(CASE WHEN d20.koulutusalataso1_koodi = d54.koulutusalataso1_koodi THEN 1 ELSE 0 END)
		OVER (
				PARTITION BY f.henkilo_oid, f.hakemus_oid, d10.id, coalesce(d5.loppuPvm, d5b.loppuPvm)) as aiempi_tutk_koulutusala_taso_1_sama_kuin_hakukohde,
	MAX(CASE WHEN d20.koulutusalataso2_koodi = d54.koulutusalataso2_koodi THEN 1 ELSE 0 END)
		OVER (
				PARTITION BY f.henkilo_oid, f.hakemus_oid, d10.id, coalesce(d5.loppuPvm, d5b.loppuPvm)) as aiempi_tutk_koulutusala_taso_2_sama_kuin_hakukohde,
	MAX(CASE WHEN d20.koulutusalataso3_koodi = d54.koulutusalataso3_koodi THEN 1 ELSE 0 END)
		OVER (
				PARTITION BY f.henkilo_oid, f.hakemus_oid, d10.id, coalesce(d5.loppuPvm, d5b.loppuPvm)) as aiempi_tutk_koulutusala_taso_3_sama_kuin_hakukohde,
	MAX(CASE WHEN d20.koulutusastetaso2_koodi = d54.koulutusastetaso2_koodi THEN 1 ELSE 0 END)
		OVER (
				PARTITION BY f.henkilo_oid, f.hakemus_oid, d10.id, coalesce(d5.loppuPvm, d5b.loppuPvm)) as aiempi_tutk_koulutusaste_taso_2_sama_kuin_hakukohde,
	MAX(CASE WHEN d20.koulutusluokitus_koodi = d54.koulutusluokitus_koodi THEN 1 ELSE 0 END)
		OVER (
				PARTITION BY f.henkilo_oid, f.hakemus_oid, d10.id, coalesce(d5.loppuPvm, d5b.loppuPvm)) as aiempi_tutk_tavoitetutkinto_sama_kuin_hakukohde,
	MAX(CASE WHEN d16b.organisaatio_nykyinen_koodi = d52.organisaatio_nykyinen_koodi THEN 1 ELSE 0 END)
		OVER (
				PARTITION BY f.henkilo_oid, f.hakemus_oid, d10.id, coalesce(d5.loppuPvm, d5b.loppuPvm)) as aiempi_tutk_korkeakoulu_sama_kuin_hakukohde,

	MAX(f.aiempi_tutkinto_suorituspvm)
		OVER (
				PARTITION BY f.henkilo_oid, f.hakemus_oid, coalesce(d5.loppuPvm, d5b.loppuPvm)) as tuorein_aiempi_tutkinto_suorituspvm,
	MAX(f.muu_alkamispvm)
		OVER (
				PARTITION BY f.henkilo_oid, f.hakemus_oid, coalesce(d5.loppuPvm, d5b.loppuPvm)) as tuorein_muu_oo_alkamispvm,
	...
	MAX(CASE
		...
		END)
			OVER (
					PARTITION BY f.henkilo_oid, f.hakemus_oid, d10.id, coalesce(d5.loppuPvm, d5b.loppuPvm)) as muun_opintooikeuden_vertailu,
	MAX(CASE
		...
		END)
			OVER (
					PARTITION BY f.henkilo_oid, f.hakemus_oid, d10.id, coalesce(d5.loppuPvm, d5b.loppuPvm)) as aiemman_tutkinnon_vertailu
