...
/****** Object:  Table [dbo].[f_TJ_4_3_Tutkinnon_suorittaneiden_paaasiallinen_toiminta]    Script Date: 13.1.2025 15.40.17 ******/
SET ANSI_NULLS ON
GO
...
TRUNCATE TABLE [dbo].[f_TJ_4_3_Tutkinnon_suorittaneiden_paaasiallinen_toiminta]
GO
...
ALTER TABLE [dbo].[f_TJ_4_3_Tutkinnon_suorittaneiden_paaasiallinen_toiminta]  WITH CHECK ADD  CONSTRAINT [FK_4_3_d_rahoituslahde_versio2] FOREIGN KEY([rahoituslahde_v2_id])
REFERENCES [dbo].[d_rahoituslahde_versio2] ([id])
GO

ALTER TABLE [dbo].[f_TJ_4_3_Tutkinnon_suorittaneiden_paaasiallinen_toiminta] CHECK CONSTRAINT [FK_4_3_d_rahoituslahde_versio2]
GO
