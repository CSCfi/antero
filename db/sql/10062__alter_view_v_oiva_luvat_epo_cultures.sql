...
/****** Object:  View [dw].[v_oiva_luvat_epo_cultures]    Script Date: 28.8.2024 13:37:50 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dw].[v_oiva_luvat_epo_cultures] AS


SELECT
	 [tarkasteluvuosi] = d11.vuosi
	...
	,[tarkastelupaiva_fi] = concat('Voimassa 1.', d11.kuukausi, '.') -- Lupa voimassa muutos tarkastelupäiväksi JK
	...
	,[hyvinvointialue_fi] = d2.hyvinvointialue_fi
	...
	,[tarkastelupaiva_sv] = concat('Giltigt 1.', d11.kuukausi, '.') -- Lupa voimassa muutos tarkastelupäiväksi JK
	...
	,[hyvinvointialue_sv] = d2.hyvinvointialue_sv
	...
	,[tarkastelupaiva_en] = concat('Valid 1.', d11.kuukausi, '.') -- Lupa voimassa muutos tarkastelupäiväksi JK
	...
	,[hyvinvointialue_en] = d2.hyvinvointialue_en
	...
	,[jarjestys_hyvinvointialue] = d2.jarjestys_hyvinvointialue_koodi
	,[jarjestys_opetus_jota_lupa_koskee] = d7.jarjestys2
...
LEFT JOIN dw.d_kalenteri d11 on d11.id = f.d_kalenteri_tarkastelupaiva -- Lupa voimassa muutos tarkastelupäiväksi JK
LEFT JOIN dw.d_organisaatioluokitus d12 on d12.id = f.d_organisaatioluokitus_oppilaitos_id
--erityisopetuksen suodattaminen
