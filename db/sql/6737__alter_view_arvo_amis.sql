...
/****** Object:  View [dw].[v_arvo_amis]    Script Date: 7.12.2022 13:29:15 ******/
SET ANSI_NULLS ON
GO
...
SELECT
	...
	, d11.jarjestys								AS 'Järjestys rahoitusryhmä'
	...
	, d5.kyselykertaid							AS 'kyselykertaid'
...
LEFT JOIN dw.d_rahoitusryhma d11 ON d11.id = f.d_rahoitusryhma_id
...
LEFT JOIN dw.f_arvo_luodut_vastaajatunnukset f2 ON f2.kyselykertaid = d5.kyselykertaid 
												and coalesce(f2.oppilaitoskoodi,'-1') = o2.organisaatio_koodi 
