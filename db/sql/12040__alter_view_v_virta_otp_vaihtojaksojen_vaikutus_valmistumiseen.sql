...
/****** Object:  View [dw].[v_virta_otp_vaihtojaksojen_vaikutus_valmistumiseen]    Script Date: 28.4.2026 10.43.36 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dw].[v_virta_otp_vaihtojaksojen_vaikutus_valmistumiseen] as
...
f.Vaihtovuosi,
d6.lukuvuosi,
NULLIF(CONCAT(f.Vaihtovuosi,LEFT(d6.lukukausi_fi,1)),''),
d1.organisaatio_fi,
f.korkeakoulun_lyhenne,
d1.oppilaitostyyppi_fi,
d2.koulutusalataso1_fi,
d2.koulutusalataso2_fi,
d2.koulutusastetaso1_fi,
