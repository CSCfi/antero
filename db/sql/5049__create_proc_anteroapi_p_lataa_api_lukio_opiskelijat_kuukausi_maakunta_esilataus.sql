...
DROP PROCEDURE IF EXISTS [dw].[p_lataa_api_lukio_opiskelijat_kuukausi_maakunta_esilataus]
GO
...
CREATE PROCEDURE [dw].[p_lataa_api_lukio_opiskelijat_kuukausi_maakunta_esilataus] AS
