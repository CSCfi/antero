...
/****** Object:  View [dbo].[v_sa_2_3h_Lukio_ja_amm_koulutuksen_opiskelijat]    Script Date: 5.6.2026 15.21.52 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN TK_H9098_CSC.dbo.TK_6_5_sopv_26 d on d.koulk = f.koulk --päivitä vuosi kaikkiin: tietolahde, f, d
