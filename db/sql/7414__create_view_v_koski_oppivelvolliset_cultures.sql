...
/****** Object:  View [dw].[v_koski_oppivelvolliset_cultures]    Script Date: 22.2.2023 10:01:19 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER VIEW [dw].[v_koski_oppivelvolliset_cultures] AS
...
SELECT 
	...
	,d4.kieliryhma1_fi as aidinkieli_ryhma_fi
	,d4.kieliryhma1_sv as aidinkieli_ryhma_sv
	...
	,d4.jarjestys_kieliryhma1 as jarjestys_aidinkieli_ryhma
