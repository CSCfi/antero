...
/****** Object:  View [dbo].[v_f_tutkinnon_suorittaneiden_aiempi_koulutus_4_7]    Script Date: 21.12.2023 12:25:49 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER VIEW [dbo].[v_f_tutkinnon_suorittaneiden_aiempi_koulutus_4_7] AS
...
*/
    ...
    Select 
      ...
      ,[ammtutktav] = Case when amm_ika <= jaksovuosi then ammtutktav else '' end
	...
	where 
	-- tarkastelujaksojen määrä riippuu koulutusasteesta
