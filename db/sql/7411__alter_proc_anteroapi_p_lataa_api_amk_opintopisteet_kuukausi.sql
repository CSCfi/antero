...
/****** Object:  StoredProcedure [dw].[p_lataa_api_amk_opintopisteet_kuukausi]    Script Date: 22.2.2023 7:48:01 ******/
SET ANSI_NULLS ON
GO
...
IF (((((	select count (*) from (
		select [tilastovuosi], [kuukausi], [ammattikorkeakoulu], [koodit_ammattikorkeakoulu], [okm_ohjauksen_ala], [koodit_okm_ohjauksen_ala], 
			   ...
			   [op_kv_suomi_vieraana_lkm],[op_kv_ruotsi_vieraana_lkm],[op_muun_kuin_korkeakoulun_yhteistyo_lkm]
