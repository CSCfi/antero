...
/****** Object:  View [dbo].[v_f_tab_koulutukseen_sijoittuneet_2v_ammatillinen]    Script Date: 12.7.2019 17:25:00 ******/
SET ANSI_NULLS ON
GO
...
WHERE tutkintoryhma_koodi IN (3,31,32,33) 
-- AND (d24.opetussuunnitelmaperusteinen_koulutus_nayttotutkintoon_valmistava_koulutus_koodi in (1, -1)) 
AND d15.vuosiselite <> '2008'
