...
/****** Object:  View [dbo].[v_f_tab_tyollistyminen_syntyperan_mukaan]    Script Date: 21.10.2022 18:05:55 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER VIEW [dbo].[v_f_tab_tyollistyminen_syntyperan_mukaan] as
...
SELECT
	...
	,[Koulutusmuoto] = d10.koulutusmuoto
	...
	,[Koodit Tutk. suor.maakunta] = d4.maakunta_koodi
	...
	,d10.jarjestys as jarjestys_koulutusmuoto
...
WHERE d9.Koulutusaste_taso2_koodi not in ('73','81') --sovittu poistettavan lääk. erik.koulutukset sekä harvat lis. tutkinnot
