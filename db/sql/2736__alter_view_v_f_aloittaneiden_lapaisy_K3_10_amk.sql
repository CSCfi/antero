...
/****** Object:  View [dbo].[v_f_aloittaneiden_lapaisy_K3_10_amk]    Script Date: 20.12.2019 14:01:42 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
		...
		d5.ika AS Ikä, 
		COALESCE(d5b.ikaryhma2_fi,'Tuntematon') AS Ikäryhmä,
		...
		d5.ika_SV AS Ålder, 
		COALESCE(d5b.ikaryhma2_sv,'Okänt') AS Åldersgrupp,
		...
		d5.ika_EN AS Age, 
		COALESCE(d5b.ikaryhma2_en,'Unknown') AS [Age group],
		...
		d5.jarjestys_ika, 
		d5.jarjestys_ika5v,
		COALESCE (d5b.jarjestys_ikaryhma2, 99) as jarjestys_ikaryhma,
...
WHERE   aineistokoodi = 'K3.10' 
		...
		AND d17.tarkastelujakso != '0,5 vuotta' 
		AND d1.lukuvuosi != '1999/2000' 
		AND d1.lukuvuosi != '2000/2001' 
		AND d1.lukuvuosi != '2001/2002' 
