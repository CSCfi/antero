...
/****** Object:  View [dbo].[v_sa_2_22b_oppilasmaarat_sp]    Script Date: 7.5.2026 10.05.28 ******/
SET ANSI_NULLS ON
GO
...
ALTER     VIEW [dbo].[v_sa_2_22b_oppilasmaarat_sp] AS
...
SELECT [tilv], [tunn], [sp], [luokka], [esi], [lkm]
FROM [TK_H9098_CSC].[dbo].[TK_K2_22b_sopv_26]
WHERE oppilas = '1'
)
