...
/****** Object:  View [dw].[v_kk_rahoitusmalli_yo]    Script Date: 20.2.2019 15:04:29 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	  ...
	  ,case when d3.oppilaitostyyppi_koodi='42' AND d1.julkaisunpaaluokka_koodi in ('A', 'B', 'C', 'D', 'E') then julkaisunTunnus end as 'JulkaisuID'
	  ,cast(julkaisufoorumitaso_koodi as integer) as 'Jufotaso'
	 ,d1.[julkaisutyyppi_koodi] as 'Julkaisutyyppi'
	 ,f.lukumaara as 'Julkaisut lukumaara'
...
SELECT
		...
		,tilikausi as 'Tilastovuosi - rahoitusmalli'
      , d50.organisaatio_fi  as 'Organisaatio'
	  ,[Sektori]='Yliopisto'
	  , NULL as 'Koulutusnimike'
	  , NULL AS 'koulutusaste2002'
	  ...
	  ,case when tili_taso2_fi IN ('Suomen Akatemia','Tekes','Kotimaiset yritykset','Ulkomaiset yritykset','Business Finland') then arvo else 0 end AS 'Kilpailtu tutkimusrahoitus rah_malli'
...
SELECT 
	...
	,erillisilla_oik_opkoul_op_lkm as 'erillisilla_oik_opkoul_op_lkm'
...
SELECT
	 ...
	 ,f.tilastovuosi as 'Tilastovuosi - rahoitusmalli'
	  ...
	  -- Opiskelijapalaute --
	  ,f.opiskelijapalaute as 'Opiskelijapalautepisteet'
