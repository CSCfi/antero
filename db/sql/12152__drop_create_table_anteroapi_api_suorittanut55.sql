...
/****** Object:  Table [dw].[api_suorittanut55]    Script Date: 25.8.2026 12.10.09 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dw].[api_suorittanut55]') AND type in (N'U'))
DROP TABLE [dw].[api_suorittanut55]
GO
