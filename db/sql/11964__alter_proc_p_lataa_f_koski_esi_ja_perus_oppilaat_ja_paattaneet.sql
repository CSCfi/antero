...
SELECT 	
	...
	,max(vaihe_koodi_priorisoitu) as 'vaihe_koodi_priorisoitu'
	,max(aikuisten_alkuvaihe_1_0) as 'aikuisten_alkuvaihe_1_0' --raportilla korvattu edellisellä
...
OUTER APPLY (
	...
	from Koski_SA.dbo.esi_ja_perus_oppilaat_aipe_lukukausittain_vaihe_priorisoitu 
	where paatason_suoritus_id = k.paatason_suoritus_id
	and vuosi = k.vuosi
	and lukuvuosi = d1.lukuvuosi
) ca
