USE [Koski_SA]
GO
/****** Object:  StoredProcedure [dbo].[p_lataa_opiskelijavuodet_valitaulu]    Script Date: 25.10.2020 20:22:59 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	EXEC Koski_SA.sa.p_lataa_opiskelijavuodet_tutkinnon_osaa_pienemmat
	...
	SELECT 
		...
		,kustannusryhma_uusi =
				CASE 
					WHEN ps.suorituksen_tyyppi = 'ammatillinentutkintoosittainen' THEN otkr.kr_uusi
					WHEN ps.suorituksen_tyyppi = 'muuammatillinenkoulutus' then 'muu'
