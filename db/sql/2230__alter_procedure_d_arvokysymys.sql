USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_d_arvokysymys]    Script Date: 1.5.2019 17:39:46 ******/
SET ANSI_NULLS ON
GO
...
USING (
  ...
  case when taustakysymyksen_tyyppi in ('kiusaaminen','kiusaamiseen_puuttuminen') then 1 else 0 end as kiusaamiskysymys,
  vastaustyyppi,
