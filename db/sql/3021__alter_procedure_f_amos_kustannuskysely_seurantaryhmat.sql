USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_amos_kustannuskysely_seurantaryhmat]    Script Date: 27.4.2020 17:46:59 ******/
SET ANSI_NULLS ON
GO
...
FROM (
	...
	FROM [ANTERO].[sa].[sa_amos_kustannuskysely_seurantaryhmat_2018] sa1
	UNPIVOT (
