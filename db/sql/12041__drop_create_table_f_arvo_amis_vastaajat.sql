...
ALTER TABLE [dw].[f_arvo_amis_vastaajat] DROP CONSTRAINT [DF__f_arvo_amis_vastaajat__username]
GO

ALTER TABLE [dw].[f_arvo_amis_vastaajat] DROP CONSTRAINT [DF__f_arvo_amis_vastaajat__loadtime]
GO

/****** Object:  Table [dw].[f_arvo_amis_vastaajat]    Script Date: 29.4.2026 7.38.07 ******/
