...
/****** Object:  View [dw].[v_haku_ja_valinta_yoarvosanat]    Script Date: 6.9.2019 13:58:07 ******/
DROP VIEW IF EXISTS [dw].[v_haku_ja_valinta_yoarvosanat]
GO
...
CREATE VIEW [dw].[v_haku_ja_valinta_yoarvosanat] AS
