...
/****** Object:  View [dw].[v_indikaattori_asemointi]    Script Date: 30.8.2019 10:39:32 ******/
SET ANSI_NULLS ON
GO
...
SELECT   f.koulutuksen_alkamisvuosi
	  ...
	  , d90.jarjestys_paatieteenala2010 as 'jarj. paatieteenala'
	  , d90.jarjestys_tieteenala2010 as 'jarj. tieteenala'
	  , g.d_organisaatio_toimipiste_id as 'toimipiste_id'
	  , g.d_hakukohde_id as 'hakukohde_id'
	  , g.aloituspaikat as 'alpa'
	...
	left join [ANTERO].[dw].[f_haku_ja_valinta_aloituspaikat_ja_pistemaarat] g 
		on g.koulutuksen_alkamisvuosi = f.koulutuksen_alkamisvuosi
		and g.d_tutkinnon_aloitussykli_kk_id = f.d_tutkinnon_aloitussykli_kk_id
		and g.d_hakukohde_id = f.d_hakukohde_id
		and g.d_organisaatio_oppilaitos_id = f.d_organisaatio_oppilaitos_id
