...
ALTER TABLE [dw].[d_esco_ammatti] DROP CONSTRAINT [DF__d_esco_ammatti__username__531856C7]
GO

ALTER TABLE [dw].[d_esco_ammatti] DROP CONSTRAINT [DF__d_esco_ammatti__loadtime__5224328E]
GO
