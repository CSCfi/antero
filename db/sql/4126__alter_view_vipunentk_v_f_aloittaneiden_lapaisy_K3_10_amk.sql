...
/****** Object:  View [dbo].[v_f_aloittaneiden_lapaisy_K3_10_amk]    Script Date: 21.10.2020 11:48:32 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
		...
		Case 
			when d7.koulutusaste2002_koodi='62' then 'Aloitus I syklin tutkinnossa' 
		...
		Case 
			when d7.koulutusaste2002_koodi='62' then 'Påbörjande i I-skedets examen' 
			when d7.koulutusaste2002_koodi='71' then 'Påbörjande i II-skedets examen'  
			else 'Okänt' 
		end AS [Startskede], 
		...
		Case 
			when d7.koulutusaste2002_koodi='62' then 'Beginning of studies in cycle I degree' 
			when d7.koulutusaste2002_koodi='71' then 'Beginning of studies in cycle II degree'  
			else 'Unknown' 
