...
/****** Object:  View [dw].[v_koski_lukio_opintojen_kulku_cultures]    Script Date: 7.10.2021 7:04:48 ******/
DROP VIEW IF EXISTS [dw].[v_koski_lukio_opintojen_kulku_cultures]
GO
...
CREATE VIEW [dw].[v_koski_lukio_opintojen_kulku_cultures] AS
...
aidinkieli_ryhma_fi = d8.kieliryhma1_fi,
...
jarjestys_aidinkieli_ryhma = d13.jarjestys_kieliryhma1,
...
jarjestys_suorituskieli = d13.kieli_koodi,
