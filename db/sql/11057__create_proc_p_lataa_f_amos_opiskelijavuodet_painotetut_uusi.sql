...
CREATE OR ALTER PROCEDURE [dw].[p_lataa_f_amos_opiskelijavuodet_painotetut_uusi] @generoitu2 int = null
AS
...
FROM (
	...
	SELECT 
		...
		,[opiskelijavuodet_painotettu_pt] = --ca.opv_ei_maksuton_kerroin * 
			(select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='tutkintotyyppi' and kerroin_koodi='tt_9' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) 
			* ( 
				(select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='kustannusryhma' and kerroin_koodi='kr_1' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d1.tutkintotyyppi_koodi = '02' and d2.koodi='1' then opiskelijavuodet else 0 end)
				+ (select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='kustannusryhma' and kerroin_koodi='kr_2' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d1.tutkintotyyppi_koodi = '02' and d2.koodi='2' then opiskelijavuodet else 0 end)
				+ (select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='kustannusryhma' and kerroin_koodi='kr_3' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d1.tutkintotyyppi_koodi = '02' and d2.koodi='3' then opiskelijavuodet else 0 end)
				+ (select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='kustannusryhma' and kerroin_koodi='kr_4' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d1.tutkintotyyppi_koodi = '02' and d2.koodi='4' then opiskelijavuodet else 0 end)
				+ (select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='kustannusryhma' and kerroin_koodi='kr_5' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d1.tutkintotyyppi_koodi = '02' and d2.koodi='5' then opiskelijavuodet else 0 end)
				+ (select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='kustannusryhma' and kerroin_koodi='kr_6' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d1.tutkintotyyppi_koodi = '02' and d2.koodi='6' then opiskelijavuodet else 0 end)
				+ (select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='kustannusryhma' and kerroin_koodi='kr_7' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d1.tutkintotyyppi_koodi = '02' and d2.koodi='7' then opiskelijavuodet else 0 end)
			)

		,[opiskelijavuodet_painotettu_at_eat] = --ca.opv_ei_maksuton_kerroin * 
			(
				(select case when d4.kytkin_koodi = '1' then perusrahoitus else 0.0 end from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='tutkintotyyppi' and kerroin_koodi='tt_9' and right(f.rahoituskausi,4)+1 = varainhoitovuosi)
				+ (select case when d4.kytkin_koodi != '1' then perusrahoitus else 0.0 end from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='tutkintotyyppi' and kerroin_koodi='tt_10' and right(f.rahoituskausi,4)+1 = varainhoitovuosi)
			) 
			* ( 
				(select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='kustannusryhma' and kerroin_koodi='kr_1' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d1.tutkintotyyppi_koodi in ('19','20') and d2.koodi='1' then opiskelijavuodet else 0 end)
				+ (select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='kustannusryhma' and kerroin_koodi='kr_2' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d1.tutkintotyyppi_koodi in ('19','20') and d2.koodi='2' then opiskelijavuodet else 0 end)
				+ (select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='kustannusryhma' and kerroin_koodi='kr_3' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d1.tutkintotyyppi_koodi in ('19','20') and d2.koodi='3' then opiskelijavuodet else 0 end)
				+ (select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='kustannusryhma' and kerroin_koodi='kr_4' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d1.tutkintotyyppi_koodi in ('19','20') and d2.koodi='4' then opiskelijavuodet else 0 end)
				+ (select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='kustannusryhma' and kerroin_koodi='kr_5' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d1.tutkintotyyppi_koodi in ('19','20') and d2.koodi='5' then opiskelijavuodet else 0 end)
				+ (select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='kustannusryhma' and kerroin_koodi='kr_6' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d1.tutkintotyyppi_koodi in ('19','20') and d2.koodi='6' then opiskelijavuodet else 0 end)
				+ (select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='kustannusryhma' and kerroin_koodi='kr_7' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d1.tutkintotyyppi_koodi in ('19','20') and d2.koodi='7' then opiskelijavuodet else 0 end)
			)

		,[opiskelijavuodet_painotettu_valma_telma] = --ca.opv_ei_maksuton_kerroin * 
			(select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='kustannusryhma' and kerroin_koodi='kr_8' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d2.koodi='vt' then opiskelijavuodet else 0 end)

		,[opiskelijavuodet_painotettu_muu] = --ca.opv_ei_maksuton_kerroin * 
			(select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='kustannusryhma' and kerroin_koodi='kr_9' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d2.koodi='muu' and d4.kytkin_koodi = '1' then opiskelijavuodet else 0 end)
			+ (select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='kustannusryhma' and kerroin_koodi='kr_10' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d2.koodi='muu' and d4.kytkin_koodi != '1' then opiskelijavuodet else 0 end)
			
		,[opiskelijavuodet_painotettu_erityistuki] = --ca.opv_ei_maksuton_kerroin * (
			(select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='erityisopetus' and kerroin_koodi='eo_21' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d6.erityisopetus_koodi in ('4','5','6') then opiskelijavuodet else 0 end)
			+ (select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='erityisopetus' and kerroin_koodi='eo_22' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d6.erityisopetus_koodi in ('7','8','9') and d1.koulutusluokitus_koodi in ('999901','999908') then opiskelijavuodet else 0 end)
			+ (select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='erityisopetus' and kerroin_koodi='eo_23' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d6.erityisopetus_koodi in ('7','8','9') and d1.koulutusluokitus_koodi='999903' then opiskelijavuodet else 0 end)
			--)
		...
		,[opiskelijavuodet_painotettu_majoitus] = --ca.opv_ei_maksuton_kerroin * (
			(select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='majoitusetu' and kerroin_koodi='me_21' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d7.majoitus_koodi='2' then opiskelijavuodet else 0 end)
			+ (select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='majoitusetu' and kerroin_koodi='me_22' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d7.majoitus_koodi='3' then opiskelijavuodet else 0 end)
			+ (select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='majoitusetu' and kerroin_koodi='me_23' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) * (case when d7.majoitus_koodi='4' then opiskelijavuodet else 0 end)
			--)
		,[opiskelijavuodet_painotettu_majoitus_hyv] = --ca.opv_ei_maksuton_kerroin * (
			...
			/*
			--ca.opv_ei_maksuton_kerroin * (
			(select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='majoitusetu' and kerroin_koodi='me_21' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) 
			...
			+ (case when d11.koodi = 2 then (select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='majoitusetu' and kerroin_koodi='me_21' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) 
				else (select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='majoitusetu' and kerroin_koodi='me_22' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) end) 
				* (case when d7.majoitus_koodi='3' then ca.opv_som_kerroin * opiskelijavuodet else 0 end)
			+ (select perusrahoitus from sa.sa_amos_siirtotiedosto_okm7_uusi_rinnakkainen where kerroin_luokka='majoitusetu' and kerroin_koodi='me_23' and right(f.rahoituskausi,4)+1 = varainhoitovuosi) 
