...
/****** Object:  StoredProcedure [dw].[p_lataa_f_amos_opiskelijavuodet]    Script Date: 25.9.2026 14.26.37 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN dw.d_organisaatioluokitus d13 ON d13.organisaatio_oid = COALESCE(d13b.oid_amos_spl, d13b.oid_avain) -- CSCVIPUNEN-3358: Taustatiedot uusimman varainhoitovuoden järjestäjärakenteen mukaan. JK
