...
SELECT tilastovuosi
 ...
 where d1.julkaisunpaaluokka_koodi in ('A', 'B', 'C', 'D', 'E', 'F', 'I') and d3.oppilaitostyyppi_koodi='42' and tilastovuosi>2010
...
SELECT tilastovuosi
 ...
 --left join antero.dw.d_koulutusluokitus as d92 on d91.koulutuskoodi=d92.koulutusluokitus_koodi
 left join antero.dw.d_julkaisufoorumitaso as d5 on d_julkaisufoorumitaso_id=d5.id
 where d1.julkaisunpaaluokka_koodi in ('A', 'B', 'C', 'D', 'E', 'F', 'I') and d3.oppilaitostyyppi_koodi='41' and tilastovuosi>2010
 ...
 left join ANTERO.dw.d_tieteenala d90 on d90.id=f.d_tieteenala_id
 where d1.julkaisunpaaluokka_koodi in ('A', 'B', 'C', 'D', 'E', 'F', 'I') and vuosi>2010
...
SELECT tilastovuosi as 'Tilastointivuosi'
	  ...
	  , case 
			when d90.tieteenala_avain like '%TA10%' then ltrim(substring(d90.paatieteenala2010,CHARINDEX(' ',d90.paatieteenala2010),LEN(d90.paatieteenala2010))) else ltrim(substring(d90.paatieteenala2007,CHARINDEX(' ',d90.paatieteenala2007),LEN(d90.paatieteenala2007)))
			end as 'Päätieteenala'
	  , case 
			when d90.tieteenala_avain like '%TA10%' then ltrim(substring(d90.tieteenala2010,CHARINDEX(' ',d90.tieteenala2010),LEN(d90.tieteenala2010))) else ltrim(substring(d90.tieteenala2007,CHARINDEX(' ',d90.tieteenala2007),LEN(d90.tieteenala2007)))
			end as 'Tieteenala'
	  ,null as 'Tutkijanuravaihe'
      ,NULL AS 'koulutuksen_kunta'
      ,NULL AS 'kansalaisuus'
	  ...
	  , d5.koulutus_koodi as 'Koodit Koulutusnimike'
	  ,d3.organisaatio_koodi as 'Koodit oppilaitos'
	  , NULL as 'Koodit kunta'
  	  , NULL as 'jarjestys_iscle2011'
	  , NULL as 'jarjestys_Koulutusaste_taso2'
  ...
  where d1.rahoituslahde in ('Suomen Akatemia', 'Tekes', 'EU-puiteohjelmarahoitus')
  union all
...
SELECT koulutuksen_alkamisvuosi
	...
	where d12.koulutussektori_koodi=5
