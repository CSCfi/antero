...
GO
IF NOT EXISTS(
SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'sa_koski_paatason_suoritus' AND TABLE_SCHEMA = 'sa' AND COLUMN_NAME = 'oppisopimusjaksojen_paivat' OR COLUMN_NAME = 'koulutussopimusjaksojen_paivat'
)
BEGIN 
