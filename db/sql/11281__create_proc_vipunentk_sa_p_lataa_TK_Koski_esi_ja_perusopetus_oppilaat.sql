...
CREATE OR ALTER PROC [dbo].[p_lataa_TK_Koski_esi_ja_perusopetus_oppilaat] AS

/*
Kokoaa tiedot jäädytyspalvelimella populoiduista välitauluista. 
Lisää ja päivitä ylimmäksi uusi vuosi. 
HUOM. Sisältää s24 alkaen kaksi poimintaa. 
s26 alkaen voisi siirtyä delete-insertiin ja vain tuoreimpaan vuoteen (historiasta johtuen ei ehkä dynaamista)
*/

TRUNCATE TABLE dbo.TK_Koski_esi_ja_perusopetus_oppilaat
;
...
--2/2: Päättynyt lukuvuosi (luokalle jääneet; myös 2024 katsotaan 2025 jäädytyksestä)
INSERT dbo.TK_Koski_esi_ja_perusopetus_oppilaat
SELECT 
	[opisk]
    ,[tutk]
