...
/****** Object:  StoredProcedure [sa].[p_lataa_virta_opettajakelpoisuus]    Script Date: 8.7.2022 10:19:17 ******/
SET ANSI_NULLS ON
GO
	...
	FROM (
		SELECT DISTINCT
			...
			CASE 
				...
				WHEN kelpoisuuskoodi1 = 'AI' AND ainepatevyys is not null AND ainepatevyys not in ('gf','ms') THEN 'AI'
			...
			CASE 
				...
				WHEN kelpoisuuskoodi1 = 'ER' AND kelpoisuuskoodi2 = 'AI' THEN
					CASE WHEN pvm1 < pvm2 THEN pvm2 ELSE pvm1 END
				WHEN kelpoisuuskoodi1 = 'AI' AND ainepatevyys is not null AND ainepatevyys not in ('gf','ms') THEN 
		...
		SELECT DISTINCT
			henkilo,
			CASE 
				WHEN d.oppilaitostyyppi_koodi <> 41 AND kelpoisuuskoodi1 = 'AI' THEN 'AI'
				WHEN d.oppilaitostyyppi_koodi = 41 THEN 'LA'
			END as kelpoisuus,
			CASE 
				WHEN d.oppilaitostyyppi_koodi <> 41 AND aine_pvm <= pvm1 AND kelpoisuuskoodi1 = 'AI' then pvm1
				WHEN d.oppilaitostyyppi_koodi <> 41 AND aine_pvm > pvm1 AND kelpoisuuskoodi1 = 'AI' then aine_pvm
				WHEN d.oppilaitostyyppi_koodi = 41 then aine_pvm 
			END as pvm,
