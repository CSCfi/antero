...
/****** Object:  StoredProcedure [dw].[p_lataa_f_arvo_yo_uraseuranta_2018]    Script Date: 5.3.2026 16.02.20 ******/
SET ANSI_NULLS ON
GO
...
SELECT  
	...
	case					
		when kysymysryhma_fi = 'VI TYÖ JA OSAAMINEN (3/3)' then 1.000000 / 6.000000
		else 1.0
