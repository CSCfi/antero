...
CREATE OR ALTER PROCEDURE [dw].[p_lataa_api_amm_myonnetty_rahoitus_esilataus] AS

TRUNCATE TABLE [dw].[api_amm_myonnetty_rahoitus]

INSERT INTO [dw].[api_amm_myonnetty_rahoitus] (
	[defaultorder]
	,[vuosi]
    ,[suoritepaatos]
...
--DROP TABLE [dw].[api_amm_myonnetty_rahoitus]
...
--INTO [AnteroAPI].[dw].[api_amm_myonnetty_rahoitus]
