...
/****** Object:  View [dw].[v_koski_opintojen_kulku_toinen_aste_cultures]    Script Date: 21.3.2025 13.59.45 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR  ALTER VIEW [dw].[v_koski_opintojen_kulku_toinen_aste_cultures] AS 
