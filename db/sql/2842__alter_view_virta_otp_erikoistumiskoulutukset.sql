USE [ANTERO]
GO
/****** Object:  View [dw].[v_virta_otp_erikoistumiskoulutukset]    Script Date: 11.2.2020 14:30:36 ******/
DROP VIEW IF EXISTS [dw].[v_virta_otp_erikoistumiskoulutukset]
GO
/****** Object:  View [dw].[v_virta_otp_erikoistumiskoulutukset]    Script Date: 11.2.2020 14:30:36 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dw].[v_virta_otp_erikoistumiskoulutukset] AS
