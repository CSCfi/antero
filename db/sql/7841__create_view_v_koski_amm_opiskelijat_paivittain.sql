...
/****** Object:  View [dw].[v_koski_amm_opiskelijat_paivittain]    Script Date: 7.7.2023 9:24:57 ******/
DROP VIEW IF EXISTS [dw].[v_koski_amm_opiskelijat_paivittain]
GO
...
CREATE VIEW [dw].[v_koski_amm_opiskelijat_paivittain] AS
...
SELECT
	...
	-- Koulutusmuuttujat
	,d7.selite_fi as 'Suorituksen tyyppi'
	,f.d_tutkintotyyppi_id as 'Tutkintotyyppi'
	...
	,d7.jarjestys as 'Järjestys Suorituksen tyyppi'
	,f.jarj_tutkintotyyppi as 'Järjestys Tutkintotyyppi'
...
FROM [ANTERO].[dw].[f_koski_amm_opiskelijat_paivittain] f
...
LEFT JOIN [ANTERO].[dw].[d_suorituksen_tyyppi] d7 ON d7.id = f.d_suorituksen_tyyppi_id
