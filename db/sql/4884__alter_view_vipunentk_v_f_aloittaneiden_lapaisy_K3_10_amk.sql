...
/****** Object:  View [dbo].[v_f_aloittaneiden_lapaisy_K3_10_amk]    Script Date: 20.9.2021 22:33:01 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
		...
		Case 
			when d7.koulutusaste2002_koodi='62' or d7.Koulutusaste_taso2_koodi='62' then 'Aloitus I syklin tutkinnossa' 
			when d7.koulutusaste2002_koodi='71' or d7.Koulutusaste_taso2_koodi='71' then 'Aloitus II syklin tutkinnossa'  
			else 'Tuntematon' 
		...
		f.[9a Aloittaneiden opintojen kulku koulutusalan, taso 1 mukaan prioriteettina mikä tahansa tutkinto] AS [Opintojen kulku koul.aloittain, taso 1], 
		f.[9b Aloittaneiden opintojen kulku koulutusalan, taso 1 mukaan prioriteettina tutkinto ja opiskelu alkuperäisellä] AS [Opintojen kulku koul.aloittain, taso 1 prioriteetti 2], 
		...
		f.[10a Aloittaneiden opintojen kulku koulutusalan, taso 2 mukaan prioriteettina mikä tahansa tutkinto] AS [Opintojen kulku koul.aloittain, taso 2], 
		f.[10b Aloittaneiden opintojen kulku koulutusalan, taso 2 mukaan prioriteettina tutkinto ja opiskelu alkuperäisellä] AS [Opintojen kulku koul.aloittain, taso 2 prioriteetti 2], 
		...
		f.[11a Aloittaneiden opintojen kulku koulutusalan, taso 3 mukaan prioriteettina mikä tahansa tutkinto] AS [Opintojen kulku koul.aloittain, taso 3], 
		f.[11b Aloittaneiden opintojen kulku koulutusalan, taso 3 mukaan prioriteettina tutkinto ja opiskelu alkuperäisellä] AS [Opintojen kulku koul.aloittain, taso 3 prioriteetti 2], 
		...
		Case 
			when d7.koulutusaste2002_koodi='62' or d7.Koulutusaste_taso2_koodi='62' then 'Påbörjande i I-skedets examen' 
			when d7.koulutusaste2002_koodi='71' or d7.Koulutusaste_taso2_koodi='71' then 'Påbörjande i II-skedets examen'  
			else 'Okänt' 
		end AS [Startskede], 
		...
		Case 
			when d7.koulutusaste2002_koodi='62' or d7.Koulutusaste_taso2_koodi='62' then 'Beginning of studies in cycle I degree' 
			when d7.koulutusaste2002_koodi='71' or d7.Koulutusaste_taso2_koodi='71' then 'Beginning of studies in cycle II degree'  
			else 'Unknown' 
...
WHERE aineistokoodi = 'K3.10' 
	AND d10.lahde_koodi = '41'
	AND d1.lukuvuosi not in ('1999/2000','2000/2001','2001/2002')
