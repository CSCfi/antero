USE [VipunenTK_DW]
GO
/****** Object:  View [dbo].[v_f_R4_23_Tyollisten_ammattisiirtymat]    Script Date: 9.3.2018 14:16:28 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[v_f_R4_23_Tyollisten_ammattisiirtymat]'))
...
CREATE VIEW [dbo].[v_f_R4_23_Tyollisten_ammattisiirtymat] AS
