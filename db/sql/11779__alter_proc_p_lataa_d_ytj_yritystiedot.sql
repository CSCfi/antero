...
CREATE OR ALTER PROCEDURE [dw].[p_lataa_d_ytj_yritystiedot] AS

DECLARE @pvm datetime = getdate()
...
BEGIN
	...
	UPDATE t
	SET ytunnus_raportointiin = CONVERT(VARCHAR(64), HASHBYTES('SHA2_256', CONCAT([ytunnus], @pvm)), 2)
