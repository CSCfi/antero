...
1. TOTEUMA
	...
	e) kirjoitetaan talteen käytettäväksi API-tietojoukon runkona
...
DECLARE @t decimal(30,29) --varainhoitovuosikohtainen tasauskerroin
...
--opiskelijavuodet
UPDATE f
SET [painotetut_opv_lahtotaso_hyv_ka] = v.painotetut_opv_lahtotaso_hyv_ka
	,[painotetut_opv_kr_hyv_ka] = v.painotetut_opv_kr_hyv_ka
	,[painotetut_opv_lahtotaso_hyv_ka_osuus] = v.painotetut_opv_lahtotaso_hyv_ka_osuus
...
UPDATE f
SET [painotetut_tutk_ja_osp_hyv_ka] = v.painotetut_tutk_ja_osp_hyv_ka
	,[painotetut_tutk_ja_osp_hyv_ka_osuus] = v.painotetut_tutk_ja_osp_hyv_ka_osuus
FROM [dw].[f_amos_koonti_rahoitusperusteet] f
...
UPDATE f
SET [tyoll_ja_jatkoopisk_ei_tyoll_ennen_koul_ka] = v.tyoll_ja_jatkoopisk_ei_tyoll_ennen_koul_ka
	,[tyoll_ja_jatkoopisk_ei_tyoll_ennen_koul_ka_osuus] = v.tyoll_ja_jatkoopisk_ei_tyoll_ennen_koul_ka_osuus
FROM [dw].[f_amos_koonti_rahoitusperusteet] f
...
--työelämäpalaute
UPDATE f
SET [tyopaikkakysely_pisteet] = v.tyopaikkakysely_pisteet
	,[tyopaikkaohjaajakysely_painotetut_pisteet] = v.tyopaikkaohjaajakysely_painotetut_pisteet
	,[tyopaikkakysely_pisteet_osuus] = v.tyopaikkakysely_pisteet_osuus
...
--opiskelijapalaute
UPDATE f
SET [aloituskysely_painotetut_pisteet] = v.aloituskysely_painotetut_pisteet
	,[paattokysely_painotetut_pisteet] = v.paattokysely_painotetut_pisteet
	,[aloituskysely_painotetut_pisteet_osuus] = v.aloituskysely_painotetut_pisteet_osuus
...
--1.e) kirjoitetaan talteen käytettäväksi API-tietojoukon runkona
drop table if exists anteroapi.dw.api_amm_rahoitus_yhteenvetotaulukko

select 
	generoitu = 0
	,f.* 
into anteroapi.dw.api_amm_rahoitus_yhteenvetotaulukko
from [dw].[f_amos_koonti_rahoitusperusteet] f
;
...
--2.e) kirjoitetaan talteen käytettäväksi API-tietojoukon runkona
insert anteroapi.dw.api_amm_rahoitus_yhteenvetotaulukko
select 
	generoitu = 1
	,f.* 
from [dw].[f_amos_koonti_rahoitusperusteet] f
where f.Varainhoitovuosi = @maxVuosi
;
