...
/****** Object:  StoredProcedure [dw].[p_lataa_f_haku_ja_valinta_aloituspaikat_ja_pistemaarat]    Script Date: 23.12.2021 11:55:41 ******/
SET ANSI_NULLS ON
GO
...
WHERE d1.hakukohde_tila = 'JULKAISTU'
and (d1.tila = 'JULKAISTU' OR (d1.tila='VALMIS' AND d11.kohdejoukontarkenne_fi = 'Jatkotutkintohaku'))
