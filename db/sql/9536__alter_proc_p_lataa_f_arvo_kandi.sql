...
/****** Object:  StoredProcedure [dw].[p_lataa_f_arvo_kandi]    Script Date: 29.1.2024 8:40:32 ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT
	...
	,coalesce(d17.id,-1) AS d_arvovastaus_monivalinta_id
...
and concat(d4.id, '_', d3.id) not in (SELECT avain FROM ANTERO.dbo.arvo_kandi_temp)
