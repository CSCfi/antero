USE [VipunenTK_SA]
GO
/****** Object:  StoredProcedure [dbo].[p_lataa_TK_Koski_lukio_ainevalinnat_suorittaneet]    Script Date: 31.1.2022 11:27:04 ******/
SET ANSI_NULLS ON
GO
...
--henkilö
,[sukupuoli_koodi] = coalesce(h2.sukupuoli,
	case 
...
LEFT JOIN ' + @linkedServerPrefix + '[Koski_SA].[sa].[sa_koski_henkilo] h2 on h2.[oppija_oid] = oo.[oppija_oid] --hetuttomille sukupuoli-tieto purettu vasta 2021
