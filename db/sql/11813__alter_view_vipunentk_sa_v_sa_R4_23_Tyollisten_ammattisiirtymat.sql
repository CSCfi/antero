...
/****** Object:  View [dbo].[v_sa_R4_23_Tyollisten_ammattisiirtymat]    Script Date: 25.3.2026 12.14.34 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
      ...
      ,[tutklaja] = null
      ,[opkelp] = null
      ,[ptoim1r9_s] = [ptoim1r9_2023]
      ,[tmaak_se] = [tmaak_2023]
      ,[tol2008_2_s] = [tol2008_2_2023]
      ,[amm2010_m2_s] = null
	  ,[amm2010_oef2_s] = [amm2010_oef2_2023]
      ,[opmast_2_s] = null
	  ,[kaste_t2_2_2023]
      ,[opmopa_s] = null
	  ,[iscfinarrow2013_s] = [iscfinarrow2013_2023]
      ,[tutklaja_s] = null
      ,[opkelp_s] = null
	  ,[erik_s] = null
	  ,[erik_amk_s] = null
      ...
      ,[suhteellinen_ajankohta_avain] =  
		CASE 
		 WHEN tilv = 2018 THEN 'tilv+5'
		 WHEN tilv = 2022 THEN 'tilv+1'
		 ELSE '-1'		 
		END
	  ,[tietolahde]='R4_23_sopv_25'
FROM [TK_H9098_CSC].[dbo].[TK_K4_23_sopv_25]
