USE [VipunenTK_DW]
GO
/****** Object:  StoredProcedure [dbo].[p_lataa_K_f_3_11]    Script Date: 23.10.2017 17:54:09 ******/
SET ANSI_NULLS ON
GO
...
/* Tämä ehto hidasti kyselyä liikaa, joten tehdään valinta jo SA-kannan näkymässä, jossa ennakkoaineisto kommentoidaan pois sitten kun lopullinen aineisto on käytettävissä.
