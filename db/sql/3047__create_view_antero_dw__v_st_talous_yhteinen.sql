...
/****** Object:  View [dw].[v_st_talous_yhteinen]     Script Date: 6.5.2020 23:49:28 ******/
DROP VIEW IF EXISTS [dw].[v_st_talous_yhteinen]
GO
...
CREATE VIEW [dw].[v_st_talous_yhteinen] AS
SELECT 
...
SELECT 
  ...
  ,tilikausi AS 'Tilastovuosi'
  ,CASE WHEN konserni = 'E' THEN 'Ei' ELSE 'Kyllä' END AS Konserni
  ,d1.amk_nimi_fi AS 'Korkeakoulu'
  ,NULL
  ,NULL
  ,d2.ohjauksenala_nimi_fi AS 'Ohjauksenala'

   ,tilikausi AS 'Statistikår'
  ,d1.amk_nimi_sv AS 'Högskola'
  ,NULL
  ,NULL
  ,d2.ohjauksenala_nimi_sv AS 'Utbildningsområde'

  ,tilikausi AS 'Statistical year'
  ,d1.amk_nimi_en AS 'Higher educational institute'
  ,NULL
  ,NULL
  ,d2.ohjauksenala_nimi_en AS 'Field of education'

  ,d1.amk_tunnus AS 'Koodit_korkeakoulu'
  ,NULL
  ,NULL
