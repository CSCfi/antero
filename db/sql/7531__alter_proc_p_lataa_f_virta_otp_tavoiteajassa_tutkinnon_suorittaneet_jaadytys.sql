...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_tavoiteajassa_tutkinnon_suorittaneet_jaadytys]    Script Date: 30.3.2023 15:25:42 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	' WHERE (' + cast(@alkuVuosi as nvarchar(4)) + ' = 2020 and d10a.vuosi < 2021) OR (' + cast(@alkuVuosi as nvarchar(4)) + ' > 2020 and d10a.vuosi = ' + cast(@alkuVuosi as nvarchar(4)) +')'
