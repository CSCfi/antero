...
/****** Object:  View [dw].[v_virta_otp_tavoiteajassa_tutkinnon_suorittaneet_cultures]    Script Date: 18.9.2026 13.04.36 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW  [dw].[v_virta_otp_tavoiteajassa_tutkinnon_suorittaneet_cultures] AS 
...
SELECT  
	...
	, sektori_fi							= CASE WHEN d2.koulutusluokitus_koodi in ('662151','751303', '655303')  THEN 'Yliopistokoulutus' ELSE d2.koulutussektori_fi END
	...
	, rahoitusmallialat_amk_2021_2024_fi	= coalesce(d10.Ammattikorkeakoulut_tutkintotavoitteet, 'Tieto puuttuu')			 
	, rahoitusmallialat_yo_2021_2024_fi		= coalesce(d10.Yliopistot_tutkintotavoitteet2021, 'Tieto puuttuu')
	...
	, sektori_sv							= CASE WHEN d2.koulutusluokitus_koodi in ('662151','751303', '655303') THEN 'Universitetsutbildning' ELSE d2.koulutussektori_sv END
	...
	, rahoitusmallialat_amk_2021_2024_sv	= coalesce(d10.Ammattikorkeakoulut_tutkintotavoitteet_SV, 'Information saknas')			 
	, rahoitusmallialat_yo_2021_2024_sv		= coalesce(d10.Yliopistot_tutkintotavoitteet2021_SV, 'Information saknas')
	...
	, sektori_en							= CASE WHEN d2.koulutusluokitus_koodi in ('662151','751303', '655303')  THEN 'University education' ELSE d2.koulutussektori_en END
	...
	, rahoitusmallialat_amk_2021_2024_en	= coalesce(d10.Ammattikorkeakoulut_tutkintotavoitteet_EN, 'Missing data')		 
	, rahoitusmallialat_yo_2021_2024_en		= coalesce(d10.Yliopistot_tutkintotavoitteet2021_EN, 'Missing data')
	...
	, apusarake_henkilokoodi = HASHBYTES('SHA2_256', vs.salt + f.apusarake_henkilokoodi)		
...
INNER JOIN ANTERO.dbo.view_salt vs on vs.[view] = 'v_virta_otp_tavoiteajassa_tutkinnon_suorittaneet_cultures'