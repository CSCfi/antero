...
/****** Object:  View [dw].[v_koski_tuva_opiskelijat_kuukausittainen_cultures]    Script Date: 16.11.2023 11:52:56 ******/
SET ANSI_NULLS ON
GO
...
SELECT --top 1000
	...
	,oppivelvollinen_20_9_fi									= d16.kytkin_fi
	...
	,oppivelvollinen_20_9_sv									= d16.kytkin_sv
...
LEFT JOIN [ANTERO].[dw].[d_kytkin] d15 ON d15.kytkin_koodi = f.oppivelvollinen_kk
LEFT JOIN [ANTERO].[dw].[d_kytkin] d16 ON d16.kytkin_koodi = f.oppivelvollinen_20_9
