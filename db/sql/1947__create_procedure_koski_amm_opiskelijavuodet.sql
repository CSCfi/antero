...
BEGIN
	...
	FROM (
		...
		SELECT 
			...
			,k2.koulutusluokitus_koodi AS koulk --näyttötutkintoon valmistavalle koulutukselle haetaan "oikea" tutkintokoodi
		...
		LEFT JOIN [dw].[d_koulutusluokitus] k2 ON k2.koulutusluokitus_koodi=(CASE WHEN k.koulutusluokitus_koodi like '3%' and k.koulutusluokitus_fi like '%erikoisammattitutkinto%' THEN '4' + RIGHT(k.koulutusluokitus_koodi,LEN(k.koulutusluokitus_koodi)-1) ELSE k.koulutusluokitus_koodi END) --erikoiskäsittely erikoisammattitutkinnoille, joilla on vanha 3-alkuinen koodi
