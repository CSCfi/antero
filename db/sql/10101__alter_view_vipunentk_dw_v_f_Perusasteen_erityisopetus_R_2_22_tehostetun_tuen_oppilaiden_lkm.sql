...
/****** Object:  View [dbo].[v_f_Perusasteen_erityisopetus_R_2_22_tehostetun_tuen_oppilaiden_lkm]    Script Date: 12.9.2024 13:12:33 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
  ...
  tehostetun_tuen_oppilaat=tehoesin
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv>2020 and tehoesin>0
...
SELECT 
  ...
  perusopetuksen_tehostettu_tuki='ertu_teho',
  tehostetun_tuen_oppilaat=teho16n
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv>2020 and teho16n>0
...
SELECT 
  ...
  perusopetuksen_tehostettu_tuki='ertu_teho',
  tehostetun_tuen_oppilaat=teho79n
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki] 
WHERE tilv>2020 and teho79n>0
...
SELECT 
  ...
  perusopetuksen_tehostettu_tuki='ertu_teho',
  tehostetun_tuen_oppilaat=teholisan
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv>2020 and teholisan>0
...
SELECT 
  ...
  perusopetuksen_vuosiluokat='lk0',
  perusopetuksen_tehostettu_tuki='ertu_teho',
  tehostetun_tuen_oppilaat=tehoesim
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv>2020 and tehoesim>0
...
SELECT 
  ...
  perusopetuksen_vuosiluokat='lk1_6',
  perusopetuksen_tehostettu_tuki='ertu_teho',
  tehostetun_tuen_oppilaat=teho16m
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv>2020 and teho16m>0
...
SELECT 
  ...
  perusopetuksen_vuosiluokat='lk7_9',
  perusopetuksen_tehostettu_tuki='ertu_teho',
  tehostetun_tuen_oppilaat=teho79m
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki] 
WHERE tilv>2020 and teho79m>0
...
SELECT 
  ...
  perusopetuksen_vuosiluokat='lk10',
  perusopetuksen_tehostettu_tuki='ertu_teho',
  tehostetun_tuen_oppilaat=teholisam
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv>2020 and teholisam>0
...
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv=2020 and teholisa>0

UNION ALL

--ertu 2020 (sukupuolet yhteensä)
SELECT 
  tilv,
  tunn,
  tiedtype = null,
...
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv=2020 and ertulisa>0

UNION ALL

--kaatoluokat 2020 (sukupuolet yhteensä)
SELECT 
  tilv,
  tunn,
  tiedtype = null,
  ...
  tehostetun_tuen_oppilaat=ove-tehoesi-ertuesi
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv=2020 and ove-tehoesi-ertuesi>0
...
SELECT 
  ...
  perusopetuksen_vuosiluokat='lk1_6',
  perusopetuksen_tehostettu_tuki='ertu_ei',
  tehostetun_tuen_oppilaat=ov16-teho16-ertu16
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv=2020 and ov16-teho16-ertu16>0
...
SELECT 
  ...
  perusopetuksen_vuosiluokat='lk7_9',
  perusopetuksen_tehostettu_tuki='ertu_ei',
  tehostetun_tuen_oppilaat=ov79-teho79-ertu79
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv=2020 and ov79-teho79-ertu79>0
...
SELECT 
  ...
  perusopetuksen_vuosiluokat='lk10',
  perusopetuksen_tehostettu_tuki='ertu_ei',
  tehostetun_tuen_oppilaat=ovlisa-teholisa-ertulisa
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv=2020 and ovlisa-teholisa-ertulisa>0


UNION ALL

--ertu > 2021 (sukupuolittain)
SELECT 
  tilv,
  tunn,
  tiedtype = null,
  ...
  perusopetuksen_vuosiluokat='lk0',
  perusopetuksen_tehostettu_tuki='-1',
  tehostetun_tuen_oppilaat=ertuesin
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv>2020 and ertuesin>0
...
SELECT 
  ...
  perusopetuksen_vuosiluokat='lk1_6',
  perusopetuksen_tehostettu_tuki='-1',
  tehostetun_tuen_oppilaat=ertu16n
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv>2020 and ertu16n>0
...
SELECT 
  ...
  perusopetuksen_vuosiluokat='lk7_9',
  perusopetuksen_tehostettu_tuki='-1',
  tehostetun_tuen_oppilaat=ertu79n
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki] 
WHERE tilv>2020 and ertu79n>0
...
SELECT 
  ...
  perusopetuksen_vuosiluokat='lk10',
  perusopetuksen_tehostettu_tuki='-1',
  tehostetun_tuen_oppilaat=ertulisan
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv>2020 and ertulisan>0
...
SELECT 
  ...
  perusopetuksen_vuosiluokat='lk0',
  perusopetuksen_tehostettu_tuki='-1',
  tehostetun_tuen_oppilaat=ertuesim
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv>2020 and ertuesim>0
...
SELECT 
  ...
  perusopetuksen_vuosiluokat='lk1_6',
  perusopetuksen_tehostettu_tuki='-1',
  tehostetun_tuen_oppilaat=ertu16m
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv>2020 and ertu16m>0
...
SELECT 
  ...
  perusopetuksen_vuosiluokat='lk7_9',
  perusopetuksen_tehostettu_tuki='-1',
  tehostetun_tuen_oppilaat=ertu79m
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki] 
WHERE tilv>2020 and ertu79m>0
...
SELECT 
  ...
  perusopetuksen_vuosiluokat='lk10',
  perusopetuksen_tehostettu_tuki='-1',
  tehostetun_tuen_oppilaat=ertulisam
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv>2020 and ertulisam>0


UNION ALL

--kaatoluokat > 2020 (sukupuolittain)
SELECT 
  tilv,
  tunn,
  tiedtype = null,
  ...
  perusopetuksen_vuosiluokat='lk0',
  perusopetuksen_tehostettu_tuki='ertu_ei',
  tehostetun_tuen_oppilaat=oven-tehoesin-ertuesin
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv>2020 and oven-tehoesin-ertuesin>0
...
SELECT 
  ...
  perusopetuksen_vuosiluokat='lk1_6',
  perusopetuksen_tehostettu_tuki='ertu_ei',
  tehostetun_tuen_oppilaat=ov16n-teho16n-ertu16n
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv>2020 and ov16n-teho16n-ertu16n>0
...
SELECT 
  ...
  perusopetuksen_vuosiluokat='lk7_9',
  perusopetuksen_tehostettu_tuki='ertu_ei',
  tehostetun_tuen_oppilaat=ov79n-teho79n-ertu79n
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv>2020 and ov79n-teho79n-ertu79n>0
...
SELECT 
  ...
  perusopetuksen_vuosiluokat='lk10',
  perusopetuksen_tehostettu_tuki='ertu_ei',
  tehostetun_tuen_oppilaat=ovlisan-teholisan-ertulisan
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv>2020 and ovlisan-teholisan-ertulisan>0
...
SELECT 
  ...
  perusopetuksen_vuosiluokat='lk0',
  perusopetuksen_tehostettu_tuki='ertu_ei',
  tehostetun_tuen_oppilaat=ovem-tehoesim-ertuesim
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv>2020 and ovem-tehoesim-ertuesim>0
...
SELECT 
  ...
  perusopetuksen_vuosiluokat='lk1_6',
  perusopetuksen_tehostettu_tuki='ertu_ei',
  tehostetun_tuen_oppilaat=ov16m-teho16m-ertu16m
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv>2020 and ov16m-teho16m-ertu16m>0
...
SELECT 
  ...
  perusopetuksen_vuosiluokat='lk7_9',
  perusopetuksen_tehostettu_tuki='ertu_ei',
  tehostetun_tuen_oppilaat=ov79m-teho79m-ertu79m
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv>2020 and ov79m-teho79m-ertu79m>0
...
SELECT 
  ...
  perusopetuksen_vuosiluokat='lk10',
  perusopetuksen_tehostettu_tuki='ertu_ei',
  tehostetun_tuen_oppilaat=ovlisam-teholisam-ertulisam
FROM [VipunenTK_SA].[dbo].[v_sa_2_22c_peruskoulujen_erityinen_tuki]
WHERE tilv>2020 and ovlisam-teholisam-ertulisam>0
