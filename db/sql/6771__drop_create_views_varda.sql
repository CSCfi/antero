/****** Object:  View [dw].[v_varda_vakajarjestajat_toimipaikat]    Script Date: 20.12.2022 10:40:38 ******/
SET ANSI_NULLS ON
GO
...
select
	...
	group by
	va.tilastointivuosi, al.kunta_fi, al.kunta_en, al.kunta_sv, al.maakunta_fi, al.maakunta_en, al.maakunta_sv, al.kunta_koodi, va.ika,
	case
