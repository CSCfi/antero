...
/****** Object:  StoredProcedure [dbo].[p_lataa_AP_f_2_1_R2_22_Peruskoulutiedosto_kieltenmaara_oppilasmaarat]    Script Date: 11.7.2023 16:46:29 ******/
SET ANSI_NULLS ON
GO
...
/*
Poistettu latauksesta ainevalintafaktan populoinnit, koska raskas eikä enää tule uusia tietoja. Tarvittaessa vapauta tai ks. vanha versio ohessa. JS 11.7.2023
*/
...
SELECT tilv, tilv_date, 'lk1', tunn, NULL, NULL, lkm_arvo, '-1', NULL, 'muuttuja ov1n' 
FROM [VipunenTK_DW].[dbo].[f_Ainevalinnat_R2_22_Oppilaitostason_oppil_ja_opisk] 
WHERE lkm_id='ov1n'
...
SELECT tilv, tilv_date, 'lk1', tunn, NULL
	, f1.lkm_arvo 
		- ISNULL(
			(
				SELECT lkm_arvo 
				FROM [VipunenTK_DW].[dbo].[f_Ainevalinnat_R2_22_Oppilaitostason_oppil_ja_opisk] f2 
				WHERE lkm_id='ov1n' AND f2.rivinumero=f1.rivinumero and f2.tilv=f1.tilv
			)
			, 0
		)
	, NULL, '-1', NULL, 'muuttuja ov1 , rivi 189' 
 FROM [VipunenTK_DW].[dbo].[f_Ainevalinnat_R2_22_Oppilaitostason_oppil_ja_opisk] f1 
 WHERE f1.lkm_id='ov1 ' 
