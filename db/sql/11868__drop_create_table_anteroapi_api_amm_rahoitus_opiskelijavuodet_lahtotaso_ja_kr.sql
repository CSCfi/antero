...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dw].[api_amm_rahoitus_opiskelijavuodet_lahtotaso_ja_kr]') AND type in (N'U'))
DROP TABLE [dw].[api_amm_rahoitus_opiskelijavuodet_lahtotaso_ja_kr]
GO
