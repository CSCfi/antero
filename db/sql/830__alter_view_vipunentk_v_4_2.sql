...
/****** Object:  View [dbo].[v_f_vaeston_koulutusrakenne_ja_paaasiallinen_toiminta]    Script Date: 11.10.2017 17:28:59 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_f_vaeston_koulutusrakenne_ja_paaasiallinen_toiminta]
AS
...
FROM dbo.f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta F
	  ...
	  WHERE aineisto = 
(case 
	when NOT EXISTS (SELECT 1 FROM dbo.f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta o WHERE o.aineisto='L' and o.tilastointivuosi=f.tilastointivuosi) then 'P' 
	else 'L' 
end)
