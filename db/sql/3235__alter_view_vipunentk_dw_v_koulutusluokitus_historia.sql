...
/****** Object:  View [dbo].[v_koulutusluokitus_historia]    Script Date: 2.9.2020 16:25:40 ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT d_koulutusluokitus.[id]
	  ...
	  --rahoitusmallialaluokitukset 2021-
...
SELECT DISTINCT [VipunenTK_lisatiedot].[dbo].[koulutusluokitus].[id]
      ...
      ,[VipunenTK_lisatiedot].[dbo].[koulutusluokitus].[tietolahde]
	   ...
	   --rahoitusmallialaluokitukset 2021-
	  ,[jarjestys_OKM_ohjauksen_ala_yo_tav2021] = ktpo.[jarjestys_Yliopistot_tutkintotavoitteet2021]
	  ,[OKM_ohjauksen_ala_yo_tav2021_koodi] = ktpo.[Yliopistot_tutkintotavoitteet2021_koodi]
	  ,[OKM_ohjauksen_ala_yo_tav2021] = ktpo.[Yliopistot_tutkintotavoitteet2021]
	  ,[OKM_ohjauksen_ala_yo_tav2021_SV] = ktpo.[Yliopistot_tutkintotavoitteet2021_SV]
	  ,[OKM_ohjauksen_ala_yo_tav2021_EN] = ktpo.[Yliopistot_tutkintotavoitteet2021_EN]
