...
/****** Object:  View [dbo].[v_f_tab_keskeytaneet_lukio]    Script Date: 24.11.2021 20:01:01 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_f_tab_keskeytaneet_lukio] AS
...
,d1_75.opintojen_kulku_kala_t1n_mukaan_versio2 AS 'Opintojen kulku 2bb, koul.ala taso 1'
,d2_75.opintojen_kulku_kala_t2n_mukaan_versio2 AS 'Opintojen kulku 2bb, koul.ala taso 2'
,d3_75.opintojen_kulku_kala_t3n_mukaan_versio2 AS 'Opintojen kulku 2bb, koul.ala taso 3'
...
,d1_75.opintojen_kulku_kala_t1n_mukaan_versio2_SV AS 'Studieförlopp (utb.område 1)'
,d2_75.opintojen_kulku_kala_t2n_mukaan_versio2_SV AS 'Studieförlopp (utb.område 2)'
,d3_75.opintojen_kulku_kala_t3n_mukaan_versio2_SV AS 'Studieförlopp (utb.område 3)'
...
,d1_75.opintojen_kulku_kala_t1n_mukaan_versio2_EN AS 'Progress of studies (level of ed. 1)'
,d2_75.opintojen_kulku_kala_t2n_mukaan_versio2_EN AS 'Progress of studies (level of ed. 2)'
,d3_75.opintojen_kulku_kala_t3n_mukaan_versio2_EN AS 'Progress of studies (level of ed. 3)'
...
,d1_75.jarjestys_2bb_t1
,d2_75.jarjestys_2bb_t2
,d3_75.jarjestys_2bb_t3
--vanhat
,d33.jarjestys_1a
,d34.jarjestys_1b
,d35.jarjestys_1c
...
FROM dbo.f_keskeyttaneet
	...
	JOIN d_opintojen_kulku_kala_t1n_mukaan_versio2 d1_75 ON d1_75.id = [2bb_opiskelijoiden_opintojen_kulku_kala_t1_mukaan_id]
	JOIN d_opintojen_kulku_kala_t2n_mukaan_versio2 d2_75 ON d2_75.id = [2bb_opiskelijoiden_opintojen_kulku_kala_t2_mukaan_id]
	JOIN d_opintojen_kulku_kala_t3n_mukaan_versio2 d3_75 ON d3_75.id = [2bb_opiskelijoiden_opintojen_kulku_kala_t3_mukaan_id]
	--vanhat
...
WHERE d16.koulutusaste2002_koodi = 31 or d16.Koulutusaste_taso2_koodi = 31
