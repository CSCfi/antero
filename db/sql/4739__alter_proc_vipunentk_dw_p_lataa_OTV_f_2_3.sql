USE [VipunenTK_DW]
GO
/****** Object:  StoredProcedure [dbo].[p_lataa_OTV_f_2_3]    Script Date: 9.8.2021 22:15:15 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN VipunenTK..d_ika AS d16 ON d16.ika_avain=f.ika_1v
LEFT JOIN VipunenTK..d_ika AS d16b ON d16b.ika_avain='kirikar1'+coalesce(f.ika_5v,'')
