...
/****** Object:  View [dw].[v_virta_otp_kvliikkuvuus]    Script Date: 21.9.2026 10.30.22 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	...
	,d15.lukukausi_fi as 'Liikkuvuusjakson alkamislukukausi'
	,d16.kytkin_fi as 'Virtuaalinen osio'
    ...
    ,HASHBYTES('SHA2_256', vs.salt + f.opiskeluoikeusavain) as opiskeluoikeusavain
    ,HASHBYTES('SHA2_256', vs.salt + f.liikkuvuusjaksoavain) as liikkuvuusjaksoavain
    ,f.jaksoAlkupvm
    ,f.jaksoLoppupvm
    ,f.kesto
    ,f.lukumaara
	...
	,d15.lukukausi_sv as 'Begynnelsetermin av mobilitet'
	,d16.kytkin_sv as 'Virtuell del'
	...
	,d15.lukukausi_fi as jarjestys_lukukausi
  ...
  INNER JOIN dbo.view_salt vs on vs.[view] = 'v_virta_otp_kvliikkuvuus'