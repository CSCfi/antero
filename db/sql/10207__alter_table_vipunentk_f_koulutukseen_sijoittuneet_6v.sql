...
/****** Object:  Table [dbo].[f_koulutukseen_sijoittuneet_6v]    Script Date: 10.10.2024 12:19:34 ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [dbo].[f_koulutukseen_sijoittuneet_6v]  WITH CHECK ADD  CONSTRAINT [FK_f_koulutukseen_sijoittuneet6v_tj0_koulutus] FOREIGN KEY([tj0_koul_luokitus_id])
REFERENCES [dbo].[d_koulutusluokitus] ([id])
GO

ALTER TABLE [dbo].[f_koulutukseen_sijoittuneet_6v] CHECK CONSTRAINT [FK_f_koulutukseen_sijoittuneet6v_tj0_koulutus]
GO
