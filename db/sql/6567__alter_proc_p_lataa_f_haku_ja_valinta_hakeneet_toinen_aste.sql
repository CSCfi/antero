...
/****** Object:  StoredProcedure [dw].[p_lataa_f_haku_ja_valinta_hakeneet_toinen_aste]    Script Date: 12.10.2022 15:10:29 ******/
SET ANSI_NULLS ON
GO
...
henkilo_oid,
hakemus_oid,
sa_haku_ja_valinta_vuosikello_toinen_aste_id,
d_sukupuoli_id,
...
d_kytkin_ammatillinen_perustutkinto_erityisopetuksena_id,
...
d0.id as sa_haku_ja_valinta_vuosikello_toinen_aste_id,
...
case when f.PohjakoulutuksenSuoritusvuosi = '0' or f.PohjakoulutuksenSuoritusvuosi is null then '0' else cast(f.PohjakoulutuksenSuoritusvuosi as nvarchar) end as pohjakoulutuksen_paattovuosi,
coalesce(d7.id,'-1') as d_pohjakoulutus_id,
coalesce(d21.id,'-1') as d_kytkin_kiinnostunut_oppisopimuksesta_id,
coalesce(d24.id,'-1') as d_kytkin_ammatillinen_perustutkinto_erityisopetuksena_id,
...
left join sa.sa_haku_ja_valinta_vuosikello_toinen_aste d0 on d0.haku_oid=d10.haku_oid and d0.haku_oid is not null and @loadtime >= d0.hakijat
...
left join dw.d_kytkin d24 on d11.ammatillinen_perustutkinto_erityisopetuksena=d24.kytkin_koodi
