...
/****** Object:  View [dw].[v_virta_otp_opiskelija_ja_tutkinto_ennakko]    Script Date: 1.11.2024 11:09:10 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	...
	CASE
		...
		WHEN d2.koulutusastetaso2_koodi = 72 and f.tilastovuosi = f.aloitusvuosi and d2.okmohjauksenala_fi = 'Lääketieteet' THEN 'I sykli'
