...
/****** Object:  View [dw].[v_arvo_amis_tep_cultures_pbi]    Script Date: 29.5.2026 13.35.59 ******/
SET ANSI_NULLS ON
GO
...
--EN
	...
	,d11.ytunnus_raportointiin					AS 'koodit_tyopaikka' --koodit_yritys_yhteiso (ei saa viedä kuutioon)
	...
	,(select max(d.kysymysjarjestys) from dw.d_arvokysymys d where d.kysymys_fi=d4.kysymys_fi) AS 'jarjestys_kysymys'
