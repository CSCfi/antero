...
ALTER TABLE [dw].[f_koski_oppivelvollisten_opintojen_kulku] DROP CONSTRAINT [DF__f_koski_oppivelvollisten_opintojen_kulku__username__531856C7]
GO

ALTER TABLE [dw].[f_koski_oppivelvollisten_opintojen_kulku] DROP CONSTRAINT [DF__f_koski_oppivelvollisten_opintojen_kulku__loadtime__5224328E]
GO

/****** Object:  Table [dw].[f_koski_oppivelvollisten_opintojen_kulku]    Script Date: 9.10.2023 13:32:04 ******/
