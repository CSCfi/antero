...
/****** Object:  StoredProcedure [sa].[p_lataa_virta_opettajakelpoisuus]    Script Date: 4.1.2023 13:24:00 ******/
SET ANSI_NULLS ON
GO
...
-- TEMP-tauluun kombinaatiot kelpoisuuskoodeista sekä kelpoisuuskoodien korkeakoulu ja pvm
	select
		pat.henkilo,
	...
	FROM (
		...
		-- Pedagogiset opinnot ilman ainemerkintää
		SELECT DISTINCT
			henkilo,
			'PD' as kelpoisuus,
			pvm1 as pvm,
		...
		-- Ammatillisen opettajankoulutuksen kelpoisuudet, pl. IX
		SELECT DISTINCT
			henkilo,
		...
		-- Luovien alojen opettajien kelpoisuus
		SELECT DISTINCT
			henkilo,
			'LA' as kelpoisuus,
