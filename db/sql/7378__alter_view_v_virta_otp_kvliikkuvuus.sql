...
/****** Object:  View [dw].[v_virta_otp_kvliikkuvuus]    Script Date: 21.2.2023 9:08:22 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	...
	,CASE
		WHEN f.liikkuvuudenluokittelu = 'a' THEN 'Aikuiskoulutus'
		WHEN f.liikkuvuudenluokittelu = 'b' THEN 'Blended'
		ELSE 'Tieto puuttuu'
	END as 'Liikkuvuuden luokittelu'
