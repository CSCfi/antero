...
/****** Object:  View [dbo].[v_f_tab_korkeakouluopiskelijoiden_aikaisempi_koulutus_yliopisto]    Script Date: 9.4.2021 1:15:16 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_f_tab_korkeakouluopiskelijoiden_aikaisempi_koulutus_yliopisto] AS
...
,[aiemman_tutkinnon_yotutk_koulutusala_taso1_sama] as "Pohjakoul. koul.ala 1 sama (lukio)"
,[aiemman_tutkinnon_yotutk_koulutusala_taso2_sama] as "Pohjakoul. koul.ala 2 sama (lukio)"
,[aiemman_tutkinnon_yotutk_koulutusala_taso3_sama] as "Pohjakoul. koul.ala 3 sama (lukio)"
,[aiemman_tutkinnon_yotutk_koulutusaste_taso1_sama] as "Pohjakoul. koul.aste 1 sama (lukio)"
,[aiemman_tutkinnon_yotutk_koulutusaste_taso2_sama] as "Pohjakoul. koul.aste 2 sama (lukio)"
...
,[aiemman_tutkinnon_amm_koulutusala_taso1_sama] as "Pohjakoul. koul.ala 1 sama (amm)"
,[aiemman_tutkinnon_amm_koulutusala_taso2_sama] as "Pohjakoul. koul.ala 2 sama (amm)"
,[aiemman_tutkinnon_amm_koulutusala_taso3_sama] as "Pohjakoul. koul.ala 3 sama (amm)"
,[aiemman_tutkinnon_amm_koulutusaste_taso1_sama] as "Pohjakoul. koul.aste 1 sama (amm)"
,[aiemman_tutkinnon_amm_koulutusaste_taso2_sama] as "Pohjakoul. koul.aste 2 sama (amm)"
...
,[aiemman_tutkinnon_amk_koulutusala_taso1_sama] as "Pohjakoul. koul.ala 1 sama (amk)"
,[aiemman_tutkinnon_amk_koulutusala_taso2_sama] as "Pohjakoul. koul.ala 2 sama (amk)"
,[aiemman_tutkinnon_amk_koulutusala_taso3_sama] as "Pohjakoul. koul.ala 3 sama (amk)"
,[aiemman_tutkinnon_amk_koulutusaste_taso1_sama] as "Pohjakoul. koul.aste 1 sama (amk)"
,[aiemman_tutkinnon_amk_koulutusaste_taso2_sama] as "Pohjakoul. koul.aste 2 sama (amk)"
...
,[aiemman_tutkinnon_ylamk_koulutusala_taso1_sama] as "Pohjakoul. koul.ala 1 sama (ylempi amk)"
,[aiemman_tutkinnon_ylamk_koulutusala_taso2_sama] as "Pohjakoul. koul.ala 2 sama (ylempi amk)"
,[aiemman_tutkinnon_ylamk_koulutusala_taso3_sama] as "Pohjakoul. koul.ala 3 sama (ylempi amk)"
,[aiemman_tutkinnon_ylamk_koulutusaste_taso1_sama] as "Pohjakoul. koul.aste 1 sama (ylempi amk)"
,[aiemman_tutkinnon_ylamk_koulutusaste_taso2_sama] as "Pohjakoul. koul.aste 2 sama (ylempi amk)"
...
,[aiemman_tutkinnon_alkk_koulutusala_taso1_sama] as "Pohjakoul. koul.ala 1 sama (alempi kk)"
,[aiemman_tutkinnon_alkk_koulutusala_taso2_sama] as "Pohjakoul. koul.ala 2 sama (alempi kk)"
,[aiemman_tutkinnon_alkk_koulutusala_taso3_sama] as "Pohjakoul. koul.ala 3 sama (alempi kk)"
,[aiemman_tutkinnon_alkk_koulutusaste_taso1_sama] as "Pohjakoul. koul.aste 1 sama (alempi kk)"
,[aiemman_tutkinnon_alkk_koulutusaste_taso2_sama] as "Pohjakoul. koul.aste 2 sama (alempi kk)"
...
,[aiemman_tutkinnon_ylkk_koulutusala_taso1_sama] as "Pohjakoul. koul.ala 1 sama (ylempi kk)"
,[aiemman_tutkinnon_ylkk_koulutusala_taso2_sama] as "Pohjakoul. koul.ala 2 sama (ylempi kk)"
,[aiemman_tutkinnon_ylkk_koulutusala_taso3_sama] as "Pohjakoul. koul.ala 3 sama (ylempi kk)"
,[aiemman_tutkinnon_ylkk_koulutusaste_taso1_sama] as "Pohjakoul. koul.aste 1 sama (ylempi kk)"
,[aiemman_tutkinnon_ylkk_koulutusaste_taso2_sama] as "Pohjakoul. koul.aste 2 sama (ylempi kk)"
...
,[aiemman_tutkinnon_koulutusala_taso1_sama] as "Pohjakoul. koul.ala 1 sama"
,[aiemman_tutkinnon_koulutusala_taso2_sama] as "Pohjakoul. koul.ala 2 sama"
,[aiemman_tutkinnon_koulutusala_taso3_sama] as "Pohjakoul. koul.ala 3 sama"
,[aiemman_tutkinnon_koulutusaste_taso1_sama] as "Pohjakoul. koul.aste 1 sama"
,[aiemman_tutkinnon_koulutusaste_taso2_sama] as "Pohjakoul. koul.aste 2 sama"
...
WHERE d10.lahde_koodi = '51' 
AND d9.oppilaitoskoodi not in ('02557' , '10031', '02358')
--AND (d21.Koulutusaste_taso2_koodi not in ('73', '81', '82') or d21.koulutusaste2002_koodi not in ('73', '81', '82'))
