...
/****** Object:  View [dw].[v_virta_otp_tavoiteajassa_tutkinnon_suorittaneet]    Script Date: 18.9.2026 12.52.43 ******/
SET ANSI_NULLS ON
GO
...
ALTER  VIEW [dw].[v_virta_otp_tavoiteajassa_tutkinnon_suorittaneet] AS
...
SELECT  
	...
	[Henkilo_koodi] = HASHBYTES('SHA2_256', vs.salt + opiskelijaavain+opiskeluoikeusAvain+d1.organisaatio_koodi),			 
...
INNER JOIN ANTERO.dbo.view_salt vs on vs.[view] = 'v_virta_otp_tavoiteajassa_tutkinnon_suorittaneet'