...
/****** Object:  StoredProcedure [sa].[p_poista_indeksit_arvo_sa]    Script Date: 12.7.2023 18:12:13 ******/
SET ANSI_NULLS ON
GO
...
DROP INDEX IF EXISTS [NC__sa_arvo_vastaukset] ON [sa].[sa_arvo_vastaukset] --kaikki
