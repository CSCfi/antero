...
/****** Object:  View [dbo].[v_sa_R2_22_Oppilaitostason_oppil_ja_opisk]    Script Date: 2.11.2021 9:43:17 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
  ...
  WHERE luokka <> '00' or esi = '2' --or oppilas = '2' --aikuiset vain suorittaneissa, Ahvenanmaa vain oppilaissa
