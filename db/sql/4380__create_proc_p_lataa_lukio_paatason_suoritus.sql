...
/****** Object:  StoredProcedure [sa].[p_lataa_lukio_paatason_suoritus]    Script Date: 29.1.2021 16:26:37 ******/
DROP PROCEDURE IF EXISTS [sa].[p_lataa_lukio_paatason_suoritus]
GO
...
CREATE PROCEDURE [sa].[p_lataa_lukio_paatason_suoritus] AS
