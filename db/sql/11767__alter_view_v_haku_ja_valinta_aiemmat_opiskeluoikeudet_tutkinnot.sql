...
/****** Object:  View [dw].[v_haku_ja_valinta_aiemmat_opiskeluoikeudet_tutkinnot]    Script Date: 17.12.2025 12.37.47 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	...
	,[Kansainvälinen opiskelija] = 
		case
			when f.kansainvalinen_opiskelija = 1 then 'Kyllä' 
			when f.kansainvalinen_opiskelija = 0 then 'Kyllä' 
			else 'Tieto puuttuu'
		end
