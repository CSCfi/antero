...
SELECT  
      ...
      ,CASE 
			WHEN kysymykset.kysymysid=6821 
			OR kysymykset.kysymysid=6805 
			OR kysymykset.kysymysid=6950 THEN 'arvosana6' 
      ...
      , f2.gen_vastaaja_id													as [vastaajaid]
      , 1																	as [lukumaara]
...
WHERE 
kysymykset.vastaustyyppi<>'vapaateksti' OR f1.Kysymysnumero in (8240, 8242, 8254, 6923, 6921, 6935)
and kysymykset.kysymysryhma_fi not in ('VII Kiitos paljon vastauksistasi!','V  Kiitos paljon vastauksistasi!')
