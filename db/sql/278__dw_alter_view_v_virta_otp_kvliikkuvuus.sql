...
SELECT d1.organisaatio_koodi
	  ...
	  ,d3.koulutusastetaso2_fi
	  ,d3.koulutusalataso2_sv
	  ,d3.koulutusastetaso2_en
	  ,d3.koulutusalataso1_koodi
	  ,d3.koulutusalataso1_fi
	  ,d3.koulutusalataso1_sv
	  ,d3.koulutusalataso1_en
	  ,d3.koulutusalataso2_koodi
	  ,d3.koulutusalataso2_fi
	  ,d3.koulutusalataso2_sv
	  ,d3.koulutusalataso2_en
	  ,d3.koulutusalataso3_koodi
	  ,d3.koulutusalataso3_fi
	  ,d3.koulutusalataso3_sv
	  ,d3.koulutusalataso3_en
	  ,d3.koulutusluokitus_koodi
	  ,d3.koulutusluokitus_fi
