...
/****** Object:  StoredProcedure [dw].[p_lataa_api_amk_opintopisteet_kuukausi_esilataus]    Script Date: 10.3.2025 10.26.07 ******/
SET ANSI_NULLS ON
GO
	...
	BEGIN
		...
		FROM (
			SELECT 
				...
				[koodit_ammattikorkeakoulu] = d3.organisaatio_koodi,
	...
	BEGIN
		...
		'INSERT INTO AnteroAPI.dw.[api_amk_opintopisteet_kuukausi]
		 SELECT
			...
			d3.organisaatio_koodi as koodit_ammattikorkeakoulu,
