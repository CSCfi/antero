...
/****** Object:  View [dbo].[v_f_tab_ulkomaalaiset_ulk_ja_vieraskieliset_yhteiset]    Script Date: 23.3.2018 9:28:15 ******/
SET ANSI_NULLS ON
GO
...
/* kaikille yhteiset dimensiot */
	  ...
	  ,hallinnonala2_id
      ,[opiskelijan_olo_id]
      ,case when tilastovuosi>=2016 then [koulutusala_taso2_id] else [koulutusluokitus_id] end as koulutusluokitus_id
