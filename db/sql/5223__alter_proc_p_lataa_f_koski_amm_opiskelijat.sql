USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_amm_opiskelijat]    Script Date: 2.12.2021 22:06:31 ******/
SET ANSI_NULLS ON
GO
...
SELECT
	...
	,valma1_telma2 = case when d11.koulutusluokitus_fi like '%VALMA%' then 1 when d11.koulutusluokitus_fi like '%TELMA%' then 2 end
	,loadtime = GETDATE()
