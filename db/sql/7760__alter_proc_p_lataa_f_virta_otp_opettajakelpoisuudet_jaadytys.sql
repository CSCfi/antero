...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_opettajakelpoisuudet_jaadytys]    Script Date: 2.6.2023 8:05:57 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	' SELECT DISTINCT' +
		...
		' case when pvm1 > pvm2 and d1a.patevyys_fi like ' + '''' + '%erilliset%' + '''' + ' THEN 2 when pvm2 >= p.pvm1 and d1b.patevyys_fi like ' + '''' + '%erilliset%' + '''' + ' then 2 else 1 end as suoritustapa,' +
