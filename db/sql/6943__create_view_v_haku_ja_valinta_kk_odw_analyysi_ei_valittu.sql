...
/****** Object:  View [dw].[v_haku_ja_valinta_kk_odw_analyysi_ei_valittu]    Script Date: 24.1.2023 15:13:00 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER VIEW [dw].[v_haku_ja_valinta_kk_odw_analyysi_ei_valittu] AS
