...
/****** Object:  StoredProcedure [dw].[p_lataa_f_oiva_luvat_amm]    Script Date: 3.9.2024 8:45:17 ******/
SET ANSI_NULLS ON
GO
...
BEGIN 
	...
	DROP TABLE IF EXISTS dw.f_oiva_luvat_amm
		...
		FROM (
			...
			join  sa.temp_amm_jarjluvat_kalenteri ka ON kalenteri_avain between l.alkupvm and coalesce(l.loppupvm, '9999-12-31')
			WHERE rivi_nro=1 
