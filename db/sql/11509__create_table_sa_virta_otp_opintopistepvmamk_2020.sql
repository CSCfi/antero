USE [ANTERO]
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[sa].[sa_virta_otp_opintopistepvmamk_2020]') AND type in (N'U'))
BEGIN
	CREATE TABLE [sa].[sa_virta_otp_opintopistepvmamk_2020](
