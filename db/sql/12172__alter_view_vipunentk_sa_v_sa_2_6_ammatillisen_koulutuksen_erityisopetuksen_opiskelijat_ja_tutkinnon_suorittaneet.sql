...
/****** Object:  View [dbo].[v_sa_2_6_ammatillisen_koulutuksen_erityisopetuksen_opiskelijat_ja_tutkinnon_suorittaneet]    Script Date: 2.9.2026 12.11.41 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
      ...
      ,[opintokok] = NULL
      ,[lkm]
	  ,tietolahde = '2_6_sopv_24'
FROM [TK_H9098_CSC].[dbo].[TK_K2_6_sopv_24]
...
SELECT [tilv]
      ...
      ,[opintokok] = NULL
      ,[lkm]
	  ,tietolahde = '2_6_sopv_25'
FROM [TK_H9098_CSC].[dbo].[TK_K2_6_sopv_25]
...
SELECT [tilv]
      ...
      ,[opintokok] = NULL
      ,[lkm]
	  ,tietolahde = '2_6_sopv_26'
FROM [TK_H9098_CSC].[dbo].[TK_K2_6_sopv_26]
