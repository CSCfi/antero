USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_amos_spl_vaikuttavuus_maakunnat]    Script Date: 29.4.2022 23:00:51 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
    ...
    ,[kouljat]
    ,[oppis]
    ,[opso] --ei sisältöä vielä tilv 2019
    ,[koso] --ei sisältöä vielä tilv 2019
    ,[tutklaja_tr]
    ,[ptoim1r6]
    ,[amm2010]
    ,[tsekt]
    ...
    ,[luontipvm]
	,'a' AS toimitus
	,'pääasiallinen toiminta, lopullinen (toimitus: joulukuu tilv+2)' AS toimitus_kuvaus --select distinct tilvasmaak
