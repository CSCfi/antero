...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dw].[api_amm_rahoitus_yhteenvetotaulukko]') AND type in (N'U'))
DROP TABLE [dw].[api_amm_rahoitus_yhteenvetotaulukko]
GO
...
CREATE TABLE [dw].[api_amm_rahoitus_yhteenvetotaulukko](
	...
	[painotetut_opv_lahtotaso_hyv_ka] [decimal](20, 10) NULL,
	[painotetut_opv_kr_hyv_ka] [decimal](20, 10) NULL,
	[painotetut_tutk_ja_osp_hyv_ka] [decimal](20, 10) NULL,
	[tyoll_ja_jatkoopisk_ei_tyoll_ennen_koul_ka] [decimal](20, 10) NULL,
	[tyopaikkakysely_pisteet] [decimal](20, 10) NULL,
	[tyopaikkaohjaajakysely_painotetut_pisteet] [decimal](20, 10) NULL,
	[aloituskysely_painotetut_pisteet] [decimal](20, 10) NULL,
	[paattokysely_painotetut_pisteet] [decimal](20, 10) NULL,
