...
/****** Object:  View [dw].[v_arvo_uraseuranta]    Script Date: 5.12.2019 9:53:13 ******/
SET ANSI_NULLS ON
GO
...
,convert(int,	case when f.kysymysid in (2942,2946)							---VASTAUSTEN JÄRJESTYSNUMEROT
		...
		WHEN (f.kysymysid = 3143 and vapaateksti='1')							THEN 1
		WHEN (f.kysymysid = 3143 and vapaateksti='2')							THEN 2
		WHEN (f.kysymysid = 3143 and vapaateksti='3')							THEN 3
		WHEN (f.kysymysid = 3143 and vapaateksti='4')							THEN 4
		WHEN (f.kysymysid = 3143 and vapaateksti='5')							THEN 5
		WHEN (f.kysymysid = 3143 and vapaateksti='6')							THEN 6
		WHEN (f.kysymysid = 3143 and vapaateksti='7')							THEN 7
		WHEN (f.kysymysid = 3143 and vapaateksti='8')							THEN 8
		WHEN (f.kysymysid = 3143 and vapaateksti='9')							THEN 9
		WHEN (f.kysymysid = 3143 and vapaateksti='10')							THEN 10
		WHEN (f.kysymysid = 3143 and vapaateksti='11')							THEN 11
		WHEN (f.kysymysid = 3143 and vapaateksti='12')							THEN 12
		WHEN (f.kysymysid = 3143 and vapaateksti='13')							THEN 13
		WHEN (f.kysymysid = 3143 and vapaateksti='14')							THEN 14
		WHEN (f.kysymysid = 3143 and vapaateksti='15')							THEN 15
