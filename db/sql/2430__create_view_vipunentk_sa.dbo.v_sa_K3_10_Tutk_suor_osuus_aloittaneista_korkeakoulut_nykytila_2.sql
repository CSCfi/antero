...
/****** Object:  View [dbo].[v_sa_K3_10_Tutk_suor_osuus_aloittaneista_korkeakoulut_nykytila_2_T1285]    Script Date: 16.9.2019 12:22:35 ******/
DROP VIEW IF EXISTS [dbo].[v_sa_K3_10_Tutk_suor_osuus_aloittaneista_korkeakoulut_nykytila_2_T1285]
GO
...
CREATE VIEW [dbo].[v_sa_K3_10_Tutk_suor_osuus_aloittaneista_korkeakoulut_nykytila_2] AS

/*
* -------------- HUOM ----------------
* 5.10.2018
* Sovittu Haapamäen kanssa, että voidaan jättää lataamatta tilaston alkupäästä vuosi, sillä kenttein lukumäärä ylitti
* SQL-palvelimen sisäisen 1024 kentän rajan.
* Etsitään parempi ratkaisu kuin vuoden lataamatta jättäminen 
*/
SELECT
/*    [tilv]
   ,[lahde]
...
-- lisää sarakkeet ylle ja päivitä tietolähde sekä lähdetaulut alle
    ...
    ,[lkm]
    ,[tietolahde]='K3_10_sopv_19'
    ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv, alvv, allk)
    ,[aineistorivinumero] = ROW_NUMBER() OVER(ORDER BY tilv, alvv, allk)
	,f1.[rivinro]
  FROM [TK_H9098_CSC].[dbo].[TK_K3_10_sopv_19_1] f1
  inner join [TK_H9098_CSC].[dbo].[TK_K3_10_sopv_19_2] as f2 on f1.rivinro=f2.rivinro 
