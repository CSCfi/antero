...
/****** Object:  StoredProcedure [dbo].[ETL_tyhjenna_ja_lataa_VipunenTK_DW_dimensiot]    Script Date: 17.4.2026 16.55.27 ******/
SET ANSI_NULLS ON
GO
...
--TRUNCATE TABLE VipunenTK_DW..d_aikuisten_perusopetus;
--INSERT INTO VipunenTK_DW..d_aikuisten_perusopetus
--	SELECT * FROM VipunenTK_lisatiedot.[dbo].[v_aikuisten_perusopetus] WHERE virhetilanne = 'E';
...
--TRUNCATE TABLE VipunenTK_DW..d_kieli_vst;
--INSERT INTO VipunenTK_DW..d_kieli_vst
--	SELECT * FROM VipunenTK_lisatiedot.[dbo].[v_kieli_vst] WHERE virhetilanne = 'E';
...
TRUNCATE TABLE VipunenTK_DW..d_koulutusala_vst;
INSERT INTO VipunenTK_DW..d_koulutusala_vst
	SELECT * FROM VipunenTK_lisatiedot.[dbo].[v_koulutusala_vst] WHERE virhetilanne = 'E';
...
--TRUNCATE TABLE VipunenTK_DW..d_koulutustausta_vst;
--INSERT INTO VipunenTK_DW..d_koulutustausta_vst
--	SELECT * FROM VipunenTK_lisatiedot.[dbo].[v_koulutustausta_vst] WHERE virhetilanne = 'E';
...
--TRUNCATE TABLE VipunenTK_DW..d_oppimaara_vst;
--INSERT INTO VipunenTK_DW..d_oppimaara_vst
--	SELECT * FROM VipunenTK_lisatiedot.[dbo].[v_oppimaara_vst] WHERE virhetilanne = 'E';
...
--TRUNCATE TABLE VipunenTK_DW..d_paaasiallinen_toiminta_vst;
--INSERT INTO VipunenTK_DW..d_paaasiallinen_toiminta_vst
--	SELECT * FROM VipunenTK_lisatiedot.[dbo].[v_paaasiallinen_toiminta_vst] WHERE virhetilanne = 'E';
...
--TRUNCATE TABLE VipunenTK_DW..d_perusopetuksen_oppilas;
--INSERT INTO VipunenTK_DW..d_perusopetuksen_oppilas
--	SELECT * FROM VipunenTK_lisatiedot.[dbo].[v_perusopetuksen_oppilas] WHERE virhetilanne = 'E';
