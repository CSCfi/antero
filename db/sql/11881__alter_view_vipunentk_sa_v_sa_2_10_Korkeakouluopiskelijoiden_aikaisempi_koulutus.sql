...
/****** Object:  View [dbo].[v_sa_2_10_Korkeakouluopiskelijoiden_aikaisempi_koulutus]    Script Date: 1.4.2026 12.54.39 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
 ...
 UNION ALL
  ...
  SELECT [tilv]
      ...
      ,[opm95opaed] = null
      ,[lkm]
      ,[tietolahde]='TK_2_10_sopv_26'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
  FROM [TK_H9098_CSC].[dbo].[TK_K2_10_sopv_26]
