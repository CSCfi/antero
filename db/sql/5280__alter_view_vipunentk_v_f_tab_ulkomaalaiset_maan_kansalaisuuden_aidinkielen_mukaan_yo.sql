...
/****** Object:  View [dbo].[v_f_tab_ulkomaalaiset_maan_kansalaisuuden_aidinkielen_mukaan_yo]    Script Date: 30.12.2021 13:47:49 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_f_tab_ulkomaalaiset_maan_kansalaisuuden_aidinkielen_mukaan_yo] AS
SELECT 
...
WHERE (d2.koulutusaste2002_koodi in (63,72,73,81,82) or d2.Koulutusaste_taso2_koodi in (63,72,73,81,82)) 
AND (d2.koulutusala2002_koodi not in ('-1','9') or d2.iscfibroad2013_koodi not in ('-1','99')) 
