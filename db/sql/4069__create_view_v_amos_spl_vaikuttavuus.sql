...
/****** Object:  View [dw].[v_amos_spl_vaikuttavuus]    Script Date: 28.10.2020 23:14:05 ******/
DROP VIEW IF EXISTS [dw].[v_amos_spl_vaikuttavuus]
GO
...
CREATE VIEW [dw].[v_amos_spl_vaikuttavuus] AS
SELECT
-- AIKAMUUTTUJAT
	 [Tutkinnon suoritusvuosi]
      ,[Tutkinnon aloitusvuosi]
      ,[Tutkinnon aloituslukukausi]
      ,[Tilastovuosi]
