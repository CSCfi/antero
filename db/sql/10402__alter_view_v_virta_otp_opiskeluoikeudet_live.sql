...
/****** Object:  View [dw].[v_virta_otp_opiskeluoikeudet_live]    Script Date: 21.11.2024 8:19:17 ******/
SET ANSI_NULLS ON
GO
...
ALTER   VIEW  [dw].[v_virta_otp_opiskeluoikeudet_live]
AS
SELECT 
...
FROM [ANTERO].[dw].[f_virta_otp_opiskeluoikeudet_live] f
