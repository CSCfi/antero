...
/****** Object:  View [dbo].[v_sa_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta]    Script Date: 30.1.2026 10.57.59 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
     ...
     -- ,[opiskkoulk] = null  -- null on 2025 kesämuutos
	  ...
	  ,[ulkom]
	  ,[lkm]
      ,[tietolahde]='4_2a_sopv_25'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
FROM [TK_H9098_CSC].[dbo].[TK_K4_2a_sopv_25]
...
SELECT [tilv]
     ...
     -- ,[opiskkoulk] = null  -- null on 2025 kesämuutos
	  ...
	  ,[ulkom]
	  ,[lkm]
      ,[tietolahde]='4_2c_sopv_25'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
FROM [TK_H9098_CSC].[dbo].[TK_K4_2c_sopv_25]
