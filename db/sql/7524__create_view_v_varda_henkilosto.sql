...
/****** Object:  View [dw].[v_varda_henkilosto]    Script Date: 30.3.2023 14:04:59 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER VIEW [dw].[v_varda_henkilosto] AS
	...
	-- apusarakkeet
		...
		hl.taydennyskoulutus_id as apusarake_taydennyskoulutus_id,
		CAST(COALESCE(hl.koulutuspaivat,0) as float) as apusarake_koulutuspaivat,
	...
	-- organisaatiomuuttujat
		...
		CASE WHEN tm.kuvaus_fi is null THEN 'Tieto puuttuu' ELSE tm.kuvaus_fi END as toimintamuoto_fi,
		CASE WHEN tm.kuvaus_sv is null THEN 'Tieto puuttuu' ELSE tm.kuvaus_sv END as toimintamuoto_sv,
		CASE WHEN tm.kuvaus_en is null THEN 'Tieto puuttuu' ELSE tm.kuvaus_en END as toimintamuoto_en,
	...
	FROM ANTERO.dw.f_varda_henkilosto hl
