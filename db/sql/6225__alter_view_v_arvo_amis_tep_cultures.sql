...
/****** Object:  View [dw].[v_arvo_amis_tep_cultures]    Script Date: 19.5.2022 13:54:45 ******/
SET ANSI_NULLS ON
GO
...
--FI
	...
	,coalesce(d13.toimiala_2008,'Tieto puuttuu')		AS 'tyopaikan_toimiala_fi'
	,coalesce(d11b.kunta_fi,'Tieto puuttuu')	AS 'tyopaikan_kunta_fi'
	,coalesce(d11b.maakunta_fi,'Tieto puuttuu')	AS 'tyopaikan_maakunta_fi'
...
--SV
	...
	,coalesce(d11b.kunta_sv,'Information saknas')		AS 'tyopaikan_kunta_sv'
	,coalesce(d11b.maakunta_sv,'Information saknas')	AS 'tyopaikan_maakunta_sv'
...
--EN
	...
	,coalesce(d11b.kunta_en,'Missing data')		AS 'tyopaikan_kunta_en'
	,coalesce(d11b.maakunta_en,'Missing data')	AS 'tyopaikan_maakunta_en'
	...
	,coalesce(d11b.jarjestys_maakunta_koodi,'99999')	AS 'jarjestys_tyopaikan_maakunta'
