...
GO
/****** Object:  Table [dbo].[patevyyteen_tahtaavat_opinnot_amk]    Script Date: 8.10.2022 1:45:51 ******/
...
GO
INSERT [dbo].[patevyyteen_tahtaavat_opinnot_amk] ([id], [luotu], [alkaa], [paattyy], [patevyyteen_tahtaavat_opinnot_koodi], [patevyyteen_tahtaavat_opinnot], [patevyyteen_tahtaavat_opinnot_SV], [patevyyteen_tahtaavat_opinnot_EN], [jarjestys], [virhetilanne], [poistettu], [tietolahde], [kommentti]) VALUES (2, CAST(N'2017-09-12' AS Date), CAST(N'1900-01-01' AS Date), CAST(N'9999-01-01' AS Date), N'2', N'Sairaanhoitajan pätevyys', N'*SV*Sairaanhoitajan pätevyys (tutkintokeruu)', N'*EN*Sairaanhoitajan pätevyys (tutkintokeruu)', N'2', N'E', N'0', N'Tilastokeskus', N'CSC Anssi')
GO
...
GO
INSERT [dbo].[patevyyteen_tahtaavat_opinnot_amk] ([id], [luotu], [alkaa], [paattyy], [patevyyteen_tahtaavat_opinnot_koodi], [patevyyteen_tahtaavat_opinnot], [patevyyteen_tahtaavat_opinnot_SV], [patevyyteen_tahtaavat_opinnot_EN], [jarjestys], [virhetilanne], [poistettu], [tietolahde], [kommentti]) VALUES (7, CAST(N'2022-10-08' AS Date), CAST(N'1900-01-01' AS Date), CAST(N'9999-01-01' AS Date), N'7', N'Erilliset varhaiskasvatuksen sosionomipätevyyteen tähtäävät opinnot', N'*SV*Erilliset varhaiskasvatuksen sosionomipätevyyteen tähtäävät opinnot', N'*EN*Erilliset varhaiskasvatuksen sosionomipätevyyteen tähtäävät opinnot', N'7', N'E', N'0', N'Tilastokeskus', N'CSC Juha')
GO
