...
BEGIN
CREATE TABLE [dbo].[Rahoitusmalli_korkeakoulut](
	[id] [int] NOT NULL,
	[rahoituksen_vuosi] [int] NULL,
	[sektori] [nvarchar](20) NULL,
	[rahoituksen_kategoria] [nvarchar](100) NULL,
	[indikaattori] [nvarchar](100) NULL,
...
IF NOT EXISTS 
		...
		WHERE f.[rahoituksen_vuosi]<>2019
		)
BEGIN
INSERT INTO [dbo].[Rahoitusmalli_korkeakoulut]
	([id]
	,[rahoituksen_vuosi]
	,[sektori]
