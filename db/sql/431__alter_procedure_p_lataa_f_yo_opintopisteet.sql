ALTER PROCEDURE dw.p_lataa_f_yo_opintopisteet
AS
...
,kaikperop_lkm as kaikki_tutk_op_lkm
,vierkielper_op_lkm
,erillisilla_oik_op_lkm
,erillisilla_oik_opkoul_op_lkm
,joo_op_lkm
,kvvaihtop_lkm as kv_vaihtoopiskelijat_op_lkm
,erikoul_suor_op_lkm
,ulkom_hyv_luetut_op_lkm
...
,s.avoinop_amk_lkm
,s.avoinop_kesa_lkm
,s.avoinop_kansan_lkm
,s.avoinop_kansal_lkm
,s.avoinop_muut_lkm

,'etl: sa_suorat_hist_yo2_opintopisteet' as source
FROM sa.sa_suorat_hist_yo2_opintopisteet s
LEFT JOIN dw.d_yo d1 ON d1.yo_tunnus=s.yliopisto_tunnus
...
,s.perustutkinto as kaikki_tutk_op_lkm
,s.vieraskielinen as vierkielper_op_lkm
,s.erillinenOO as erillisilla_oik_op_lkm
,s.erillinenopettaja as erillisilla_oik_opkoul_op_lkm
,s.joo as joo_op_lkm
,s.kvVaihto as kv_vaihtoopiskelijat_op_lkm
,s.erikoistumisopinnot as erikoul_suor_op_lkm
,s.hyvaksiluetut as ulkom_hyv_luetut_op_lkm
,s.ulkomaaHarjoittelu as ulkom_harj_op_lkm

,s.avoinKK as avoinop_lkm
--avoimen järjestävät
...
LEFT JOIN dw.d_yo d1 ON d1.yo_tunnus=sk.nimi -- hack! koodisto as a map (using nimi for mapping!)
LEFT JOIN dw.d_ohjauksenala d2 ON d2.ohjauksenala_koodi=s.koodi
LEFT JOIN dw.d_kalenteri as d3 ON d3.kalenteri_avain=cast(s.loadtime as date)
