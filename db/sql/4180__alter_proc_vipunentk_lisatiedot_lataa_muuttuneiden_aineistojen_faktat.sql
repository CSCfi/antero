...
GO
/****** Object:  StoredProcedure [dbo].[lataa_muuttuneiden_aineistojen_faktat]    Script Date: 9.12.2020 9:52:21 ******/
SET ANSI_NULLS ON
GO
...
WHERE Faktalataus_suoritettu=0 
  AND left(Taulu,8) not in ('TK_K3_9_','TK_K3_10') --Aloittaneiden läpäisy erikseen; faktalataus ja kuutiot mukana kuitenkin viikonloppuajossa
)
