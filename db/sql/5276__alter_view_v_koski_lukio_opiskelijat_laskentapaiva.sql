...
/****** Object:  View [dw].[v_koski_lukio_opiskelijat_laskentapaiva]    Script Date: 30.12.2021 12:19:16 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dw].[v_koski_lukio_opiskelijat_laskentapaiva]
AS
SELECT DISTINCT 
-- LASKENTAMUUTTUJAT 
...
-- JÄRJESTYSMUUTTUJAT
	...
	,d11.jarjestys_maakunta_koodi AS jarjestys_oppilaitoksen_maakunta
