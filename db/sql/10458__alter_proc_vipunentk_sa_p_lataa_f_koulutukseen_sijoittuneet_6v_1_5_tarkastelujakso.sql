...
/****** Object:  StoredProcedure [dbo].[p_lataa_f_koulutukseen_sijoittuneet_6v_1_5_tarkastelujakso]    Script Date: 9.1.2025 10.16.29 ******/
SET ANSI_NULLS ON
GO
...
-- Koulutuksen maakunta 2
 ...
 l.tietolahde,
 'K3.13',
 -- l.opintotuki_ulkom_3,  -- ei-kumulatiivinen
 (case when l.opintotuki_ulkom_1 = '1' or l.opintotuki_ulkom_2 = '1' or l.opintotuki_ulkom_3 = '1' then '1' else '2' end) as opintotuki_ulkom,
 -- Lukiokoulutuksessa
 (case
