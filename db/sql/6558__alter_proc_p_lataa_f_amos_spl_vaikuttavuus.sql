USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_amos_spl_vaikuttavuus]    Script Date: 11.10.2022 19:32:37 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN ANTERO.sa.sa_amos_siirtotiedosto_okm8 okm8 ON okm8.koul_jarj = spl.ytunnus_amos_spl AND year(okm8.voimaan_alkaen) = (case when k13.tilv+4 > @maxVuosi then k13.tilv+3 else k13.tilv+4 end)
