...
DROP PROCEDURE IF EXISTS [dw].[p_lataa_api_muu_henkilosto_amk_esilataus]
GO
...
CREATE PROCEDURE [dw].[p_lataa_api_muu_henkilosto_amk_esilataus] AS
...
FROM (
	SELECT
		...
		,[koodit_ammattikorkeakoulu] = d6.amk_tunnus
	...
	join ANTERO.dw.d_amk d6 on d6.id=f.d_amk_id
