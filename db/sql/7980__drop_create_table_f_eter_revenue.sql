...
/****** Object:  Table [dw].[f_eter_revenue]    Script Date: 25.8.2023 15:37:06 ******/
DROP TABLE [dw].[f_eter_revenue]
GO
...
CREATE TABLE [dw].[f_eter_revenue](
	...
	[Notes on revenues] [varchar](max) NULL,
