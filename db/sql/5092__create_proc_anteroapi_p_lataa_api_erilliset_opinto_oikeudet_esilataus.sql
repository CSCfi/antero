...
DROP PROCEDURE IF EXISTS [dw].[p_lataa_api_erilliset_opinto_oikeudet_esilataus]
GO
...
CREATE PROCEDURE [dw].[p_lataa_api_erilliset_opinto_oikeudet_esilataus] AS
...
FROM (
	...
	JOIN ANTERO.dw.d_yo d6 on d6.id=f.d_yo_id
