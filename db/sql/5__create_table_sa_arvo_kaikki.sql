IF NOT EXISTS (select * from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA='sa' and TABLE_NAME='sa_arvo_kaikki') BEGIN

CREATE TABLE sa.sa_arvo_kaikki(
 ...
 CONSTRAINT PK__sa_arvo_kaikki PRIMARY KEY CLUSTERED 
(
  id ASC
)
)
...
ALTER TABLE sa.sa_arvo_kaikki ADD  CONSTRAINT DF__sa_arvo_kaikki__loadtime  DEFAULT (getdate()) FOR loadtime
;
ALTER TABLE sa.sa_arvo_kaikki ADD  CONSTRAINT DF__sa_arvo_kaikki__username  DEFAULT (suser_name()) FOR username
;
