...
/****** Object:  View [dbo].[v_oppilaitos_kaikkivuodet]    Script Date: 15.9.2021 17:11:35 ******/
SET ANSI_NULLS ON
GO
...
SELECT tunn --[koodi]
 ...
 UNION ALL
  ...
  SELECT tunn --[koodi]
      ,[korvaavakoodi] = case when tunn in ('02470','02609') then '10126' else utunn end --saimaa&lahti -> lab yhdistyminen puuttuu sopv21
      ,[alkaa] = '1999-01-01'
      ,[paattyy] = '9999-01-01'
