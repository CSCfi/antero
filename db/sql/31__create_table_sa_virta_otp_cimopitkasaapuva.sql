...
ALTER TABLE sa.sa_virta_otp_cimopitkasaapuva ADD  CONSTRAINT DF__sa_virta_otp_cimopitkasaapuva__loadtime  DEFAULT (getdate()) FOR loadtime
;
ALTER TABLE sa.sa_virta_otp_cimopitkasaapuva ADD  CONSTRAINT DF__sa_virta_otp_cimopitkasaapuva__username  DEFAULT (suser_name()) FOR username
;
