IF NOT EXISTS (
    ...
    where TABLE_SCHEMA='dbo' and TABLE_NAME='sa_virta_otp_okmaloittaneetopintopisteetyo'
) BEGIN

CREATE TABLE dbo.sa_virta_otp_okmaloittaneetopintopisteetyo(
...
ALTER TABLE dbo.sa_virta_otp_okmaloittaneetopintopisteetyo
