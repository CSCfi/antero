IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'dbo.SA_SUORAT_AMK_TALOUS_3_tuloslaskelman_toiminnot') AND type in (N'U'))
BEGIN
CREATE TABLE dbo.SA_SUORAT_AMK_TALOUS_3_tuloslaskelman_toiminnot(
	TILIK int NULL,
