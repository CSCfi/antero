IF NOT EXISTS (
    ...
    where TABLE_SCHEMA='dbo' and TABLE_NAME='sa_virta_otp_opintopistepvmamk'
) BEGIN

CREATE TABLE dbo.sa_virta_otp_opintopistepvmamk(
...
ALTER TABLE dbo.sa_virta_otp_opintopistepvmamk
