...
def load(secure,hostname,url,schema,table,codeset,verbose=False,debug=False):
  ...
  headers = {"Content-Type": "application/json", "Accept": "application/json", "Caller-Id": "1.2.246.562.10.2013112012294919827487.vipunen"}
  ...
  for i in j:
    ...
    httpconn.request('GET', "/koodisto-service/rest/json/relaatio/sisaltyy-ylakoodit/%s" % i["koodiUri"], headers)
