...
def main():
    ...
    for i in j:
        ...
        okmohjauksenalakoodi = None
        okmohjauksenalanimi = None
        okmohjauksenalanimi_sv = None
        okmohjauksenalanimi_en = None
        ...
        for ii in jj:
            ...
            if ii["koodisto"]["koodistoUri"] == "okmohjauksenala":
                okmohjauksenalakoodi = ii["koodiArvo"]
                okmohjauksenalanimi = haenimi(ii,"FI")
                okmohjauksenalanimi_sv = haenimi(ii,"SV")
