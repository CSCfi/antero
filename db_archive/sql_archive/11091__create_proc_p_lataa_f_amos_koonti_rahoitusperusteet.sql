...
CREATE OR ALTER PROCEDURE [dw].[p_lataa_f_amos_koonti_rahoitusperusteet] --@generoitu [int], @kokonaisuus [nvarchar](255)
AS

--Jätetään kohdetauluun toistaiseksi toteuman osalta vain rajoitekerroin, muihin estimaattikauden tiedot.
...
UPDATE dw.d_amos_spl_jarjestaja_linkki 
SET sisaltyy_amos_spl = 0
WHERE ytunnus_amos_spl = '2189108-4' --Cimsonin v. 2025 suoritepäätöksen rahoitus oikaisulla/korjauksella nollattu, mistä syystä menisi uuteen järjestäjään sovellettavalla yleisellä tasauskertoimella.
...
--huom. kiinteä aineisto, "generointi" vasta koontinäkymässä
