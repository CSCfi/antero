...
/****** Object:  StoredProcedure [dbo].[p_lataa_f_ammattirakenne_ennuste]    Script Date: 12.9.2023 13:16:26 ******/
SET ANSI_NULLS ON
GO
...
SELECT mitenna_ammatti_id, mitenna_toimiala_id INTO [VipunenTK].[dbo].[temp_ammatti]
FROM (SELECT DISTINCT mitenna_ammatti_id, mitenna_toimiala_id FROM [VipunenTK].[dbo].[f_alueella_tyossakayvat_1v]) f
