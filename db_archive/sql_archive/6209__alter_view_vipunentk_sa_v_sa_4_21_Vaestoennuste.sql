...
/****** Object:  View [dbo].[v_sa_4_21_Vaestoennuste]    Script Date: 11.5.2022 12:05:26 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN (SELECT DISTINCT kunta_koodi,kunta_fi FROM ANTERO.dw.d_alueluokitus WHERE ely_koodi IS NOT NULL) d on d.kunta_fi = 
(CASE 
