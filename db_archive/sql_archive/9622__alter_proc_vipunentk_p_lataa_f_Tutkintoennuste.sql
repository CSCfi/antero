...
/****** Object:  StoredProcedure [dbo].[p_lataa_f_Tutkintoennuste]    Script Date: 19.2.2024 11:43:02 ******/
SET ANSI_NULLS ON
GO
...
-- Yliopistokoulutuksessa: ylempi korkeakoulututkinto, lääkäreiden erikoistumiskoulutus, alemmat korkeakoulututkinnot farmaseuteilta ja varhaiskasvatuksen opettajilta
	...
	AND ((d7.koulutustyyppi in ('Ammattikorkeakoulututkinto, päivätoteutus', 'Ammattikorkeakoulututkinto, monimuotototeutus') and d16.Koulutusaste_taso2_koodi = '62') or (d16.Koulutusaste_taso2_koodi = '72' or (d16.Koulutusaste_taso2_koodi = '63' and d16.iscfi2013_koodi in ('0916', '0112'))))
	AND f.aineisto = 'L'
