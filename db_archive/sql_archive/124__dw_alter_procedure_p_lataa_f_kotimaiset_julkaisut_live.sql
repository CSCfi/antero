...
LEFT JOIN dw.d_organisaatio d1_1 ON d1_1.organisaatio_avain like 'oppilaitosnumero_%' and d1_1.organisaatio_koodi = f.organisaatioTunnus
LEFT JOIN dw.d_organisaatio d1_2 ON d1_2.organisaatio_avain like 'koulutustoimija_%' and d1_2.organisaatio_koodi = f.organisaatioTunnus
LEFT JOIN dw.d_organisaatio d1_3 ON d1_3.organisaatio_avain like 'tutkimusorganisaatio_%' and d1_3.organisaatio_koodi = f.organisaatioTunnus
