...
/****** Object:  View [dbo].[v_f_tab_koulutukseen_sijoittuneet_8v_yhteiset]    Script Date: 22.10.2024 10:32:19 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER VIEW [dbo].[v_f_tab_koulutukseen_sijoittuneet_8v_yhteiset] AS
Select --top 100
[lkm_int2] = lkm
...
,d60.kylla_ei as 'Saanut opintotukea ulkomailla opiskeluun'
...
,d60.kylla_ei_SV as [Fått studiestöd för studier utomlands]
...
,d60.kylla_ei_EN as [Received financial aid for studies abroad]
...
,d60.jarjestys as saanut_opintotukea_ulkomailla_opiskeluun_jarjestys
...
FROM            dbo.f_koulutukseen_sijoittuneet_8v
	...
	LEFT JOIN d_kylla_ei d60 on d60.id = opintotuki_ulkom_id
