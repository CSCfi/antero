...
/****** Object:  View [dbo].[v_f_tab_otv_korkeakoulut_syntypera_2_8f_2_9d]    Script Date: 13.1.2025 13.05.17 ******/
SET ANSI_NULLS ON
GO
...
ALTER   VIEW [dbo].[v_f_tab_otv_korkeakoulut_syntypera_2_8f_2_9d] AS
...
SELECT --top 1000
  ...
  --FI
	...
	,[Kansainvälinen opiskelija] = d15.kylla_ei
  ...
  --JARJESTYS
	...
	,jarjestys_kansainvalinen_opiskelija = d15.jarjestys
...
LEFT JOIN dbo.d_kylla_ei d15 ON d15.id = f.kvopisk_id
