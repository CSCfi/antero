USE [Koski_SA]
GO
/****** Object:  StoredProcedure [dbo].[p_lataa_amm_opiskelijat_valitaulu]    Script Date: 22.7.2020 17:32:30 ******/
SET ANSI_NULLS ON
GO
...
WHILE @alkuPvm <= '2018-12-31'--DATEADD(MONTH, DATEDIFF(MONTH, 0, GETDATE())-1, 0)
