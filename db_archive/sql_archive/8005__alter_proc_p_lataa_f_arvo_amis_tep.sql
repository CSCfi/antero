...
/****** Object:  StoredProcedure [dw].[p_lataa_f_arvo_amis_tep]    Script Date: 4.9.2023 21:27:39 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN dw.d_arvovastaus_taustakysymys d11 ON d11.koodi = MQ.tk_teht_koodi and d11.kysymysid = MQ.tk_teht_kysymysid AND d11.kysymysversio = MQ.kysymysversio
...
--tyhjien rivien generointi työpaikkakyselyn rahoitusraporttia varten (voidaan luopua, jos eriytetään rahoitusraporttien lataukset)
--delete from dw.f_arvo_amis_tep where [source] = 'generoitu'
INSERT dw.f_arvo_amis_tep
SELECT DISTINCT 
	[d_organisaatio_oppilaitos_id] = -1
	,[d_organisaatio_koulutustoimija_id]
	,[d_amos_spl_jarjestaja_linkki_id]
	,[d_alueluokitus_oppilaitos_id] = -1
	,[d_alueluokitus_koulutustoimija_id]
	,[d_koulutusluokitus_id] = -1
	,[d_alueluokitus_toimipaikka_id] = -1
	,[d_maatjavaltiot2_toimipaikka_id] = -1
	,[d_kalenteri_jakso_paattynyt_id]
	,[d_arvokysymys_id] = -1
	,[d_arvokyselykerta_id] = null --ohjataan näkymässä työpaikkakyselyyn
	,[d_arvovastaus_taustakysymys_tehtava_id] = -1
	,[d_arvovastaus_monivalinta_id] = -1
	,[d_suoritus_kieli_id] = -1
	,[d_ytj_yritystiedot_tyonantaja_id] = -1
	,[d_oppisopimuksen_perusta_id] = -1
	,[d_tutkinnon_osa_id] = -1
	,[d_osaamisen_hankkimistapa_id] = -1
	,[numerovalinta] = null
	,[vaihtoehto] = null
	,[tyopaikkajakson_kesto] = null
	,[vastaajaid] = null
	,[vastaajatunnus] = null
	,[tyopaikkaohjaajakysely_vastaajaid] = null
	,[tyopaikkaohjaajakysely_vastaajatunnus] = null
	,[tyopaikkakysely_vastaajaid] = null
	,[tyopaikkakysely_vastaajatunnus] = null
	,[tyopaikkakysely_liittyva_ohjaajatunnus] = null
	,[source] = 'generoitu'
FROM [ANTERO].[dw].[f_arvo_amis_tep]
WHERE [d_oppisopimuksen_perusta_id] = (select id from dw.d_oppisopimuksen_perusta where koodi = '02')
