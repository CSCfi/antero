...
/****** Object:  StoredProcedure [dw].[p_lataa_f_arvo_yo_uraseuranta_2018]    Script Date: 25.9.2019 8:26:31 ******/
SET ANSI_NULLS ON
GO
...
SELECT  
      ...
      ,Case when kysymykset.kysymysid=6821 OR kysymykset.kysymysid=6805 Then 'arvosana6' else kysymykset.vastaustyyppi			end									as [vastaustyyppi]
      ,null 																as [vaihtoehto]
