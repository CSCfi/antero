...
/****** Object:  View [dbo].[v_sa_2_11_Oppilaitosten_tutkintoon_johtamaton]    Script Date: 20.12.2022 18:27:48 ******/
SET ANSI_NULLS ON
GO
...
--JS 3.2.2022:
--Raportoidaan vapaan sivistystyön oppilaitostyyppi (sopv21-; osa18- ja tunn1-) erillisenä kokonaisuutena.
--Ks. [v_sa_2_11_Oppilaitosten_tutkintoon_johtamaton_vst_oppilaitostyyppi]
...
SELECT [tilv] = Cast(tilv as varchar(4))
	  ...
	  ,[osa17] = Cast([osa17] as int)
	  ,[nai17] = Cast([nai17] as int)
	  ,osa18 = cast(osa18 as int)
	  ,osa19 = cast(osa19 as int)
	  ,osa20 = cast(osa20 as int)
	  ,osa21 = cast(osa21 as int)
	  ,osa22 = cast(osa22 as int)
	  ,osa23 = cast(osa23 as int)
	  ,osa24 = cast(osa24 as int)
	  ,osa25 = cast(osa25 as int)
	  ,osa26 = cast(osa26 as int)
	  ,osa27 = cast(osa27 as int)
	  ,osa28 = cast(osa28 as int)
	  ,osa29 = cast(osa29 as int)
	  ,[eikoul]
...
SELECT [tilv]
	  ...
	  ,osa28
	  ,osa29
	  --,osa_vst_yhdistyneet = osa18+osa19+osa20+osa21+osa22+osa23
	  ,[eikoul]
	  ,[tietolahde] = '2_11_sopv_21'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv, tunn)
  FROM [TK_H9098_CSC].[dbo].[TK_2_11_sopv_21] f
...
SELECT [tilv]
	  ...
	  --,osa_vst_yhdistyneet = osa18+osa19+osa20+osa21+osa22+osa23
	  ,[eikoul]
	  ,[tietolahde] = '2_11_sopv_22'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv, tunn)
  FROM [TK_H9098_CSC].[dbo].[TK_2_11_sopv_22] f
