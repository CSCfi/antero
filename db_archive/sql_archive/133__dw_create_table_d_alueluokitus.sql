IF NOT EXISTS (select * from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA='dw' and TABLE_NAME='d_alueluokitus') BEGIN
...
;
ALTER TABLE dw.d_alueluokitus ADD  CONSTRAINT PK__d_alueluokitus PRIMARY KEY CLUSTERED (id ASC)
