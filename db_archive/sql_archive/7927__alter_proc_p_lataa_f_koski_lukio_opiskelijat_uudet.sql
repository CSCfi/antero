...
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_lukio_opiskelijat_uudet]    Script Date: 31.7.2023 16:54:40 ******/
SET ANSI_NULLS ON
GO
...
FROM (
	...
	FROM (
		...
		SELECT oo.[opiskeluoikeus_oid]
		  ...
		  WHERE (
			ps.suorituksen_tyyppi IN ('ibtutkinto', 'preiboppimaara', 'lukionoppiaineenoppimaara', 'lukionoppimaara', 'diatutkintovaihe', 'luva', 'internationalschooldiplomavuosiluokka', 'ebtutkinto', 'europeanschoolofhelsinkivuosiluokkasecondaryupper')
