...
USING (
  SELECT DISTINCT
    ...
    --
    -- 7.2.2019 /VHa  koulutusluokitus2016:sta puuttuu paljon koodeja, jotka löytyvät isced2011:sta
    --
    COALESCE([koulutusluokitus2016koulutusalataso1koodi],isced2011koulutusalataso1koodi,t.koodi) as koulutusluokitus2016koulutusalataso1koodi,
    COALESCE([koulutusluokitus2016koulutusalataso1nimi], isced2011koulutusalataso1nimi,  t.nimi) AS koulutusluokitus2016koulutusalataso1nimi,
    COALESCE([koulutusluokitus2016koulutusalataso1nimi_sv], isced2011koulutusalataso1nimi_sv,  t.nimi_sv) AS koulutusluokitus2016koulutusalataso1nimi_sv,
    COALESCE([koulutusluokitus2016koulutusalataso1nimi_en], isced2011koulutusalataso1nimi_en,  t.nimi_en) AS koulutusluokitus2016koulutusalataso1nimi_en,
    -- 7.2.2019 /VHa vanhat
