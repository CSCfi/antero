...
/****** Object:  View [dw].[v_haku_ja_valinta_toinen_aste_valmistava]    Script Date: 22.2.2022 11:01:22 ******/
SET ANSI_NULLS ON
GO
...
FROM dw.f_haku_ja_valinta_aloituspaikat_ja_pistemaarat f
	  ...
	  WHERE d1.korkeakouluhaku=0 and f.koulutuksen_alkamisvuosi>2013 and f.koulutuksen_alkamisvuosi<2022 and d1.hakuryhma_koodi = '2'
