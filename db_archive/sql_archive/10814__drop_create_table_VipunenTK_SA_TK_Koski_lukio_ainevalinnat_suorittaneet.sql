...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[TK_Koski_lukio_ainevalinnat_suorittaneet]') AND type in (N'U'))
DROP TABLE [dbo].[TK_Koski_lukio_ainevalinnat_suorittaneet]
GO
