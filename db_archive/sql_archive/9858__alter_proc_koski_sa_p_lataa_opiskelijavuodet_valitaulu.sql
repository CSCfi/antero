...
/****** Object:  StoredProcedure [dbo].[p_lataa_opiskelijavuodet_valitaulu]    Script Date: 17.5.2024 13:14:19 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	CROSS APPLY (
		/*Huom. TUVA-koulutuksesta päällekkäisissä huomioitu edeltävässä vaiheessa alustavasti vain [tuva_jarjestamislupa]='ammatillinen'*/
		SELECT 
