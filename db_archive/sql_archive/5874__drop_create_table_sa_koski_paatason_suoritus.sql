...
IF 2 != (
SELECT count(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'sa_koski_paatason_suoritus' AND TABLE_SCHEMA = 'sa' AND COLUMN_NAME = 'osaamisala_alku' OR COLUMN_NAME = 'osaamisala_loppu' 
)
BEGIN
...
CREATE TABLE [sa].[sa_koski_paatason_suoritus](
	...
	[osaamisala_alku] [datetime] NUlL,
	[osaamisala_loppu] [datetime] NUlL, 
