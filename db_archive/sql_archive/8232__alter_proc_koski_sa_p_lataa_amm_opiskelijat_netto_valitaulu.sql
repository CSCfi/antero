...
/****** Object:  StoredProcedure [dbo].[p_lataa_amm_opiskelijat_netto_valitaulu]    Script Date: 20.10.2023 8:13:43 ******/
SET ANSI_NULLS ON
GO
...
DROP TABLE IF EXISTS Koski_SA.sa.temp_amm_koski_opiskeluoikeus_hk
...
INTO Koski_SA.sa.temp_amm_koski_opiskeluoikeus_hk
...
BEGIN
	...
	LEFT JOIN Koski_SA.sa.temp_amm_koski_opiskeluoikeus_hk oo_hk on oo_hk.sisaltyy_opiskeluoikeuteen_oid = oo.opiskeluoikeus_oid and oo_hk.koulutustoimija_oid != oo.koulutustoimija_oid and oo_hk.rnk = 1
