...
/****** Object:  Table [api].[yo_opintopisteet_kuukausi]    Script Date: 22.11.2022 12:39:50 ******/
DROP TABLE IF EXISTS [api].[yo_opintopisteet_kuukausi]
GO
...
CREATE TABLE [api].[yo_opintopisteet_kuukausi](
