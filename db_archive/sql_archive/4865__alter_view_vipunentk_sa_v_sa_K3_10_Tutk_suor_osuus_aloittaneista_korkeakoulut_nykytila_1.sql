...
/****** Object:  View [dbo].[v_sa_K3_10_Tutk_suor_osuus_aloittaneista_korkeakoulut_nykytila_1]    Script Date: 10.9.2021 13:14:38 ******/
SET ANSI_NULLS ON
GO
...
--CSC Juha 10.9.2021:
--nykytilaan päivitys tehdään toistaiseksi osissa vasta myöhemmässä latauksessa
--korvaa tarvittaessa tähän ja toiseen osaan ,(.*)kmaak(.*) = coalesce(.*) -> ,\1kmaak\2 = coalesce(nullif((.*)kmaak(.*) = coalesce(.*) -> ,\1kmaak\2,'20'),'01')
