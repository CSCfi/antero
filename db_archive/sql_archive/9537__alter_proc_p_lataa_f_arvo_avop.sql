...
/****** Object:  StoredProcedure [dw].[p_lataa_f_arvo_avop]    Script Date: 29.1.2024 7:58:44 ******/
SET ANSI_NULLS ON
GO
...
and concat(d4.id, '_', d3.id) not in (SELECT avain FROM ANTERO.dbo.arvo_avop_temp)
