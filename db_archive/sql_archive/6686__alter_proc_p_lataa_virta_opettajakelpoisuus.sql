...
/****** Object:  StoredProcedure [sa].[p_lataa_virta_opettajakelpoisuus]    Script Date: 25.11.2022 15:54:15 ******/
SET ANSI_NULLS ON
GO
...
-- TEMP-tauluun kombinaatiot kelpoisuuskoodeista sekä kelpoisuuskoulujen korkeakoulu ja pvm
	...
	FROM (
		...
		WHERE ainepatevyys in ('gf','ms') and kelpoisuuskoodi1 in ('AI', 'JA', 'JB', 'JC')) f
