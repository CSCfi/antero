...
/****** Object:  View [dw].[v_virta_otp_kvliikkuvuus]    Script Date: 23.1.2020 12:05:33 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	...
	,case 
		when YEAR(f.tilannepvm)=2019 then 1
		when MONTH(f.tilannepvm)=3 AND DAY(f.tilannepvm)=20 then 1
	    else 1
	...
	,d11.liikkuvuudenkesto_sv as 'Mobilitetens läng'
