...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_opiskelija_ja_tutkinto_ennakko]    Script Date: 10.3.2023 9:11:54 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE  [dw].[p_lataa_f_virta_otp_opiskelija_ja_tutkinto_ennakko] AS
