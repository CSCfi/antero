...
/****** Object:  StoredProcedure [dw].[p_lataa_f_varda_kielipainotus2021]    Script Date: 3.5.2023 12:31:32 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dw].[p_lataa_f_varda_kielipainotus2021]
AS
...
BEGIN
	...
	FROM varda_sa.sa.sa_varda_kielipainotus2021 s1
