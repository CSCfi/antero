...
CREATE TABLE [sa].[sa_amos_suoritepaatos_rahoitusperusteet_ja_myonnetty_rahoitus_kaikki](
	...
	[Tutkintojen määrä] INT NULL,
	[Tutkintojen painotetut pisteet]  decimal(20,1),
	[Tutkinnon osien osaamispisteet] INT NULL,
	[Tutkinnon osien painotetut osaamispisteet]  decimal(20,1),
	[Tutkintojen ja tutkinnon osien painotetut pisteet yhteensä]  decimal(20,1) NULL,
	[Suoritusrahoitus yhteensä, €] INT NULL,
	[Työllistyneet ja jatko-opintoihin siirtyneet] INT NULL,
	[Työllistyneet ja jatko-opintoihin siirtyneet, painotetut pisteet]  decimal(20,1) NULL,
	[Työllistyneet ja jatko-opintoihin siirtyneet, €] INT NULL,
...
/****** Object:  Table [sa].[sa_amos_suoritepaatos_rahoitusperusteet_ja_myonnetty_rahoitus_kaikki]    Script Date: 22.11.2023 16.12.59 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[sa].[sa_amos_suoritepaatos_rahoitusperusteet_ja_myonnetty_rahoitus]') AND type in (N'U'))
DROP TABLE [sa].[sa_amos_suoritepaatos_rahoitusperusteet_ja_myonnetty_rahoitus]
GO
