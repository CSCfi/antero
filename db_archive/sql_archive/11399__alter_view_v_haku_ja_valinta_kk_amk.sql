...
/****** Object:  View [dw].[v_haku_ja_valinta_kk_amk]    Script Date: 18.11.2025 16.44.33 ******/
SET ANSI_NULLS ON
GO
...
--Englanti
	  ...
	  ,[Hakutapa järjestys] = case when d1.hakutapa_fi = 'Jatkuva haku' then 2 else jarjestys_hakutapa end
