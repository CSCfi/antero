...
/****** Object:  View [dbo].[v_f_tab_tutkintoon_johtamaton_koulutus]    Script Date: 16.3.2023 0:39:07 ******/
SET ANSI_NULLS ON
GO
...
Select
	  ...
	  ,Koulutukset2 = null
	  ,Osallistuneet2 = null
	  ,OsallistuneetNetto2 = null
	  ,OsallistuneetVst2 = null
	  ,OsallistuneetVstNetto2 = null
...
left join VipunenTK_lisatiedot.dbo.opetustuntien_sisalto_ja_tavoiteluokitus d2 on d2.id=f.opetustunti_id
...
Select
	  ...
	  ,OsallistuneetNetto2 = f.[Osallistuneiden lukumäärä (netto)]
	  ,OsallistuneetVst2 = null
	  ,OsallistuneetVstNetto2 = null
...
Select
	  ...
	  ,[Koulutuksen järjestäjä] = d3.koulutuksen_jarjestaja
	  ,[Oppilaitoksen omistajatyyppi] = d3.oppilaitoksen_omistajatyyppi
	  ,[Oppilaitostyyppi] = d3b.oppilaitostyyppi
	  ,[Oppilaitos] = d3.oppilaitos
	  ,[Oppilaitoksen maakunta] = d4.maakunta
	  ,[Oppilaitoksen kunta] = d4.kunta
	  ,[Oppilaitoksen opetuskieli] = d3.opetuskieli
	  --,[Oppilaitoskoodi] = coalesce(d3.oppilaitoksen_korvaavakoodi,d3.oppilaitoskoodi)
	  ,[Oppilaitoksessa annettu tutkintoon johtamatonta koulutusta] = null
	  ...
	  ,Osallistuneet2 = null
	  ,OsallistuneetNetto2 = null
	  ,OsallistuneetVst2 = f.lkm_brutto
	  ,OsallistuneetVstNetto2 = f.lkm_netto
	  ...
	  ,Utbildningsanordnare = d3.koulutuksen_jarjestaja_SV
	  ,[Läroanstaltens ägartyp] = d3.oppilaitoksen_omistajatyyppi_SV
	  ,[Läroanstaltstyp] = d3b.oppilaitostyyppi_SV
	  ,[Läroanstalt] = d3.oppilaitos_SV
	  ,[Läroanstaltens landskap] = d4.maakunta_SV
	  ,[Läroanstaltens kommun] = d4.kunta_SV
	  ,[Läroanstaltens undervisningsspråk] = d3.opetuskieli_SV
	  ...
	  ,[Education provider] = d3.koulutuksen_jarjestaja_EN
	  ,[Type of institution owner] = d3.oppilaitoksen_omistajatyyppi_EN
	  ,[Type of institution] = d3b.oppilaitostyyppi_EN
	  ,[Educational institution] = d3.oppilaitos_EN
	  ,[Region of the institution ] = d4.maakunta_EN
	  ,[Municipality of the institution] = d4.kunta_EN
	  ,[Language of the institution ] = d3.opetuskieli_EN
	  ...
	  ,[Opintoala jarj] = d2.Opintoala_lajittelu
	  ,[Omistajatyyppi jarj] = d3.jarjestys_omistajatyyppi
	  ,[Oppilaitostyyppi jarj] = d3b.jarjestys_oppilaitostyyppi
	  ,[Maakunta jarj] = d4.jarjestys_maakunta
	  ,[Opetuskieli jarj] = d3.jarjestys_opetuskieli
	  ,[Kyllaei d5 jarj] = 'ööö'

FROM [dbo].[f_2_11_Oppilaitosten_tutkintoon_johtamaton_vst_oppilaitostyyppi] f
left join VipunenTK.dbo.d_sukupuoli d1 on d1.id = -1
left join VipunenTK_lisatiedot.dbo.opetustuntien_sisalto_ja_tavoiteluokitus d2 on d2.Opetustuntikoodi = 'osa15' and f.tilv between d2.alkaa and d2.paattyy
left join VipunenTK.dbo.d_oppilaitoksen_taustatiedot d3 on d3.id = f.tunn_id
left join VipunenTK.dbo.d_oppilaitoksen_taustatiedot d3b on d3b.id = f.vst_oltyp_id
left join VipunenTK.dbo.d_alueluokitus d4 on d4.alueluokitus_avain = d3.sijaintikuntakoodi
