...
/****** Object:  View [dbo].[v_f_aloittaneiden_lapaisy_K3_10_amk]    Script Date: 27.9.2019 10:10:30 ******/
SET ANSI_NULLS ON
GO
...
SELECT
		...
		d5c.ikaryhma2_fi as [Ikäryhmä 3],
		...
		d5c.jarjestys_ikaryhma2 as  [Ikaryhma 3 jarj],
...
FROM     dbo.f_aloittaneiden_lapaisy f LEFT JOIN
			...
			dbo.d_ika as d5b on d5b.ika_avain = case 
												...
												LEFT join
			[ANTERO].[dw].[d_ika] as d5c on d5c.ika_avain = d5.ika LEFT JOIN
