USE [ANTERO]
GO
/****** Object:  View [dw].[v_virta_otp_lukuvuosimaksuvelvolliset]    Script Date: 13.11.2018 14:29:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dw].[v_virta_otp_lukuvuosimaksuvelvolliset]'))
EXEC dbo.sp_executesql @statement = N'
CREATE VIEW [dw].[v_virta_otp_lukuvuosimaksuvelvolliset] AS
...
FROM f_virta_otp_lukuvuosimaksuvelvolliset f
