...
/****** Object:  View [dw].[v_valos_koulutuksenkustannukset]    Script Date: 10.1.2023 11:23:48 ******/
SET ANSI_NULLS ON
GO
...
FROM
	(SELECT rekno,vuosi,ytunnus,kala,koulumto,OMISTAJA,KUNTA,VIRKUNTA,suorite,k100l01,k100l02,k100l03
	  FROM sa.sa_valos WHERE rekno=55 OR koulumto=133 or koulumto=134 or koulumto=135 or koulumto=140 or koulumto=141 or koulumto=142) p
UNPIVOT
	(summa FOR menolajitoiminto IN
