USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_amos_opiskelijapalaute_vastausosuudet_kertoimet]    Script Date: 21.12.2022 21:28:38 ******/
SET ANSI_NULLS ON
GO
...
FROM (
	...
	FROM (
		...
		FROM (
			...
			GROUP BY jl.ytunnus_amos_spl, jl.nimi_amos_spl, q1.Rahoituskausi, Kysely, [Kysely tarkenne]
...
ORDER BY ytunnus_amos_spl /*q4.organisaatio_koodi*/, nimi_amos_spl, Rahoituskausi
