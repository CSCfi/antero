...
d2.aloituspaikatLkm as aloituspaikat,
...
left join (select distinct HakukohdeOID,AlinLaskettuValintapistemaara from sa.sa_odw_hakeneet) d19 on d19.HakukohdeOID=d2.oid
