USE [VipunenTK_DW]
GO
/****** Object:  StoredProcedure [dbo].[p_lataa_OTV_f_2_8]    Script Date: 31.8.2017 10:22:34 ******/
SET ANSI_NULLS ON
GO
...
d1.aineisto_koodi=
(case
	when d50.aineisto like '2.8%' then (case when NOT EXISTS (SELECT 1 FROM dbo.f_2_8_Korkeakouluopiskelijat o WHERE o.aineisto='L' and o.tilastointivuosi=f.tilastointivuosi) then 'E' else 'L' end)
	else '-1'
end
)
