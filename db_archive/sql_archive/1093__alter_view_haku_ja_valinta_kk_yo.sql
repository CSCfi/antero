USE [ANTERO]
GO
/****** Object:  View [dw].[v_haku_ja_valinta_kk]    Script Date: 19.12.2017 17:43:45 ******/
SET ANSI_NULLS ON
GO
...
' 
GO
/****** Object:  View [dw].[v_haku_ja_valinta_kk_amk]    Script Date: 19.12.2017 17:43:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
where f.koulutuksen_alkamisvuosi > 2014 and d20.koulutussektori_koodi = ''4''
...
where (f.koulutuksen_alkamisvuosi > 2016 OR (f.koulutuksen_alkamisvuosi = 2016 and d9.selite_fi = ''Syksy''))
and d1.korkeakouluhaku = 1 and d6.koulutussektori_koodi = ''4''

' 
GO
/****** Object:  View [dw].[v_haku_ja_valinta_kk_yo]    Script Date: 19.12.2017 17:43:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SELECT --top 10
	  ...
	  ,[Sukupuoli] = d7.sukupuoli_fi
	  ,[Toisen asteen koulutuksen suoritusvuosi] = case f.toisen_asteen_koulutuksen_suoritusvuosi when ''-1'' then ''Tieto puuttuu'' else f.toisen_asteen_koulutuksen_suoritusvuosi end
	  ,[Tutkinnon taso] = f.hakukohteen_tutkinnon_taso_kk 
	  ,[Tutkinnon aloitussykli] = f.hakukohteen_tutkinnon_taso_kk_sykli
	  --,[Valinnan tila] = d23.valinnan_tila
	  --,[Vastaanoton tila] = d24.vastaanoton_tila
	  ,[Äidinkieli] = d8.kieliryhma1_fi
