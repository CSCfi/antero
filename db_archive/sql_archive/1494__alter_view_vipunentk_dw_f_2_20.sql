...
/****** Object:  View [dbo].[v_f_2_20_Lukio_amm_oppis_opisk_ian_ja_koul_mukaan]    Script Date: 28.3.2018 13:56:50 ******/
SET ANSI_NULLS ON
GO
 ...
 --vertailut     
	...
	,aiemman_tutkinnon_koulutusaste_taso2_sama  = 
	 CAST(
      (
		case
			when koulk_koulutusaste_taso2 = [kaste_t2_pex] then 'Aiemman tutkinnon koulutusaste sama'
			when koulk_koulutusaste_taso2 = [kaste_t2_lix] then 'Aiemman tutkinnon koulutusaste sama'
			when koulk_koulutusaste_taso2 = [kaste_t2_akx] then 'Aiemman tutkinnon koulutusaste sama'
			when koulk_koulutusaste_taso2 = [kaste_t2_ykx] then 'Aiemman tutkinnon koulutusaste sama'
		else 'Ei sama koulutusaste'
	...
	(
		case 
			when  alvv /*kirjoihintulovuosi*/ = tilv /*tilastointivuosi*/ and olosyys /*opiskelijan_olo_syys*/ in ('1','2') then lkm /*lukumaara*/
		end
	)
	as int)
