...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_opettajakelpoisuudet]    Script Date: 10.1.2023 9:16:37 ******/
SET ANSI_NULLS ON
GO
		...
		FROM (
			...
			FROM (
				...
				FROM (
					...
					INNER JOIN #temp_ope_pat3 p2 on p2.kelpoisuus in ('PE', 'ER') and p1.henkilo = p2.henkilo
					WHERE (p2.kelpoisuus = 'ER' and p1.kelpoisuus = 'VA') or (p1.kelpoisuus in ('AI', 'ER', 'VA') and p2.kelpoisuus = 'PE')
				) p
				OUTER APPLY (
