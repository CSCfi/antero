...
DROP TABLE IF EXISTS [sa].[sa_virta_otp_tk_opisk_ennakko_2024]

CREATE TABLE [sa].[sa_virta_otp_tk_opisk_ennakko_2024](
...
INSERT INTO [sa].[sa_virta_otp_tk_opisk_ennakko_2024] (	
	[aikielir1x]
    ,[aineisto]
    ,[allk]
    ,[alvv]
