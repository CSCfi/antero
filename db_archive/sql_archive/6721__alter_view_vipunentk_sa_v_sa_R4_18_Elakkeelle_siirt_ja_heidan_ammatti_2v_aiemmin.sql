...
/****** Object:  View [dbo].[v_sa_R4_18_Elakkeelle_siirt_ja_heidan_ammatti_2v_aiemmin]    Script Date: 1.12.2022 9:17:56 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
      ...
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
      ,'2' AS tietojen_ajankohta  
FROM [TK_H9098_CSC].[dbo].[TK_K4_18a_sopv_21] 
...
SELECT [tilv]
      ...
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
      ,'2' AS tietojen_ajankohta  
FROM [TK_H9098_CSC].[dbo].[TK_K4_18b_sopv_21]
...
SELECT [tilv]
      ...
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
      ,'2' AS tietojen_ajankohta  
FROM [TK_H9098_CSC].[dbo].[TK_K4_18a_sopv_22] 
...
SELECT [tilv]
      ...
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
      ,'2' AS tietojen_ajankohta  
FROM [TK_H9098_CSC].[dbo].[TK_K4_18b_sopv_22]
