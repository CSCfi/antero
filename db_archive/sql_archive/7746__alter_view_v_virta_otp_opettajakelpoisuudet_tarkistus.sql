...
/****** Object:  View [dw].[v_virta_otp_opettajakelpoisuudet_tarkistus]    Script Date: 23.5.2023 8:45:25 ******/
SET ANSI_NULLS ON
GO
...
SELECT
	...
	d8.organisaatio_fi as 'Osallinen korkeakoulu',
	d7.kytkin_fi as 'Kelpoisuus suoritettu yhdessä korkeakoulussa',
	d9.kytkin_fi as 'Kelpoisuus päätelty tutkinnosta'
...
LEFT JOIN ANTERO.dw.d_kytkin d9 on f.d_kytkin_paatelty_tutkinnosta_id = d9.id
