IF NOT EXISTS (
    ...
    where TABLE_SCHEMA='sa' and TABLE_NAME='sa_virta_otp_tkeriopepatevyydet'
) BEGIN

CREATE TABLE sa.sa_virta_otp_tkeriopepatevyydet(
...
ALTER TABLE sa.sa_virta_otp_tkeriopepatevyydet
