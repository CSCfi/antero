...
/****** Object:  View [dw].[v_haku_ja_valinta_kk_live_cultures]    Script Date: 18.5.2021 17:53:15 ******/
SET ANSI_NULLS ON
GO
...
SELECT --top 10
	...
	,[hakuaika_fi] = 
		coalesce(
			case 
				...
				else 'Muu kuin kevaan yhteishaun varsinainen haku'
			end
		,'Tieto puutuu')
	...
	,[toisen_asteen_koulutuksen_suoritusvuosi_sv] = case d_pohjakoulutuskk_id when '7' then  f.toisen_asteen_koulutuksen_suoritusvuosi when '8' then f.toisen_asteen_koulutuksen_suoritusvuosi when '15' then f.toisen_asteen_koulutuksen_suoritusvuosi Else 'Tieto puuttuu' end
	...
	,[hakuaika_sv] = 
		coalesce(
			case 
				when d25.hakutapa_koodi = '01' and d25.hakutyyppi_koodi = '01' and d2.koodi = 'S' /* d31.selite_sv in ('Haku 1 / Hakuaika 1','Haku 2 / Hakuaika 2')*/ then d31.selite_sv 
				else 'Muu kuin kevaan yhteishaun varsinainen haku'
			end
		,'Tieto puutuu')
	...
	,[toisen_asteen_koulutuksen_suoritusvuosi_en] = case d_pohjakoulutuskk_id when '7' then  f.toisen_asteen_koulutuksen_suoritusvuosi when '8' then f.toisen_asteen_koulutuksen_suoritusvuosi when '15' then f.toisen_asteen_koulutuksen_suoritusvuosi Else 'Tieto puuttuu' end
	...
	,[hakuaika_en] = 
		coalesce(
			case 
				when d25.hakutapa_koodi = '01' and d25.hakutyyppi_koodi = '01' and d2.koodi = 'S' /* d31.selite_en in ('Haku 1 / Hakuaika 1','Haku 2 / Hakuaika 2')*/ then d31.selite_en 
				else 'Muu kuin kevaan yhteishaun varsinainen haku'
			end
		,'Tieto puutuu')
