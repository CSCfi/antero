...
/****** Object:  View [dbo].[v_sa_4_8_Tutkinnon_suorittaneiden_myohempi_koulutus]    Script Date: 23.6.2022 4:11:27 ******/
SET ANSI_NULLS ON
GO
...
SELECT [suorv]
      ...
      ,[lkm]
      ,[luontipvm]
	  ,tilv = (select max(lusuorv) FROM [TK_H9098_CSC].[dbo].[TK_K4_8_sopv_22])
      ,[tietolahde]='TK_4_8_sopv_22'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY koulk)
FROM [TK_H9098_CSC].[dbo].[TK_K4_8_sopv_22]
