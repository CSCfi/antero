...
/****** Object:  StoredProcedure [dw].[p_lataa_f_arvo_kandi]    Script Date: 31.1.2022 8:55:56 ******/
SET ANSI_NULLS ON
GO
...
SELECT * INTO #uudetkysymykset FROM (
...
FROM (
	...
	LEFT JOIN #uudetkysymykset AS uk ON uk.kysymys_fi = f3.kysymys_fi AND uk.kysymys_sv = f3.kysymys_sv AND uk.kysymys_en = f3.kysymys_en
...
DROP TABLE IF EXISTS #uudetkysymykset
