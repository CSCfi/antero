...
/****** Object:  View [dw].[v_koski_perusopetus_ainevalinnat_ja_arvosanat_cultures]    Script Date: 4.10.2023 20:08:28 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dw].[v_koski_perusopetus_ainevalinnat_ja_arvosanat_cultures] AS
...
SELECT 
  ...
  --hlö
	...
	,[aidinkieli_ryhma_fi] = d3.kieliryhma2_fi
  ...
  --koulutus
	...
	,[oppiaineryhma_II_fi] = case when d16.ryhma2_koodi != 'kie' then d16.ryhma2_nimi else d17.ryhma2_nimi end
  ...
  --jarj
	...
	,[jarjestys_aidinkieli_ryhma] = d3.jarjestys_kieliryhma2
	...
	,[jarjestys_oppiaineryhma_II] = case when d16.ryhma2_koodi != 'kie' then d16.jarjestys_ryhma2 else d17.jarjestys_ryhma2 end
...
--SV
  ...
  --hlö
	...
	,[aidinkieli_ryhma_sv] = d3.kieliryhma2_sv
  ...
  --koulutus
	...
	,[oppiaineryhma_II_sv] = case when d16.ryhma2_koodi != 'kie' then d16.ryhma2_nimi_sv else d17.ryhma2_nimi_sv end
