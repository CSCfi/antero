...
/****** Object:  Table [dbo].[f_R4_23_Tyollisten_ammattisiirtymat]    Script Date: 1.3.2024 13:52:28 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[f_R4_23_Tyollisten_ammattisiirtymat]') AND type in (N'U'))
...
CREATE TABLE [dbo].[f_R4_23_Tyollisten_ammattisiirtymat](
	...
	[oef_toimiala_avain] [varchar](3) NULL,
	[mitenna_ammattiryhma2_koodi] [varchar](17) NULL,
	[oef_ammattiryhma2_koodi] [varchar](17) NULL,
	...
	[oef_ammattiryhma2_siirtyman_paassa_koodi] [varchar](17) NULL,
