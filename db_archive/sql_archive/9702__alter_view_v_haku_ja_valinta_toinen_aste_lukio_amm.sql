...
/****** Object:  View [dw].[v_haku_ja_valinta_toinen_aste_lukio_amm]    Script Date: 15.3.2024 11:58:03 ******/
SET ANSI_NULLS ON
GO
...
where  f.koulutuksen_alkamisvuosi>2013 and d25.korkeakouluhaku=0 and d25.hakuryhma_koodi in('1','6')
and d25.hakutapa_koodi='01'
...
SELECT distinct --top 0
	  ...
	  ,[Pohjakoulutuksen oppilaitostyyppi] = NULL
...
--Ruotsi
	  ...
	  ,[Grundutbildningens läroanstaltstyp] = null
...
--Englanti
	  ...
	  ,[Type of institution of prior education] = null
	...
	/* Koodimuuttujat */
	  ...
	  ,[Kansalaisuus (maanosa) järjestys] = '999999'
	  ,[Kansalaisuus järjestys] = '999999'
	  ,[Kiinnostunut oppiksesta järjestys] = 999999
	  ,[Kotipaikan maakunta järjestys] = '999999'
	  ,[Kotipaikan kunta järjestys] = '999999'
	  ...
	  ,[Pohjakoulutus järjestys] = '999999'
	  ...
	  ,[Pohjakoulutuksen järjestäjä järjestys] = '999999'
	  ,[Pohjakoulutuksen oppilaitos järjestys] = '999999'
	  ,[Pohjakoulutuksen oppilaitostyyppi järjestys] = '999999'
	  ,[Pohjakoulutuksen oppilaitoksen opetuskieli järjestys] = '9'
...
WHERE d1.korkeakouluhaku=0 and f.koulutuksen_alkamisvuosi>2013 and d1.hakuryhma_koodi in('1','6')
and d1.hakutapa_koodi='01'
