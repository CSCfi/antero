...
CREATE OR ALTER VIEW [dw].[v_amos_koonti_laaja] AS
...
FROM (  
	...
	SELECT
		...
		,Oppilaitos --_s = 'Tieto puuttuu'
		,[Oppilaitoksen kunta] --_s = 'Tieto puuttuu'
		,[Oppilaitoksen maakunta] --_s = 'Tieto puuttuu'
		,jarj_oppilaitoksen_maakunta = [jarj Koulutuksen järjestäjän maakunta] --_s = 99999
		,Toimipiste = 'Tieto puuttuu'
		,[Toimipisteen kunta] = 'Tieto puuttuu'
		,[Toimipisteen maakunta] = 'Tieto puuttuu'
		,jarjestys_toimipisteen_maakunta = 99999
		...
		,Tutkinto --_s = 'Tieto puuttuu'
		,[Koodit Tutkinto] --_s = -1
		,[Koulutusala, taso 1] --_s = 'Tieto puuttuu'
		,[jarjestys Koulutusala, taso 1] --_s = 99999
		,[Koulutusala, taso 2] --_s = 'Tieto puuttuu'
		,[jarjestys Koulutusala, taso 2] --_s = 99999
		,[Koulutusala, taso 3] --_s = 'Tieto puuttuu'
		,[jarjestys Koulutusala, taso 3] --_s = 99999
		,[Rahoitusmuoto hyväksytään] = 'Rahoitusmuoto hyväksytään'
