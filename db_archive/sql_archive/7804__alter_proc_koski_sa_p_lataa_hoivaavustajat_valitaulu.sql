...
/****** Object:  StoredProcedure [dbo].[p_lataa_hoivaavustajat_valitaulu]    Script Date: 29.6.2023 21:17:14 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	SELECT DISTINCT
		...
		,coalesce(oo_pat.oppilaitos_oid, tt_pat.oppilaitos_oid) as oppilaitos_oid_oo_pat
		...
		,coalesce(oo_tutk.oppilaitos_oid, tt_tutk.oppilaitos_oid) as oppilaitos_oid_oo_tutk
	...
	--pätevyys ("pat"); tutkintotodistus/opiskeluoikeus ("tt"/"oo") <-> pihvi/kuori hankintakoulutuksen tapauksessa 
