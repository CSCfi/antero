...
/****** Object:  View [dbo].[v_sa_R2_22_Oppilaitostason_oppil_ja_opisk]    Script Date: 23.6.2022 1:28:55 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
  ...
  --(päivähoidon raportointi 2.18-ketjussa)
  --2.22b: 
  --aikuisilla opiskelijoilla aik null, alkuvaihetta ei eroteltu 
  --sopv21 luokattomia suorittaneita joilta puuttuu tilastovuosi
  --sopv22 suorittaneita aikuisia liikaa (kysytty kootusti 23.6.)
  WHERE luokka <> '00' or esi = '2' --or oppilas = '2' or aik = '1'
...
SELECT [tilv]
  ...
  --sopv21 luokattomia suorittaneita joilta puuttuu tilastovuosi
  --sopv22 suorittaneita aikuisia liikaa (kysytty kootusti 23.6.)
  WHERE luokka <> '00' or esi = '2' --or aik = '1' or oppilas = '2'
  GROUP BY tilv, jarj, tunn
