...
/****** Läpäisy ******/
 SELECT
      ...
      ,[tutkinnot] = NULL
	  ,case when tarkastelujakso='7,5' and (d6.koulutuslaji2_koodi='51b'  OR (d2.koulutus_koodi in (612101, 613101,613401,672401))) then f_aloittaneiden_lapaisy.lkm_int else 0 end AS 'YO_7v_aloittaneet_lkm'
	  ...
	  ,case when tarkastelujakso='7,5' and (d6.koulutuslaji2_koodi='51b'  OR (d2.koulutus_koodi in (612101, 613101,613401,672401))) and [1a Aloittaneiden opintojen kulku koulutuslajin mukaan prioriteettina mikä tahansa tutkinto]='Tutkinto alkuperäisessä tutkintolajissa' then f_aloittaneiden_lapaisy.lkm_int else 0 end AS '7v_suorittaneet_lkm'
