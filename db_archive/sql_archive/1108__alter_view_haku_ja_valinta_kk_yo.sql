...
/****** Object:  View [dw].[v_haku_ja_valinta_kk_yo]    Script Date: 21.12.2017 11:27:04 ******/
SET ANSI_NULLS ON
GO
...
SELECT --top 10
	  ...
	  ,[Tutkinnon taso] = case when f.hakukohteen_tutkinnon_taso_kk = 'Tutkintoon johtamaton koulutus' and d3.selite_fi not like 'Ammatillinen%' then 'Tieto puuttuu' else hakukohteen_tutkinnon_taso_kk end 
	  ,[Tutkinnon aloitussykli] = case when f.hakukohteen_tutkinnon_taso_kk_sykli = 'Tutkintoon johtamaton koulutus' and d10.selite_fi not like 'Ammatillinen%' then 'Tieto puuttuu' else hakukohteen_tutkinnon_taso_kk_sykli end 
...
Select distinct --top 0
	  ...
	  ,[Tutkinnon taso (hakukohde)] = case when f.hakukohteen_tutkinnon_taso_kk = 'Tutkintoon johtamaton koulutus' and d3.selite_fi not like 'Ammatillinen%' then 'Tieto puuttuu' else hakukohteen_tutkinnon_taso_kk end 
	  ,[Tutkinnon aloitussykli (hakukohde)] = case when f.hakukohteen_tutkinnon_taso_kk_sykli = 'Tutkintoon johtamaton koulutus' and d3.selite_fi not like 'Ammatillinen%' then 'Tieto puuttuu' else hakukohteen_tutkinnon_taso_kk_sykli end 
	  --,[Valinnan tila] = NULL
