...
/****** Object:  View [dbo].[v_f_tab_tutkinnon_suorittaneiden_aikaisempi_koulutus_yhteiset]    Script Date: 21.12.2023 14:03:46 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER  VIEW [dbo].[v_f_tab_tutkinnon_suorittaneiden_aikaisempi_koulutus_yhteiset] AS
...
,ISNULL(NULLIF([ylamksuorv],''),'Tuntematon') as "Ylemm‰n amk-tutk. suoritusvuosi"
,ISNULL(NULLIF([ykksuorv],''),'Tuntematon')  as "Ylemm‰n kk-tutk. suoritusvuosi"
,ISNULL(NULLIF([laakersuorv],''),'Tuntematon') as "L‰‰k. erikois.tutk. suoritusvuosi"
