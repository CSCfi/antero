...
/****** Object:  View [dw].[v_virta_otp_opettajakelpoisuudet_jaadytys_cultures]    Script Date: 23.8.2023 11:00:50 ******/
SET ANSI_NULLS ON
GO
...
DROP VIEW IF EXISTS [dw].[v_virta_otp_opettajakelpoisuudet_jaadytys]

GO

CREATE OR ALTER VIEW [dw].[v_virta_otp_opettajakelpoisuudet_jaadytys_cultures] AS
