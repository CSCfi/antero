...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_ainekelpoisuudet]    Script Date: 20.12.2022 14:21:38 ******/
SET ANSI_NULLS ON
GO
...
FROM (
	...
	LEFT JOIN ANTERO.dw.d_virta_patevyydet d on d.patevyys_koodi = pat.patevyyskoodi
	INNER JOIN ANTERO.sa.sa_virta_otp_ope_patevyydet pat2 on pat.henkilo = pat2.henkilo and pat2.patevyyskoodi in ('ik', 'il', 'im','ja','jb','jc', 'ir', 'jd', 'oa')
