...
CREATE OR ALTER PROCEDURE [dw].[p_lataa_f_amos_opiskelijapalaute] AS

--sis. estimaattikauden generointi, poisrajattu vanhan mallin kuutiosta
--koodiarvoja mukana, jotta voidaan prosessoida kuutiot myös muiden rahoitusperusteiden yhteydessä
