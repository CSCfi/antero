...
/****** Object:  View [dw].[v_virta_otp_ainekelpoisuudet_jaadytys]    Script Date: 7.6.2023 13:38:49 ******/
SET ANSI_NULLS ON
GO
...
ALTER   VIEW [dw].[v_virta_otp_ainekelpoisuudet_jaadytys] AS
...
SELECT		
	...
	,d7.kytkin_fi as 'Kelpoisuus päätelty tutkinnosta'
