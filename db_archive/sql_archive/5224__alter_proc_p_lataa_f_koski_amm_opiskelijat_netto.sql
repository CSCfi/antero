USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_amm_opiskelijat_netto]    Script Date: 8.12.2021 21:23:11 ******/
SET ANSI_NULLS ON
GO
...
SELECT
	...
	,valma1_telma2 = MIN(case when d11.koulutusluokitus_fi like '%VALMA%' then 1 when d11.koulutusluokitus_fi like '%TELMA%' then 2 end)
...
LEFT JOIN dw.d_kytkin d10 ON d10.kytkin_koodi = '-1'--k.vankilaopetus
