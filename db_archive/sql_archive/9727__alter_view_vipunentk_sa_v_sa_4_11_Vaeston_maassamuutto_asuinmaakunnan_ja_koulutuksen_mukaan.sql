...
/****** Object:  View [dbo].[v_sa_4_11_Vaeston_maassamuutto_asuinmaakunnan_ja_koulutuksen_mukaan]    Script Date: 2.4.2024 17:24:31 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
      ,[asmaak]
      ,[koulk] = case when koulk = '' then '999999' else koulk end
      ,[sisaanmuutto]
      ,[ulosmuutto]
      ,[luontipvm]
...
--SELECT [tilv]
--      ,[asmaak]
--      ,[koulk] = case when nullif(koulk, '') = '201101' then '999999' else koulk end
--      ,[sisaanmuutto]
--      ,[ulosmuutto]
--      ,[luontipvm]
...
SELECT [tilv]
      ,[asmaak]
      ,[koulk] = case when koulk = '201101' then '999999' else koulk end
      ,[sisaanmuutto]
      ,[ulosmuutto]
      ,[luontipvm]
...
SELECT [tilv]
      ...
      ,[ulosmuutto]
      ,[luontipvm]
      ,[tietolahde]='TK_4_11_sopv_22'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv, asmaak, koulk)
FROM [TK_H9098_CSC].[dbo].[TK_4_11_sopv_22]
...
SELECT [tilv]
      ...
      ,[ulosmuutto]
      ,[luontipvm]
      ,[tietolahde]='TK_4_11_sopv_23'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv, asmaak, koulk)
FROM [TK_H9098_CSC].[dbo].[TK_4_11_sopv_23]
...
SELECT [tilv]
      ...
      ,[ulosmuutto]
      ,[luontipvm]
      ,[tietolahde]='TK_4_11_sopv_24'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv, asmaak, koulk)
FROM [TK_H9098_CSC].[dbo].[TK_4_11_sopv_24]
