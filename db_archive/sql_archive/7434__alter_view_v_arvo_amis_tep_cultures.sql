...
/****** Object:  View [dw].[v_arvo_amis_tep_cultures]    Script Date: 1.3.2023 12:50:22 ******/
SET ANSI_NULLS ON
GO
...
/*
Huom!
Yrityksen ja sen toimipaikan käännösavaimet tässä osin vanhassa muodossa, selitteet löytyvät käännöstaulusta koodien "yrityksen_yhteison.." sekä "tyopaikan.." alta.
Erityisesti käännökset ja kansio eroavat muualla (koulutuksen) toimipaikalle käytettävistä, joten huomioitava jos luodaan kuutio uusiksi.
*/
...
--FI
	...
	,d12.selite_fi								AS 'oppisopimuksen_perusta_fi'
												...
												--RAHOITUSMALLIMUUTTUJAT
	--poistettu ks. CSCVIPUNEN-3260
	--,d17.selite_fi								AS 'rahoitusryhma_fi'
...
--SV
	...
	,d12.selite_sv								AS 'oppisopimuksen_perusta_sv'
												...
												--RAHOITUSMALLIMUUTTUJAT
	--poistettu ks. CSCVIPUNEN-3260
	--,d17.selite_sv								AS 'rahoitusryhma_sv'
...
--EN
	...
	,d12.selite_en								AS 'oppisopimuksen_perusta_en'
												...
												--RAHOITUSMALLIMUUTTUJAT
	--poistettu ks. CSCVIPUNEN-3260
	--,d17.selite_en								AS 'rahoitusryhma_en'
...
--poistettu ks. CSCVIPUNEN-3260
--LEFT JOIN dw.d_rahoitusryhma d17 ON d17.id = f.d_rahoitusryhma_id
CROSS APPLY (
	SELECT
		viive =
			CASE
				WHEN d5.kyselypohja_tarkenne_fi = 'Työelämäpalaute: työpaikkaohjaajan kysely' THEN 3
				WHEN d5.kyselypohja_tarkenne_fi = 'Työelämäpalaute: työpaikkakysely' THEN
					CASE WHEN MONTH(GETDATE()) BETWEEN 3 AND 8 THEN MONTH(GETDATE()) ELSE (MONTH(GETDATE())+6) % 12 END --vasta maalis-/syyskuussa edellinen puolivuotisjakso
			END
) ca
