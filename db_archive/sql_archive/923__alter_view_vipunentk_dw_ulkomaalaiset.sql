...
/****** Object:  View [dbo].[v_f_ulkomaalaiset_maan_kansalaisuuden_aidinkielen_mukaan_2_13_14_15]    Script Date: 20.10.2017 17:27:28 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN VipunenTK.dbo.d_hallinnonala2 d_ha 
	...
	(case
		when f.opetushallinnon_koulutus = '1' then '1' --Opetushallinto, työvoimakoulutus
		when f.opetushallinnon_koulutus = '2' and d_ksm.maakunta_koodi <> '21' and d_kl.opintoala2002_koodi not in ('902','903','904')  /*'Ålands Landskapsregering','Poliisiammattikorkeakoulu','Rikosseuraamusalan Koulutuskeskus','Pelastusopisto'*/ then '2' --Opetushallinto, pl. työvoimakoulutus
