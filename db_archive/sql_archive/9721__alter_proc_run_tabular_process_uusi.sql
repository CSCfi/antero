...
/****** Object:  StoredProcedure [dbo].[run_tabular_process_uusi]    Script Date: 25.3.2024 17:52:44 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dbo].[run_tabular_process_uusi]
  @buildID int NULL,
...
/*
HUOM. prod tab22-yliheiton jälkeen täytyy poistaa ulompi korvausehto alla
*/
N'
Import-Module SqlServer

[string]$server = "' + replace(replace(@sqlServer, 'sql', 'tab'), '22', case when @env='prod' then '16' else '22' end) + '"
