...
/****** Object:  View [dbo].[v_f_tab_ulkomaalaiset_maan_kansalaisuuden_aidinkielen_mukaan_amm]    Script Date: 7.1.2021 22:25:17 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_f_tab_ulkomaalaiset_maan_kansalaisuuden_aidinkielen_mukaan_amm] AS
SELECT
	  ...
	  ,d15.koulutuslaji4 AS 'Koulutuslaji II'
	  ...
	  ,d15.koulutuslaji4_SV AS 'Utbildningsslag II'
	  ...
	  ,d15.koulutuslaji4_EN AS [Form of education and training II]
...
WHERE koulutusaste2002_koodi = 32 
--AND d13.opiskelijan_olo_koodi <> '-1'
