USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_arvo_uraseuranta]    Script Date: 18.4.2018 12:01:13 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dw].[p_lataa_f_arvo_uraseuranta]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dw].[p_lataa_f_arvo_uraseuranta] AS' 
END
GO


ALTER PROCEDURE [dw].[p_lataa_f_arvo_uraseuranta] AS

TRUNCATE TABLE dw.f_arvo_uraseuranta

INSERT INTO dw.f_arvo_uraseuranta (
...
SELECT
  ...
  f.[taustatiedot.lasnaolo_lukukausia] as lasnaolo_lukukausia,
...
--INTO ANTERO.dw.f_arvo_uraseuranta
