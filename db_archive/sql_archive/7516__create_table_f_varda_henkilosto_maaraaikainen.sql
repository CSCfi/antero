...
/****** Object:  Table [dw].[f_varda_henkilosto_maaraaikainen]    Script Date: 30.3.2023 13:37:15 ******/
SET ANSI_NULLS ON
GO
...
if not exists (select * from sysobjects where name='f_varda_henkilosto_maaraaikainen' and xtype='U')
