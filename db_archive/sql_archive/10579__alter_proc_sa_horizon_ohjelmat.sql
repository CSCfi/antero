...
/****** Object:  StoredProcedure [dw].[p_lataa_d_horizon_ohjelma]    Script Date: 17.2.2025 15.35.17 ******/
SET ANSI_NULLS ON
GO
...
USING (
	...
	WHERE programme_id is not null and ((programme_id = 'HORIZON' and shortTitle like 'Horizon Europe%') or programme_id <> 'HORIZON')
	) AS src
