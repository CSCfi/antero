...
/*
1. muodostetaan tulevalle varainhoitovuodelle (alustava) järjestäjärakenne
2. liitetään edellisen varainhoitovuoden laskennallinen rahoitus ilman harkinnanvaraista korotusta
3. alustetaan tulevan varainhoitovuoden rahoituksen laskentaan tarvittavat osuudet, painot ja rajoitteet
*/
...
FROM (
	SELECT DISTINCT 
		Vuosi = (
			...
			where Vuosi <= year(getdate()) --aloitetaan uuden kauden estimointi vasta viimeisellä vuosipuolikkaalla
		) 
		,ytunnus_amos_spl
		,nimi_amos_spl
