USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_amos_spl_vaikuttavuus]    Script Date: 9.12.2022 17:43:46 ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT 
	...
	,[jarjnimi_tutk] = COALESCE(CASE WHEN jarjnimi_tutk = 'NULL' THEN NULL ELSE jarjnimi_tutk END, CASE WHEN jarj_opisk = 'NULL' THEN NULL ELSE jarj_opisk END)
    ,[jarjmaak]
    ,[jarjmaaknimi]
    ,[tutkmaak]
    ,[tutkmaaknimi]
