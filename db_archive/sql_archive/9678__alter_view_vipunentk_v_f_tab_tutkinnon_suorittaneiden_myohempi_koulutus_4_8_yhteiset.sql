...
/****** Object:  View [dbo].[v_f_tab_tutkinnon_suorittaneiden_myohempi_koulutus_4_8_yhteiset]    Script Date: 28.2.2024 13:10:53 ******/
SET ANSI_NULLS ON
GO
...
,ISNULL(NULLIF(CAST([lusuorv] as varchar(40)),'') ,'Ei myöhempää tutkintoa') as "Yo-tutkinnon suoritusvuosi"
,ISNULL(NULLIF(CAST([ammsuorv] as varchar(40)),''),'Ei myöhempää tutkintoa') as "Amm. tutkinnon suoritusvuosi"
,ISNULL(NULLIF(CAST([opistsuorv] as varchar(40)),''),'Ei myöhempää tutkintoa') as "Opistoast. tutkinnon suoritusvuosi"
,ISNULL(NULLIF(CAST([ammkasuorv] as varchar(40)),''),'Ei myöhempää tutkintoa') as "Amm. kork.asteen tutk. suoritusvuosi"
,ISNULL(NULLIF(CAST([amksuorv] as varchar(40)),''),'Ei myöhempää tutkintoa') as "Amk-tutkinnon suoritusvuosi"
,ISNULL(NULLIF(CAST([akksuorv] as varchar(40)),''),'Ei myöhempää tutkintoa') as "Alemman kk-tutk. suoritusvuosi"
,ISNULL(NULLIF(CAST([ylamksuorv] as varchar(40)),''),'Ei myöhempää tutkintoa') as "Ylemmän amk-tutk. suoritusvuosi"
,ISNULL(NULLIF(CAST([ykksuorv] as varchar(40)),''),'Ei myöhempää tutkintoa')  as "Ylemmän kk-tutk. suoritusvuosi"
,ISNULL(NULLIF(CAST([laakersuorv] as varchar(40)),''),'Ei myöhempää tutkintoa') as "Lääk. erikois.tutk. suoritusvuosi"
,ISNULL(NULLIF(CAST([lissuorv] as varchar(40)),''),'Ei myöhempää tutkintoa')  as "Lisensiaatin tutk. suoritusvuosi"
,ISNULL(NULLIF(CAST([tohtsuorv] as varchar(40)),''),'Ei myöhempää tutkintoa') as "Tohtorin tutk. suorituvuosi"
