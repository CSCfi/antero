...
/****** Object:  View [dw].[v_amos_spl_koski_osasuoritus_pl_eivos]    Script Date: 9.8.2019 16:36:29 ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT
  ...
  (
	...
	SELECT 
		...
		case 
			when isnumeric(os.koulutusmoduuli_koodiarvo)= 1 and os.koulutusmoduuli_koodiarvo not like '0%' and os.koulutusmoduuli_koodiarvo not like '%.%' 
				then convert(BIGINT, os.koulutusmoduuli_koodiarvo) 
			else NULL 
