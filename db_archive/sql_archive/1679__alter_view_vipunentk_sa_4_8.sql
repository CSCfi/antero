...
/****** Object:  View [dbo].[v_sa_4_8_Tutkinnon_suorittaneiden_myohempi_koulutus]    Script Date: 14.6.2018 17:58:11 ******/
SET ANSI_NULLS ON
GO
...
SELECT [suorv]
      ...
      ,[tietolahde]='TK_4_8_sopv_18'
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY koulk)
  FROM [TK_H9098_CSC].[dbo].[TK_4_8_sopv_18]
