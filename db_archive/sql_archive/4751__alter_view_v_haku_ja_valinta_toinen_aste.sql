...
/****** Object:  View [dw].[v_haku_ja_valinta_toinen_aste]    Script Date: 10.8.2021 21:22:05 ******/
SET ANSI_NULLS ON
GO
...
--Englanti
	...
	/* Koodimuuttujat */
	  ...
	  ,[Hakukohteen toimipiste järjestys] = case when d8c.organisaatio_fi='Tieto puuttuu' then '999999' else left(d8c.organisaatio_fi,20) end
