...
/****** Object:  StoredProcedure [dbo].[p_lataa_OTV_f_2_3]    Script Date: 26.9.2024 12:04:16 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	...
	,tuva_opiskeluoikeus_amm_id = coalesce(d44.id, -1)
	,f.aloittaneet
	,f.opiskelijat
	,f.opiskelijat_lasna
	,aineisto_id = -1
...
LEFT JOIN VipunenTK..d_kylla_ei d44 ON d44.kylla_ei_koodi = f.tuva_opiskeluoikeus_amm
