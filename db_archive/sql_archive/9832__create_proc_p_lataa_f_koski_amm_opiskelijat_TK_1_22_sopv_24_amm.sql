...
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_amm_opiskelijat_TK_1_22_sopv_24_amm]    Script Date: 10.5.2024 18:12:26 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dw].[p_lataa_f_koski_amm_opiskelijat_TK_1_22_sopv_24_amm] AS

DROP TABLE IF EXISTS dw.f_koski_amm_opiskelijat_TK_1_22_sopv_24_amm
...
INTO dw.f_koski_amm_opiskelijat_TK_1_22_sopv_24_amm
...
FROM (
	...
	SELECT DISTINCT
		...
		,oppivelvollinen 
		,samanaikainen_tuva
	FROM Koski_SA.dbo.amm_opiskelijat_valitaulu_TK_1_22_sopv_24_amm sa
