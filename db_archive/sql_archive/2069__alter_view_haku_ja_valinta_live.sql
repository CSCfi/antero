...
/****** Object:  View [dw].[v_haku_ja_valinta_kk_live]    Script Date: 29.1.2019 14:18:47 ******/
SET ANSI_NULLS ON
GO
...
--Apusarakkeet mittareille	    
	  ...
	  ,[Hakuaika järjestys] = case when d31.selite_fi IN ('Hakuaika 1','Hakuaika 2') then 1 else 2 end
...
Select distinct --top 0
	  ...
	  ,[Hakuaika järjestys] = case when d13.selite_fi IN ('Hakuaika 1','Hakuaika 2') then 1 else 2 end
