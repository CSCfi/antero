...
/****** Object:  View [dbo].[v_f_tab_yosairaalojen_tutkimus_ja_kehitys]    Script Date: 15.2.2022 13:28:20 ******/
SET ANSI_NULLS ON
GO
...
--Rahoitus- ja menomuuttujat
		  ,'Rahoituslähde' = case when f.rahoituslahde_avain = 'OKM_Perus_ORAHAS' then 'Perusrahoitus ja oma rahoitus' else d_tutkimuksen_rahoituslahde.rahoituslahde end
          ...
          ,'Rahoituslähdetarkennus' = case when f.rahoituslahde_avain = 'OKM_Perus_ORAHAS' then 'perusrahoitus ja oma rahoitus' else d_tutkimuksen_rahoituslahde.rahoituslahdetarkennus end
...
--Rahoitus- ja menomuuttujat
          ,'Finansieringskälla' = case when f.rahoituslahde_avain = 'OKM_Perus_ORAHAS' then 'Basfinansiering och egen finansiering' else d_tutkimuksen_rahoituslahde.rahoituslahde_SV end
          ...
          ,'Spec. av finansieringskällan' = case when f.rahoituslahde_avain = 'OKM_Perus_ORAHAS' then 'basfinansiering och egen finansiering' else d_tutkimuksen_rahoituslahde.rahoituslahdetarkennus_SV end
...
--Rahoitus- ja menomuuttujat
          ,'Source of funding I' = case when f.rahoituslahde_avain = 'OKM_Perus_ORAHAS' then 'Basic funding and self-financing' else d_tutkimuksen_rahoituslahde.rahoituslahde_EN end
          ...
          ,'Source of funding II' = case when f.rahoituslahde_avain = 'OKM_Perus_ORAHAS' then 'basic funding and self-financing' else d_tutkimuksen_rahoituslahde.rahoituslahdetarkennus_EN end
