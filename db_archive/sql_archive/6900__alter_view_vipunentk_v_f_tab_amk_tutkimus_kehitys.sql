...
/****** Object:  View [dbo].[v_f_tab_amk_tutkimus_kehitys]    Script Date: 13.1.2023 20:04:59 ******/
SET ANSI_NULLS ON
GO
...
WHERE oppilaitoskoodi <> 02557 AND oppilaitoskoodi <> 10031 AND ((Tilastovuosi != '2011' AND d_tutkimuksen_rahoituslahde.rahoituslahde <> 'EU yhteensä') OR Tilastovuosi = '2011')
