USE [VipunenTK_DW]
GO
/****** Object:  Table [dbo].[f_2_8e_Korkeakouluopiskelijat]    Script Date: 18.9.2017 15:53:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[f_2_8e_Korkeakouluopiskelijat]') AND type in (N'U'))
BEGIN
