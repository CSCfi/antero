...
/****** Object:  View [dbo].[v_f_tab_tieteen_ja_teknologian_henkilovoimavarat_K5_5]    Script Date: 31.1.2018 13:30:19 ******/
SET ANSI_NULLS ON
GO
...
SELECT --top 100000 --testausta
	  ...
	  ,'Tid som förflutit sedan examen avlagts PRVT' = d14.koulutuksesta_kulunut_aika_tthv_SV
	  ,'Kön' = d3.sukupuoli_SV
	  ,'Åldersgrupp' = d4.ika_SV
	  ,'Födelseland' = d1.maa_SV
	  ,'Födelseland (världsdel)' = d1.maanosa_SV
	  ,'Födelseland (Finland världsdel)' = Cast(
		Case when d1.maa_koodi='246' then d1.maa_SV --Suomi 
			 else d1.maanosa_SV end as nvarchar(50))
	  ,'Medborgarskap (land)' = d2.maa_SV
	  ,'Medborgarskap (världsdel)' = d2.maanosa_SV
	  ...
	  ,'Medborgare i ett EES-land' = d2.etamaa_SV
	  ,'Medborgare i ett EU-land' = d2.eumaa_SV
	  ...
	  ,'Huvudsaklig verksamhet PRVT' = d15.paaasiallinen_toiminta_versio3_TTHV_SV
	  ...
	  ,'UKM-styrningsområde' = d6.OKM_ohjauksen_ala_SV
      ,'År då utbildningen avlagts' = [tutkinnon_suoritusvuosi]
	  ,'Landskap där examen avlagts' = d7.maakunta_SV
	  ,'Vetenskapsgren (2010)' = d13.tieteenala2010_SV
	  ,'Huvudvetenskapsgren (2010)' = d13.paatieteenala2010_SV
      
	  ,'Arbetsplatsens landskap' = d9.maakunta_SV
	  ,'Bransch PRVT, nivå 2' = d10.toimiala_tthv_SV
	  ,'Bransch PRVT, nivå 2 föregående år' = d20.toimiala_tthv_SV
	  ,'Bransch PRVT, nivå 1' = d10.paatoimiala_tthv_SV
	  ,'Bransch PRVT, nivå 1 föregående år' = d20.paatoimiala_tthv_SV
	  ,'Bransch PRVT 1 förändrats' = d22.toimiala_tthv1_sama_kuin_ed_vuonna_SV
	  ,'Bransch PRVT 2 förändrats' = d23.toimiala_tthv2_sama_kuin_ed_vuonna_SV
	  ,'Arbetsgivarens sektor' = d11.tyonantajasektori2_SV
	  ,'Arbetsgivarens sektor föregående år' = d17.tyonantajasektori2_SV
	  ,'Arbetsgivarens sektor PRVT' = d18.tyonantajasektori2_SV
	  ,'Arbetsgivarens sektor PRVT föregående år' = d19.tyonantajasektori2_SV
	  ,'Arbetsgivarens sektor förändrats' = d21.tyonantajasektori_sama_kuin_ed_vuonna_SV
      ,'Bostadslanskap samma eller annat än arbetsplatsens landskap' = d12.asuinmaakunta_sama_kuin_tyopaikan_SV
	  ,'Företagets storlek' = d16.yrityksen_koko_SV
	  ,'Arbetsgivare förändrats' = d24.kylla_ei_SV
	  ...
	  ,'Time since attaining the qualification HRST' = d14.koulutuksesta_kulunut_aika_tthv_EN
	  ,'Gender' = d3.sukupuoli_EN
	  ,'Age group' = d4.ika_EN
	  ,'Country of birth' = d1.maa_EN
	  ,'Country of birth (continent)' = d1.maanosa_EN
	  ...
	  ,'Nationality (country)' = d2.maa_EN
	  ,'Nationality (continent)' = d2.maanosa_EN
	  ...
	  ,'Citizen of EEA nation' = d2.etamaa_EN
	  ,'Citizen of EU nation' = d2.eumaa_EN
	  ...
	  ,'Main type of activity HRST' = d15.paaasiallinen_toiminta_versio3_TTHV_EN
	  ...
	  ,'Level of ed. tier 2' = d6.Koulutusaste_taso2_EN
  	  ,'Field of education, HE steering' = d6.OKM_ohjauksen_ala_EN
      ,'Graduation year' = tutkinnon_suoritusvuosi
	  ,'Region of degree/qualification' = d7.maakunta_EN
	  ,'Discipline (2010)' = d13.tieteenala2010_EN
	  ,'Main discipline (2010)' = d13.paatieteenala2010_EN
      
	  ,'Region where the job is located' = d9.maakunta_EN
	  ,'Industry HRST, level 2' = d10.toimiala_tthv_EN
	  ,'Industry HRST, level 2 previous year' = d20.toimiala_tthv_EN
	  ,'Industry HRST, level 1' = d10.paatoimiala_tthv_EN
	  ,'Industry HRST, level 1 previous year' = d20.paatoimiala_tthv_EN
	  ,'Industry HRST 1 changed' = d22.toimiala_tthv1_sama_kuin_ed_vuonna_EN
	  ,'Industry HRST 2 changed' = d23.toimiala_tthv2_sama_kuin_ed_vuonna_EN
	  ,'Employer sector' = d11.tyonantajasektori2_EN
	  ,'Employer sector previous year' = d17.tyonantajasektori2_EN
	  ,'Employer sector HRST' = d18.tyonantajasektori2_EN
	  ,'Employer sector HRST previous year' = d19.tyonantajasektori2_EN
	  ,'Employer sector changed' = d21.tyonantajasektori_sama_kuin_ed_vuonna_EN
      ,'Region of residence the same as the region where the job is located' = d12.asuinmaakunta_sama_kuin_tyopaikan_EN
	  ,'Employer size' = d16.yrityksen_koko_EN
	  ,'Employer changed' = d24.kylla_ei_EN
	  ...
	  ,jarj_ammattiluokitustaso1 = d8.jarjestys_ammattiluokitus_2010_paataso--case when f.tilastovuosi >= '2011' then d8.jarjestys_ammattiluokitus_2010_paataso else coalesce(d8_2001_1.jarjestys, d8_2001_tuntematon.jarjestys) end
