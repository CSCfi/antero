...
/****** Object:  StoredProcedure [dbo].[p_lataa_f_koulutukseen_sijoittuneet_6v_0__valittomasti_tarkastelujakso]    Script Date: 7.2.2024 9:49:19 ******/
SET ANSI_NULLS ON
GO
...
-- Oppilaitos 1
	...
	-- lukiokoulutuksen oppilaitos ja ammatillisen koulutuksen oppilaitos, merkit‰‰n lukiokoulutuksen oppilaitos _1
	when l.suorlk = '1' and l.luopisktunn_1 <> '' and l.ammopisktunn_1 <> '' and
	l.amkopisktunn_1 = '' and l.yoopisktunn_1 = '' then l.luopisktunn_1
	...
	-- ammattikorkeakoulutus ja yliopistokoulutus oppilaitos, merkit‰‰n ammattikorkeakoulutus _1  
	when l.suorlk = '1' and l.amkopisktunn_1 <> '' and l.yoopisktunn_1  <> '' and
	l.luopisktunn_1 = '' and l.ammopisktunn_1 = ''  then l.amkopisktunn_1 
...
-- Koulutus 2
(case
   -- jos lukiokoulutuksessa vain niin j‰tet‰‰n tyhj‰ksi _1
	when l.suorlk = '1' and l.luopiskkoulk_1 <> '' and l.ammopiskkoulk_1 = '' and
	l.amkopiskkoulk_1 = '' and l.yoopiskkoulk_1 = '' then ''
	-- jos ammattikoulutuksessa vain  j‰tet‰‰n tyhj‰ksi _1 
	when l.suorlk = '1' and l.luopiskkoulk_1 = '' and l.ammopiskkoulk_1 <> '' and
	l.amkopiskkoulk_1 ='' and l.yoopiskkoulk_1 = ''  then ''
	-- jos lukiokoulutksessa ja ammattikoulutuksessa merkit‰‰n ammattikoulutus _1 
	when l.suorlk = '1' and l.luopiskkoulk_1 <> '' and l.ammopiskkoulk_1 <> '' and
	l.amkopiskkoulk_1 = '' and l.yoopiskkoulk_1 = '' then l.ammopiskkoulk_1 
	...
	when l.suorlk = '1' and l.amkopiskkoulk_1 = '' and l.yoopiskkoulk_1 <> '' and 
	l.luopiskkoulk_1 = '' and l.ammopiskkoulk_1 = ''   then ''
	-- jos ammattikorkeakoulutuksessa ja yliopistokoulutuksessa merkit‰‰n yliopistokoulutus _1
	when l.suorlk = '1' and l.amkopiskkoulk_1 <> '' and l.yoopiskkoulk_1  <> '' and
	l.luopiskkoulk_1 = '' and l.ammopiskkoulk_1 = ''  then l.yoopiskkoulk_1
...
(case
	...
	-- ammatillisen koulutuksen oppilaitos _1 merkit‰‰n tyhj‰ksi
	when l.suorlk = '1' and l.luopisktunn_1 = '' and l.ammopisktunn_1 <> '' and
	l.amkopisktunn_1 ='' and l.yoopisktunn_1 = ''  then '' 
	-- lukiokoulutuksen ja ammatillisen koulutuksen oppilaitos merkit‰‰n ammatillisen koulutuksen oppilaitos _1
	when l.suorlk = '1' and l.luopisktunn_1 <> '' and l.ammopisktunn_1 <> '' and
	l.amkopisktunn_1 = '' and l.yoopisktunn_1 = '' then l.ammopisktunn_1 
	-- ammattikorkeakoulutksen oppilaitos vain merkit‰‰n tyhj‰ksi _1
	when l.suorlk = '1' and l.amkopisktunn_1  <> '' and l.yoopisktunn_1  = '' and
	l.luopisktunn_1 = '' and l.ammopisktunn_1 = '' then ''
	-- yliopistokoulutksen oppilaitos vain merkit‰‰n tyhj‰ksi _1
	when l.suorlk = '1' and l.amkopisktunn_1 = '' and l.yoopisktunn_1 <> '' and 
	l.luopisktunn_1 = '' and l.ammopisktunn_1 = ''   then ''  
	--  ammattikorkeakoulutksen oppilaitos ja yliopistokoulutuksen oppilaitos, merkit‰‰n yliopistokoulutuksen oppilaitos _1
	when l.suorlk = '1' and l.amkopisktunn_1 <> '' and l.yoopisktunn_1  <> '' and
	l.luopisktunn_1 = '' and l.ammopisktunn_1 = ''  then l.yoopisktunn_1 
...
-- Koulutuksen j‰rjest‰j‰ 2
	(case
	-- lukiokoulutuksen j‰rjest‰j‰ vain _1, merkit‰‰n tyhj‰ksi
	when l.suorlk = '1' and l.luopiskjarj_1  <> '' and l.ammopiskjarj_1 = '' and
	l.amkopiskjarj_1 = '' and l.yoopiskjarj_1 = '' then ''
	-- ammatillisen koulutuksen j‰rjest‰j‰ vain _1, merkit‰‰n tyhj‰ksi
	when l.suorlk = '1' and l.luopiskjarj_1 = '' and l.ammopiskjarj_1 <> '' and
	l.amkopiskjarj_1 ='' and l.yoopiskjarj_1 = ''  then ''
	-- lukiokoulutuksen ja ammatillisen koulutuksen j‰rjest‰j‰, merkit‰‰n ammatillisen koulutuksen j‰rjest‰j‰ _1
	when l.suorlk = '1' and l.luopiskjarj_1 <> '' and l.ammopiskjarj_1 <> '' and
	l.amkopiskjarj_1 = '' and l.yoopiskjarj_1 = '' then l.ammopiskjarj_1 
	...
	when l.suorlk = '1' and l.amkopiskjarj_1  = '' and l.yoopiskjarj_1  <> '' and 
	l.luopiskjarj_1  = '' and l.ammopiskjarj_1 = ''   then ''
	-- ammattikorkeakoulutuksen ja yliopistokoulutuksen j‰rjest‰j‰ merkit‰‰n yliopistokoulutuksen j‰rjet‰j‰ _1
	when l.suorlk = '1' and l.amkopiskjarj_1  <> '' and l.yoopiskjarj_1   <> '' and
	l.luopiskjarj_1  = '' and l.ammopiskjarj_1  = ''  then l.yoopiskjarj_1 
...
-- Koulutuksen maakunta 2
	(case
	-- vain lukiokoulutuksen maakunta _1, j‰tet‰‰n tyhj‰ksi
	when l.suorlk = '1' and l.luopiskmaak_1   <> '' and l.ammopiskmaak_1  = '' and
	l.amkopiskmaak_1  = '' and l.yoopiskmaak_1  = '' then ''
	-- vain ammatillisen koulutuksen maakunta _1, j‰tet‰‰n tyhj‰ksi   
	when l.suorlk = '1' and l.luopiskmaak_1  = '' and l.ammopiskmaak_1  <> '' and
	l.amkopiskmaak_1  ='' and l.yoopiskmaak_1  = ''  then ''  
	-- lukiokoulutuksen ja ammatillisen koulutuksen maakunta, merkit‰‰n ammatillisen koulutuksen maakunta _1
	when l.suorlk = '1' and l.luopiskmaak_1  <> '' and l.ammopiskmaak_1  <> '' and
	l.amkopiskmaak_1  = '' and l.yoopiskmaak_1  = '' then l.ammopiskmaak_1 
	-- vain ammattikorkeakoulutuksen maakunta _1, j‰tet‰‰n tyhj‰ksi
	when l.suorlk = '1' and l.amkopiskmaak_1   <> '' and l.yoopiskmaak_1   = '' and
	l.luopiskmaak_1 = '' and l.ammopiskmaak_1 = '' then '' 
	-- vain yliopistokoulutuksen maakunta _1, merkit‰‰n tyhj‰ksi
	when l.suorlk = '1' and l.amkopiskmaak_1  = '' and l.yoopiskmaak_1  <> '' and 
	l.luopiskmaak_1  = '' and l.ammopiskmaak_1 = ''   then '' 
	-- ammattikorkeakoulutuksen ja yliopistokoulutuksen maakunta _1, merkit‰‰n yliopistokoulutuksen maakunta _1
	when l.suorlk = '1' and l.amkopiskmaak_1  <> '' and l.yoopiskmaak_1   <> '' and
	l.luopiskjarj_1  = '' and l.ammopiskmaak_1  = ''  then l.yoopiskmaak_1
...
----MITTARIT
--Ei hakenut korkea-asteelle eik‰ opiskellut mit‰‰n
,case
...
(
	...
	and tutkryh <> '3' 
	/* HUOM!
	Ammatillista tutkintokoodia ei ennen sopv20 rajattu suoritusvuoden opiskelusta pois, mik‰ vaikuttaa myˆs ptoim-p‰‰ttelyihin, j‰lkimm‰inen tilanne myˆs sopv20.
	Kumulatiivisista muuttujista toimii vain ne, jotka eiv‰t koske v‰litˆnt‰ ammatillista opiskelua tai opiskelemattomuutta.
	Monihakumuuttujissa kuitenkin ammatillinen + jompikumpi kk-sektori sijoitettu vastaavan kk-sektorin alle ennen sopv20, joten ammatillista hakua ei saada tarkasti. / jsyrjala 4.9.2020
	*/
) as l
