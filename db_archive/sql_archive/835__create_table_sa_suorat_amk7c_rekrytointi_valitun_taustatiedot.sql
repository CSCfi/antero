--
--  create table sa_suorat_amk7c_rekrytointi_valitun_taustatiedot
--

IF NOT EXISTS
(SELECT * FROM INFORMATION_SCHEMA.TABLES
	WHERE TABLE_SCHEMA='sa'
	AND TABLE_NAME='sa_suorat_amk7c_rekrytointi_valitun_taustatiedot')
	...
	/* revert
	drop table sa.sa_suorat_amk7c_rekrytointi_valitun_taustatiedot
	--*/
