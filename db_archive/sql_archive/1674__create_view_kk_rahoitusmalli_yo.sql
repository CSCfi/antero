...
CREATE view [dw].[v_kk_rahoitusmalli_yo] as
Select
	  *
  From (
...
-- Opiskelijapalaute --
	  ...
	  ,NULL as 'Yhtenäistetty asteikko'
	  ,NULL as 'Kysymysryhmä_id'
	  ,NULL as 'Kysymysryhmä'
	  ,NULL as 'Rahoitusmallikysymys'
	  ,NULL as 'Koulutusmuoto'
	  ,NULL as 'VastaajaID'
	  		  ,Null as 'AVOP-AMK'
      ,NULL as 'AVOP-YAMK' 
	,NULL as 'KANDIPALAUTE' 
	,NULL 'URASEURANTA-AMK' 
	,Null as  'URASEURANTA-YAMK'
	,NULL as 'URASEURANTA-KANDI' 
	,Null as 'URASEURANTA-MAISTERI' 
	,Null as 'URASEURANTA-TOHTORI' 
	,NULL as 'Vastaustyyppi'
		,Null as 'Kysymys'
			 ,Null as 'Vaihtoehto'
	 ,Null as 'Monivalintavaihtoehto'
	 	,Null as 'vuosi_tilasto'
...
--Hakijat--
	  ...
	  ,NULL as 'valintojen aloituspaikat'
	  	  ,Null as 'yksi_pk_per_hakija'
	  ,Null as 'Hakijat2'
	  ,Null as 'Ensisijaiset hakijat2'
	  ,Null as 'Valitut2'
	  ,Null as 'Paikan vastaaottaneet2'
	  ,Null as 'Aloittaneet2'
	  ,NULL as 'Henkilö OID'
 ...
 Where (aineisto = 'L' or (aineisto = 'E' and tilastointivuosi=YEAR(GETDATE())-1)) and tilastointivuosi>2010 and d50.organisaatio_koodi not in ('02358', '01740', '01742', '01717')
...
--Hakijat--
 ...
 left join VipunenTK.dbo.d_tieteenala d90 on d90.tieteenala_avain=d59.tieteenala_avain
 Where aineisto = 'L' and tilastointivuosi>2010 and d50.organisaatio_koodi not in ('02358', '01740', '01742', '01717') 
...
--Hakijat--
 ...
 where d1.julkaisunpaaluokka_koodi in ('A', 'B', 'C', 'D', 'E', 'F', 'I') and tilastovuosi>2010 and d3.organisaatio_koodi not in ('02358', '01740', '01742', '01717') 
...
--Hakijat--
 ...
 -- Taloustiedot --
  ,d5.tili_taso0_fi AS 'Tilitaso 0'
  ,d5.tili_taso1_fi AS 'Tilitaso 1'
  ,d5.tili_taso2_fi AS 'Tilitaso 2'
  ,d5.tili_taso3_fi AS 'Tilitaso 3'
  ,d5.tili_taso4_fi AS 'Tilitaso 4'
  ,d5.tili_taso5_fi AS 'Tilitaso 5'
  ,d6.toiminto_nimi_fi AS 'Toiminto'
  ,f.arvo AS 'Talousarvo'
  ,NULL as 'Talouserittely'
 ...
 /* WHERE konserni='E' AND d1.aineistotyyppi_koodi='L' and d50.organisaatio_koodi not in ('02358', '01740', '01742', '01717')*/ --Onko tarpeellinen?
...
SELECT
	 d13.vuosi AS 'Tilastovuosi'
	  ...
	  ,case when d14.kysymysryhmaid <('14') then case when numerovalinta='0' then cast(7 as integer)
			when numerovalinta='1' then cast(5.5 as integer)
			when numerovalinta='2' then cast(4 as integer)
			when numerovalinta='3' then cast(2.5 as integer)
			when numerovalinta='4' then cast(1 as integer)
			when d14.vastaustyyppi='arvosana7' then cast(numerovalinta as integer) else null
			end end as 'Yhtenäistetty asteikko'
	  ...
	  ,f.koulutusmuoto as 'Koulutusmuoto'
	  ,Vastaajaid
	...
	,d14.vastaustyyppi as 'Vastaustyyppi'
	,d14.kysymys_fi as 'Kysymys'
	,vaihtoehto
	...
	,case when d13.vuosi < YEAR(GETDATE()) then 1 else 0 end as vuosi_tilasto
 ...
 where d14.kysymysryhmaid  <('14') or d14.kysymysryhmaid between 117 and 124 and  kyselypohja in ('KANDIPALAUTE','AVOP-AMK') and d3.oppilaitostyyppi_koodi in ('41','42') and d3.organisaatio_koodi not in ('02358', '01740', '01742', '01717') 
...
--Hakijat--
  ...
  ,NULL as 'Talouserittely'
	...
	where d12.koulutussektori_koodi=4 OR d12.koulutussektori_koodi=5  and d3.organisaatio_koodi not in ('02358', '01740', '01742', '01717') 
...
--Hakijat-- 
	  ,NULL as 'Ensisijainen hakija'-- Pois
	  ,NULL as 'Paikan vastaanottaneet'-- Pois

	  , d12.okmohjauksenala_koodi as 'Koodit OKM ohjauksen ala'
	  , d7.koulutus_koodi as 'Koodit Koulutusnimike'
	  , d3.organisaatio_koodi as 'Koodit organisaatio'
	  , d15.kunta_koodi as 'Koodit kunta'
	  , case when d12.jarjestys_koulutusastetaso1_koodi ='ööö' then null else d12.jarjestys_koulutusastetaso1_koodi end as 'jarj. koulutusaste, taso 1'
	  , case when d12.jarjestys_koulutusastetaso2_koodi ='ööö' then null else d12.jarjestys_koulutusastetaso2_koodi end as 'jarj. koulutusaste, taso 2'
	  , case 
			when d12.okmohjauksenala_koodi='1' then 1 
	  ...
	  , d90.jarjestys_paatieteenala2010 as 'jarj. paatieteenala'
	  , d90.jarjestys_tieteenala2010 as 'jarj. tieteenala'
	  ,f.[aloituspaikat] as 'aloituspaikat'
	  ,f.[valintojen_aloituspaikat] as 'valintojen aloituspaikat'
	  	  ,Null as 'yksi_pk_per_hakija'
	  ,Null as 'Hakijat2'
	  ,Null as 'Ensisijaiset hakijat2'
	  ,Null as 'Valitut2'
	  ...
	  ,Null as 'Aloittaneet2'
	  ,NULL as 'Henkilö OID'
	  --,case when cast(f.loadtime as date)>=d1.aloituspaikat then f.[aloituspaikat] else null end as aloituspaikat -- UUSIA NULL as 'aloituspaikat'
     -- ,case when cast(f.loadtime as date)>=d1.aloituspaikat then f.[valintojen_aloituspaikat] else null end as valintojen aloituspaikat -- UUSIA NULL as 'valintojen aloituspaikat'
 ...
 -- Taloustiedot --
  ...
  ,NULL  AS 'Talousarvo'
  ,NULL as 'Talouserittely'
	  FROM ANTERO.dw.f_haku_ja_valinta_aloituspaikat_ja_pistemaarat as f
	LEFT JOIN ANTERO.dw.d_haku d25 ON d25.id = f.d_haku_id
	 LEFT JOIN ANTERO.dw.d_kausi d2 ON d2.id = f.d_kausi_koulutuksen_alkamiskausi_id
    INNER JOIN ANTERO.sa.sa_haku_ja_valinta_vuosikello_korkea_aste d1 on ((d1.haku_oid=d25.haku_oid and		d1.haku_oid is not null) OR (d1.koulutuksen_alkamiskausi=cast(f.koulutuksen_alkamisvuosi as varchar)+cast(d2.jarjestys as varchar) and d25.hakutapa_koodi <> '01' and d1.haku_oid is null)) and f.loadtime >= d1.hakijat	
	left join antero.dw.d_organisaatioluokitus d3 on f.d_organisaatio_oppilaitos_id = d3.id
	...
	left join VipunenTK_lisatiedot.dbo.Haku_valinta_kandi_maisteri d10 on d7.koulutus_koodi=d10.I_sykli_kandi
	left join VipunenTK.dbo.d_koulutusluokitus d7a on d10.I_sykli_maisteri=d7a.koulutus_koodi
	LEFT JOIN VipunenTK.dbo.d_alueluokitus d15 on d15.id=f.d_alueluokitus_hakukohde_id
	...
	WHERE Sektori='Yliopisto' AND Tilastovuosi>2011
