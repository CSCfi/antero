...
/****** Object:  Table [dw].[api_opiskelijat_ja_tutkinnot]    Script Date: 17.12.2019 17:13:31 ******/
DROP TABLE IF EXISTS [dw].[api_opiskelijat_ja_tutkinnot]
GO
...
--SELECT * INTO [dw].[api_opiskelijat_ja_tutkinnot]
--FROM [dw].[v_api_opiskelijat_ja_tutkinnot];
