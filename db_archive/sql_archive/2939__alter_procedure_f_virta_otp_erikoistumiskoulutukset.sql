USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_erikoistumiskoulutukset]    Script Date: 26.3.2020 19:46:38 ******/
SET ANSI_NULLS ON
GO
...
select
	...
	year(convert(date,dateadd(s, convert(bigint, sa.tutkinnonsuorituspvm) / 1000, convert(datetime, '1-1-1970')))) as muun_tutkinnon_suoritusvuosi,
	1 as lkm,
