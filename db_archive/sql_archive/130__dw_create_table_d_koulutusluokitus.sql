IF NOT EXISTS (select * from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA='dw' and TABLE_NAME='d_koulutusluokitus') BEGIN
...
;
ALTER TABLE dw.d_koulutusluokitus ADD  CONSTRAINT PK__d_koulutusluokitus PRIMARY KEY CLUSTERED (id ASC)
