...
/****** Object:  StoredProcedure [dw].[p_lataa_d_arvovastaus_koulutustausta]    Script Date: 13.7.2023 13:38:37 ******/
SET ANSI_NULLS ON
GO
...
--Dimensio käytössä tällä hetkellä vain ammatillisen opiskelijapalautteelle. Mikäli liitytään muualta, lisättävä vastaustauluja alle. JS 13.7.2023
