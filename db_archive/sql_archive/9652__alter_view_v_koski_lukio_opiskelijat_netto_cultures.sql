...
/****** Object:  View [dw].[v_koski_lukio_opiskelijat_netto_cultures]    Script Date: 23.2.2024 8:20:38 ******/
SET ANSI_NULLS ON
GO
...
-- FI
	...
	-- HENKILÖMUUTTUJAT
		...
		,oppivelvollinen_1_8_2021_fi						= d25.kytkin_fi
	...
	-- ORGANISAATIOMUUTTUJAT
		...
		-- Toimipiste
			...
			,toimipisteen_hyvinvointialue_fi				= d24.hyvinvointialue_fi
...
-- SV
	...
	-- HENKILÖMUUTTUJAT
		...
		,oppivelvollinen_1_8_2021_sv						= d25.kytkin_sv
	...
	-- ORGANISAATIOMUUTTUJAT
		...
		--Toimipiste
			...
			,toimipisteen_hyvinvointialue_sv				= d24.hyvinvointialue_sv
...
-- JÄRJESTYSMUUTTUJAT
	...
	,jarjestys_koul_jarjestys_hyvinvointialue 					= d12.jarjestys_hyvinvointialue_koodi
	...
	,jarjestys_toimipisteen_hyvinvointialue 					= d24.jarjestys_hyvinvointialue_koodi
...
LEFT JOIN dw.d_kytkin d25 on d25.id = f.d_kytkin_oppivelvollinen_id
