...
/****** Object:  View [dbo].[v_f_tab_opettajat_7_1]    Script Date: 22.12.2017 10:10:12 ******/
SET ANSI_NULLS ON
GO
...
Select
	  ...
	  ,[Opettajan tunnit] = null
	  ,[Resurssiopettajan osallistuminen] = null
	  ,[Resurssiopettajan tunnit] = null
...
where tilastointivuosi<2016 --pitäisi olla vain väliaikainen ratkaisu
