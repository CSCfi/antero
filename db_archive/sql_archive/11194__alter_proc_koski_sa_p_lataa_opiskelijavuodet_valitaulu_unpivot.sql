...
--HUOM. Käyttää samaa kohdetaulua kuin _uusi-päätteinen lataus, joten muutokset mahd. huomioitava tässäkin.
...
SELECT 
	...
	,toisen_asteen_pohjakoulutus_2018 = null --oa2.toisen_asteen_pohjakoulutus_2018
	,toisen_asteen_tutkinto_2018 = null --oa2b.toisen_asteen_tutkinto_2018
	,maksuttomuus = null /*
		case 
			when 
				maksuton = 1
	...
	*/
	...
	,perusopetuksen_suoritusvuosi = -1 --coalesce(year(oa.perusopetuksen_paattymispaiva), -1)
	,keskiarvo_lahde = null --oa.keskiarvo_lahde
	,keskiarvoluokka = null --oa.keskiarvoluokka
	,yksilollistaminen = null --oa.yksilollistaminen
	,[osa_aikaisuus]
	,[oppis]
	,[erityisopetus]
	,[majoitus]
	...
	,[hylkaamisen_peruste] =
		case op_vuosi_tyyppi
			...
			when 'hylatty_opiskelijavuosi_paallekkainen_perusop_valmistava' then 13
			else 9
		end
	,[hyvaksytaan] = 
		case
