...
/****** Object:  StoredProcedure [dw].[p_lataa_f_amos_opiskelijapalaute_vastausosuudet_kertoimet]    Script Date: 3.9.2025 15.20.18 ******/
SET ANSI_NULLS ON
GO
		...
		FROM (
			...
			FROM (
				...
				LEFT JOIN (
					...
					LEFT JOIN dw.d_arvokyselykerta akk ON akk.kyselyid = f.kyselyid
