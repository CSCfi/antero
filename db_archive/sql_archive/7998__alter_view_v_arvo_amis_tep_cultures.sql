...
/****** Object:  View [dw].[v_arvo_amis_tep_cultures]    Script Date: 30.8.2023 14:33:02 ******/
SET ANSI_NULLS ON
GO
...
--FI
	...
	,d3.kuukausi_fi								AS 'tilastokuukausi_fi'
												...
												--KYSELYMUUTTUJAT
	,coalesce(d5.kyselypohja_tarkenne_fi, 'Työelämäpalaute: työpaikkakysely') --case [source] when 'generoitu'
												AS 'kysely_fi'
	,coalesce(d5.kyselypohja_tarkenne_fi, 'Työelämäpalaute: työpaikkakysely') --case [source] when 'generoitu'
												AS 'kyselyn_kohderyhma_fi'
	...
	,d17.nimi_amos_spl							AS 'koulutuksen_jarjestaja_amos_spl'
...
--SV
	...
	,d3.kuukausi_sv								AS 'tilastokuukausi_sv'
												...
												--KYSELYMUUTTUJAT
	,coalesce(d5.kyselypohja_tarkenne_sv, 'Työelämäpalaute: työpaikkakysely') --case [source] when 'generoitu'
												AS 'kysely_sv'
	,coalesce(d5.kyselypohja_tarkenne_sv, 'Työelämäpalaute: työpaikkakysely') --case [source] when 'generoitu'
												AS 'kyselyn_kohderyhma_sv'
...
--EN
	...
	,d3.kuukausi_en								AS 'tilastokuukausi_en'
												...
												--KYSELYMUUTTUJAT
	,coalesce(d5.kyselypohja_tarkenne_en, 'Työelämäpalaute: työpaikkakysely') --case [source] when 'generoitu'
											AS 'kysely_en'
	,coalesce(d5.kyselypohja_tarkenne_en, 'Työelämäpalaute: työpaikkakysely') --case [source] when 'generoitu'
												AS 'kyselyn_kohderyhma_en'
	...
	--piilosuodatin rahoitusraporteilla
	,d17.sisaltyy_amos_spl - 1					AS 'rahoitusraporteilta_poisrajattava_1_0'
...
LEFT JOIN dw.d_amos_spl_jarjestaja_linkki d17 ON d17.oid_avain = d1.organisaatio_oid	--CSCVIPUNEN-3268
--LEFT JOIN dw.d_rahoitusryhma d17 ON d17.id = f.d_rahoitusryhma_id	--CSCVIPUNEN-3260
CROSS APPLY (
	SELECT
		viive =
			CASE
				WHEN d5.kyselypohja_tarkenne_fi = 'Työelämäpalaute: työpaikkakysely' 
					OR /*pelkät yrittäjäjaksot ohjaajakyselystä*/ f.[source] = 'generoitu' THEN 
					--maalis-/syyskuussa edellinen puolivuotisjakso
					CASE
...
AND d3.rahoituskausi_amm != '01.07.2020 - 30.06.2021'
