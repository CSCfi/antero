...
/****** Object:  View [dbo].[v_sa_2_9_Korkeakoulut_tutkinnot]    Script Date: 6.6.2023 12:25:10 ******/
SET ANSI_NULLS ON
GO
...
SELECT
	 tilv
	,cast('L' as varchar(1)) as aineisto   -- Anssin mukaan pitää käyttää tätä vakioarvoa
	,lahde
	,tunn
	,jarj
	,koulk
