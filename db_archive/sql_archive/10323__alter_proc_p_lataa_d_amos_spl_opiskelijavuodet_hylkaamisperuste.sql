...
/****** Object:  StoredProcedure [dw].[p_lataa_d_amos_spl_opiskelijavuodet_hylkaamisperuste]    Script Date: 24.10.2024 14:55:33 ******/
SET ANSI_NULLS ON
GO
...
(10,10,'Hylätään: Samanaikainen opiskeluoikeus, TUVA (ammatillinen)','SV*','EN*',21,'manuaalinen'), --sisältyy toistaiseksi koodiin 2
