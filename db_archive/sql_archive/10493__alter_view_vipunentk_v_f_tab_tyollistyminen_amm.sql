...
/****** Object:  View [dbo].[v_f_tab_tyollistyminen_amm]    Script Date: 13.1.2025 16.27.46 ******/
SET ANSI_NULLS ON
GO
...
ALTER view [dbo].[v_f_tab_tyollistyminen_amm] as
...
WHERE d1.Koulutusaste_taso2_koodi in ('32','33','41') --d1.koulutusaste2002_koodi = 32 
