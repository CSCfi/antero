...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dw].[api_amm_perusrahoituksen_kohdennukset]') AND type in (N'U'))
...
CREATE TABLE [dw].[api_amm_perusrahoituksen_kohdennukset](
