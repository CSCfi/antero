IF NOT EXISTS (select * from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA='sa' and TABLE_NAME='sa_arvo_valtakunnallinen') BEGIN

CREATE TABLE sa.sa_arvo_valtakunnallinen(
...
ALTER TABLE sa.sa_arvo_valtakunnallinen ADD  CONSTRAINT DF__sa_arvo_valtakunnallinen__loadtime  DEFAULT (getdate()) FOR loadtime
;
ALTER TABLE sa.sa_arvo_valtakunnallinen ADD  CONSTRAINT DF__sa_arvo_valtakunnallinen__username  DEFAULT (suser_name()) FOR username
;
