...
/****** Object:  View [dbo].[v_f_2_20_Lukio_amm_oppis_opisk_ian_ja_koul_mukaan]    Script Date: 20.10.2017 15:19:46 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	...
	as nvarchar(10))	
	  ...
	  (
		...
		when ophal = '2' and d1.maakunta_koodi <> '21' and d2.opintoala2002_koodi not in ('902','903','904') /* 'Ålands Landskapsregering','Poliisiammattikorkeakoulu','Rikosseuraamusalan Koulutuskeskus','Pelastusopisto'*/ then '2' --Opetushallinto, pl. työvoimakoulutus
