USE [Koski_SA]
GO
/****** Object:  StoredProcedure [sa].[p_lataa_opiskelijavuodet_paallekkaiset_opiskeluoikeudet]    Script Date: 27.9.2022 19:20:09 ******/
SET ANSI_NULLS ON
GO
...
FROM (
	...
	FROM (
		...
		inner join (
			...
			where 1=1
			and (
				(oo.koulutusmuoto = 'ammatillinenkoulutus' or (oo.tuva_jarjestamislupa = 'ammatillinen' and oo.alkamispaiva > '2022-07-31'))
			...
			and 
			(														--ammatillinen alkanut ennen nykyistä tai samana päivänä
				(
					(
						oo_la.alkamispaiva < oo_a.alkamispaiva 
						and (oo_la.koulutusmuoto = 'ammatillinenkoulutus' or (oo_la.tuva_jarjestamislupa = 'ammatillinen' and oo_la.alkamispaiva > '2022-07-31')) 
						and alkanut_samana_paivana = 0
					) 
					or 
					(
						(oo_la.koulutusmuoto = 'ammatillinenkoulutus' or (oo_la.tuva_jarjestamislupa = 'ammatillinen' and oo_la.alkamispaiva > '2022-07-31')) 
