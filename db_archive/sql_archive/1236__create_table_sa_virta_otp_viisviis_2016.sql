-- 2016 freezed data with age (ikä)

-- IF EXISTS (
  -- select * from INFORMATION_SCHEMA.TABLES
  -- where TABLE_SCHEMA='sa' and TABLE_NAME='sa_virta_otp_viisviis_2016'
-- ) BEGIN
-- DROP TABLE sa.sa_virta_otp_viisviis_2016
-- END
...
CREATE TABLE sa.sa_virta_otp_viisviis_2016(
  ...
  CONSTRAINT PK__sa_virta_otp_viisviis_2016 PRIMARY KEY CLUSTERED (id ASC)
)
;

ALTER TABLE sa.sa_virta_otp_viisviis_2016 ADD  CONSTRAINT DF__sa_virta_otp_viisviis_2016__loadtime  DEFAULT (getdate()) FOR loadtime
;
ALTER TABLE sa.sa_virta_otp_viisviis_2016 ADD  CONSTRAINT DF__sa_virta_otp_viisviis_2016__username  DEFAULT (suser_name()) FOR username
;
