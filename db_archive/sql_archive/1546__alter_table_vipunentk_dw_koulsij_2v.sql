USE [VipunenTK_DW]
GO
/****** Object:  Table [dbo].[_koulutukseen_sijoittuneet_2v_tarkastelu]    Script Date: 19.4.2018 14:14:35 ******/
DROP TABLE IF EXISTS [dbo].[_koulutukseen_sijoittuneet_2v_tarkastelu]
GO
/****** Object:  Table [dbo].[_f_koulutukseen_sijoittuneet_2v_tarkastelu]    Script Date: 19.4.2018 14:14:35 ******/
...
CREATE TABLE [dbo].[_f_koulutukseen_sijoittuneet_2v_tarkastelu](
	...
	[opisk_lu] [nvarchar](2) NULL,
	[opisk_amm_pk] [nvarchar](2) NULL,
	[opisk_amm_at] [nvarchar](2) NULL,
	[opisk_amm_eat] [nvarchar](2) NULL,
	[opisk_amm] [nvarchar](2) NULL,
	[opisk_amk] [nvarchar](2) NULL,
	[opisk_yo] [nvarchar](2) NULL,
	[opisk_amk_koulala1] [nvarchar](2) NULL,
	[opisk_amk_koulala2] [nvarchar](2) NULL,
	[opisk_amk_koulala3] [nvarchar](2) NULL,
	[opisk_amk_koulala4] [nvarchar](2) NULL,
	[opisk_amk_koulala5] [nvarchar](2) NULL,
	[opisk_amk_koulala6] [nvarchar](2) NULL,
	[opisk_amk_koulala7] [nvarchar](2) NULL,
	[opisk_amk_koulala8] [nvarchar](2) NULL,
	[opisk_amk_koulala9] [nvarchar](2) NULL,
	[opisk_amk_koulala10] [nvarchar](2) NULL,
	[opisk_yo_koulala1] [nvarchar](2) NULL,
	[opisk_yo_koulala2] [nvarchar](2) NULL,
	[opisk_yo_koulala3] [nvarchar](2) NULL,
	[opisk_yo_koulala4] [nvarchar](2) NULL,
	[opisk_yo_koulala5] [nvarchar](2) NULL,
	[opisk_yo_koulala6] [nvarchar](2) NULL,
	[opisk_yo_koulala7] [nvarchar](2) NULL,
	[opisk_yo_koulala8] [nvarchar](2) NULL,
	[opisk_yo_koulala9] [nvarchar](2) NULL,
	[opisk_yo_koulala10] [nvarchar](2) NULL,
	[opisk_vah2_koulala] [nvarchar](2) NULL,
	[haku_amm] [nvarchar](2) NULL,
	[haku_amk] [nvarchar](2) NULL,
	[haku_yo] [nvarchar](2) NULL,
