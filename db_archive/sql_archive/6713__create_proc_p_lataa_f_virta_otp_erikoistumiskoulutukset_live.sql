...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_erikoistumiskoulutukset_live]    Script Date: 1.12.2022 12:42:00 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dw].[p_lataa_f_virta_otp_erikoistumiskoulutukset_live] as

TRUNCATE TABLE dw.f_virta_otp_erikoistumiskoulutukset_live

INSERT INTO [dw].[f_virta_otp_erikoistumiskoulutukset_live] (
...
select
	...
	1 as lkm,
	'p_lataa_f_virta_otp_erikoistumiskoulutukset_live' as [source]
