...
/****** Object:  StoredProcedure [dbo].[p_lataa_lukio_opiskelijat_netto_valitaulu]    Script Date: 11.8.2023 8:05:41 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	AND CASE WHEN ooa.alku >= ps.alku THEN ooa.alku ELSE ps.alku END <= @pvm_loppu AND ooa.loppu >= @pvm_alku and ooa.loppu >= ps.alku
