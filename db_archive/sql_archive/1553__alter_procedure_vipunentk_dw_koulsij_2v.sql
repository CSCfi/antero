USE [VipunenTK_DW]
GO
/****** Object:  StoredProcedure [dbo].[p_lataa_f_koulutukseen_sijoittuneet_2v]    Script Date: 19.4.2018 13:38:16 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN VipunenTK..d_ika  AS d29b ON d29b.ika_avain    =f.ika_1v_suorv
