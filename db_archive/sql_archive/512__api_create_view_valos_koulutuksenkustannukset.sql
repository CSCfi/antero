IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'api.valos_koulutuksenkustannukset'))
EXEC dbo.sp_executesql @statement = N'create view api.valos_koulutuksenkustannukset as select 1 as a'
GO

ALTER VIEW api.valos_koulutuksenkustannukset AS
