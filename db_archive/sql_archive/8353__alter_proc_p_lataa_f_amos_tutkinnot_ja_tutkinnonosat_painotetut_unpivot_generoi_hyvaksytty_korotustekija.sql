...
/****** Object:  StoredProcedure [dw].[p_lataa_f_amos_tutkinnot_ja_tutkinnonosat_painotetut_unpivot_generoi_hyvaksytty_korotustekija]    Script Date: 29.11.2023 12:44:39 ******/
SET ANSI_NULLS ON
GO
...
WHERE NOT EXISTS (
	select 1 from dw.f_amos_tutkinnot_ja_tutkinnonosat_painotetut_unpivot f2 
	where f2.d_amos_luvaton_korotustekija_id = 0 and f2.d_organisaatioluokitus_jarjestaja_id = f1.d_organisaatioluokitus_jarjestaja_id
)
