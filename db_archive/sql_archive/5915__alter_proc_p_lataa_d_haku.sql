...
/****** Object:  StoredProcedure [dw].[p_lataa_d_haku]    Script Date: 21.2.2022 17:13:51 ******/
SET ANSI_NULLS ON
GO
...
USING (
	SELECT 
		...
		,case
			...
			when kh.nimi like 'Perusopetuksen jälkeisen valmistavan koulutuksen%' or kh.nimi like 'Lisähaku kymppiluokalle%' then '3'
			when kh.nimi like '%haku erityisopetuksena järjestettävään ammatilliseen koulutukseen%' or kh.nimi like 'Erityisopetuksena järjestettävän ammatillisen koulutuksen haku%' or kh.nimi like '%vaativana erityisenä tukena järjestettävään ammatilliseen koulutukseen%' then '4'
			when kh.nimi like '%korkeakoulujen%' and (kh.nimi like '%yhteishaku%' or kh.nimi like '%lisähaku%')  then '5'
			when k4.nimi in ('Erillishaku','Jatkuva haku') then '6'
			else '9'
...
SELECT DISTINCT
		...
		,case
			when kh.nimi_fi like 'Yhteishaku ammatilliseen ja lukioon%' or kh.nimi_fi like 'Ammatillisen koulutuksen ja lukiokoulutuksen%' or kh.nimi_fi like 'Ammatillisen koulutuksen syksyn%' or kh.nimi_fi like 'Perusopetuksen jälkeisen koulutuksen yhteishaku%' or (kh.nimi_fi like '%yhteishaussa%' and kh.nimi_fi like '%lisähaku%') then '1'
			when kh.nimi_fi like 'Perusopetuksen jälkeisen koulutuksen yhteishaku%' then '2'
			when kh.nimi_fi like 'Perusopetuksen jälkeisen valmistavan koulutuksen%' or kh.nimi_fi like 'Lisähaku kymppiluokalle%' then '3'
			when kh.nimi_fi like '%haku erityisopetuksena järjestettävään ammatilliseen koulutukseen%' or kh.nimi_fi like 'Erityisopetuksena järjestettävän ammatillisen koulutuksen haku%' or kh.nimi_fi like '%vaativana erityisenä tukena järjestettävään ammatilliseen koulutukseen%' then '4'
			when kh.nimi_fi like '%korkeakoulujen%' and (kh.nimi_fi like '%yhteishaku%' or kh.nimi_fi like '%lisähaku%')  then '5'
			when k4.nimi in ('Erillishaku','Jatkuva haku') then '6'
			else '9'
		end as hakuryhma_koodi
		,case
			when kh.nimi_fi like 'Yhteishaku ammatilliseen ja lukioon%' or kh.nimi_fi like 'Ammatillisen koulutuksen ja lukiokoulutuksen%' or kh.nimi_fi like 'Ammatillisen koulutuksen syksyn%' or kh.nimi_fi like 'Perusopetuksen jälkeisen koulutuksen yhteishaku%' or (kh.nimi_fi like '%yhteishaussa%' and kh.nimi_fi like '%lisähaku%') then 'Ammatillisen koulutuksen ja lukiokoulutuksen yhteishaku'
		...
		,case
			when kh.nimi_fi like 'Yhteishaku ammatilliseen ja lukioon%' or kh.nimi_fi like 'Ammatillisen koulutuksen ja lukiokoulutuksen%' or kh.nimi_fi like 'Ammatillisen koulutuksen syksyn%' or kh.nimi_fi like 'Perusopetuksen jälkeisen koulutuksen yhteishaku%' or (kh.nimi_fi like '%yhteishaussa%' and kh.nimi_fi like '%lisähaku%') then 'Gemensam ansökan till yrkes- och gymnasieutbildning'
		...
		,case
			when kh.nimi_fi like 'Yhteishaku ammatilliseen ja lukioon%' or kh.nimi_fi like 'Ammatillisen koulutuksen ja lukiokoulutuksen%' or kh.nimi_fi like 'Ammatillisen koulutuksen syksyn%' or kh.nimi_fi like 'Perusopetuksen jälkeisen koulutuksen yhteishaku%' or (kh.nimi_fi like '%yhteishaussa%' and kh.nimi_fi like '%lisähaku%') then 'Application to vocational or general upper secondary education in the joint application system'
	...
	where kh.Tila = 'julkaistu' or (kh.tila = 'valmis' and k6.nimi='Jatkotutkintohaku')
) AS src
