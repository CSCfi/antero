...
/****** Object:  StoredProcedure [dw].[p_lataa_d_koulutusluokitus]    Script Date: 20.12.2023 13:14:14 ******/
SET ANSI_NULLS ON
GO
...
USING (
  SELECT DISTINCT
	...
	CASE 
		WHEN s.tutkintotyyppikoodi = '02' or s.koulutusluokitus2016koulutusastetaso2koodi = '32' then '02'
		WHEN s.tutkintotyyppikoodi in (19,20) or s.koulutusluokitus2016koulutusastetaso2koodi in ('33','41') or s.nimi like '%ammattitutkinto' THEN '08'
		WHEN s.nimi like '%VALMA%' OR s.nimi like '%TELMA%' OR s.nimi = 'Tutkintokoulutukseen valmentava koulutus' THEN '91' 
		WHEN s.tutkintotyyppikoodi = '09' then s.tutkintotyyppikoodi
		WHEN s.koodi = '999900' THEN '92'
		ELSE '-1'
	END as tutkintotyypin_ryhmakoodi,
	CASE 
		WHEN s.tutkintotyyppikoodi = '02' or s.koulutusluokitus2016koulutusastetaso2koodi = '32' then 'Ammatilliset perustutkinnot'
		WHEN s.tutkintotyyppikoodi in (19,20) or s.koulutusluokitus2016koulutusastetaso2koodi in ('33','41') or s.nimi like '%ammattitutkinto' THEN 'Ammatti- ja erikoisammattitutkinnot'
		WHEN s.nimi like '%VALMA%' OR s.nimi like '%TELMA%' OR s.nimi = 'Tutkintokoulutukseen valmentava koulutus' THEN 'Valmentava koulutus' 
	...
	CASE 
		WHEN s.tutkintotyyppikoodi = '02' or s.koulutusluokitus2016koulutusastetaso2koodi = '32' then 'Yrkesinriktade grundexamina'
		WHEN s.tutkintotyyppikoodi in (19,20) or s.koulutusluokitus2016koulutusastetaso2koodi in ('33','41') or s.nimi like '%ammattitutkinto' THEN 'Yrkes- och specialyrkesexamina'
		WHEN s.nimi like '%VALMA%' OR s.nimi like '%TELMA%' OR s.nimi = 'Tutkintokoulutukseen valmentava koulutus' THEN 'Handledande utbildning'  
	...
	CASE 
		WHEN s.tutkintotyyppikoodi = '02' or s.koulutusluokitus2016koulutusastetaso2koodi = '32' then 'Vocational upper secondary qualifications'
		WHEN s.tutkintotyyppikoodi in (19,20) or s.koulutusluokitus2016koulutusastetaso2koodi in ('33','41') or s.nimi like '%ammattitutkinto' THEN 'Further and Specialist vocational qualifications' 
		WHEN s.nimi like '%VALMA%' OR s.nimi like '%TELMA%' OR s.nimi = 'Tutkintokoulutukseen valmentava koulutus' THEN 'Preparatory education'
    ...
    CASE 
		WHEN s.nimi like '%VALMA%' OR s.nimi like '%TELMA%' OR s.nimi = 'Tutkintokoulutukseen valmentava koulutus' THEN '91'
		WHEN s.koulutusluokitus2016koulutusastetaso2koodi = '32' THEN '02'
		WHEN s.koulutusluokitus2016koulutusastetaso2koodi = '33' THEN '19'
		WHEN s.koulutusluokitus2016koulutusastetaso2koodi = '41' THEN '20'
		ELSE COALESCE(tutkintotyyppikoodi, t.koodi)
	END as tutkintotyyppikoodi,
     CASE 
		WHEN s.nimi like '%VALMA%' OR s.nimi like '%TELMA%' OR s.nimi = 'Tutkintokoulutukseen valmentava koulutus' THEN 'Valmentava koulutus' 
		WHEN s.koulutusluokitus2016koulutusastetaso2koodi = '32' THEN 'Ammatilliset perustutkinnot'
		WHEN s.koulutusluokitus2016koulutusastetaso2koodi = '33' THEN 'Ammattitutkinnot'
		WHEN s.koulutusluokitus2016koulutusastetaso2koodi = '41' THEN 'Erikoisammattitutkinnot'
		ELSE COALESCE(tutkintotyyppinimi, tutkintotyyppinimi_sv, tutkintotyyppinimi_en, t.nimi)
	END AS tutkintotyyppinimi,
    CASE 
		WHEN s.nimi like '%VALMA%' OR s.nimi like '%TELMA%' OR s.nimi = 'Tutkintokoulutukseen valmentava koulutus' THEN 'Handledande utbildning' 
		WHEN s.koulutusluokitus2016koulutusastetaso2koodi = '32' THEN 'Yrkesinriktade grundexamina'
		WHEN s.koulutusluokitus2016koulutusastetaso2koodi = '33' THEN 'Yrkesexamina'
		WHEN s.koulutusluokitus2016koulutusastetaso2koodi = '41' THEN 'Specialyrkesexamina'
		ELSE COALESCE(tutkintotyyppinimi_sv, tutkintotyyppinimi, tutkintotyyppinimi_en, t.nimi_sv)
	END AS tutkintotyyppinimi_sv,
    CASE 
		WHEN s.nimi like '%VALMA%' OR s.nimi like '%TELMA%' OR s.nimi = 'Tutkintokoulutukseen valmentava koulutus' THEN 'Preparatory education' 
		WHEN s.koulutusluokitus2016koulutusastetaso2koodi = '32' THEN 'Vocational upper secondary qualifications'
		WHEN s.koulutusluokitus2016koulutusastetaso2koodi = '33' THEN 'Further vocational qualifications'
		WHEN s.koulutusluokitus2016koulutusastetaso2koodi = '41' THEN 'Specialist vocational qualifications'
		ELSE COALESCE(tutkintotyyppinimi_en, tutkintotyyppinimi, tutkintotyyppinimi_sv, t.nimi_en)
	END AS tutkintotyyppinimi_en,
	...
	CASE
		WHEN s.koodi = '301102' THEN '2'
		ELSE koulutustyyppikoodi
	END as koulutustyyppi_koodi,
    s.source
...
WHEN MATCHED THEN
  UPDATE SET
	...
	koulutusastetaso1_koodi = src.koulutusluokitus2016koulutusastetaso1koodi,
	...
	koulutusastetaso2_koodi = src.koulutusluokitus2016koulutusastetaso2koodi,
	...
	koulutustyyppi_koodi = src.koulutustyyppi_koodi,
...
IF NOT EXISTS (
	...
	BEGIN
		ALTER TABLE dw.d_koulutusluokitus ADD jarjestys_okmohjauksenala_koodi AS case when okmohjauksenala_koodi = '-1' then '99999' else cast(100+okmohjauksenala_koodi as varchar(10))
	  END
	END
