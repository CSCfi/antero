...
/****** Object:  StoredProcedure [dbo].[p_lataa_OTV_f_2_4]    Script Date: 25.9.2024 15:17:12 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	...
	,f.tuva_opiskeluoikeus_amm
	,tuva_opiskeluoikeus_amm_id = coalesce(d43.id, -1)
	,f.tutkinnot
	,aineisto_id = -1
...
LEFT JOIN VipunenTK..d_kylla_ei d43 ON d43.kylla_ei_koodi = f.tuva_opiskeluoikeus_amm
