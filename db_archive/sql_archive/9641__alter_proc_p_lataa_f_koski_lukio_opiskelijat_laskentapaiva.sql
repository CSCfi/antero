...
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_lukio_opiskelijat_laskentapaiva]    Script Date: 21.2.2024 14:59:35 ******/
SET ANSI_NULLS ON
GO
...
FROM (
	...
	FROM (
		...
		SELECT  
			...
			,CASE 
				WHEN paivays >= ov.alkuPvm and paivays < ov.loppuPvm THEN 1
				ELSE 0
