...
/****** Object:  StoredProcedure [dw].[p_lataa_api_tavoiteajassa_tutkinnon_suorittaneet]    Script Date: 31.1.2023 12:09:44 ******/
SET ANSI_NULLS ON
GO
...
IF (((((select count (*) from (
		select	[Tilastovuosi],[Kuukausi],[Sektori],[Korkeakoulu],[Koulutus],[Tutkinnot],[Tavoiteajassa],[Tavoiteaika ylitetty korkeintaan 12 kk],
				...
				[Koodi Korkeakoulu],[Koodi Koulutus],[Aineistotyyppi]
