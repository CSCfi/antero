USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_amos_spl_vaikuttavuus]    Script Date: 2.2.2022 16:13:57 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN ANTERO.sa.sa_amos_siirtotiedosto_okm8 okm8 ON okm8.koul_jarj = spl.ytunnus_amos_spl AND k13.tilv + 4 = YEAR(okm8.voimaan_alkaen) --AND YEAR(okm8.voimaan_alkaen) = 2020
