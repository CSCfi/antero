...
/****** Object:  StoredProcedure [dw].[p_lataa_f_arvo_luodut_vastaajatunnukset]    Script Date: 13.9.2024 9:13:31 ******/
SET ANSI_NULLS ON
GO
...
FROM (
	...
	WHERE (kk.tyyppi in ('avop', 'kandipalaute') OR (kk.tyyppi = 'amk-uraseuranta' AND YEAR(vastaajatunnus_alkupvm) > 2017)) AND k.oppilaitoskoodi is not null
	GROUP BY
	k.kyselykertaid,
	k.oppilaitoskoodi,
	k.tutkintokoodi,
