...
DROP VIEW IF EXISTS [dw].[v_amos_netto_opiskelijat_cultures]
GO

/****** Object:  View [dw].[v_koski_amm_opiskelijat_ja_tutkinnot_cultures]    Script Date: 6.7.2023 21:56:12 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dw].[v_amos_netto_opiskelijat_cultures] AS

/*
Käytetään raportilla: Oppisopimuksen koulutuskorvauksen lisärahoituksen perusteena olevat opiskelijat (Live)
Huom. 
Nyt jäädytettynä lähteenä on [dw].[v_koski_amm_opiskelijat_ja_tutkinnot_cultures_jaadytys], joka korvattaneen s23 jäädytyksen yhteydessä vastaavasti.
Muutos voi vaikuttaa yksittäisiin organisaation taustatietoihin, koska alun perin luotaessa vain järjestäjän y-tunnus ja nimi haettiin linkkidimensiosta.
*/
