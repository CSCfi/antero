...
/****** Object:  View [dbo].[v_f_aloittaneiden_lapaisy_K3_9_ammatillinen]    Script Date: 16.1.2018 16:13:49 ******/
SET ANSI_NULLS ON
GO
...
FROM  dbo.f_aloittaneiden_lapaisy f INNER JOIN
		...
		dbo.d_koulutusluokitus d7b ON d7b.koulutusluokitus_avain=d7.korvaava_koulutus_koodi INNER JOIN
