...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_ainekelpoisuudet]    Script Date: 22.11.2022 17:09:58 ******/
SET ANSI_NULLS ON
GO
...
FROM (
	...
	WHERE d.patevyysryhma1_fi = 'opettajaaineet' and (kl.koulutusaste2002_koodi in (72,81,82) or kl.koulutusastetaso2_koodi in (72,81,82)) and pat.patevyyskoodi not in ('ms', 'gf')
