...
/****** Object:  View [dw].[v_haku_ja_valinta_kk_amk]    Script Date: 21.4.2022 10:00:16 ******/
SET ANSI_NULLS ON
GO
...
SELECT --top 10
	  ...
	  ,[Hakuaika] = coalesce(d31.selite2_fi,'Tieto puuttuu')
...
--Ruotsi
	  ...
	  ,[Ansökningstiden] = coalesce(d31.selite2_sv,'Information saknas')
...
--Englanti
	  ...
	  ,[Application period] = coalesce(d31.selite2_en,'Missing data')
...
--Apusarakkeet mittareille	    
	  ...
	  ,[Hakuaika järjestys] = coalesce(d31.jarjestys2,999)
...
Select distinct --top 0
     ...
     ,case when f.loadtime>=d4.aloituspaikat then f.[aloituspaikat] else null end as alpa
	  ...
	  ,[Hakuaika] = coalesce(d13.selite2_fi,'Tieto puuttuu')
	  ...
	  ,[Hakutoive] = NULL
	  ,[Koulutusnimike] = d6.koulutusluokitus_fi
...
--Ruotsi
	  ...
	  ,[Ansökningstiden] = coalesce(d13.selite2_SV,'Information saknas')
	  ...
	  ,[Utbildningsbenämning] = d6.koulutusluokitus_sv
...
--Englanti
	  ...
	  ,[Application period] = coalesce(d13.selite2_EN,'Missing data')
	  ...
	  ,[Name of education] = d6.koulutusluokitus_en
	  ...
	  ,[Hakuaika järjestys] = coalesce(d13.jarjestys2,999)--case when coalesce(isnull(d13.selite_fi,''),'')='' then 'ööö' else d13.selite_fi end
