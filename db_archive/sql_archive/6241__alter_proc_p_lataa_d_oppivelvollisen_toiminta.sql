USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_d_oppivelvollisen_toiminta]    Script Date: 2.6.2022 19:58:32 ******/
SET ANSI_NULLS ON
GO
...
('7','Suorittaa oppivelvollisuutta','SV*','EN*','Tutkintoon johtamattomassa koulutuksessa (kelpaa oppivelvollisuuden suorittamiseen)','SV*','EN*',2,7,'manuaalinen'),
