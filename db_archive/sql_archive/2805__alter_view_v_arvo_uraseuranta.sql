...
/****** Object:  View [dw].[v_arvo_uraseuranta]    Script Date: 30.1.2020 11:12:27 ******/
SET ANSI_NULLS ON
GO
...
,CASE WHEN d7.ika_fi in ('20','21','22','23','24') 
THEN '20–24-vuotiaat' ELSE d7.ikaryhma1_sv END as 'Åldersgrupp'
...
,CASE WHEN d7.ika_fi in ('20','21','22','23','24') 
THEN '20–24-vuotiaat' ELSE d7.ikaryhma1_en END as 'Agegroup'
