USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_oppivelvolliset]    Script Date: 3.6.2022 14:32:43 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	FROM (
		...
		SELECT 
			...
			ov.kotikunta,
			CASE 
				WHEN ovt.oppivelvollisen_toiminta in (10,11,12) THEN 'Tieto puuttuu'
