...
/****** Object:  View [dw].[v_st_henkilosto]    Script Date: 21.1.2019 16:25:21 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	...
	,[Kansalaisuus järj] =
	  ...
	  END
	,[jarj Tehtäväjaottelu] = CASE  WHEN d3a.selite_fi = 'Muu henkilökunta' OR d3b.selite_fi = 'Muu henkilökunta' THEN 4 ELSE COALESCE(NULLIF(d3a.jarjestys_koodi,99999), d3b.jarjestys_koodi) END
