...
SELECT
 ...
 Where (aineisto = 'L' or (aineisto = 'E' and tilastointivuosi=YEAR(GETDATE())-1)) and tilastointivuosi>2010 AND koulutusaste2002_koodi in ('62','71','63','72','82') and d50.organisaatio_koodi not in ('02358', '01740', '01742', '01717')
...
OR (tarkastelujakso= '7,5' and  koulutussektori= 'Yiopistokoulutus' ) and d50.organisaatio_koodi not in ('02358', '01740', '01742', '01717') 
...
left join VipunenTK.dbo.d_koulutusluokitus d60 on d2.koulutusluokitus_koodi=d60.koulutusluokitus_avain
 ...
 left join VipunenTK.dbo.d_tieteenala d90 on d90.tieteenala_avain=d59.tieteenala_avain
where vuosi>2010 and d1.organisaatio_koodi not in ('02358', '01740', '01742', '01717') 
...
SELECT [tilastointivuosi]
 ...
 left join VipunenTK.dbo.d_tieteenala d90 on d90.tieteenala_avain=d59.tieteenala_avain
 Where aineisto = 'L' and tilastointivuosi>2010 and d2.koulutusaste2002_koodi in ('62','71') and d50.organisaatio_koodi not in ('02358', '01740', '01742', '01717') 
...
SELECT [vuosi]
	  ...
	  ,case when d7.koodi=1 then henkilotyovuosi end AS 'AMK Opetushenkilökunta'
	  ,case when d7.koodi=2 then henkilotyovuosi end AS 'AMK TKI-henkilökunta'
	  ,NULL as 'JulkaisuID'
	  ,NULL as 'Jufotaso'
	  ,NULL AS  'AMK Julkaisut (A-E)'
	  ,NULL AS  'AMK julkaisut (F ja I)'
 ...
 left join VipunenTK_lisatiedot.dbo.tieteenalan_TTHV d90a on 'TA10_'+d90.tieteenala_koodi=d90a.Tieteenala2010
 left join VipunenTK.dbo.d_tieteenala d91 on d90a.TTHV=d91.tieteenala_avain
 where d7.koodi in (1, 2) and d50.organisaatio_koodi not in ('02358', '01740', '01742', '01717') 
...
SELECT tilastovuosi
 ...
 where d1.julkaisunpaaluokka_koodi in ('A', 'B', 'C', 'D', 'E', 'F', 'I') and d3.oppilaitostyyppi_koodi='42' and tilastovuosi>2010 and d3.organisaatio_koodi not in ('02358', '01740', '01742', '01717') 
...
SELECT tilastovuosi
 ...
 --left join antero.dw.d_koulutusluokitus as d92 on d91.koulutuskoodi=d92.koulutusluokitus_koodi
 left join antero.dw.d_julkaisufoorumitaso as d5 on d_julkaisufoorumitaso_id=d5.id
 where d1.julkaisunpaaluokka_koodi in ('A', 'B', 'C', 'D', 'E', 'F', 'I') and d3.oppilaitostyyppi_koodi='41' and tilastovuosi>2010 and d3.organisaatio_koodi not in ('02358', '01740', '01742', '01717') 
 ...
 left join VipunenTK_lisatiedot.dbo.tieteenalan_TTHV d90a on 'TA10_'+d90.tieteenala_koodi=d90a.Tieteenala2010
 left join VipunenTK.dbo.d_tieteenala d91 on d90a.TTHV=d91.tieteenala_avain
 where d1.julkaisunpaaluokka_koodi in ('A', 'B', 'C', 'D', 'E', 'F', 'I') and vuosi>2010 and d3.organisaatio_koodi not in ('02358', '01740', '01742', '01717') 
...
SELECT tilastovuosi as 'Tilastointivuosi'
 ...
 where d1.rahoituslahde in ('Suomen Akatemia', 'Tekes', 'EU-puiteohjelmarahoitus') and d3.organisaatio_koodi not in ('02358', '01740', '01742', '01717') 
...
SELECT tilastointivuosi
 ...
 d3.organisaatio_koodi <> '02557' AND d3.organisaatio_koodi <> '10031'  AND NOT (sijoittuminen_1v_tutkinnon_jalkeen = 0 AND sijoittuminen_3v_tutkinnon_jalkeen = 0 AND sijoittuminen_5v_tutkinnon_jalkeen = 0)and d3.organisaatio_koodi not in ('02358', '01740', '01742', '01717') 
...
SELECT d15.vuosi
	  ...
	  ,case when kyselypohja='AVOP-AMK' and rahoitusmallikysymys='1' and not (kysymys_fi = 'Työelämän asiantuntijoiden osaamista hyödynnettiin onnistuneesti korkeakouluni toiminnassa.'and (kyselypohja = 'AVOP-AMK' or (kyselypohja = 'AVOP-YAMK' and d15.vuosi = 2016)))  then 
		 case when d14.kysymys_fi='Missä määrin opiskelijoiden palaute mielestäsi huomioitiin opintojen kehittämisessä? Palaute huomioitiin' and numerovalinta='0' then cast(7 as integer)
			when  d14.kysymys_fi='Missä määrin opiskelijoiden palaute mielestäsi huomioitiin opintojen kehittämisessä? Palaute huomioitiin' and numerovalinta='1' then cast(5.5 as integer)
			when d14.kysymys_fi='Missä määrin opiskelijoiden palaute mielestäsi huomioitiin opintojen kehittämisessä? Palaute huomioitiin' and numerovalinta='2' then cast(4 as integer)
			when d14.kysymys_fi='Missä määrin opiskelijoiden palaute mielestäsi huomioitiin opintojen kehittämisessä? Palaute huomioitiin' and numerovalinta='3' then cast(2.5 as integer)
			when d14.kysymys_fi='Missä määrin opiskelijoiden palaute mielestäsi huomioitiin opintojen kehittämisessä? Palaute huomioitiin' and numerovalinta='4' then cast(1 as integer)
			when d14.vastaustyyppi='arvosana7' then numerovalinta else null
			end
		end as 'AVOP-AMK pistemäärä'
	  ,case when d14.kysymysryhmajarjestys in ('10','11','9') and d13.kyselypohja='AVOP-AMK' and rahoitusmallikysymys='1' and not (kysymys_fi = 'Työelämän asiantuntijoiden osaamista hyödynnettiin onnistuneesti korkeakouluni toiminnassa.'and (kyselypohja = 'AVOP-AMK' or (kyselypohja = 'AVOP-YAMK' and d15.vuosi = 2016)))  then 
		 case when d14.kysymys_fi='Missä määrin opiskelijoiden palaute mielestäsi huomioitiin opintojen kehittämisessä? Palaute huomioitiin' and numerovalinta='0' then cast(7 as integer)
			when  d14.kysymys_fi='Missä määrin opiskelijoiden palaute mielestäsi huomioitiin opintojen kehittämisessä? Palaute huomioitiin' and numerovalinta='1' then cast(5.5 as integer)
			when d14.kysymys_fi='Missä määrin opiskelijoiden palaute mielestäsi huomioitiin opintojen kehittämisessä? Palaute huomioitiin' and numerovalinta='2' then cast(4 as integer)
			when d14.kysymys_fi='Missä määrin opiskelijoiden palaute mielestäsi huomioitiin opintojen kehittämisessä? Palaute huomioitiin' and numerovalinta='3' then cast(2.5 as integer)
			when d14.kysymys_fi='Missä määrin opiskelijoiden palaute mielestäsi huomioitiin opintojen kehittämisessä? Palaute huomioitiin' and numerovalinta='4' then cast(1 as integer)
			when d14.kysymysryhmajarjestys in ('10','11','9') and d13.kyselypohja='AVOP-AMK' and rahoitusmallikysymys='1' and d14.vastaustyyppi='arvosana7' then numerovalinta else null
			end
		end as 'AVOP-AMK Opiskelijapalaute_työelämä'
	  ,case when d14.kysymysryhmaid in ('10','11','9') and d13.kyselypohja='AVOP-YAMK' and rahoitusmallikysymys='1' and not (kysymys_fi = 'Työelämän asiantuntijoiden osaamista hyödynnettiin onnistuneesti korkeakouluni toiminnassa.'and (kyselypohja = 'AVOP-AMK' or (kyselypohja = 'AVOP-YAMK' and d15.vuosi = 2016)))  then 
		 case when d14.kysymys_fi='Missä määrin opiskelijoiden palaute mielestäsi huomioitiin opintojen kehittämisessä? Palaute huomioitiin' and numerovalinta='0' then cast(7 as integer)
			when  d14.kysymys_fi='Missä määrin opiskelijoiden palaute mielestäsi huomioitiin opintojen kehittämisessä? Palaute huomioitiin' and numerovalinta='1' then cast(5.5 as integer)
			when d14.kysymys_fi='Missä määrin opiskelijoiden palaute mielestäsi huomioitiin opintojen kehittämisessä? Palaute huomioitiin' and numerovalinta='2' then cast(4 as integer)
			when d14.kysymys_fi='Missä määrin opiskelijoiden palaute mielestäsi huomioitiin opintojen kehittämisessä? Palaute huomioitiin' and numerovalinta='3' then cast(2.5 as integer)
 ...
 left join antero.dw.d_kalenteri d15 on d_kalenteri_id=d15.id
 ...
 left join VipunenTK.dbo.d_tieteenala d90 on d90.tieteenala_avain=d59.tieteenala_avain
 where kyselypohja in ('KANDIPALAUTE','AVOP-AMK') and d3.oppilaitostyyppi_koodi in ('41','42') and d3.organisaatio_koodi not in ('02358', '01740', '01742', '01717') 
...
SELECT koulutuksen_alkamisvuosi
	...
	where d12.koulutussektori_koodi in (5,4) and d3.organisaatio_koodi not in ('02358', '01740', '01742', '01717') 
...
SELECT 2018 as 'Tilastovuosi'
	...
	where d2.organisaatio_koodi not in ('02358', '01740', '01742', '01717') 
