IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'dw.v_ytl_arvosanat'))
EXEC dbo.sp_executesql @statement = N'create view dw.v_ytl_arvosanat as select 1 as a'
GO

ALTER VIEW dw.v_ytl_arvosanat AS

SELECT id AS 'Opiskelija Koodi'
,tutkintokerta AS 'Tutkintokerta'
,koulun_nro AS 'Lukio Koodi'
,koulun_nimi AS 'Lukio'
,tyyppi AS 'Opetussuunnitelma Koodi'
,case tyyppi when 1 then 'Nuorten opetussuunnitelma' when 2 then 'Aikuisten opetussuunnitelma' end AS 'Opetussuunnitelma'
