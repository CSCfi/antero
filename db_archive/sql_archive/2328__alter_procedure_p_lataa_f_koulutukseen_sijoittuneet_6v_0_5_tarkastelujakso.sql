...
/****** Object:  StoredProcedure [dbo].[p_lataa_f_koulutukseen_sijoittuneet_6v_0_5_tarkastelujakso]    Script Date: 25.7.2019 14:03:45 ******/
SET ANSI_NULLS ON
GO
...
,case
	when   l.suorlk = '2' and (l.monihaku_1 in (4,5,6) or l.monihaku_2 in (4,5,6)) then 1
...
,case
	when   l.suorlk = '2' and (l.monihaku_1 in (5,6,7) or l.monihaku_2 in (5,6,7)) then 1
