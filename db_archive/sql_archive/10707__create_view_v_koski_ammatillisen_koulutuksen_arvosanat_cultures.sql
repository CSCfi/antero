...
/****** Object:  View [dw].[v_koski_ammatillisen_koulutuksen_arvosanat_cultures]    Script Date: 25.3.2025 8.57.26 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER    VIEW [dw].[v_koski_ammatillisen_koulutuksen_arvosanat_cultures] as
