...
ALTER TABLE [dw].[d_varda_toiminnallinenpainotus] DROP CONSTRAINT [DF__d_varda_toiminnallinenpainotus__username]
GO

ALTER TABLE [dw].[d_varda_toiminnallinenpainotus] DROP CONSTRAINT [DF__d_varda_toiminnallinenpainotus__loadtime]
GO

/****** Object:  Table [dw].[d_varda_toiminnallinenpainotus]    Script Date: 17.3.2022 16:06:48 ******/
