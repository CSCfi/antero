IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'api.yhteisjulkaisut'))
EXEC dbo.sp_executesql @statement = N'
CREATE VIEW api.yhteisjulkaisut AS
SELECT 1 AS a
'
GO

ALTER VIEW api.yhteisjulkaisut AS
