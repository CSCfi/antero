USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_d_haku]    Script Date: 16.1.2018 13:48:46 ******/
SET ANSI_NULLS ON
GO
...
USING (
	...
	,case
		...
		when kh.nimi like '%haku erityisopetuksena järjestettävään ammatilliseen koulutukseen%' or kh.nimi like 'Erityisopetuksena järjestettävän ammatillisen koulutuksen haku%' then '3'
	...
	,case
		...
		when kh.nimi like '%haku erityisopetuksena järjestettävään ammatilliseen koulutukseen%' or kh.nimi like 'Erityisopetuksena järjestettävän ammatillisen koulutuksen haku%' then 'Erityisopetuksena järjestettävän ammatillisen koulutuksen haku'
	...
	,case
		...
		when kh.nimi like '%haku erityisopetuksena järjestettävään ammatilliseen koulutukseen%' or kh.nimi like 'Erityisopetuksena järjestettävän ammatillisen koulutuksen haku%' then 'Ansökan till yrkesinriktad utbildning som anordnas som specialundervisning'
	...
	,case
		...
		when kh.nimi like '%haku erityisopetuksena järjestettävään ammatilliseen koulutukseen%' or kh.nimi like 'Erityisopetuksena järjestettävän ammatillisen koulutuksen haku%' then 'Application to vocational special needs education and training'
