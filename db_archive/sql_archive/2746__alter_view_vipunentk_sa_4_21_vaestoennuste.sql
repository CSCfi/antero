...
/****** Object:  View [dbo].[v_sa_4_21_Vaestoennuste]    Script Date: 7.1.2020 17:42:20 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN VipunenTK.dbo.d_alueluokitus d on d.kunta = (CASE WHEN sa.kunta LIKE 'Maarianhamina%' THEN 'Maarianhamina' ELSE sa.Kunta END)
