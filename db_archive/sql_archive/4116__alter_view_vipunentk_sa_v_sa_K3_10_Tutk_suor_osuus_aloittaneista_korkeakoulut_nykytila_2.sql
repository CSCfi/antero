...
/****** Object:  View [dbo].[v_sa_K3_10_Tutk_suor_osuus_aloittaneista_korkeakoulut_nykytila_2]    Script Date: 2.10.2020 16:42:07 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_sa_K3_10_Tutk_suor_osuus_aloittaneista_korkeakoulut_nykytila_2] AS
...
--2016
   ...
   ,[amksuorv_2016]
   ,[amksuorlk_2016]
   ,[amktutkkmaak_2016] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[amktutkkmaak_2016]), [amktutkkmaak_2016])
   ,[amktutkjarj_2016] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[amktutkjarj_2016]), [amktutkjarj_2016])
   ,[amktutkkoulk_2016] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[amktutkkoulk_2016]), [amktutkkoulk_2016])
   ,[ylamksuorv_2016]
   ,[ylamksuorlk_2016]
   ,[ylamktutkkmaak_2016] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[ylamktutkkmaak_2016]), [ylamktutkkmaak_2016])
   ,[ylamktutkjarj_2016] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[ylamktutkjarj_2016]), [ylamktutkjarj_2016])
   ,[ylamktutkkoulk_2016] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[ylamktutkkoulk_2016]), [ylamktutkkoulk_2016])
   ,[alkksuorv_2016]
   ,[alkksuorlk_2016]
   ,[alkktutkkmaak_2016] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[alkktutkkmaak_2016]), [alkktutkkmaak_2016])
   ,[alkktutkjarj_2016] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[alkktutkjarj_2016]), [alkktutkjarj_2016])
   ,[alkktutkkoulk_2016] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[alkktutkkoulk_2016]), [alkktutkkoulk_2016])
   ,[ylkksuorv_2016]
   ,[ylkksuorlk_2016]
   ,[ylkktutkkmaak_2016] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[ylkktutkkmaak_2016]), [ylkktutkkmaak_2016])
   ,[ylkktutkjarj_2016] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[ylkktutkjarj_2016]), [ylkktutkjarj_2016])
   ,[ylkktutkkoulk_2016] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[ylkktutkkoulk_2016]), [ylkktutkkoulk_2016])
   ,[tksuorv_2016]
   ,[tksuorlk_2016]
   ,[tktutkkmaak_2016] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[tktutkkmaak_2016]), [tktutkkmaak_2016])
   ,[tktutkjarj_2016] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[tktutkjarj_2016]), [tktutkjarj_2016])
   ,[tktutkkoulk_2016] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[tktutkkoulk_2016]), [tktutkkoulk_2016])
   ,[muutasuorv_2016]
   ,[muutasuorlk_2016]
   ,[muutatutkkmaak_2016] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[muutatutkkmaak_2016]), [muutatutkkmaak_2016])
   ,[muutatutkjarj_2016] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[muutatutkjarj_2016]), [muutatutkjarj_2016])
   ,[muutatutkkoulk_2016] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[muutatutkkoulk_2016]), [muutatutkkoulk_2016])
   ,[amkopiskkoulk_2016] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[amkopiskkoulk_2016]), [amkopiskkoulk_2016])
   ,[amkopiskjarj_2016] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[amkopiskjarj_2016]), [amkopiskjarj_2016])
   ,[amkkmaak_2016] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[amkkmaak_2016]), [amkkmaak_2016])
   ,[amkolotamm_2016]
   ,[amkolosyys_2016]
   ,[ylamkopiskkoulk_2016] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[ylamkopiskkoulk_2016]), [ylamkopiskkoulk_2016])
   ,[ylamkopiskjarj_2016] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[ylamkopiskjarj_2016]), [ylamkopiskjarj_2016])
   ,[ylamkkmaak_2016] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[ylamkkmaak_2016]), [ylamkkmaak_2016])
   ,[ylamkolotamm_2016]
   ,[ylamkolosyys_2016]
   ,[alkkopiskkoulk_2016] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[alkkopiskkoulk_2016]), [alkkopiskkoulk_2016])
   ,[alkkopiskjarj_2016] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[alkkopiskjarj_2016]), [alkkopiskjarj_2016])
   ,[alkkkmaak_2016] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[alkkkmaak_2016]), [alkkkmaak_2016])
   ,[alkkolotamm_2016]
   ,[alkkolosyys_2016]
   ,[ylkkopiskkoulk_2016] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[ylkkopiskkoulk_2016]), [ylkkopiskkoulk_2016])
   ,[ylkkopiskjarj_2016] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[ylkkopiskjarj_2016]), [ylkkopiskjarj_2016])
   ,[ylkkkmaak_2016] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[ylkkkmaak_2016]), [ylkkkmaak_2016])
   ,[ylkkolotamm_2016]
   ,[ylkkolosyys_2016]
   ,[tkopiskkoulk_2016] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[tkopiskkoulk_2016]), [tkopiskkoulk_2016])
   ,[tkopiskjarj_2016] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[tkopiskjarj_2016]), [tkopiskjarj_2016])
   ,[tkkmaak_2016] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[tkkmaak_2016]), [tkkmaak_2016])
   ,[tkolotamm_2016]
   ,[tkolosyys_2016]
   ,[muutaopiskkoulk_2016] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[muutaopiskkoulk_2016]), [muutaopiskkoulk_2016])
   ,[muutaopiskjarj_2016] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[muutaopiskjarj_2016]), [muutaopiskjarj_2016])
   ,[muutakmaak_2016] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[muutakmaak_2016]), [muutakmaak_2016])
   ,[muutaolotamm_2016]
   ,[muutaolosyys_2016]
   ,[ptoim1r5_2016]
   ,[amas_2016]
...
--2017
   ...
   ,[amksuorv_2017]
   ,[amksuorlk_2017]
   ,[amktutkkmaak_2017] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[amktutkkmaak_2017]), [amktutkkmaak_2017])
   ,[amktutkjarj_2017] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[amktutkjarj_2017]), [amktutkjarj_2017])
   ,[amktutkkoulk_2017] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[amktutkkoulk_2017]), [amktutkkoulk_2017])
   ,[ylamksuorv_2017]
   ,[ylamksuorlk_2017]
   ,[ylamktutkkmaak_2017] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[ylamktutkkmaak_2017]), [ylamktutkkmaak_2017])
   ,[ylamktutkjarj_2017] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[ylamktutkjarj_2017]), [ylamktutkjarj_2017])
   ,[ylamktutkkoulk_2017] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[ylamktutkkoulk_2017]), [ylamktutkkoulk_2017])
   ,[alkksuorv_2017]
   ,[alkksuorlk_2017]
   ,[alkktutkkmaak_2017] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[alkktutkkmaak_2017]), [alkktutkkmaak_2017])
   ,[alkktutkjarj_2017] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[alkktutkjarj_2017]), [alkktutkjarj_2017])
   ,[alkktutkkoulk_2017] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[alkktutkkoulk_2017]), [alkktutkkoulk_2017])
   ,[ylkksuorv_2017]
   ,[ylkksuorlk_2017]
   ,[ylkktutkkmaak_2017] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[ylkktutkkmaak_2017]), [ylkktutkkmaak_2017])
   ,[ylkktutkjarj_2017] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[ylkktutkjarj_2017]), [ylkktutkjarj_2017])
   ,[ylkktutkkoulk_2017] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[ylkktutkkoulk_2017]), [ylkktutkkoulk_2017])
   ,[tksuorv_2017]
   ,[tksuorlk_2017]
   ,[tktutkkmaak_2017] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[tktutkkmaak_2017]), [tktutkkmaak_2017])
   ,[tktutkjarj_2017] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[tktutkjarj_2017]), [tktutkjarj_2017])
   ,[tktutkkoulk_2017] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[tktutkkoulk_2017]), [tktutkkoulk_2017])
   ,[muutasuorv_2017]
   ,[muutasuorlk_2017]
   ,[muutatutkkmaak_2017] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[muutatutkkmaak_2017]), [muutatutkkmaak_2017])
   ,[muutatutkjarj_2017] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[muutatutkjarj_2017]), [muutatutkjarj_2017])
   ,[muutatutkkoulk_2017] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[muutatutkkoulk_2017]), [muutatutkkoulk_2017])
   ,[amkopiskkoulk_2017] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[amkopiskkoulk_2017]), [amkopiskkoulk_2017])
   ,[amkopiskjarj_2017] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[amkopiskjarj_2017]), [amkopiskjarj_2017])
   ,[amkkmaak_2017] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[amkkmaak_2017]), [amkkmaak_2017])
   ,[amkolotamm_2017]
   ,[amkolosyys_2017]
   ,[ylamkopiskkoulk_2017] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[ylamkopiskkoulk_2017]), [ylamkopiskkoulk_2017])
   ,[ylamkopiskjarj_2017] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[ylamkopiskjarj_2017]), [ylamkopiskjarj_2017])
   ,[ylamkkmaak_2017] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[ylamkkmaak_2017]), [ylamkkmaak_2017])
   ,[ylamkolotamm_2017]
   ,[ylamkolosyys_2017]
   ,[alkkopiskkoulk_2017] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[alkkopiskkoulk_2017]), [alkkopiskkoulk_2017])
   ,[alkkopiskjarj_2017] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[alkkopiskjarj_2017]), [alkkopiskjarj_2017])
   ,[alkkkmaak_2017] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[alkkkmaak_2017]), [alkkkmaak_2017])
   ,[alkkolotamm_2017]
   ,[alkkolosyys_2017]
   ,[ylkkopiskkoulk_2017] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[ylkkopiskkoulk_2017]), [ylkkopiskkoulk_2017])
   ,[ylkkopiskjarj_2017] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[ylkkopiskjarj_2017]), [ylkkopiskjarj_2017])
   ,[ylkkkmaak_2017] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[ylkkkmaak_2017]), [ylkkkmaak_2017])
   ,[ylkkolotamm_2017]
   ,[ylkkolosyys_2017]
   ,[tkopiskkoulk_2017] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[tkopiskkoulk_2017]), [tkopiskkoulk_2017])
   ,[tkopiskjarj_2017] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[tkopiskjarj_2017]), [tkopiskjarj_2017])
   ,[tkkmaak_2017] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[tkkmaak_2017]), [tkkmaak_2017])
   ,[tkolotamm_2017]
   ,[tkolosyys_2017]
   ,[muutaopiskkoulk_2017] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[muutaopiskkoulk_2017]), [muutaopiskkoulk_2017])
   ,[muutaopiskjarj_2017] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[muutaopiskjarj_2017]), [muutaopiskjarj_2017])
   ,[muutakmaak_2017] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[muutakmaak_2017]), [muutakmaak_2017])
   ,[muutaolotamm_2017]
   ,[muutaolosyys_2017]
   ,[ptoim1r5_2017]
   ,[amas_2017]
...
--2018
   ...
   ,[amksuorv_2018]
   ,[amksuorlk_2018]
   ,[amktutkkmaak_2018] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[amktutkkmaak_2018]), [amktutkkmaak_2018])
   ,[amktutkjarj_2018] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[amktutkjarj_2018]), [amktutkjarj_2018])
   ,[amktutkkoulk_2018] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[amktutkkoulk_2018]), [amktutkkoulk_2018])
   ,[ylamksuorv_2018]
   ,[ylamksuorlk_2018]
   ,[ylamktutkkmaak_2018] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[ylamktutkkmaak_2018]), [ylamktutkkmaak_2018])
   ,[ylamktutkjarj_2018] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[ylamktutkjarj_2018]), [ylamktutkjarj_2018])
   ,[ylamktutkkoulk_2018] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[ylamktutkkoulk_2018]), [ylamktutkkoulk_2018])
   ,[alkksuorv_2018]
   ,[alkksuorlk_2018]
   ,[alkktutkkmaak_2018] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[alkktutkkmaak_2018]), [alkktutkkmaak_2018])
   ,[alkktutkjarj_2018] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[alkktutkjarj_2018]), [alkktutkjarj_2018])
   ,[alkktutkkoulk_2018] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[alkktutkkoulk_2018]), [alkktutkkoulk_2018])
   ,[ylkksuorv_2018]
   ,[ylkksuorlk_2018]
   ,[ylkktutkkmaak_2018] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[ylkktutkkmaak_2018]), [ylkktutkkmaak_2018])
   ,[ylkktutkjarj_2018] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[ylkktutkjarj_2018]), [ylkktutkjarj_2018])
   ,[ylkktutkkoulk_2018] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[ylkktutkkoulk_2018]), [ylkktutkkoulk_2018])
   ,[tksuorv_2018]
   ,[tksuorlk_2018]
   ,[tktutkkmaak_2018] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[tktutkkmaak_2018]), [tktutkkmaak_2018])
   ,[tktutkjarj_2018] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[tktutkjarj_2018]), [tktutkjarj_2018])
   ,[tktutkkoulk_2018] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[tktutkkoulk_2018]), [tktutkkoulk_2018])
   ,[muutasuorv_2018]
   ,[muutasuorlk_2018]
   ,[muutatutkkmaak_2018] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[muutatutkkmaak_2018]), [muutatutkkmaak_2018])
   ,[muutatutkjarj_2018] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[muutatutkjarj_2018]), [muutatutkjarj_2018])
   ,[muutatutkkoulk_2018] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[muutatutkkoulk_2018]), [muutatutkkoulk_2018])
   ,[amkopiskkoulk_2018] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[amkopiskkoulk_2018]), [amkopiskkoulk_2018])
   ,[amkopiskjarj_2018] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[amkopiskjarj_2018]), [amkopiskjarj_2018])
   ,[amkkmaak_2018] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[amkkmaak_2018]), [amkkmaak_2018])
   ,[amkolotamm_2018]
   ,[amkolosyys_2018]
   ,[ylamkopiskkoulk_2018] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[ylamkopiskkoulk_2018]), [ylamkopiskkoulk_2018])
   ,[ylamkopiskjarj_2018] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[ylamkopiskjarj_2018]), [ylamkopiskjarj_2018])
   ,[ylamkkmaak_2018] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[ylamkkmaak_2018]), [ylamkkmaak_2018])
   ,[ylamkolotamm_2018]
   ,[ylamkolosyys_2018]
   ,[alkkopiskkoulk_2018] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[alkkopiskkoulk_2018]), [alkkopiskkoulk_2018])
   ,[alkkopiskjarj_2018] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[alkkopiskjarj_2018]), [alkkopiskjarj_2018])
   ,[alkkkmaak_2018] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[alkkkmaak_2018]), [alkkkmaak_2018])
   ,[alkkolotamm_2018]
   ,[alkkolosyys_2018]
   ,[ylkkopiskkoulk_2018] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[ylkkopiskkoulk_2018]), [ylkkopiskkoulk_2018])
   ,[ylkkopiskjarj_2018] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[ylkkopiskjarj_2018]), [ylkkopiskjarj_2018])
   ,[ylkkkmaak_2018] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[ylkkkmaak_2018]), [ylkkkmaak_2018])
   ,[ylkkolotamm_2018]
   ,[ylkkolosyys_2018]
   ,[tkopiskkoulk_2018] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[tkopiskkoulk_2018]), [tkopiskkoulk_2018])
   ,[tkopiskjarj_2018] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[tkopiskjarj_2018]), [tkopiskjarj_2018])
   ,[tkkmaak_2018] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[tkkmaak_2018]), [tkkmaak_2018])
   ,[tkolotamm_2018]
   ,[tkolosyys_2018]
   ,[muutaopiskkoulk_2018] = coalesce((Select koulutus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutusluokitus_nykytila] WHERE koulutus_koodi=[muutaopiskkoulk_2018]), [muutaopiskkoulk_2018])
   ,[muutaopiskjarj_2018] = coalesce((Select koulutuksen_jarjestajakoodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_koulutuksen_jarjestaja_nykytila] WHERE koulutuksen_jarjestajakoodi=[muutaopiskjarj_2018]), [muutaopiskjarj_2018])
   ,[muutakmaak_2018] = coalesce((Select alueluokitus_koodi_nykytila FROM [VipunenTK_lisatiedot].[dbo].[v_AL_K3_10_alueluokitus_maakunta_nykytila] WHERE alueluokitus_koodi=[muutakmaak_2018]), [muutakmaak_2018])
   ,[muutaolotamm_2018]
   ,[muutaolosyys_2018]
   ,[ptoim1r5_2018]
   ,[amas_2018]
