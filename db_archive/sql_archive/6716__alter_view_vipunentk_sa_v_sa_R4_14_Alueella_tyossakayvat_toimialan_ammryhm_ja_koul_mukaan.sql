...
/****** Object:  View [dbo].[v_sa_R4_14_Alueella_tyossakayvat_toimialan_ammryhm_ja_koul_mukaan]    Script Date: 1.12.2022 9:13:08 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
	  ...
	  ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
FROM [TK_H9098_CSC].[dbo].[TK_K4_14a_sopv_22]
