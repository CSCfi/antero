...
/****** Object:  View [dw].[v_haku_ja_valinta_kk_live]    Script Date: 21.12.2017 15:56:37 ******/
SET ANSI_NULLS ON
GO
...
SELECT --top 10
	  ...
	  ,[Hakuaika] = coalesce(case when d31.selite_fi not in ('Hakuaika 1','Hakuaika 2') then '' else d31.selite_fi end,'')
...
--Apusarakkeet mittareille	    
	  ...
	  ,[Hakuaika järjestys] = coalesce(case when d31.selite_fi not in ('Hakuaika 1','Hakuaika 2') then 2 else 1 end,2)
...
Select distinct --top 0
	  ...
	  ,[Hakuaika] = coalesce(case when d13.selite_fi not in ('Hakuaika 1','Hakuaika 2') then '' else d13.selite_fi end,'')
...
--Englanti
	  ...
	  ,[Hakuaika järjestys] = coalesce(case when d13.selite_fi not in ('Hakuaika 1','Hakuaika 2') then 2 else 1 end,2)
