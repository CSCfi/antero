...
DROP VIEW IF EXISTS [dw].[v_koski_amm_sopimusmuotoinen_koulutus] 
GO

/****** Object:  View [dw].[v_koski_amm_sopimusmuotoinen_koulutus]    Script Date: 14.12.2020 17:23:39 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dw].[v_koski_amm_sopimusmuotoinen_koulutus] AS
SELECT 
