IF NOT EXISTS (select * from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA='sa' and TABLE_NAME='sa_virta_otp_cimopitkalahteva') BEGIN
...
ALTER TABLE sa.sa_virta_otp_cimopitkalahteva ADD  CONSTRAINT DF__sa_virta_otp_cimopitkalahteva__loadtime  DEFAULT (getdate()) FOR loadtime
;
ALTER TABLE sa.sa_virta_otp_cimopitkalahteva ADD  CONSTRAINT DF__sa_virta_otp_cimopitkalahteva__username  DEFAULT (suser_name()) FOR username
;
