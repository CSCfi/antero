...
/****** Object:  StoredProcedure [dbo].[p_lataa_f_koulutukseen_sijoittuneet_2v]    Script Date: 13.2.2024 14:05:16 ******/
SET ANSI_NULLS ON
GO
...
SELECT
	  ...
	  ,[ika_1v_suorv_id] =  coalesce(d29b.id,-1)
...
LEFT JOIN VipunenTK..d_ika  AS d29b ON d29b.ika_avain  =
														case 
															when f.ika_1v_suorv < 19 then '18655v18'
