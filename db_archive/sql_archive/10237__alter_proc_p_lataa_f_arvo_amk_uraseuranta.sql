...
/****** Object:  StoredProcedure [dw].[p_lataa_f_arvo_amk_uraseuranta]    Script Date: 16.10.2024 12:46:01 ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT
     coalesce(d1a.id,d1c.id,-1)		AS d_organisaatio_oppilaitos_id
...
LEFT JOIN ANTERO.dw.d_organisaatioluokitus d1c on d1b.organisaatio_oid = d1c.ylaorganisaatio_oid
--
LEFT JOIN dw.d_alueluokitus d2a ON d2a.kunta_koodi = coalesce(d1a.kunta_koodi, d1c.kunta_koodi)
