...
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_hoivaavustajat]    Script Date: 29.6.2023 21:15:36 ******/
SET ANSI_NULLS ON
GO
...
--exec [dw].[p_lataa_f_koski_hoivaavustajat]
...
SELECT
	...
	--org
	,coalesce(jl_pat.id, -1) as d_amos_spl_jarjestaja_linkki_id_oo_pat
	,coalesce(d6b.id, -1) as d_organisaatioluokitus_oppilaitos_id_oo_pat
	,coalesce(d7.id, -1) as d_organisaatioluokitus_koulutustoimija_id_tt_pat
	,coalesce(d8.id, -1) as d_organisaatioluokitus_oppilaitos_id_tt_pat
	,coalesce(d9.id, -1) as d_organisaatioluokitus_toimipiste_id_tt_pat
	,coalesce(d10.id, -1) as d_alueluokitus_koulutustoimija_id_oo_pat
	,coalesce(d10b.id, -1) as d_alueluokitus_oppilaitos_id_oo_pat
	,coalesce(d11.id, -1) as d_alueluokitus_koulutustoimija_id_tt_pat
	,coalesce(d12.id, -1) as d_alueluokitus_oppilaitos_id_tt_pat
	,coalesce(d13.id, -1) as d_alueluokitus_toimipiste_id_tt_pat
	,coalesce(jl_tutk.id, -1) as d_amos_spl_jarjestaja_linkki_id_oo_tutk
	,coalesce(d16b.id, -1) as d_organisaatioluokitus_oppilaitos_id_oo_tutk
	,coalesce(d17.id, -1) as d_organisaatioluokitus_koulutustoimija_id_tt_tutk
	,coalesce(d18.id, -1) as d_organisaatioluokitus_oppilaitos_id_tt_tutk
	,coalesce(d19.id, -1) as d_organisaatioluokitus_toimipiste_id_tt_tutk
	,coalesce(d20.id, -1) as d_alueluokitus_koulutustoimija_id_oo_tutk
	,coalesce(d20b.id, -1) as d_alueluokitus_oppilaitos_id_oo_tutk
	,coalesce(d21.id, -1) as d_alueluokitus_koulutustoimija_id_tt_tutk
	,coalesce(d22.id, -1) as d_alueluokitus_oppilaitos_id_tt_tutk
	,coalesce(d23.id, -1) as d_alueluokitus_toimipiste_id_tt_tutk
