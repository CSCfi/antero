...
/****** Object:  View [dbo].[v_f_tab_keskeytaneet_amk]    Script Date: 24.11.2021 18:50:19 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_f_tab_keskeytaneet_amk] AS
...
,d1_75.opintojen_kulku_kala_t1n_mukaan_versio2 AS 'Opintojen kulku (koulutusala 1)'
,d2_75.opintojen_kulku_kala_t2n_mukaan_versio2 AS 'Opintojen kulku (koulutusala 2)'
,d3_75.opintojen_kulku_kala_t3n_mukaan_versio2 AS 'Opintojen kulku (koulutusala 3)'
...
,d1_75.opintojen_kulku_kala_t1n_mukaan_versio2_EN AS 'Progress of studies (field of ed. 1)'
,d2_75.opintojen_kulku_kala_t2n_mukaan_versio2_EN AS 'Progress of studies (field of ed. 2)'
,d3_75.opintojen_kulku_kala_t3n_mukaan_versio2_EN AS 'Progress of studies (field of ed. 3)'
...
FROM dbo.f_keskeyttaneet
	...
	LEFT JOIN d_lahde d2 ON d2.id = lahde_id
	...
	LEFT JOIN d_opintojen_kulku_kala_t1n_mukaan_versio2 d1_75 ON d1_75.id = [2bb_opiskelijoiden_opintojen_kulku_kala_t1_mukaan_id]
	LEFT JOIN d_opintojen_kulku_kala_t2n_mukaan_versio2 d2_75 ON d2_75.id = [2bb_opiskelijoiden_opintojen_kulku_kala_t2_mukaan_id]
	LEFT JOIN d_opintojen_kulku_kala_t3n_mukaan_versio2 d3_75 ON d3_75.id = [2bb_opiskelijoiden_opintojen_kulku_kala_t3_mukaan_id]

WHERE d28.oppilaitoskoodi not in ('02557','10031') --seur. v. oppilaitos ei Poliisiammattikorkeakoulu, Högskolan på Åland
  AND (d16.koulutusaste2002_koodi in ('62','71') OR d16.Koulutusaste_taso2_koodi in ('62','71')) 
