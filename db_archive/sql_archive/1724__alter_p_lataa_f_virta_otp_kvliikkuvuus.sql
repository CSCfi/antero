...
select
           ...
           case when  AMK like 'Arcada%' then (select id from [ANTERO].[dw].[d_organisaatioluokitus] where organisaatio_koodi = '02535')
		         ...
		         when  not exists (select id from [ANTERO].[dw].[d_organisaatioluokitus] where amk = organisaatio_vanha_fi) then '-1'
		         else (select id from [ANTERO].[dw].[d_organisaatioluokitus] where amk = organisaatio_vanha_fi)
