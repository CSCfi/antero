...
GO
INSERT [sa].[sa_kuntatalous_taksonomiat_aputaulu] ([id], [tunnusluku], [sarake], [source], [loadtime], [username]) VALUES (3, N'2050-2050 Tilikauden ylijäämä (alijäämä), oma pääoma', N'ylialijaama', NULL, CAST(N'2025-10-20T13:31:33.317' AS DateTime), N'DWI\kohojoha')
GO
...
GO
INSERT [sa].[sa_kuntatalous_taksonomiat_aputaulu] ([id], [tunnusluku], [sarake], [source], [loadtime], [username]) VALUES (10, N'1900-1900 Rahat ja pankkisaamiset', N'rahoitusomaisuus', NULL, CAST(N'2025-10-20T13:31:33.317' AS DateTime), N'DWI\kohojoha')
GO
...
GO
INSERT [sa].[sa_kuntatalous_taksonomiat_aputaulu] ([id], [tunnusluku], [sarake], [source], [loadtime], [username]) VALUES (13, N'2400-2600 Vieras pääoma', N'vieras_paaoma', NULL, CAST(N'2025-10-20T13:31:33.317' AS DateTime), N'DWI\kohojoha')
GO
