...
/****** Object:  View [dw].[v_koski_lukio_opiskelijat_kuukausittain_cultures]    Script Date: 27.10.2022 12:38:46 ******/
SET ANSI_NULLS ON
GO
...
--exec [dbo].[tarkista_kaannokset2] 'v_koski_lukio_opiskelijat_kuukausittain_cultures'
CREATE or ALTER VIEW [dw].[v_koski_lukio_opiskelijat_kuukausittain_cultures] AS
...
-- JÄRJESTYSMUUTTUJAT
	...
	,jarjestys_aidinkieli		 								= d6.jarjestys_kieliryhma1
	,jarjestys_suorituskieliryhma 								= d15.jarjestys_kieliryhma1
	...
	,jarjestys_kansalaisuus										= CASE WHEN f.kansalaisuus = '246' THEN 1 ELSE 2 END
