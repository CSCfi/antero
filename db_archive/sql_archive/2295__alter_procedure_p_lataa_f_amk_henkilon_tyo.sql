...
SELECT COALESCE(s2.id,-1)
	...
	,CASE
		WHEN s1.[Nimitystapa (työsuhteen vakituisuus / määräaikaisuus)] = '2' and vuosi < '2017'
			THEN COALESCE(TRY_CONVERT(Datetime, LTRIM(RTRIM(s1.[Sopimus_loppupvm])), 104), '9999-12-31 00:00:00.000')
		WHEN s1.[Nimitystapa (työsuhteen vakituisuus / määräaikaisuus)] in ('1', '2') and vuosi > '2016'
  			THEN COALESCE(TRY_CONVERT(Datetime, LTRIM(RTRIM(s1.[Sopimus_loppupvm])), 104), '9999-12-31 00:00:00.000')
