USE [ANTERO]
GO
/****** Object:  Table [dw].[d_perusopetus_oppiaine_ja_oppimaara]    Script Date: 31.1.2022 10:28:53 ******/
...
GO
INSERT [dw].[d_perusopetus_oppiaine_ja_oppimaara] ([id], [koodisto], [koodi], [nimi], [nimi_sv], [nimi_en], [jarjestys], [ryhma_koodi], [ryhma_nimi], [ryhma_nimi_sv], [ryhma_nimi_en], [jarjestys_ryhma], [ryhma2_koodi], [ryhma2_nimi], [ryhma2_nimi_sv], [ryhma2_nimi_en], [jarjestys_ryhma2]) VALUES (64, N'koskioppiaineetyleissivistava', N'KT', N'Uskonto', N'Religion', NULL, N'5501', N'usk', N'Uskonto, Elämänkatsomustieto', NULL, NULL, 6, N'usk', N'Uskonto, Elämänkatsomustieto', NULL, NULL, 6)
GO
INSERT [dw].[d_perusopetus_oppiaine_ja_oppimaara] ([id], [koodisto], [koodi], [nimi], [nimi_sv], [nimi_en], [jarjestys], [ryhma_koodi], [ryhma_nimi], [ryhma_nimi_sv], [ryhma_nimi_en], [jarjestys_ryhma], [ryhma2_koodi], [ryhma2_nimi], [ryhma2_nimi_sv], [ryhma2_nimi_en], [jarjestys_ryhma2]) VALUES (65, N'koskioppiaineetyleissivistava', N'ET', N'Elämänkatsomustieto', N'Livsåskådningskunskap', NULL, N'5551', N'usk', N'Uskonto, Elämänkatsomustieto', NULL, NULL, 6, N'usk', N'Uskonto, Elämänkatsomustieto', NULL, NULL, 6)
GO
...
GO
INSERT [dw].[d_perusopetus_oppiaine_ja_oppimaara] ([id], [koodisto], [koodi], [nimi], [nimi_sv], [nimi_en], [jarjestys], [ryhma_koodi], [ryhma_nimi], [ryhma_nimi_sv], [ryhma_nimi_en], [jarjestys_ryhma], [ryhma2_koodi], [ryhma2_nimi], [ryhma2_nimi_sv], [ryhma2_nimi_en], [jarjestys_ryhma2]) VALUES (76, N'koskioppiaineetyleissivistava', N'KT/ET', N'Uskonto, Elämänkatsomustieto', N'Religion, Livsåskådningskunskap', NULL, N'5500', N'usk', N'Uskonto, Elämänkatsomustieto', NULL, NULL, 6, N'usk', N'Uskonto, Elämänkatsomustieto', NULL, NULL, 6)
GO
