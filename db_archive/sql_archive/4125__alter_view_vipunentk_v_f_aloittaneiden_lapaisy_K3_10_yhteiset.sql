...
/****** Object:  View [dbo].[v_f_aloittaneiden_lapaisy_K3_10_yhteiset]    Script Date: 19.10.2020 13:26:16 ******/
SET ANSI_NULLS ON
GO
...
SELECT f.lkm_int AS lkm_int2,
		...
		Or (d7.koulutusaste2002_koodi='72' 
			...
			else 'Unknown' end AS [Beginning cycle of ed.], 
