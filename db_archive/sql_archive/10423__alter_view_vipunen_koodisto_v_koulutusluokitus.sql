...
/****** Object:  View [dbo].[v_koulutusluokitus]    Script Date: 5.12.2024 14:29:56 ******/
SET ANSI_NULLS ON
GO
...
-- jsyrjala 16.10.2020:
  -- n. 2020 lisätty iscfi
  -- 14.10.2020 poistettu ei-numeerisista avaimista (pl. sa9999) lakkautusvuosi sekä korvaava_koulutuskoodi tuottamasta tuplia
  -- 16.10.2020 korjattu vielä yksi em. [iscfi2013selite_EN]:n arvo viimeisen tuplan poistamiseksi
...
SELECT DISTINCT
	  ...
	  ,[iscfi2013selite_FI]
	  ,[iscfi2013selite_SV]
	  ,[iscfi2013selite_EN] =	case iscfi2013koodi 
									when '1048' then 'Inter-disciplinary programmes and qualifications involving transport services' --Inter-dic.. 2016
									else [iscfi2013selite_EN] 
								end 
	  ,[iscfinarrow2013koodi] 
	  ,[iscfinarrow2013selite_FI] 
	  ,[iscfinarrow2013selite_SV] 
...
SELECT DISTINCT
  ...
  and not (koulutuskoodi in ('613952','719952','719953') and kaste_t2koodi not in ('69', '79'))  -- steinerkouluista mukaan myös kastekoodit 69 ja 79. MR 13.3.2024
  -- and koulutuskoodi not in ('613952','719952','719953')--steinerkoulun roskat pois -AP 20.3.2018
  and not ([kaste_t2koodi] = '72' and iscle2011koodi = '6') -- poistetaan ristiriitainen rivi -MR 4.12.2024
  and iscle2011koodi IS NOT NULL  -- poistetaan kaste_t2 = 91, joilla iscle2011 puuttuu -MR 4.12.2024
 ) kaste_t2 
