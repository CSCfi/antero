...
/****** Object:  View [dbo].[v_f_tab_oppisopimus_koulutuksen_kesto]    Script Date: 9.8.2018 10:52:53 ******/
SET ANSI_NULLS ON
GO
...
SELECT [Tilastovuosi] = f.tilastovuosi
      ...
      ,[Granskningsgrupp] = d1.oppis_osallis_ja_tutk_suor_SV
      ,[Kön] = d2.sukupuoli_SV
      ...
      ,[Reference group] = d1.oppis_osallis_ja_tutk_suor_EN
