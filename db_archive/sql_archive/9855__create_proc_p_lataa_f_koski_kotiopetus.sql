...
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_kotiopetus]    Script Date: 17.5.2024 9:26:26 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dw].[p_lataa_f_koski_kotiopetus] AS
...
BEGIN
	...
	LEFT JOIN Koski_SA.sa.toisen_asteen_tutkinnot tat on tat.oppija_oid = oo.oppija_oid and tat.rnk = 1
