IF NOT EXISTS (select * from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA='sa' and TABLE_NAME='sa_virta_otp_cimolyhytlahteva') BEGIN
...
ALTER TABLE sa.sa_virta_otp_cimolyhytlahteva ADD  CONSTRAINT DF__sa_virta_otp_cimolyhytlahteva__loadtime  DEFAULT (getdate()) FOR loadtime
;
ALTER TABLE sa.sa_virta_otp_cimolyhytlahteva ADD  CONSTRAINT DF__sa_virta_otp_cimolyhytlahteva__username  DEFAULT (suser_name()) FOR username
;
