...
/****** Object:  StoredProcedure [dw].[p_lataa_d_amos_tase_ja_tunnusluvut]    Script Date: 29.10.2025 14.22.33 ******/
DROP PROCEDURE IF EXISTS [dw].[p_lataa_d_amos_tase_ja_tunnusluvut]
GO
...
CREATE PROCEDURE [dw].[p_lataa_d_amos_tase_ja_tunnusluvut] AS
	...
	SELECT 
		[koodi],
			CASE
				...
				WHEN selite = 'Lainat rahoituslaitoksilta tai muilta luotonantajilta, vastattavaa' THEN 'vieras_paaoma'
	 ...
	 WHERE koodi in ('k00m1', 'k00m2', 'k00x1', 'f2tl0', 'f3tl0', 'e411m2', 'e491m2', 'b123te0', 'b124te0', 'b125te0', 'b212te0', 'b213te0', 'b215te0', 'b216te0', 'b210te0', 'b2221te0', 'b2220te0', 'b20te0')
