...
/****** Object:  Table [dbo].[_f_koulutukseen_sijoittuneet_8v_tarkastelu]    Script Date: 22.10.2024 9:34:23 ******/
SET ANSI_NULLS ON
GO
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[_f_koulutukseen_sijoittuneet_8v_tarkastelu]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[_f_koulutukseen_sijoittuneet_8v_tarkastelu](
