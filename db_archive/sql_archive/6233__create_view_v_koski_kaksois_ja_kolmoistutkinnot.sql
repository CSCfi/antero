...
/****** Object:  View [dw].[v_koski_kaksois_ja_kolmoistutkinnot]    Script Date: 24.5.2022 14:32:24 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER VIEW [dw].[v_koski_kaksois_ja_kolmoistutkinnot] AS
...
SELECT 
	...
	coalesce(d11.aine_selite_fi, 'Ei ylioppilastutkintoa') as 'Ylioppilastutkinnon aine',
	CASE
		WHEN f.oppija_oid_tiedossa = 0 THEN 'Tieto ammatillisen perustutkinnon ja lukion oppimäärän suorittamisesta puuttuu'
	...
	coalesce(d11.aine_selite_fi, 'ÖÖÖ') as 'Jarjestys Ylioppilastutkinnon aine'
