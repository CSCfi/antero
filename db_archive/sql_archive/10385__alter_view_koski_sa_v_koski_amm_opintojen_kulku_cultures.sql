...
/****** Object:  View [dw].[v_koski_amm_opintojen_kulku_cultures]    Script Date: 13.11.2024 14:49:30 ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT --TOP 1000
	...
	suorituksen_tyyppi_fi = d0.selite_fi,
	tutkinto_fi = d4.koulutusluokitus_fi,
	koulutusnimike_fi = d4.koulutusluokitus_fi, --ed. rivin tutkinto_fi käytössä raportilla
...
LEFT JOIN dw.d_suorituksen_tyyppi d0 ON f.d_suorituksen_tyyppi_id = d0.id
...
LEFT JOIN dw.d_opintojen_kulku_keskiarvot d18 ON d18.id = d_opintojen_kulku_keskiarvot_kategoria_id
