...
/****** Object:  View [dbo].[v_f_2_10_Korkeakouluopiskelijoiden_aikaisempi_koulutus]    Script Date: 25.11.2024 10:09:22 ******/
SET ANSI_NULLS ON
GO
	...
	as nvarchar(100))
	 ...
	 CAST(
      (
		...
		when koulk_koulutusaste_taso1 = [aikalkkkoulk_koulutusaste_taso1] then 'Aiemman tutkinnon koulutusaste taso 1 sama'  -- lisätty 21.11.2024 Mika R.
	 ...
	 CAST(
      (
		...
		when koulk_koulutusaste_taso2 = [aikalkkkoulk_koulutusaste_taso2] then 'Aiemman tutkinnon koulutusaste taso 2 sama'  -- lisätty 21.11.2024 Mika R.
