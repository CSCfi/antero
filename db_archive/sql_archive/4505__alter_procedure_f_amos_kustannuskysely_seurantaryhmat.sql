USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_amos_kustannuskysely_seurantaryhmat]    Script Date: 23.3.2021 15:42:48 ******/
SET ANSI_NULLS ON
GO
...
FROM (
	...
	FROM [ANTERO].[sa].[sa_amos_kustannuskysely_seurantaryhmat] sa1
	UNPIVOT (
