...
BEGIN
	...
	INSERT dw.d_yo_toimipiste (
		...
		,selite_sv
		,selite_en
		,toiminta_tutkintoon_johtava_koulutus
		,toiminta_tutkimustoiminta
		,toiminta_muu
		,source
		)
	VALUES (
...
WHEN MATCHED
	THEN
		...
		SET selite_fi = src.selite_fi
			...
			,toiminta_tutkintoon_johtava_koulutus = src.[Toimipisteeseen liittyvä toiminta, tutkintoon johtava koulutus]
			,toiminta_tutkimustoiminta = src.[Toimipisteeseen liittyvä toiminta, tutkimustoiminta]
			,toiminta_muu = src.[Toimipisteeseen liittyvä toiminta, Muu (aikuiskoulutus ja palvelutoiminta)]
