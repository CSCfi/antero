...
/****** Object:  StoredProcedure [dw].[p_lataa_api_yo_opintopisteet_kuukausi_esilataus]    Script Date: 2.1.2023 10:40:41 ******/
SET ANSI_NULLS ON
GO
...
coalesce(kansainvVaihto, 0) + coalesce(kkYhteistyo, 0) + coalesce(erillinenOpintoOikeus, 0) + coalesce(erillinenOpintoOpettaja, 0) > 0)
