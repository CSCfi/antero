...
ALTER TABLE [dbo].[f_alueella_tyossakayvat_1v] DROP CONSTRAINT [FK_f_alueella_tyossakayvat_1v_d_mitenna_toimiala]
GO

ALTER TABLE [dbo].[f_alueella_tyossakayvat_1v] DROP CONSTRAINT [FK_f_alueella_tyossakayvat_1v_d_mitenna_ammatti]
GO

ALTER TABLE [dbo].[f_alueella_tyossakayvat_1v] DROP CONSTRAINT [FK_f_alueella_tyossakayvat_1v_d_ika]
GO

ALTER TABLE [dbo].[f_alueella_tyossakayvat_1v] DROP CONSTRAINT [FK_f_alueella_tyossakayvat_1v_d_alueluokitus_tyopaikka_historia]
GO

ALTER TABLE [dbo].[f_alueella_tyossakayvat_1v] DROP CONSTRAINT [FK_f_alueella_tyossakayvat_1v_d_alueluokitus_tyopaikka]
GO

ALTER TABLE [dbo].[f_alueella_tyossakayvat_1v] DROP CONSTRAINT [FK_f_alueella_tyossakayvat_1v_d_alueluokitus_asuinpaikka_historia]
GO

ALTER TABLE [dbo].[f_alueella_tyossakayvat_1v] DROP CONSTRAINT [FK_f_alueella_tyossakayvat_1v_d_alueluokitus_asuinpaikka]
GO

ALTER TABLE [dbo].[f_alueella_tyossakayvat_1v] DROP CONSTRAINT [FK_f_alueella_tyossakayvat_1v_d_aidinkieli_versio1]
GO

/****** Object:  Table [dbo].[f_alueella_tyossakayvat_1v]    Script Date: 5.12.2019 0:03:53 ******/
DROP TABLE [dbo].[f_alueella_tyossakayvat_1v]
GO
