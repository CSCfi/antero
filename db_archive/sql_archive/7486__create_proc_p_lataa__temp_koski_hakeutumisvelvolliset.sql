...
/****** Object:  View [dw].[v_koski_oppivelvolliset_hv]    Script Date: 14.10.2022 15:34:32 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dw].[p_lataa__temp_koski_hakeutumisvelvolliset] AS
...
(
	...
	,[Äidinkieli (ryhmä)] = d4.kieliryhma1_fi
	...
	,[jarjestys_aidinkieli_ryhma] = d4.jarjestys_kieliryhma1
