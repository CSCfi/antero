USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_lukio_opiskelijat_kuukausittain]    Script Date: 22.12.2021 12:54:12 ******/
SET ANSI_NULLS ON
GO
...
--	  ,ps.suorituksen_tyyppi
	  ,suorituskieli_koodiarvo = --ylläpidettäisiin (12/2021) taulussa koski_sa.sa.sa_lukio_paatason_suoritus, mutta tässä tuota laajempi muuttujisto
			case 
...
--	  ,ps.koulutusmoduuli_koodiarvo
	...
	,CASE
	  ...
	  ,Sukupuoli = (CASE WHEN CAST(SUBSTRING(henk.hetu,8,3) AS INT) % 2 = 1 THEN '1' WHEN CAST(SUBSTRING(henk.hetu,8,3) AS INT) % 2 = 0 THEN '2' ELSE NULL END)
	,CASE
