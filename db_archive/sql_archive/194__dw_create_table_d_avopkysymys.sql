IF NOT EXISTS (select * from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA='dw' and TABLE_NAME='d_avopkysymys') BEGIN

CREATE TABLE dw.d_avopkysymys(
...
ALTER TABLE dw.d_avopkysymys ADD  CONSTRAINT DF__d_avopkysymys__loadtime  DEFAULT (getdate()) FOR loadtime
;
ALTER TABLE dw.d_avopkysymys ADD  CONSTRAINT DF__d_avopkysymys__username  DEFAULT (suser_sname()) FOR username
;
