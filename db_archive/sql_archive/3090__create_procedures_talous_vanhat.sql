...
BEGIN EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE dw.p_lataa_d_amk_talous_vanha_koodisto AS' END
...
BEGIN EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE dw.p_lataa_d_yo_talous_vanha_koodisto AS' END
