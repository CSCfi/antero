...
GO
/****** Object:  Table [dbo].[patevyyteen_tahtaavat_opinnot_amk]    Script Date: 14.9.2017 13:46:42 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[patevyyteen_tahtaavat_opinnot_amk]') AND type in (N'U'))
BEGIN
