...
/****** Object:  View [dw].[v_arvo_uraseuranta]    Script Date: 5.6.2018 17:08:28 ******/
SET ANSI_NULLS ON
GO
...
where kysymysryhmaid not in ('254','268') --pois kysymysryhmät 'VII  Kiitos vastauksistasi!' ja 'VII  Kiitos paljon vastauksistasi!'
and not (kysymysid between 2958 and 2967 and kyselypohja='URASEURANTA-MAISTERI')
