...
DROP PROCEDURE IF EXISTS [dbo].[p_lataa_TK_K1_12_amm_tutkinnot_rahoituskausittain]
GO
...
CREATE PROCEDURE [dbo].[p_lataa_TK_K1_12_amm_tutkinnot_rahoituskausittain] @rahoituskaudenPaattymisvuosi int = null AS
