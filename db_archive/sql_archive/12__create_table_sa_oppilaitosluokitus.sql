IF NOT EXISTS (select * from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA='sa' and TABLE_NAME='sa_oppilaitosluokitus') BEGIN

CREATE TABLE sa.sa_oppilaitosluokitus(
...
ALTER TABLE sa.sa_oppilaitosluokitus ADD  CONSTRAINT DF__sa_oppilaitosluokitus__loadtime  DEFAULT (getdate()) FOR loadtime
;
ALTER TABLE sa.sa_oppilaitosluokitus ADD  CONSTRAINT DF__sa_oppilaitosluokitus__username  DEFAULT (suser_name()) FOR username
;
