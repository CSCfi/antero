IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'api.yo_talous'))
EXEC dbo.sp_executesql @statement = N'create view api.yo_talous as select 1 as a'
GO

ALTER VIEW api.yo_talous AS
