...
/****** Object:  View [dbo].[v_f_tab_tyollisten_ammattisiirtymat]    Script Date: 15.12.2023 13:27:26 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	  ...
	  ,[ammattiryhma_luokitus] =
		case 
			when (d9.suhteellinen_ajankohta_avain  = 'tilv+1' and f.tilastovuosi > 2014) or (d9.suhteellinen_ajankohta_avain  = 'tilv+5' and f.tilastovuosi > 2010) then 'oef' 
			else 'mitenna' 
		end
