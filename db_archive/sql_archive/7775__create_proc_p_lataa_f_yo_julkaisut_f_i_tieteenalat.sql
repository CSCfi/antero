...
/****** Object:  StoredProcedure [dw].[p_lataa_f_yo_julkaisut_f_i_tieteenalat]    Script Date: 7.6.2023 12:20:57 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dw].[p_lataa_f_yo_julkaisut_f_i_tieteenalat]
AS
...
SELECT * INTO #temp_julkaisut FROM (
	...
	FROM (
		...
		FROM [ANTERO].[sa].[sa_suorat_yo3b_julkaisut] s1
...
TRUNCATE TABLE dw.[f_yo_julkaisut_f_i_tieteenalat];

INSERT INTO dw.[f_yo_julkaisut_f_i_tieteenalat] (
	 [tilastovuosi]
...
SELECT
	...
	t2.d_tieteenala_id,
	t.julkaisunTunnus,
	'etl: p_lataa_f_yo_julkaisut_f_i_tieteenalat'
