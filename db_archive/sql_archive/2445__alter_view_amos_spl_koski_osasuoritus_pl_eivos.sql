...
/****** Object:  View [dw].[v_amos_spl_koski_osasuoritus_pl_eivos]    Script Date: 23.9.2019 16:21:27 ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT
  ...
  (
	...
	SELECT 
		...
		--ap 23.9.2019 poistettu konvertointi bigintiksi, koska antoi virheen
		case 
			when isnumeric(os.koulutusmoduuli_koodiarvo)= 1 and os.koulutusmoduuli_koodiarvo not like '0%' and os.koulutusmoduuli_koodiarvo not like '%.%' then os.koulutusmoduuli_koodiarvo --convert(BIGINT, os.koulutusmoduuli_koodiarvo) 
			else NULL 
		end as koulutusmoduuli_koodiarvo_numeerinen, 
