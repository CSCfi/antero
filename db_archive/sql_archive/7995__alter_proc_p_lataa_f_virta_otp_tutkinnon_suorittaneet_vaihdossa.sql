...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_tutkinnon_suorittaneet_vaihdossa]    Script Date: 30.8.2023 13:01:25 ******/
SET ANSI_NULLS ON
GO
...
WHERE f.liikkuvuuden_kesto_id not in ('-1', '-2') and d3.koulutusastetaso2_koodi in ('62', '63', '72') 
