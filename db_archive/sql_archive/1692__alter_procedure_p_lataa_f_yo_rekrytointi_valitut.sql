USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_yo_rekrytointi_valitut]    Script Date: 20.6.2018 14:06:17 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN [dw].[d_arvokysymys] s19 ON [s19].[kysymys_fi] = [s1].[Kysymys] -- AND[s19].[Kysymysryhma_fi] tai sitten  kysymysryhma_id = [s1].[Kysymysryhmä]
