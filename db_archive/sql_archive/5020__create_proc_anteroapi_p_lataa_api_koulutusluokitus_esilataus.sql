...
/****** Object:  StoredProcedure [dw].[p_lataa_api_koulutusluokitus]    Script Date: 15.11.2021 10:22:16 ******/
DROP PROCEDURE IF EXISTS [dw].[p_lataa_api_koulutusluokitus_esilataus]
GO
...
CREATE PROCEDURE [dw].[p_lataa_api_koulutusluokitus_esilataus] AS
