...
/****** Object:  StoredProcedure [dw].[p_lataa_api_amk_opintopisteet_kuukausi_esilataus]    Script Date: 22.11.2022 12:40:37 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dw].[p_lataa_api_amk_opintopisteet_kuukausi_esilataus] AS
