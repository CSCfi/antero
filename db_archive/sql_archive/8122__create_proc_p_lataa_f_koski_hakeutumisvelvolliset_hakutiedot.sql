...
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_hakeutumisvelvolliset_hakutiedot]    Script Date: 28.9.2023 21:32:28 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dw].[p_lataa_f_koski_hakeutumisvelvolliset_hakutiedot] AS
