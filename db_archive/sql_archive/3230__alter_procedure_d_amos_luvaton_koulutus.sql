...
('2','Tutkintokoulutus (ei laajennettu oppis)','SV*','EN*',2,'manuaalinen'),
('3','Tutkintokoulutus (laajennettu oppis)','SV*','EN*',3,'manuaalinen'),
('4','Täydentävä ja syventävä (ei laajennettu oppis)','SV*','EN*',4,'manuaalinen'),
('5','Täydentävä ja syventävä (laajennettu oppis)','SV*','EN*',5,'manuaalinen'),
('6','Tehtävään valmistava (ei laajennettu oppis)','SV*','EN*',6,'manuaalinen'),
...
('20','Tutkinto (ei laajennettu oppis)','SV*','EN*',20,'manuaalinen'),
('21','Tutkinto (laajennettu oppis)','SV*','EN*',21,'manuaalinen'),
('22','Tutkinnon osa (ei laajennettu oppis)','SV*','EN*',22,'manuaalinen'),
('23','Tutkinnon osa (laajennettu oppis)','SV*','EN*',23,'manuaalinen'),
('24','Tutkinto ja tutkinnon osa (ei laajennettu oppis)','SV*','EN*',24,'manuaalinen'),
