...
/****** Object:  View [dw].[v_koski_oppivelvolliset_cultures]    Script Date: 22.9.2023 7:39:47 ******/
SET ANSI_NULLS ON
GO
...
SELECT
	...
	,d3.kunta_fi as kotikunta_nykyinen_fi
	,d3.kunta_sv as kotikunta_nykyinen_sv
	,d3.maakunta_fi as kotimaakunta_nykyinen_fi
	,d3.maakunta_sv as kotimaakunta_nykyinen_sv
	,d3.hyvinvointialue_fi as kotikunnan_hyvinvointialue_nykyinen_fi
	,d3.hyvinvointialue_sv as kotikunnan_hyvinvointialue_nykyinen_sv
	...
	,d20.kytkin_fi as vaativa_erityinen_tuki_fi
	,d20.kytkin_sv as vaativa_erityinen_tuki_sv
	...
	,d3.jarjestys_maakunta_koodi as jarjestys_kotimaakunta_nykyinen
	,d3.jarjestys_hyvinvointialue_koodi as jarjestys_kotikunnan_hyvinvointialue_nykyinen
	...
	,d20.jarjestys_kytkin_koodi as jarjestys_vaativa_erityinen_tuki
...
LEFT JOIN [ANTERO].[dw].[d_kytkin] d20 on d20.id = f.d_kytkin_vaativa_erityinen_tuki_id
