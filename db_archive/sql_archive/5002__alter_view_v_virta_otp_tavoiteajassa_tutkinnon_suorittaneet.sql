...
/****** Object:  View [dw].[v_virta_otp_tavoiteajassa_tutkinnon_suorittaneet]    Script Date: 9.11.2021 10:15:35 ******/
SET ANSI_NULLS ON
GO
...
AS
			...
			, [Ikä tutkinnon aloittaessa] = COALESCE(f.xxmikatutkinnonaloitusajankohtana,'Tuntematon')
