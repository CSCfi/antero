...
/****** Object:  StoredProcedure [dw].[p_lataa_f_arvo_amis]    Script Date: 13.7.2023 17:44:05 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN dw.d_arvovastaus_taustakysymys d9 ON d9.koodi = MQ.ak_koodi and d9.kysymysid = MQ.ak_kysymysid and d9.kysymysversio = MQ.kysymysversio
...
LEFT JOIN dw.d_arvovastaus_taustakysymys d11 ON d11.koodi = MQ.hv_koodi and d11.kysymysid = MQ.hv_kysymysid and d11.kysymysversio = MQ.kysymysversio
LEFT JOIN dw.d_oppisopimuskoulutus d13 ON d13.koodi = MQ.oppis_koodi --and d13.kysymysid = MQ.oppis_kysymysid
LEFT JOIN dw.d_arvovastaus_taustakysymys d14 ON d14.koodi = MQ.arvio_koodi and d14.kysymysid = MQ.arvio_kysymysid and d14.kysymysversio = MQ.kysymysversio
