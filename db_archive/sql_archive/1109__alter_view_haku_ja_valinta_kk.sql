...
/****** Object:  View [dw].[v_haku_ja_valinta_kk]    Script Date: 21.12.2017 11:15:45 ******/
SET ANSI_NULLS ON
GO
...
SELECT --top 10
	  ...
	  ,[Tutkinnon taso (hakukohde)] = case when f.hakukohteen_tutkinnon_taso_kk = 'Tutkintoon johtamaton koulutus' and d10.selite_fi not like 'Ammatillinen%' then 'Tieto puuttuu' else hakukohteen_tutkinnon_taso_kk end
	  ,[Tutkinnon aloitussykli (hakukohde)] = case when f.hakukohteen_tutkinnon_taso_kk_sykli = 'Tutkintoon johtamaton koulutus' and d10.selite_fi not like 'Ammatillinen%' then 'Tieto puuttuu' else hakukohteen_tutkinnon_taso_kk_sykli end 
