...
/****** Object:  View [dw].[v_haku_ja_valinta_toinen_aste_valmistava]    Script Date: 15.1.2018 17:14:02 ******/
SET ANSI_NULLS ON
GO
...
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dw].[v_haku_ja_valinta_toinen_aste_valmistava]'))
...
CREATE VIEW [dw].[v_haku_ja_valinta_toinen_aste_valmistava] AS
...
where  f.koulutuksen_alkamisvuosi>2013 and d25.korkeakouluhaku=0 and d25.hakuryhma_koodi = ''2''
