...
/****** Object:  View [dw].[v_eter]    Script Date: 27.4.2022 11:00:22 ******/
SET ANSI_NULLS ON
GO
...
CREATE or ALTER view [dw].[v_eter] AS
...
SELECT
	...
	coalesce(d3.Value, 'Missing data') as 'Sector',
	...
	,f10.[Share of women full professors]
