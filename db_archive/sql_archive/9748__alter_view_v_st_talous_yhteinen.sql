...
/****** Object:  View [dw].[v_st_talous_yhteinen]    Script Date: 16.4.2024 16:17:02 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
  ...
  ,tilikausi AS 'Statistical year'
  ,d7.organisaatio_en AS 'Higher educational institute'
  ,NULL
  ,NULL
...
LEFT JOIN dw.d_organisaatioluokitus d7 on d7.organisaatio_koodi = d1.amk_nykyinen_tunnus
WHERE f.arvo <> 0
