...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_opettajakelpoisuudet]    Script Date: 30.5.2022 11:18:28 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN dw.d_opettajapatevyys d4 ON d4.koodi = case 
													when v.kelpoisuus_koodi = 'VA_PE' and d3.oppilaitostyyppi_koodi  = 41 then 'VA' 
													when v.kelpoisuus_koodi = 'LA'    and d3.oppilaitostyyppi_koodi <> 41 then 'AI' 
													else v.kelpoisuus_koodi end
