...
/****** Object:  View [dw].[v_koski_lukio_opiskelijat_kuukausittain]    Script Date: 11.4.2023 10:52:16 ******/
SET ANSI_NULLS ON
GO
...
-- KOULUTUSMUUTTUJAT
	...
	,d15.kieliryhma2_fi AS [Suorituskieliryhmä]
...
-- HENKILÖMUUTTUJAT
	,case
		...
		AS [Ikä]
	,d6.kieliryhma2_fi AS [Äidinkieli]
...
-- JÄRJESTYSMUUTTUJAT
	...
	,d6.jarjestys_kieliryhma2 AS jarj_kieliryhma
	,d15.jarjestys_kieliryhma2 AS jarj_suorituskieliryhma
