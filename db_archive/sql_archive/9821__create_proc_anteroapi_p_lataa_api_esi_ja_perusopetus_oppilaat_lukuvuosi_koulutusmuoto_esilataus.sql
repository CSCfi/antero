...
/****** Object:  StoredProcedure [dw].[p_lataa_api_esi_ja_perusopetus_oppilaat_lukuvuosi_koulutusmuoto_esilataus]    Script Date: 29.4.2024 10:51:51 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dw].[p_lataa_api_esi_ja_perusopetus_oppilaat_lukuvuosi_koulutusmuoto_esilataus] AS
...
SELECT 
	...
	oppilaatLkm = COUNT(DISTINCT CASE WHEN opisk = 1 THEN oppija_oid ELSE NULL END),
