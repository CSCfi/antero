...
/****** Object:  View [dw].[v_arvo_amis]    Script Date: 27.12.2024 17.46.02 ******/
SET ANSI_NULLS ON
GO
...
SELECT --top 1000
	...
	--,d11.selite_fi								AS 'Rahoitusryhmä'
	...
	--, f2.vastaajatunnukset_lkm					AS 'luodut_vastaajatunnukset_lkm' --tarvitaanko?
	--, d5.kyselykertaid							AS 'kyselykertaid' --tarvitaanko?
	...
	,case when d3.rahoituskausi_amm = '01.07.2018 - 30.06.2019' then 1 else 2 end as kytkin_katokorjaus    --tarvitaanko?*/
