...
/****** Object:  View [dw].[v_koski_esi_ja_perus_oppilaat_ja_paattaneet_kuukausittain]    Script Date: 20.9.2022 10:21:14 ******/
SET ANSI_NULLS ON
GO
...
--exec [dbo].[tarkista_kaannokset2] 'v_koski_esi_ja_perus_oppilaat_ja_paattaneet_kk_cultures'

CREATE OR ALTER VIEW [dw].[v_koski_esi_ja_perus_oppilaat_ja_paattaneet_kk_cultures] AS
