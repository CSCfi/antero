...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_opettajakelpoisuudet_jaadytys]    Script Date: 30.5.2024 13:52:49 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	WHERE p.Vuosi = ' + @alkuVuosi + ' or (' + @alkuVuosi + ' = 2023 and p.Vuosi BETWEEN  2016 AND 2023)'
