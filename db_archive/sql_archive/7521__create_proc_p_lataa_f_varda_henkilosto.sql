...
/****** Object:  StoredProcedure [dw].[p_lataa_f_varda_henkilosto]    Script Date: 30.3.2023 13:58:46 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	WHERE s.alkamis_pvm <= CAST(CONCAT(@alkuVuosi, '-12-31') as date) and (s.paattymis_pvm >= CAST(CONCAT(@alkuVuosi, '-12-31') as date) or s.paattymis_pvm is NULL)
