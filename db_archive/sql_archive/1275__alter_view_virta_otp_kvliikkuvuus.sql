...
/****** Object:  View [dw].[v_virta_otp_kvliikkuvuus]    Script Date: 2.3.2018 9:09:49 ******/
SET ANSI_NULLS ON
GO
...
SELECT d1.organisaatio_koodi AS 'Oppilaitos Koodi'
	...
	,case when MONTH(f.tilannepvm)=3 AND DAY(f.tilannepvm)=1 then 1 else 0 end AS 'tilannepvm_tilasto'
