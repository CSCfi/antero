...
/****** Object:  View [dbo].[v_f_vaeston_koulutusrakenne_ja_paaasiallinen_toiminta]    Script Date: 13.9.2018 15:10:50 ******/
SET ANSI_NULLS ON
GO
...
,d14.paaasiallinen_toiminta_koodi
...
FROM dbo.f_VKP_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta F
	  ...
	  JOIN d_paaasiallinen_toiminta d14 on d14.id = f.paaasiallinen_toiminta_versio6_id
