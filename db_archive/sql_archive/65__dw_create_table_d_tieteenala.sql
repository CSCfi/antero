IF NOT EXISTS (select * from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA='dw' and TABLE_NAME='d_tieteenala') BEGIN

CREATE TABLE dw.d_tieteenala(
...
ALTER TABLE dw.d_tieteenala ADD  CONSTRAINT DF__d_tieteenala__loadtime  DEFAULT (getdate()) FOR loadtime
;
ALTER TABLE dw.d_tieteenala ADD  CONSTRAINT DF__d_tieteenala__username  DEFAULT (suser_sname()) FOR username
;
