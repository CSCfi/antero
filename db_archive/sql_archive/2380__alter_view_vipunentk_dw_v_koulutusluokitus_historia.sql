...
/****** Object:  View [dbo].[v_koulutusluokitus_historia]    Script Date: 28.8.2019 11:38:11 ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT d_koulutusluokitus.[id]
	  ...
	  -- uudet rahoitusmallialaluokitukset 2021-2024
	  ,[jarjestys_OKM_ohjauksen_ala_yo_tav2021] = isnull(ktpo.[jarjestys_Yliopistot_tutkintotavoitteet2021], ktpo_virhe.[jarjestys_Yliopistot_tutkintotavoitteet2021])
	  ,[OKM_ohjauksen_ala_yo_tav2021_koodi] = isnull(ktpo.[Yliopistot_tutkintotavoitteet2021_koodi], ktpo_virhe.[Yliopistot_tutkintotavoitteet2021_koodi])
	  ,[OKM_ohjauksen_ala_yo_tav2021] = isnull(ktpo.[Yliopistot_tutkintotavoitteet2021], ktpo_virhe.[Yliopistot_tutkintotavoitteet2021])
	  ,[OKM_ohjauksen_ala_yo_tav2021_SV] = isnull(ktpo.[Yliopistot_tutkintotavoitteet2021_SV], ktpo_virhe.[Yliopistot_tutkintotavoitteet2021_SV])
	  ,[OKM_ohjauksen_ala_yo_tav2021_EN] = isnull(ktpo.[Yliopistot_tutkintotavoitteet2021_EN], ktpo_virhe.[Yliopistot_tutkintotavoitteet2021_EN])
...
SELECT DISTINCT [VipunenTK_lisatiedot].[dbo].[koulutusluokitus].[id]
      ...
      ,[VipunenTK_lisatiedot].[dbo].[koulutusluokitus].[tietolahde]
	   ...
	   -- uudet rahoitusmallialaluokitukset 2021-2024
	  ,[jarjestys_OKM_ohjauksen_ala_yo_tav2021] = isnull(ktpo.[jarjestys_Yliopistot_tutkintotavoitteet2021], ktpo.[jarjestys_Yliopistot_tutkintotavoitteet2021])
	  ,[OKM_ohjauksen_ala_yo_tav2021_koodi] = isnull(ktpo.[Yliopistot_tutkintotavoitteet2021_koodi], ktpo.[Yliopistot_tutkintotavoitteet2021_koodi])
	  ,[OKM_ohjauksen_ala_yo_tav2021] = isnull(ktpo.[Yliopistot_tutkintotavoitteet2021], ktpo.[Yliopistot_tutkintotavoitteet2021])
	  ,[OKM_ohjauksen_ala_yo_tav2021_SV] = isnull(ktpo.[Yliopistot_tutkintotavoitteet2021_SV], ktpo.[Yliopistot_tutkintotavoitteet2021_SV])
	  ,[OKM_ohjauksen_ala_yo_tav2021_EN] = isnull(ktpo.[Yliopistot_tutkintotavoitteet2021_EN], ktpo.[Yliopistot_tutkintotavoitteet2021_EN])
