...
/****** Object:  View [dw].[v_valos_koulutuksenkustannukset]    Script Date: 10.1.2023 16:51:31 ******/
SET ANSI_NULLS ON
GO
...
--mm. Perusopetuksen aamu- ja iltapäivätoiminta ja vammaisopetus, ei toimintoerittelyä (sis. myös rekno 5, koulmto 120 erittelemättömät alvit)
UNION ALL
...
FROM (
	SELECT rekno,vuosi,ytunnus,kala,koulumto,OMISTAJA,KUNTA,VIRKUNTA
		,case when rekno=5 and koulumto=120 then '0' else suorite end as suorite
		,case when rekno=5 and koulumto=120 then '0' else k100l01 end as k100l01
		,case when rekno=5 and koulumto=120 then '0' else k100l02 end as k100l02
		,k100l03
	FROM sa.sa_valos 
	WHERE rekno=55 
	OR koulumto in (133,134,135, 140,141,142) 
	OR (
		--vain alvit erittelemättömiä
		rekno=5 
		and koulumto=120 
		and coalesce(
