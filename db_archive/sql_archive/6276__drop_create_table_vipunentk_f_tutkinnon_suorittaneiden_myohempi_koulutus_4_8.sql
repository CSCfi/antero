...
/****** Object:  Table [dbo].[f_tutkinnon_suorittaneiden_myohempi_koulutus_4_8]    Script Date: 23.6.2022 14:36:07 ******/
...
CREATE TABLE [dbo].[f_tutkinnon_suorittaneiden_myohempi_koulutus_4_8](
	...
	[rivinumero] [int] NULL--,
-- CONSTRAINT [PK__f_tutkinnon_suorittaneiden_myohempi_koulutus_4_8] PRIMARY KEY CLUSTERED 
--(
--	[id] ASC
