...
/****** Object:  Table [dbo].[f_2_4_Ammatillisen_koulutuksen_tutkinnot]    Script Date: 10.1.2024 15:25:36 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[f_2_4_Ammatillisen_koulutuksen_tutkinnot]') AND type in (N'U'))
