IF NOT EXISTS (select * from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA='dw' and TABLE_NAME='f_arvo') BEGIN

CREATE TABLE dw.f_arvo(
...
ALTER TABLE dw.f_arvo ADD  CONSTRAINT DF__f_arvo__loadtime  DEFAULT (getdate()) FOR loadtime

ALTER TABLE dw.f_arvo ADD  CONSTRAINT DF__f_arvo__username  DEFAULT (suser_sname()) FOR username
