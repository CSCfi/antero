USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_d_organisaatioluokitus]    Script Date: 23.8.2018 14:31:47 ******/
SET ANSI_NULLS ON
GO
...
--
-- update organisation names for universities and universities of applied science
--
