...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_ainekelpoisuudet_jaadytys]    Script Date: 11.6.2025 10.11.29 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	WHERE (f.kelpoisuuden_vuosi = ' + @alkuVuosi + ') or (' + @alkuVuosi + ' = 2024 and f.kelpoisuuden_vuosi <= 2024)'
