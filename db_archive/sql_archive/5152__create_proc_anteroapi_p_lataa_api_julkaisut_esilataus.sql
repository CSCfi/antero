...
DROP PROCEDURE IF EXISTS [dw].[p_lataa_api_julkaisut_esilataus]
GO
...
CREATE PROCEDURE [dw].[p_lataa_api_julkaisut_esilataus] AS
...
LEFT JOIN antero.dw.d_yo d3 ON d3.id=f.d_yliopisto_id
LEFT JOIN antero.dw.d_julkaisutyyppi d4 ON d4.id=f.d_julkaisutyyppi_id
