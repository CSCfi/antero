...
/****** Object:  View [dbo].[v_f_tab_tyollistyminen_yo]    Script Date: 13.1.2025 16.33.42 ******/
SET ANSI_NULLS ON
GO
...
ALTER view [dbo].[v_f_tab_tyollistyminen_yo] as
...
WHERE d1.Koulutusaste_taso2_koodi in ('63','72','73','81','82') --(... or d1.koulutusaste2002_koodi in ('63','72','73','81','82'))
