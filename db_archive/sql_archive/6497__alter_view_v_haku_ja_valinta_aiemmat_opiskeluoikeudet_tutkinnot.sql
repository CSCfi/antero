...
/****** Object:  View [dw].[v_haku_ja_valinta_aiemmat_opiskeluoikeudet_tutkinnot]    Script Date: 28.9.2022 10:29:52 ******/
SET ANSI_NULLS ON
GO
...
SELECT --TOP 1000
	...
	,[Muu opiskeluoikeus voimassa] =  case 
										when (muu_paattymispvm > d5.loppuPvm or muu_paattymispvm > d5b.loppuPvm) or (f.muu_alkamispvm is not null and muu_paattymispvm is null) then 'On voimassa' 
										when (muu_paattymispvm <= d5.loppuPvm or muu_paattymispvm <= d5b.loppuPvm) then 'Ei voimassa' 
