...
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_hakeutumisvelvolliset]    Script Date: 30.7.2025 13.16.20 ******/
SET ANSI_NULLS ON
GO
...
(	
	...
	LEFT JOIN (
		select distinct vuosi, master_oid
	...
	) kasilla on kasilla.master_oid = f.master_oid and kasilla.vuosi = f.tilastovuosi
