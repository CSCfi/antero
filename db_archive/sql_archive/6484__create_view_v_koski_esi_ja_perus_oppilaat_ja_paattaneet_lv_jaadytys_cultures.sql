...
/****** Object:  View [dw].[v_koski_esi_ja_perus_oppilaat_ja_paattaneet_lv_cultures]    Script Date: 20.9.2022 22:11:47 ******/
SET ANSI_NULLS ON
GO
...
--exec [dbo].[tarkista_kaannokset2] 'v_koski_esi_ja_perus_oppilaat_ja_paattaneet_lv_jaadytys_cultures'

CREATE OR ALTER VIEW [dw].[v_koski_esi_ja_perus_oppilaat_ja_paattaneet_lv_jaadytys_cultures] AS
...
SELECT --top 1000
  ...
  --FI
	...
	,aidinkieli_ryhma_fi = d2.kieliryhma1_fi
	...
	,tehostettu_tuki_fi = d36.kytkin_fi
  ...
  --SV
	...
	,aidinkieli_ryhma_sv = d2.kieliryhma1_sv
	...
	,tehostettu_tuki_sv = d36.kytkin_sv
  ...
  --JARJESTYS
	...
	,jarjestys_aidinkieli_ryhma = d2.jarjestys_kieliryhma1
...
--LEFT JOIN dbo.translations_keys_as_columns x on 1=0
...
LEFT JOIN dw.d_kytkin d30 ON d30.kytkin_koodi = coalesce(f.kotiopetus, -1)
...
LEFT JOIN dw.d_kytkin d36 ON d36.kytkin_koodi = coalesce(f.tehostettu_tuki, -1)
