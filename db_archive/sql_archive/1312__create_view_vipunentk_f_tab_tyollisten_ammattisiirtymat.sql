USE [VipunenTK]
GO
/****** Object:  View [dbo].[v_f_tab_tyollisten_ammattisiirtymat]    Script Date: 9.3.2018 14:26:08 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	  ...
	  ,[Koulutusala, taso 1] = d20.iscfinarrow2013
	  ,[Koulutusala, taso 2] = d20.iscfibroad2013
	  ...
	  ,[Koulutusala, taso 1 siirtymän päässä] = case when d21.iscfinarrow2013 = ''Tuntematon'' then ''Ei uutta tutkintoa'' else d21.iscfinarrow2013 end
	  ,[Koulutusala, taso 2 siirtymän päässä] = case when d21.iscfibroad2013 = ''Tuntematon'' then ''Ei uutta tutkintoa'' else d21.iscfibroad2013 end
	  ...
	  ,[järjestys Koulutusala, taso 1] = d20.jarjestys_iscfinarrow2013
	  ,[järjestys Koulutusala, taso 2] = d20.jarjestys_iscfibroad2013
	  ...
	  ,[järjestys Koulutusala, taso 1 siirtymän päässä] = d21.jarjestys_iscfinarrow2013
	  ,[järjestys Koulutusala, taso 2 siirtymän päässä] = d21.jarjestys_iscfibroad2013
