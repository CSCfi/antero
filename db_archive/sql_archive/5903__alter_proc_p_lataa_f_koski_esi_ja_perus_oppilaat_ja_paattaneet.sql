USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_esi_ja_perus_oppilaat_ja_paattaneet]    Script Date: 21.2.2022 12:10:43 ******/
SET ANSI_NULLS ON
GO
...
FROM (
	SELECT 
		* 
	FROM Koski_SA.dbo.esi_ja_perus_oppilaat_ja_paattaneet_valitaulu
) k
