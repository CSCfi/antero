...
/****** Object:  Table [dw].[api_perusopetuksen_jalkeinen_koulutus_hakeneet_ja_paikan_vastaanottaneet]    Script Date: 17.11.2025 12.55.29 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dw].[api_perusopetuksen_jalkeinen_koulutus_hakeneet_ja_paikan_vastaanottaneet]') AND type in (N'U'))
DROP TABLE [dw].[api_perusopetuksen_jalkeinen_koulutus_hakeneet_ja_paikan_vastaanottaneet]
GO
...
CREATE TABLE [dw].[api_perusopetuksen_jalkeinen_koulutus_hakeneet_ja_paikan_vastaanottaneet](
	[koulutuksen_alkamisvuosi] [int] NULL,
	[koulutuksen_alkamiskausi] [varchar](255) NULL,
	[haku] [nvarchar](255) NULL,
