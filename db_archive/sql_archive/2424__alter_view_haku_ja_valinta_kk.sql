USE [ANTERO]
GO
/****** Object:  View [dw].[v_haku_ja_valinta_kk_yo]    Script Date: 19.9.2019 14:52:46 ******/
DROP VIEW IF EXISTS [dw].[v_haku_ja_valinta_kk_yo]
GO
/****** Object:  View [dw].[v_haku_ja_valinta_kk_amk]    Script Date: 19.9.2019 14:52:46 ******/
DROP VIEW IF EXISTS [dw].[v_haku_ja_valinta_kk_amk]
GO
/****** Object:  View [dw].[v_haku_ja_valinta_kk]    Script Date: 19.9.2019 14:52:46 ******/
DROP VIEW IF EXISTS [dw].[v_haku_ja_valinta_kk]
GO
/****** Object:  View [dw].[v_haku_ja_valinta_kk]    Script Date: 19.9.2019 14:52:46 ******/
SET ANSI_NULLS ON
GO
...
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dw].[v_haku_ja_valinta_kk]'))
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dw].[v_haku_ja_valinta_kk_amk]'))
EXEC dbo.sp_executesql @statement = N'
...
CREATE VIEW [dw].[v_haku_ja_valinta_kk_amk] AS
...
where f.koulutuksen_alkamisvuosi > 2014 and (d20.koulutussektori_koodi = ''4'' or d10.selite_fi like ''Ammatillinen opettajankoulutus%'')
...
where (f.koulutuksen_alkamisvuosi > 2016 OR (f.koulutuksen_alkamisvuosi = 2016 and d9.selite_fi = ''Syksy''))
and d1.korkeakouluhaku = 1 and (d6.koulutussektori_koodi = ''4'' or d3.selite_fi like ''Ammatillinen opettajankoulutus%'')
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dw].[v_haku_ja_valinta_kk_yo]'))
EXEC dbo.sp_executesql @statement = N'
...
CREATE VIEW [dw].[v_haku_ja_valinta_kk_yo] AS
...
where f.koulutuksen_alkamisvuosi > 2014 and d20.koulutussektori_koodi = ''5''
