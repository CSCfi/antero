...
/****** Object:  View [dbo].[v_f_tab_tutkinnon_suorittaneiden_aikaisempi_koulutus_yhteiset]    Script Date: 28.2.2024 16:31:03 ******/
SET ANSI_NULLS ON
GO
...
ALTER    VIEW [dbo].[v_f_tab_tutkinnon_suorittaneiden_aikaisempi_koulutus_yhteiset] AS
...
,[koultasoa1_nostava_tutkinto]
,[koultasoa2_nostava_tutkinto]
...
,ISNULL(NULLIF(CAST([suorv] as varchar(20)),''),'Tuntematon') as "Tutkinnon suoritusvuosi"
,d5.lukukausiselite as "Tutkinnon suorituslukukausi"
,ISNULL(NULLIF(CAST([alvv] as varchar(20)),''),'Tuntematon') as "Aloitusvuosi"
,d6.lukukausiselite as "Aloituslukukausi"
,[syntv] as "Syntym‰vuosi"
,ISNULL(NULLIF(CAST([lusuorv] as varchar(40)),''),'Ei aiempaa tutkintoa') as "Yo-tutkinnon suoritusvuosi"
,ISNULL(NULLIF(CAST([ammsuorv] as varchar(40)),''),'Ei aiempaa tutkintoa') as "Amm. tutkinnon suoritusvuosi"
,ISNULL(NULLIF(CAST([opistsuorv] as varchar(40)),''),'Ei aiempaa tutkintoa') as "Opistoast. tutkinnon suoritusvuosi"
,ISNULL(NULLIF(CAST([ammkasuorv] as varchar(40)),''),'Ei aiempaa tutkintoa') as "Amm. kork.asteen tutk. suoritusvuosi"
,ISNULL(NULLIF(CAST([amksuorv] as varchar(40)),''),'Ei aiempaa tutkintoa') as "Amk-tutkinnon suoritusvuosi"
,ISNULL(NULLIF(CAST([akksuorv] as varchar(40)),''),'Ei aiempaa tutkintoa') as "Alemman kk-tutk. suoritusvuosi"
,ISNULL(NULLIF(CAST([ylamksuorv] as varchar(40)),''),'Ei aiempaa tutkintoa') as "Ylemm‰n amk-tutk. suoritusvuosi"
,ISNULL(NULLIF(CAST([ykksuorv] as varchar(40)),''),'Ei aiempaa tutkintoa')  as "Ylemm‰n kk-tutk. suoritusvuosi"
,ISNULL(NULLIF(CAST([laakersuorv] as varchar(40)),''),'Ei aiempaa tutkintoa') as "L‰‰k. erikois.tutk. suoritusvuosi"
,ISNULL(NULLIF(CAST([lissuorv] as varchar(40)),''),'Ei aiempaa tutkintoa')  as "Lisensiaatin tutk. suoritusvuosi"
,ISNULL(NULLIF(CAST([tohtsuorv] as varchar(40)),''),'Ei aiempaa tutkintoa') as "Tohtorin tutk. suorituvuosi"
,d7.oppisopimuskoulutus as "Oppisopimuskoulutus"
,d7ish.selite_fi as "Koulutus- ja oppisopimusjaksot"
,d8.ammatillisen_koulutuksen_koulutuslaji as "Tutkintotyyppi"
,d9.opetussuunnitelmaperusteinen_koulutus_nayttotutkintoon_valmistava_koulutus as "J‰rjest‰mistapa"
,d10.nuorten_aikuisten_koulutus_amm as "Nuorten/aikuisten koulutus"
,d11.ika as Ik‰
,d11.ika5v as Ik‰ryhm‰
...
,d172.opetussuunnitelmaperusteinen_koulutus_nayttotutkintoon_valmistava_koulutus as "Amm. tutkinnon j‰rjest‰mistapa"
,d173.oppisopimuskoulutus as "Amm. tutkinto oppisopimuskoul."
,d173ish.selite_fi as "Amm. tutkinnon koulutus- ja oppisopimusjaksot"
,d174.tutkintojen_maara as "Amm. tutkintojen m‰‰r‰"
,d175.ammatillisen_koulutuksen_luokittelu_4_7_4_8 as "Amm. koulutuksen ryhm‰t"
...
,d261.tutkintojen_maara as "Amk-tutkintojen m‰‰r‰"
...
,d291.tutkintojen_maara as "Alempien kk-tutkintojen m‰‰r‰"
,d30.koulutusala2002 as "Ylemm‰n amk-tutk. koulutusala"
,d30.opintoala2002 as "Ylemm‰n amk-tutk. opintoala"
,d30.koulutus as "Ylemm‰n amk-tutk. koulutusnimike"
,d31.tutkinto_suoritettu as "Aik. suoritettu ylempi amk-tutkinto"
,d32.koulutuksesta_kulunut_aika as "Ylemm‰st‰ amk-tutk. kulunut aika"
,d33.koulutusala2002 as "Ylemm‰n kk-tutk. koulutusala (02)"
,d33.opintoala1995 as "Ylemm‰n kk-tutk. koulutusala (95)"
,d33.opintoala2002 as "Ylemm‰n kk-tutk. opintoala"
,d33.koulutus as "Ylemm‰n kk-tutk. koulutusnimike"
,d34.tutkinto_suoritettu as "Aik. suoritettu ylempi kk-tutkinto"
,d35.koulutuksesta_kulunut_aika as "Ylemm‰st‰ kk-tutk. kulunut aika"
,d351.tutkintojen_maara as "Ylempien kk-tutkintojen m‰‰r‰"
,d36.koulutus as "L‰‰k. erikois.tutk. koulutusnimike"
,d37.tutkinto_suoritettu as "Aik. suoritettu l‰‰k. erikois.tutk."
,d38.koulutuksesta_kulunut_aika as "L‰‰k. erikois.tutk. kulunut aika"
...
,d50.tutkinto_suoritettu as "Aik. suoritettu amm. tutkinto (ryhm‰ 1)"
,d51.tutkinto_suoritettu as "Aik. suoritettu amm. tutkinto (ryhm‰ 2)"
,d52.tutkinto_suoritettu as "Aik. suoritettu amm. tutkinto (ryhm‰ 3)"
...
,d74.sama_koulutusala as "Amk-tutkinto samalla op.alalla"
,d73.sama_koulutusala as "Alempi kk-tutk. samalla op.alalla"
...
,d90.sama_koulutusala as "Amk-tutkinto samalla koul.alalla (95)"
,d89.sama_koulutusala as "Alempi kk-tutk. samalla koul.alalla (95)"
...
,d106.sama_koulutusala as "Amk-tutkinto samalla koul.alalla 1"
,d105.sama_koulutusala as "Alempi kk-tutk. samalla koul.alalla 1"
...
,d122.sama_koulutusala as "Amk-tutkinto samalla koul.alalla 2"
,d121.sama_koulutusala as "Alempi kk-tutk. samalla koul.alalla 2"
...
,d133.kylla_ei as "Tutkinto korkeampi kuin aiempi tutkinto, koulutusaste taso 1"
,d134.kylla_ei as "Tutkinto korkeampi kuin aiempi tutkinto, koulutusaste taso 2"
...
,d7ish.jarjestys_koodi as jarj_sopimusjaksot
...
,d74.jarjestys as jarj_samaopintoala02_amk
,d73.jarjestys as jarj_samaopintoala02_alempikk
...
,d90.jarjestys as jarj_samakoulutusala95_amk
,d89.jarjestys as jarj_samakoulutusala95_alempikk
...
,d106.jarjestys as jarj_samaiscbroad_amk
,d105.jarjestys as jarj_samaiscbroad_alempikk
...
,d122.jarjestys as jarj_samaiscnarrow_amk
,d121.jarjestys as jarj_samaiscnarrow_alempikk
...
,d133.jarjestys as jarj_koulutustason1_nousu
,d134.jarjestys as jarj_koulutustason2_nousu
...
,d30.koulutusala2002_koodi as "Koodit Ylemm‰n amk-tutk. koulutusala"
,d30.opintoala2002_koodi as "Koodit Ylemm‰n amk-tutk. opintoala"
,d30.koulutus_koodi as "Koodit Ylemm‰n amk-tutk. koulutusnimike"
,d33.koulutusala2002_koodi as "Koodit Ylemm‰n kk-tutk. koulutusala 02"
,d33.opintoala1995_koodi as "Koodit Ylemm‰n kk-tutk. koulutusala 95"
,d33.opintoala2002_koodi as "Koodit Ylemm‰n kk-tutk. opintoala"
,d33.koulutus_koodi as "Koodit Ylemm‰n kk-tutk. koulutusnimike"
,d36.koulutus_koodi as "Koodit L‰‰k. erikois.tutk. koulutusnimike"
...
,d30.iscfibroad2013 as "Ylemm‰n amk-tutk. koulutusala 1"
,d30.OKM_ohjauksen_ala as "Ylemm‰n amk-tutk. OKM ohjauksen ala"
,d30.iscfinarrow2013 as "Ylemm‰n amk-tutk. koulutusala 2"
,d30.iscfi2013 as "Ylemm‰n amk-tutk. koulutusala 3"
,d33.iscfibroad2013 as "Ylemm‰n kk-tutk. koulutusala 1"
,d33.OKM_ohjauksen_ala as "Ylemm‰n kk-tutk. OKM ohjauksen ala"
,d33.iscfinarrow2013 as "Ylemm‰n kk-tutk. koulutusala 2"
,d33.iscfi2013 as "Ylemm‰n kk-tutk. koulutusala 3"
,d36.iscfi2013 as "L‰‰k. erikois.tutk. koulutusala 3"
...
,d30.iscfibroad2013_koodi as "Koodit Ylemm‰n amk-tutk. koulutusala 1"
,d30.OKM_ohjauksen_ala_koodi as "Koodit Ylemm‰n amk-tutk. OKM ohjauksen ala"
,d30.iscfinarrow2013_koodi as "Koodit Ylemm‰n amk-tutk. koulutusala 2"
,d30.iscfi2013_koodi as "Koodit Ylemm‰n amk-tutk. koulutusala 3"
,d33.iscfibroad2013_koodi as "Koodit Ylemm‰n kk-tutk. koulutusala 1"
,d33.OKM_ohjauksen_ala_koodi as "Koodit Ylemm‰n kk-tutk. OKM ohjauksen ala"
,d33.iscfinarrow2013_koodi as "Koodit Ylemm‰n kk-tutk. koulutusala 2"
,d33.iscfi2013_koodi as "Koodit Ylemm‰n kk-tutk. koulutusala 3"
,d36.iscfi2013_koodi as "Koodit L‰‰k. erikois.tutk. koulutusala 3"
...
FROM dbo.f_tutkinnon_suorittaneiden_aiempi_koulutus_4_7
	...
	JOIN d_amm_sopimusjaksot d7ish ON d7ish.id = sopimusjaksot_id 
	...
	JOIN d_amm_sopimusjaksot d173ish ON d173ish.id = amm_sopimusjaksot_id 
	...
	JOIN d_kylla_ei d133 on d133.id = [koulutustason1_nousu_id]
	JOIN d_kylla_ei d134 on d134.id = [koulutustason2_nousu_id]
