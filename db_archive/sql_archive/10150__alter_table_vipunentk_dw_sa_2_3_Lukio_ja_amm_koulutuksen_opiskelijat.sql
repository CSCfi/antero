...
/****** Object:  Table [dbo].[sa_2_3_Lukio_ja_amm_koulutuksen_opiskelijat]    Script Date: 26.9.2024 10:21:29 ******/
SET ANSI_NULLS ON
GO
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sa_2_3_Lukio_ja_amm_koulutuksen_opiskelijat]') AND type in (N'U')) DROP TABLE [dbo].[sa_2_3_Lukio_ja_amm_koulutuksen_opiskelijat]
GO
...
CREATE TABLE [dbo].[sa_2_3_Lukio_ja_amm_koulutuksen_opiskelijat](
	...
	[kirika2] [nvarchar](2) NULL,
	[kirikar1] [nvarchar](2) NULL,
	[tilvika2] [nvarchar](2) NULL,
	[tilvikar1] [nvarchar](2) NULL,
	[lkm] [int] NULL,
