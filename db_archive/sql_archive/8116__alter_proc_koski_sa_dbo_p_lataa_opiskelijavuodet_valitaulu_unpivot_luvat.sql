...
/****** Object:  StoredProcedure [dbo].[p_lataa_opiskelijavuodet_valitaulu_unpivot_luvat]    Script Date: 28.9.2023 14:31:51 ******/
SET ANSI_NULLS ON
GO
	...
	case 
		when (d11.tutkintotyyppi_koodi = '02' and q.alkamispaiva >= '2018-08-01') 
			...
			or (
				...
				and (
					vuosi > 2021 
					or coalesce(sjl.ytunnus_avain, '') not in (
						'0188756-3','0773744-3','0763403-0','0108023-3','0950895-1','0112038-9','0201789-3','1524361-1','0215382-8','1041090-0'
					)
				)
			) then 1
		else 0 
