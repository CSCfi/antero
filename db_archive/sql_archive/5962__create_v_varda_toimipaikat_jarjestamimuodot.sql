...
/****** Object:  View [dw].[v_varda_toimipaikat_jarjestamismuodot]    Script Date: 1.3.2022 11.04.37 ******/
SET ANSI_NULLS ON
GO
...
CREATE or ALTER VIEW [dw].[v_varda_toimipaikat_jarjestamismuodot] AS
...
-- jm01
	  ...
	  , jd.nimi_fi as jarjestamismuoto_fi, jd.nimi_en as jarjestamismuoto_en, jd.nimi_sv as jarjestamismuoto_sv
