...
SELECT 
	...
	,coalesce(op2.maksuton, op.maksuton) as maksuton
	,coalesce(op2.oikeutta_maksuttomuuteen_pidennetty, op.oikeutta_maksuttomuuteen_pidennetty) as oikeutta_maksuttomuuteen_pidennetty
