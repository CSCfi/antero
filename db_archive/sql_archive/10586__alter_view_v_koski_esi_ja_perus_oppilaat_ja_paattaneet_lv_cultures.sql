...
/****** Object:  View [dw].[v_koski_esi_ja_perus_oppilaat_ja_paattaneet_lv_cultures]    Script Date: 19.2.2025 18.35.54 ******/
SET ANSI_NULLS ON
GO
...
--	,erityinen_maailmankatsomus_tai_kasvatusopillinen_jarjestelma_fi = coalesce(d26.selite_fi, 'Ei erityisen maailmankatsomuksen tai kasvatusopillisen järjestelmän tehtävää')
  ...
  --SV
	...
	--,erityinen_maailmankatsomus_tai_kasvatusopillinen_jarjestelma_sv = coalesce(d26.selite_sv, 'Ei erityisen maailmankatsomuksen tai kasvatusopillisen järjestelmän tehtävää')
