...
/****** Object:  StoredProcedure [dw].[p_lataa_f_indikaattorit_kk_haku_ja_valintatiedot]    Script Date: 17.4.2024 12:18:00 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dw].[p_lataa_f_indikaattorit_kk_haku_ja_valintatiedot] as
...
WHERE d3.koodi = 1 and f.pohjakoulutus_suomessa_priorisoitu = 1
