USE [ANTERO]
GO
/****** Object:  Table [dw].[f_varda_vakasuhteet_vakapaatokset]    Script Date: 15.9.2022 16:13:38 ******/
DROP TABLE IF EXISTS  [dw].[f_varda_vakasuhteet_vakapaatokset]
GO
/****** Object:  Table [dw].[f_varda_vakajarjestajat_toimipaikat]    Script Date: 15.9.2022 16:13:38 ******/
DROP TABLE IF EXISTS  [dw].[f_varda_vakajarjestajat_toimipaikat]
GO
/****** Object:  Table [dw].[f_varda_toimintapainotus]    Script Date: 15.9.2022 16:13:38 ******/
DROP TABLE IF EXISTS  [dw].[f_varda_toimintapainotus]
GO
/****** Object:  Table [dw].[f_varda_kielipainotus]    Script Date: 15.9.2022 16:13:38 ******/
DROP TABLE IF EXISTS  [dw].[f_varda_kielipainotus]
GO
/****** Object:  Table [dw].[f_varda_jarjestamismuoto]    Script Date: 15.9.2022 16:13:38 ******/
DROP TABLE IF EXISTS  [dw].[f_varda_jarjestamismuoto]
GO
/****** Object:  Table [dw].[f_varda_huoltajatiedot]    Script Date: 15.9.2022 16:13:38 ******/
