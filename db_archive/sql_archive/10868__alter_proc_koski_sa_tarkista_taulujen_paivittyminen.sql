...
/****** Object:  StoredProcedure [sa].[tarkista_taulujen_paivittyminen]    Script Date: 30.7.2025 8.54.56 ******/
SET ANSI_NULLS ON
GO
...
IF (ABS(@opiskeluoikeudetA - @opiskeluoikeudetB) / (@opiskeluoikeudetA * 1.0) >= 0.001 OR ABS(@opiskeluoikeudetA - @opiskeluoikeudetB) / (@opiskeluoikeudetB * 1.0) >= 0.001) 
