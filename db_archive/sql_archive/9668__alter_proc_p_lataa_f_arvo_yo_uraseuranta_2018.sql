...
/****** Object:  StoredProcedure [dw].[p_lataa_f_arvo_yo_uraseuranta_2018]    Script Date: 1.3.2024 11:06:00 ******/
SET ANSI_NULLS ON
GO
...
SELECT  
  ...
  LEFT JOIN dw.d_arvokysymys kysymykset on kysymykset.kysymysid=f1.kysymysnumero and (SELECT MIN(kysymysversio) FROM dw.d_arvokysymys WHERE f1.kysymysnumero = kysymysid) = kysymykset.kysymysversio 
