...
/****** Object:  View [dbo].[v_f_tab_otv_korkeakoulut_yhteiset]    Script Date: 28.8.2019 14:48:11 ******/
SET ANSI_NULLS ON
GO
...
,case
    when d21.iscfibroad2013_koodi = '01' then '101'
    when d21.iscfinarrow2013_koodi = '021' then '102'
    when d21.iscfibroad2013_koodi = '03' or d21.iscfinarrow2013_koodi in ('022','023') then '103'
    when d21.iscfibroad2013_koodi = '04' then '104'
    when d21.iscfibroad2013_koodi in ('05','08') then '105'
    when d21.iscfibroad2013_koodi in ('06','07') then '106'
    when d21.iscfi2013_koodi in ('0911','0912') then '107'
    when d21.iscfibroad2013_koodi = '10' or (d21.iscfibroad2013_koodi = '09' and d21.iscfi2013_koodi not in ('0911','0912')) then '108'
    else '998'
	end
as jarj_rahoitusala2021_yo
...
,case
    when d21.iscfibroad2013_koodi = '01' then 'Kasvatusalat'
    when d21.iscfinarrow2013_koodi = '021' then 'Taiteet ja kulttuurialat'
    when (d21.iscfibroad2013_koodi = '03' or d21.iscfinarrow2013_koodi in ('022','023')) then 'Yhteiskuntatieteet ja humanistiset alat'
    when d21.iscfibroad2013_koodi = '04' then 'Liiketalous, hallinto- ja oikeustieteet'
    when d21.iscfibroad2013_koodi in ('05','08') then 'Luonnontieteet sekä maatalous- ja metsätieteelliset alat'
    when d21.iscfibroad2013_koodi in ('06','07') then 'Tietojenkäsittely ja tietoliikenne sekä tekniikan alat'
    when d21.iscfi2013_koodi in ('0911','0912') then 'Lääketiede ja hammaslääketiede'
    when d21.iscfibroad2013_koodi = '10' or (d21.iscfibroad2013_koodi = '09' and d21.iscfi2013_koodi not in ('0911','0912')) then 'Terveys- ja hyvinvointialat sekä palvelualat'
    else 'Tuntematon'
	end
as "Rahoitusmallialat yo 2021-2024"
,d21.OKM_ohjauksen_ala_amk_tav as "Rahoitusmallialat amk 2021-2024"
--Lukumäärämuuttujat
,[Opisk2]
,[Aloit2] = case when koulutusaste2002_koodi in(62,63,71,72) then Aloit2 else 0 end
