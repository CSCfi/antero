USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_d_ytj_yritystiedot]    Script Date: 18.1.2022 13:11:21 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN ANTERO.dw.d_kalenteri d1
	ON COALESCE(try_convert(varchar,ytj.elinkeinotoimintalopetettu_pvm), '9999-12-31') = d1.kalenteri_avain
LEFT JOIN ANTERO.dw.d_kalenteri d2
	ON COALESCE(try_convert(varchar,ytj.elinkeinotoimintalopetettu_pvm), '9999-12-31') = d2.kalenteri_avain
UNION
SELECT -1
      ,'0000000-0'
	  ,'Tieto puuttuu'
