USE [Koski_SA]
GO
/****** Object:  StoredProcedure [dbo].[p_lataa_tutkinnot_ja_tutkinnonosat_valitaulu_tasot_yhdistetty_luvat]    Script Date: 10.2.2023 14:54:42 ******/
SET ANSI_NULLS ON
GO
...
--tutkinto-oikeudet
--left join ANTERO.sa.sa_amos_oiva_tutkinto_oikeudet v1 on (ca1.tilv between v1.alkupvm and coalesce(v1.siirtymapaattyy,v1.loppupvm)) and v1.jarjestajaYtunnus = ca2.jarj and d12.nimi_fi in (v1.tutkinto_nimi1, v1.tutkinto_nimi2, v1.tutkinto_nimi3, v1.tutkinto_nimi4, v1.tutkinto_nimi5)	
OUTER APPLY (
...
--muut oikeudet
--left join ANTERO.sa.v_amos_oiva_muut_oikeudet v2 on ca1.tilv between v2.alkupvm and v2.loppupvm and v2.jarjestajaYtunnus = ca2.jarj
OUTER APPLY (
	select top 1 *
...
--kielet, opetus
--LEFT JOIN ANTERO.sa.sa_amos_oiva_opetuskielet v3 ON ca1.tilv between v3.alkupvm and v3.loppupvm and v3.jarjestajaYtunnus = ca2.jarj and q.suorituskieli_koodiarvo in (v3.kieli1,v3.kieli2,v3.kieli3)
OUTER APPLY (
	select top 1 jarjestajaYtunnus
...
--kielet, tutkinto
--LEFT JOIN ANTERO.sa.sa_amos_oiva_tutkintokielet v4 ON ca1.tilv between v4.alkupvm and coalesce(v4.siirtymapaattyy,v4.loppupvm) and v4.jarjestajaYtunnus = ca2.jarj and q.suorituskieli_koodiarvo in (v4.kieli1,v4.kieli2,v4.kieli3) and v4.tutkintokoodi = d1.koulutusluokitus_koodi
OUTER APPLY (
	select top 1 jarjestajaYtunnus
