...
/****** Object:  View [dw].[v_koski_esi_ja_perus_oppilaat_ja_paattaneet_lv_cultures]    Script Date: 24.5.2023 15:35:22 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN dw.d_kytkin d38 ON d38.kytkin_koodi = coalesce(f.opiskelee_toiminta_alueittain, -1)
