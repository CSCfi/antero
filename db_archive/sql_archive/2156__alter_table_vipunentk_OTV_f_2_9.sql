USE [VipunenTK]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__tutkinnon_suoritusvuosi__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__tutkinnon_suorituslukukausi__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__syntymavuosi__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__oppilaitos__d_oppilaitoksen_taustatiedot_historia]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__oppilaitos__d_oppilaitoksen_taustatiedot]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__opintoala1995__d_koulutusluokitus_historia]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__koulutusluokitus__d_koulutusluokitus_historia]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__koulutuslaji_OKM_id]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__koulutuksen_kunta__d_alueluokitus_historia]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__koulutuksen_kunta__d_alueluokitus]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__koulutuksen_kieli__d_kieli]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__koulutuksen_jarjestaja__d_oppilaitoksen_taustatiedot_historia]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__koulutuksen_jarjestaja__d_oppilaitoksen_taustatiedot]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__kotikunta1x__d_alueluokitus_historia]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__kotikunta1x__d_alueluokitus]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__kotikunta__d_alueluokitus_historia]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__kotikunta__d_alueluokitus]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__kirjoihinvuosi_kirjoihintulovuosi_korkeakoulusektori_lasnaoleva__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__kirjoihintulovuosi_tutkinto__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__kirjoihintulovuosi_sektori_lasnaoleva__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__kirjoihintulovuosi_sektori__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__kirjoihintulovuosi_opintoala_lasnaoleva__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__kirjoihintulovuosi_opintoala__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__kirjoihintulovuosi_korkeakoulu_lasnaoleva__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__kirjoihintulovuosi_korkeakoulu__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__kirjoihintulovuosi_kirjoihintulovuosi_korkeakoulusektori__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__kirjoihintulovuosi__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__kirjoihintulokausi_tutkinto__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__kirjoihintulokausi__d_kausi]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__d_tutkinto_yo]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__d_tutkinto_amk]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__d_tilauskoulutuksen_sijaintimaa]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__d_tiedekunta_yo]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__d_suuntautumisvaihtoehto_amk]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__d_sukupuoli]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__d_rahoituslahde]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__d_opiskelumuoto]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__d_opetushallinnon_koulutus]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__d_opettajankelpoisuus]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__d_lahde]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__d_koulutustyyppi]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__d_koulutussektori]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__d_koulutusohjelma_amk]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__d_koulutuslaji_OKM]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__d_kansalaisuus_versio2]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__d_ika]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__d_aineisto_OTV]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__d_aineisto]
GO
ALTER TABLE [dbo].[f_OTV_2_9_Korkeakoulututkinnot] DROP CONSTRAINT [FK__2_9__d_aidinkieli_versio1]
GO
/****** Object:  Table [dbo].[f_OTV_2_9_Korkeakoulututkinnot]    Script Date: 12.3.2019 15:12:15 ******/
