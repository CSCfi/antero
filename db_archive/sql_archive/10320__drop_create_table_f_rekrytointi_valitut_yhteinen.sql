...
/****** Object:  Table [dw].[f_rekrytointi_valitut_yhteinen]    Script Date: 28.10.2024 13:57:28 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dw].[f_rekrytointi_valitut_yhteinen]') AND type in (N'U'))
...
CREATE TABLE [dw].[f_rekrytointi_valitut_yhteinen](
	...
	[yhdistynyt_henkilostotiedonkeruuseen] [int] NULL,
