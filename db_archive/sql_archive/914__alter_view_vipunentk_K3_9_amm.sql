...
/****** Object:  View [dbo].[v_f_aloittaneiden_lapaisy_K3_9_ammatillinen]    Script Date: 20.10.2017 14:06:24 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
		...
		(case
			when f.ophal = '1' then 'Opetushallinto, työvoimakoulutus' 
			when f.ophal = '2' and coalesce(coalesce(d13.koulutuksen_jarjestajan_korvaavakoodi,d13.koulutuksen_jarjestajakoodi),'') not in ('0145076-7','2153105-4','150622-3','0909306-3') /*'Ålands Landskapsregering','Poliisiammattikorkeakoulu','Rikosseuraamusalan Koulutuskeskus','Pelastusopisto'*/ then 'Opetushallinto, pl. työvoimakoulutus'
		...
		(case
			when f.ophal = '1' then 'Utbildningsförvaltningen, arbetskraftsutbildning' 
			when f.ophal = '2' and coalesce(coalesce(d13.koulutuksen_jarjestajan_korvaavakoodi,d13.koulutuksen_jarjestajakoodi),'') not in ('0145076-7','2153105-4','150622-3','0909306-3') /*'Ålands Landskapsregering','Poliisiammattikorkeakoulu','Rikosseuraamusalan Koulutuskeskus','Pelastusopisto'*/ then 'Utbildningsförvaltningen, exkl. arbetskraftsutbildning'
		...
		(case
			when f.ophal = '1' then 'Education administration, labour policy education and training' 
			when f.ophal = '2' and coalesce(coalesce(d13.koulutuksen_jarjestajan_korvaavakoodi,d13.koulutuksen_jarjestajakoodi),'') not in ('0145076-7','2153105-4','150622-3','0909306-3') /*'Ålands Landskapsregering','Poliisiammattikorkeakoulu','Rikosseuraamusalan Koulutuskeskus','Pelastusopisto'*/ then 'Education administration, excl. labour policy education and training'
