...
*/
	  --järjestyskentät
	  ,[Ammattiryhmä 1. taso järj (Mitenna)] = RIGHT(d1.jarjestys_ammattiryhma1,2)
      ,[Ammattiryhmä 2. taso järj (Mitenna)] = CASE RIGHT(d1.jarjestys_ammattiryhma2,5) when '010.2' then '01.02' when '020.9' then '02.09' else RIGHT(d1.jarjestys_ammattiryhma2,5) end
	  ,[Ammatti järj (Mitenna)] = RIGHT(d1.jarjestys_ammatti,5)
	  ,[Ammattiryhmä 1. taso järj] = d9.jarjestys_ammattiryhma1
      ,[Ammattiryhmä 2. taso järj] = d9.jarjestys_ammattiryhma2
	  ,[Ammatti järj] = d10.ammattiluokitus_2010_jarjestys
