...
/****** Object:  StoredProcedure [dw].[p_lataa_f_koski_amm_opiskelijat]    Script Date: 25.7.2023 12:37:10 ******/
SET ANSI_NULLS ON
GO
	...
	SELECT DISTINCT
		...
		,valmentava_koodi = 
			case
				...
				when sa.suorituksen_tyyppi = 'tuvakoulutuksensuoritus' then 3 --lähdetaulussa [tuva_jarjestamislupa] = 'ammatillinen'
			end 
		,uusi
		,uusi_rahoitus
		,sa.oppija_oid
		...
		,kotikunta_manner_suomessa = d26.mannersuomessa
		,oppivelvollinen = 
		CASE
