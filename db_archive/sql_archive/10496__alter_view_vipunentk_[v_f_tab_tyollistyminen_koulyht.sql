...
/****** Object:  View [dbo].[v_f_tab_tyollistyminen_koulyht]    Script Date: 13.1.2025 16.36.14 ******/
SET ANSI_NULLS ON
GO
...
(
	...
	WHERE o.oppilaitoskoodi <> 02557 AND o.oppilaitoskoodi <> 10031 
	  AND NOT (f2.sijoittuminen_1v_tutkinnon_jalkeen = 0 AND f2.sijoittuminen_3v_tutkinnon_jalkeen = 0 AND f2.sijoittuminen_5v_tutkinnon_jalkeen = 0) 
	  and o.oppilaitos=d9.oppilaitos
	group by o.oppilaitos
	having count(distinct o.oppilaitoskoodi)>1 and count(distinct o.oppilaitoksen_sijaintikunta)>1
) op

WHERE d9.oppilaitoskoodi <> 02557 AND d9.oppilaitoskoodi <> 10031 
AND NOT (f.sijoittuminen_1v_tutkinnon_jalkeen = 0 AND f.sijoittuminen_3v_tutkinnon_jalkeen = 0 AND f.sijoittuminen_5v_tutkinnon_jalkeen = 0)
