USE [Koski_SA]
GO
/****** Object:  StoredProcedure [dbo].[p_lataa_opiskelijavuodet_valitaulu_unpivot_luvat]    Script Date: 16.2.2023 9:32:33 ******/
SET ANSI_NULLS ON
GO
...
OUTER APPLY (
	...
	and v3.jarjestajaYtunnus = ca.jarj --and q.suorituksen_kieli in (v3.kieli1, v3.kieli2, v3.kieli3)  
) v0
--tutkinto-oikeudet
