...
/****** Object:  StoredProcedure [dw].[p_lataa_d_opettajapatevyys]    Script Date: 16.3.2022 9:55:49 ******/
SET ANSI_NULLS ON
GO
...
UPDATE d SET 
	jarjestys3_koodi = 
		case
			...
			when d.koodi = 'ER' THEN 6
			when d.koodi = 'EL' THEN 7
			when d.koodi = 'OP' THEN 8
			when d.koodi = 'IX' THEN 9
