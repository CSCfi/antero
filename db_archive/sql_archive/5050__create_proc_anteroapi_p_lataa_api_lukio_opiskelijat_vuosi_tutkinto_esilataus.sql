...
DROP PROCEDURE IF EXISTS [dw].[p_lataa_api_lukio_opiskelijat_vuosi_tutkinto_esilataus]
GO
...
CREATE PROCEDURE [dw].[p_lataa_api_lukio_opiskelijat_vuosi_tutkinto_esilataus] AS
