...
/****** Object:  StoredProcedure [dw].[p_lataa_f_haku_ja_valinta_aloituspaikat_ja_pistemaarat]    Script Date: 11.4.2024 8:05:02 ******/
SET ANSI_NULLS ON
GO
...
coalesce(d20.id,'-1') as d_ammatillinen_perustutkinto_erityisopetuksena_id,
...
left join dw.d_hakuaika d15 on d15.hakuaikaId=d1.hakuaikaId and d15b.id is null
...
left join dw.d_kytkin d20 on d20.kytkin_koodi = d12.ammatillinen_perustutkinto_erityisopetuksena
