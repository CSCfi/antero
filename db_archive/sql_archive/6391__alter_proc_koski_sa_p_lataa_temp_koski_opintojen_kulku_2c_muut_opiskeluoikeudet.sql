USE [Koski_SA]
GO
/****** Object:  StoredProcedure [sa].[p_lataa_temp_koski_opintojen_kulku_2c_muut_opiskeluoikeudet]    Script Date: 1.9.2022 15:20:52 ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT 
	...
	WHERE (
		koulutusmuoto IN ('ammatillinenkoulutus', 'diatutkinto', 'ibtutkinto', 'lukiokoulutus', 'internationalschool')  --'luva'
