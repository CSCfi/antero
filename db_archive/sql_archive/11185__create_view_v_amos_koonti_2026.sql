...
CREATE OR ALTER VIEW [dw].[v_amos_koonti_2026] AS

/*
huom. 
- vuosirajaukset optimointisyistä sisäkyselyissä (aikomuksena kuutioon vuosipartitiot)
- myös generoituSuorituskausi päivitettävä tähän tai lähdenäkymään (jossa muutenkin aineiston TK 1.13b lopullinen rakenne huomioitava)
- sijoittumistietojen laskenta suojattu kuutiossa laajemman sisällön tapauksessa lippujen avulla (ks. "--_s", apusarake_suppea_sisalto_1_0 ja apusarake_laaja_sisalto_1_0)
*/
...
FROM (  
	...
	--opiskelijavuodet
	SELECT 
		apusarake_suppea_sisalto_1_0 = 1
		,apusarake_laaja_sisalto_1_0 = 1
		,[Toteuma/Estimaatti]
	...
	SELECT
		apusarake_suppea_sisalto_1_0 = 0
		,apusarake_laaja_sisalto_1_0 = 1
		,[Toteuma/Estimaatti]
		,[Varainhoitovuosi]
		,[Rahoituskausi]
