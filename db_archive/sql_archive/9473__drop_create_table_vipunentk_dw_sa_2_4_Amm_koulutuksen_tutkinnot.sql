...
/****** Object:  Table [dbo].[sa_2_4_Amm_koulutuksen_tutkinnot]    Script Date: 10.1.2024 15:06:55 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sa_2_4_Amm_koulutuksen_tutkinnot]') AND type in (N'U'))
