...
/****** Object:  StoredProcedure [dbo].[p_lataa_f_tyollisten_ammattisiirtymat_ja_aiemmat_ammatit]    Script Date: 1.3.2024 14:21:36 ******/
SET ANSI_NULLS ON
GO
...
--      ,f.[amm2001_m1_2009]
  ...
  SELECT f.[tilastovuosi]
	...
	--uudet
	  ...
	  ,oef_toimiala_id = coalesce(d32.id, '-1')
  ...
  LEFT JOIN VipunenTK..d_oef_ammatti d30  ON d30.oef_ammatti_koodi = f.oef_ammattiryhma2_koodi
  LEFT JOIN VipunenTK..d_oef_ammatti d31  ON d31.oef_ammatti_koodi = f.oef_ammattiryhma2_siirtyman_paassa_koodi
  LEFT JOIN Vipunentk..d_oef_toimiala d32 on d32.oef_toimiala_koodi = f.oef_toimiala_avain
