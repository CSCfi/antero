...
/****** Object:  View [dw].[v_oiva_luvat_tuva_cultures]    Script Date: 2.6.2023 10:05:52 ******/
DROP VIEW IF EXISTS [dw].[v_oiva_luvat_tuva_cultures]
GO
...
CREATE VIEW [dw].[v_oiva_luvat_tuva_cultures] AS
...
SELECT
	...
	,[lupa_voimassa_sv] = d7.kytkin_sv
	,[koulutuksen_jarjestaja_sv] = d1.organisaatio_sv
	,[koulutuksen_jarjestajan_yritysmuoto_sv] = d1.koulutuksen_jarjestajan_yritysmuoto
	...
	,[lupa_voimassa_en] = d7.kytkin_en
	,[koulutuksen_jarjestaja_en] = d1.organisaatio_en
	,[koulutuksen_jarjestajan_yritysmuoto_en] = d1.koulutuksen_jarjestajan_yritysmuoto
...
LEFT JOIN dw.d_kytkin d7 on d7.id = f.d_kytkin_lupa_voimassa_id
...
WHERE d4.vuosi > 2022 OR (d4.vuosi = 2022 AND d4.kuukausi > 7)
