-- v_virta_otp_tavoiteajassa_tutkinnon_suorittaneet päivitys Rahoitusmallialat AMK ja YO seka suorituskuukausi 
USE ANTERO
GO 
...
AS
			...
			, MONTH(dateadd(S, f.[tutkinnonsuorituspvm]/1000, '1970-01-01 03:00:00'))  suorituskuukausi 
			 ...
			 , [Rahoitusmallialat YO 2021-2024] = O.Yliopistot_tutkintotavoitteet
