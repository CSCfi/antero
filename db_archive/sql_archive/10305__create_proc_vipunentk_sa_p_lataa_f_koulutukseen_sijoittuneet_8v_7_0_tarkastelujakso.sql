...
/****** Object:  StoredProcedure [dbo].[p_lataa_f_koulutukseen_sijoittuneet_8v_7_0_tarkastelujakso]    Script Date: 22.10.2024 16:51:23 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dbo].[p_lataa_f_koulutukseen_sijoittuneet_8v_7_0_tarkastelujakso] AS
...
,case
	when (l.ammopiskkoulk_1 <> '' or l.ammopiskkoulk_2 <> '' or l.ammopiskkoulk_3 <> '' or l.ammopiskkoulk_4 <> '' or
	      l.ammopiskkoulk_5 <> '' or l.ammopiskkoulk_6 <> '' or l.ammopiskkoulk_7 <> '' or l.ammopiskkoulk_8 <> '') and
...
,case
	when (l.amkopiskkoulk_1 <> '' or l.amkopiskkoulk_2 <> '' or l.amkopiskkoulk_3 <> '' or l.amkopiskkoulk_4 <> '' or
	      l.amkopiskkoulk_5 <> '' or l.amkopiskkoulk_6 <> '' or l.amkopiskkoulk_7 <> '' or l.amkopiskkoulk_8 <> '') then 1
	else 0
end as opisk_amk
--Opiskellut yliopistokoulutuksessa
,case
	when  (l.yoopiskkoulk_1 <> '' or l.yoopiskkoulk_2 <> '' or l.yoopiskkoulk_3 <> '' or l.yoopiskkoulk_4 <> '' or
	       l.yoopiskkoulk_5 <> '' or l.yoopiskkoulk_6 <> '' or l.yoopiskkoulk_7 <> '' or l.yoopiskkoulk_8 <> '') then 1
	else 0
end as opisk_yo
...
,case 
	when  monihaku_1 not in (4,5,6,7,0,8,9) and monihaku_2 not in (4,5,6,7,0,8,9) and monihaku_3 not in (4,5,6,7,0,8,9) and monihaku_4 not in (4,5,6,7,0,8,9) and
		  ...
		  (l.luopiskkoulk_1 <> '' or l.luopiskkoulk_2 <> '' or l.luopiskkoulk_3 <> '' or l.luopiskkoulk_4 <> '' or
		   l.luopiskkoulk_5 <> '' or l.luopiskkoulk_6 <> '' or l.luopiskkoulk_7 <> '' or l.luopiskkoulk_8 <> '') and
		   l.amkopiskkoulk_1 = '' and l.yoopiskkoulk_1 = '' and l.amkopiskkoulk_2 = '' and l.yoopiskkoulk_2 = '' and l.amkopiskkoulk_3 = '' and l.yoopiskkoulk_3 = '' and
		   l.amkopiskkoulk_4 = '' and l.yoopiskkoulk_4 = '' and l.amkopiskkoulk_5 = '' and l.yoopiskkoulk_5 = '' and l.amkopiskkoulk_6 = '' and l.yoopiskkoulk_6 = '' and
		   l.amkopiskkoulk_7 = '' and l.yoopiskkoulk_7 = '' and l.amkopiskkoulk_8 = '' and l.yoopiskkoulk_8 = '' then 1
	else 0
...
,case
	when (monihaku_1 in (4,8) or monihaku_2 in (4,8) or monihaku_3 in (4,8) or monihaku_4 in (4,8) or monihaku_5 in (4,8) or monihaku_6 in (4,8) or monihaku_7 in (4,8) or monihaku_8 in (4,8)) and
...
,case
	when  (monihaku_1 in (7,9) or monihaku_2 in (7,9) or monihaku_3 in (7,9) or monihaku_4 in (7,9) or monihaku_5 in (7,9) or monihaku_6 in (7,9) or monihaku_7 in (7,9) or monihaku_8 in (7,9)) and
