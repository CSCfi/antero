...
/****** Object:  View [dbo].[v_f_tab_korkeakoulujen_tutkimus_kehitys]    Script Date: 12.1.2023 23:36:39 ******/
SET ANSI_NULLS ON
GO
...
--Henkilömuuttujat
		  ...
		  ,'Tutkijanuraporras' = d_tutkijanuraporras.tutkijanuraporras
...
--Järjestykset
		  ...
		  ,jarjestys_tutkijanuraporras = d_tutkijanuraporras.jarjestys
...
--Henkilömuuttujat
		  ...
		  ,'Steg för forskarkarriären' = d_tutkijanuraporras.tutkijanuraporras_SV
--Organisaatiomuuttujat
...
--Henkilömuuttujat
		  ...
		  ,'Research career stage' = d_tutkijanuraporras.tutkijanuraporras_EN
--Organisaatiomuuttujat
...
INNER JOIN VipunenTK.[dbo].d_tutkijanuraporras			ON d_tutkijanuraporras.id = f.tutkijanuraporras_id
