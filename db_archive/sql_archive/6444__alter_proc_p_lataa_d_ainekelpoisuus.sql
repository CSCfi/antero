...
/****** Object:  StoredProcedure [dw].[p_lataa_d_ainekelpoisuus]    Script Date: 19.9.2022 18:22:00 ******/
SET ANSI_NULLS ON
GO
...
WHERE aine_fi = 'Musiikkipedagogi'
...
VALUES
('Musiikkipedagogi', '*SV', '*EN', 'Muut aineet', '*SV', '*EN', 'Musiikkipedagogi', '*SV', '*EN', getdate(), user_name(), 'ETL: p_lataa_d_ainekelpoisuus')
