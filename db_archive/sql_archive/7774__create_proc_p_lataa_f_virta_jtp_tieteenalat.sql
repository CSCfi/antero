...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_jtp_tieteenalat]    Script Date: 7.6.2023 12:20:00 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dw].[p_lataa_f_virta_jtp_tieteenalat] AS
