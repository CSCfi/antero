...
/****** Object:  View [sa].[v_sa_amos_suoritepaatos_perusrahoituksen_kohdennukset]    Script Date: 24.11.2023 17:07:10 ******/
SET ANSI_NULLS ON
GO
...
SELECT
	...
	,[Lukumäärätieto_koodi] =
		case [Lukumäärätieto]
			...
			--when 'Perusrahoitus yhteensä, €' then 9 --ei aineistossa, koodit 6 ja 8 ynnätään mittarissa
			else 99
		end
	,[arvo]
