IF NOT EXISTS (select * from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA='sa' and TABLE_NAME='sa_aipal_valtakunnallinen') BEGIN

CREATE TABLE sa.sa_aipal_valtakunnallinen(
...
ALTER TABLE sa.sa_aipal_valtakunnallinen ADD  CONSTRAINT DF__sa_aipal_valtakunnallinen__loadtime  DEFAULT (getdate()) FOR loadtime
;
ALTER TABLE sa.sa_aipal_valtakunnallinen ADD  CONSTRAINT DF__sa_aipal_valtakunnallinen__username  DEFAULT (suser_name()) FOR username
;
