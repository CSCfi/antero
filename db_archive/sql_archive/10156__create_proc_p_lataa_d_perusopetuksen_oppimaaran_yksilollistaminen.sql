...
/****** Object:  StoredProcedure [dw].[p_lataa_d_perusopetuksen_oppimaaran_yksilollistaminen]    Script Date: 26.9.2024 8:39:32 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dw].[p_lataa_d_perusopetuksen_oppimaaran_yksilollistaminen] AS
