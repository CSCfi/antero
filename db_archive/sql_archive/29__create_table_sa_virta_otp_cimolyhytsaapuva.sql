IF NOT EXISTS (select * from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA='sa' and TABLE_NAME='sa_virta_otp_cimolyhytsaapuva') BEGIN
...
ALTER TABLE sa.sa_virta_otp_cimolyhytsaapuva ADD  CONSTRAINT DF__sa_virta_otp_cimolyhytsaapuva__loadtime  DEFAULT (getdate()) FOR loadtime
;
ALTER TABLE sa.sa_virta_otp_cimolyhytsaapuva ADD  CONSTRAINT DF__sa_virta_otp_cimolyhytsaapuva__username  DEFAULT (suser_name()) FOR username
;
