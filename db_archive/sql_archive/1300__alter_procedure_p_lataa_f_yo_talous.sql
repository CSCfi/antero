USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_yo_talous]    Script Date: 8.3.2018 10:11:21 ******/
SET ANSI_NULLS ON
GO
...
(select tilik
  ...
  (varastojen_lisays_tai_vahennys
	  ...
	  where aineistotyyppi = case when (select count(*) from sa.sa_suorat_yo_talous_6_liiketoiminnan_tuloslaskelma where tilik = unpvt.tilik and aineistotyyppi = 'L' and yliop_koodi = unpvt.yliop_koodi) > 0 then 'L' else 'E' end) f
