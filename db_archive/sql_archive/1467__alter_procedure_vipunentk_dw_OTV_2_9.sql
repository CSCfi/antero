USE [VipunenTK_DW]
GO
/****** Object:  StoredProcedure [dbo].[p_lataa_OTV_f_2_9]    Script Date: 20.3.2018 17:03:19 ******/
SET ANSI_NULLS ON
GO
...
d1.aineisto_koodi=
(case
	when NOT EXISTS (SELECT 1 FROM dbo.f_2_9_Korkeakoulututkinnot o WHERE o.aineisto='L' and o.tilastointivuosi=f.tilastointivuosi) then 'E' 
	else 'L' 
end)
