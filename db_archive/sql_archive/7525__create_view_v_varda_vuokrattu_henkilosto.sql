...
/****** Object:  View [dw].[v_varda_vuokrattu_henkilosto]    Script Date: 30.3.2023 14:06:32 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER VIEW [dw].[v_varda_vuokrattu_henkilosto] AS
	...
	-- organisaatiomuuttujat
		...
		tpluok.nimi_fi as toimipaikan_luokka_fi,
		tpluok.nimi_sv as toimipaikan_luokka_sv,
		tpluok.nimi_en as toimipaikan_luokka_en,
	...
	-- järjestysmuuttujat
		...
		tpluok.jarjestys as jarjestys_toimipaikan_luokka,
