...
/****** Object:  View [dw].[v_virta_otp_kvliikkuvuus]    Script Date: 17.9.2018 10:24:48 ******/
SET ANSI_NULLS ON
GO
...
SELECT d1.organisaatio_koodi AS 'Oppilaitos Koodi'
    ...
    ,d2.ohjauksenala_koodi AS 'OKM Ohjauksen ala Koodi'
    ...
    ,d1.oppilaitostyyppi_koodi AS 'Sektori Koodi'
