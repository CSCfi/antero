IF NOT EXISTS (select * from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA='sa' and TABLE_NAME='sa_virta_otp_amkopintopiste') BEGIN

CREATE TABLE sa.sa_virta_otp_amkopintopiste(
...
ALTER TABLE sa.sa_virta_otp_amkopintopiste ADD  CONSTRAINT DF__sa_virta_otp_amkopintopiste__loadtime  DEFAULT (getdate()) FOR loadtime
;
ALTER TABLE sa.sa_virta_otp_amkopintopiste ADD  CONSTRAINT DF__sa_virta_otp_amkopintopiste__username  DEFAULT (suser_name()) FOR username
;
