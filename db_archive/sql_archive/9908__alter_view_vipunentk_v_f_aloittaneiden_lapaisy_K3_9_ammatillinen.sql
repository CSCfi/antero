...
/****** Object:  View [dbo].[v_f_aloittaneiden_lapaisy_K3_9_ammatillinen]    Script Date: 4.6.2024 14:10:46 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_f_aloittaneiden_lapaisy_K3_9_ammatillinen] AS
...
SELECT f.lkm_int AS lkm_int2,
		...
		/*
		(case
			when f.ophal = '1' then 'Opetushallinto, pl. työvoimakoulutus' 
			when f.ophal = '2' and coalesce(coalesce(d13.koulutuksen_jarjestajan_korvaavakoodi,d13.koulutuksen_jarjestajakoodi),'') not in ('0145076-7','2153105-4','150622-3','0909306-3') /*'Ålands Landskapsregering','Poliisiammattikorkeakoulu','Rikosseuraamusalan Koulutuskeskus','Pelastusopisto'*/ then 'Opetushallinto, työvoimakoulutus'
			when f.ophal = '2' then 'Muut hallinnonalat'
			else '-1'	
		end) as Hallinnonala,
		*/
		(case
			...
			--when f.ophal = '2' and coalesce(coalesce(d13.koulutuksen_jarjestajan_korvaavakoodi,d13.koulutuksen_jarjestajakoodi),'') not in ('0145076-7','2153105-4','150622-3','0909306-3') /*'Ålands Landskapsregering','Poliisiammattikorkeakoulu','Rikosseuraamusalan Koulutuskeskus','Pelastusopisto'*/ then 'Opetushallinto, työvoimakoulutus'
			when f.ophal = '2' then 'Muut hallinnonalat'
			when f.ophal = '3' then 'Opetushallinto, työvoimakoulutus'
			else 'Tuntematon'	
		end) as Hallinnonala,
		...
		f.[2g Aloittaneista alkuperäisellä koulutusalalla (2002) opiskelua jatkavat koulutusalan mukaan] AS [Opiskelee tavoitet. koulutusalalla], 		
		...
		f.[9a Aloittaneiden opintojen kulku koulutusalan, taso 1 mukaan prioriteettina mikä tahansa tutkinto] AS [Opintojen kulku koulutusaloittain, taso 1],
		f.[9b Aloittaneiden opintojen kulku koulutusalan, taso 1 mukaan prioriteettina tutkinto ja opiskelu alkuperäisellä] AS [Opintojen kulku koulutusaloittain, taso 1 prioriteetti 2], 		
		f.[9e Aloittaneista alkuperäisen koulutusalan, taso 1 tutkinnon suorittaneet koulutusalan mukaan] AS [Tutkinto tavoitet. koulutusalalla, taso 1], 		
		...
		f.[9g Aloittaneista alkuperäisellä koulutusalalla, taso 1 opiskelua jatkavat koulutusalan mukaan] AS [Opiskelee tavoitet. koulutusalalla, taso 1], 		
		...
		f.[10a Aloittaneiden opintojen kulku koulutusalan, taso 2 mukaan prioriteettina mikä tahansa tutkinto] AS [Opintojen kulku koulutusaloittain, taso 2],
		f.[10b Aloittaneiden opintojen kulku koulutusalan, taso 2 mukaan prioriteettina tutkinto ja opiskelu alkuperäisellä] AS [Opintojen kulku koulutusaloittain, taso 2 prioriteetti 2], 		
		f.[10e Aloittaneista alkuperäisen koulutusalan, taso 2 tutkinnon suorittaneet koulutusalan mukaan] AS [Tutkinto tavoitet. koulutusalalla, taso 2], 		
		...
		f.[10g Aloittaneista alkuperäisellä koulutusalalla, taso 2 opiskelua jatkavat koulutusalan mukaan] AS [Opiskelee tavoitet. koulutusalalla, taso 2], 		
		...
		f.[11a Aloittaneiden opintojen kulku koulutusalan, taso 3 mukaan prioriteettina mikä tahansa tutkinto] AS [Opintojen kulku koulutusaloittain, taso 3],
		f.[11b Aloittaneiden opintojen kulku koulutusalan, taso 3 mukaan prioriteettina tutkinto ja opiskelu alkuperäisellä] AS [Opintojen kulku koulutusaloittain, taso 3 prioriteetti 2], 		
		f.[11e Aloittaneista alkuperäisen koulutusalan, taso 3 tutkinnon suorittaneet koulutusalan mukaan] AS [Tutkinto tavoitet. koulutusalalla, taso 3], 		
		...
		f.[11g Aloittaneista alkuperäisellä koulutusalalla, taso 3 opiskelua jatkavat koulutusalan mukaan] AS [Opiskelee tavoitet. koulutusalalla, taso 3], 		
		...
		/*
		(case
			when f.ophal = '1' then 'Utbildningsförvaltningen, exkl. arbetskraftsutbildning' 
			when f.ophal = '2' and coalesce(coalesce(d13.koulutuksen_jarjestajan_korvaavakoodi,d13.koulutuksen_jarjestajakoodi),'') not in ('0145076-7','2153105-4','150622-3','0909306-3') /*'Ålands Landskapsregering','Poliisiammattikorkeakoulu','Rikosseuraamusalan Koulutuskeskus','Pelastusopisto'*/ then 'Utbildningsförvaltningen, arbetskraftsutbildning'
			when f.ophal = '2' then 'Andra förvaltningsområden'
			else '-1'	
		...
		*/
		(case
			...
			--when f.ophal = '2' and coalesce(coalesce(d13.koulutuksen_jarjestajan_korvaavakoodi,d13.koulutuksen_jarjestajakoodi),'') not in ('0145076-7','2153105-4','150622-3','0909306-3') /*'Ålands Landskapsregering','Poliisiammattikorkeakoulu','Rikosseuraamusalan Koulutuskeskus','Pelastusopisto'*/ then 'Opetushallinto, työvoimakoulutus'
			when f.ophal = '2' then 'Andra förvaltningsområden'
			when f.ophal = '3' then 'Utbildningsförvaltningen, arbetskraftsutbildning'
			else 'Okänd'	
		end) as Förvaltningsområde,
		...
		, 
		[Examen i målex. utbildn.område nivå 1] =
			case [9e Aloittaneista alkuperäisen koulutusalan, taso 1 tutkinnon suorittaneet koulutusalan mukaan]
				when 'Kyllä' then 'Ja'
				when 'Ei' then 'Inte'
				when 'Virhetilanne' then 'Information saknas'
			end	
		, 
		[Examen i målex. utbildn.område nivå 2] =
			case [10e Aloittaneista alkuperäisen koulutusalan, taso 2 tutkinnon suorittaneet koulutusalan mukaan]
				when 'Kyllä' then 'Ja'
				when 'Ei' then 'Inte'
				when 'Virhetilanne' then 'Information saknas'
			end	
		, 
		[Examen i målex. utbildn.område nivå 3] =
			case [11e Aloittaneista alkuperäisen koulutusalan, taso 3 tutkinnon suorittaneet koulutusalan mukaan]
				when 'Kyllä' then 'Ja'
				when 'Ei' then 'Inte'
				when 'Virhetilanne' then 'Information saknas'
			end	
		...
		/*
		(case
			when f.ophal = '1' then 'Education administration, excl. labour policy education and training' 
			when f.ophal = '2' and coalesce(coalesce(d13.koulutuksen_jarjestajan_korvaavakoodi,d13.koulutuksen_jarjestajakoodi),'') not in ('0145076-7','2153105-4','150622-3','0909306-3') /*'Ålands Landskapsregering','Poliisiammattikorkeakoulu','Rikosseuraamusalan Koulutuskeskus','Pelastusopisto'*/ then 'Education administration, labour policy education and training'
			when f.ophal = '2' then 'Other administrative sectors'
			else '-1'	
		...
		*/
		(case
			...
			--when f.ophal = '2' and coalesce(coalesce(d13.koulutuksen_jarjestajan_korvaavakoodi,d13.koulutuksen_jarjestajakoodi),'') not in ('0145076-7','2153105-4','150622-3','0909306-3') /*'Ålands Landskapsregering','Poliisiammattikorkeakoulu','Rikosseuraamusalan Koulutuskeskus','Pelastusopisto'*/ then 'Opetushallinto, työvoimakoulutus'
			when f.ophal = '2' then 'Other administrative sectors'
			when f.ophal = '3' then 'Education administration, labour policy education and training'
			else 'Unknown'	
		end) as 'Administrative sector',
		...
		[Completed in target subfield of ed. 02] =
		 ...
		 [Completed in target field of ed. level 1] =
			case f.[9e Aloittaneista alkuperäisen koulutusalan, taso 1 tutkinnon suorittaneet koulutusalan mukaan]
				when 'Kyllä' then 'Yes'
				when 'Ei' then 'No'
				when 'Virhetilanne' then 'Missing data'
			end, 
		 [Completed in target field of ed. level 2] =
			case f.[10e Aloittaneista alkuperäisen koulutusalan, taso 2 tutkinnon suorittaneet koulutusalan mukaan]
				when 'Kyllä' then 'Yes'
				when 'Ei' then 'No'
				when 'Virhetilanne' then 'Missing data'
			end, 
		 [Completed in target field of ed. level 3] =
			case f.[11e Aloittaneista alkuperäisen koulutusalan, taso 3 tutkinnon suorittaneet koulutusalan mukaan]
				when 'Kyllä' then 'Yes'
				when 'Ei' then 'No'
				when 'Virhetilanne' then 'Missing data'
			end, 
		...
		(case
			when f.ophal = '1' then '1' 
			when f.ophal = '2' and coalesce(coalesce(d13.koulutuksen_jarjestajan_korvaavakoodi,d13.koulutuksen_jarjestajakoodi),'') not in ('0145076-7','2153105-4','150622-3','0909306-3') /*'Ålands Landskapsregering','Poliisiammattikorkeakoulu','Rikosseuraamusalan Koulutuskeskus','Pelastusopisto'*/ then '2'
			when f.ophal = '2' then '3'
			else '-1'	
		end) AS opetushallinnon_koulutus_jarjestys, 
		...
		--isced
		,COALESCE(NULLIF(d7.iscle2011,'Tuntematon'),d7b.iscle2011) as "Tavoitetutk. koul.aste 1"
		,COALESCE(NULLIF(d7.Koulutusaste_taso2,'Tuntematon'),d7b.koulutusaste_taso2) as "Tavoitetutk. koul.aste 2"
		,COALESCE(NULLIF(d7.iscfibroad2013,'Tuntematon'),d7b.iscfibroad2013) as "Tavoitetutk. koul.ala 1"
		,COALESCE(NULLIF(d7.iscfinarrow2013,'Tuntematon'),d7b.iscfinarrow2013) as "Tavoitetutk. koul.ala 2"
		,COALESCE(NULLIF(d7.iscfi2013,'Tuntematon'),d7b.iscfi2013) as "Tavoitetutk. koul.ala 3"
		,COALESCE(NULLIF(d7.iscle2011_SV,'Information saknas'),d7b.iscle2011_sv) as "Målexamens utbildn.nivå 1"
		,COALESCE(NULLIF(d7.Koulutusaste_taso2_SV,'Information saknas'),d7b.Koulutusaste_taso2_SV) as "Målexamens utbildn.nivå 2"
		,COALESCE(NULLIF(d7.iscfibroad2013_SV,'Information saknas'),d7b.iscfibroad2013_SV) as "Målexamens utbildn.omr. 1"
		,COALESCE(NULLIF(d7.iscfinarrow2013_SV,'Information saknas'),d7b.iscfinarrow2013_SV) as "Målexamens utbildn.omr. 2"
		,COALESCE(NULLIF(d7.iscfi2013_SV,'Information saknas'),d7b.iscfi2013_SV) as "Målexamens utbildn.omr. 3"
		,COALESCE(NULLIF(d7.iscle2011_EN,'Missing data'),d7b.iscle2011_EN) as "Target level of ed. 1"
		,COALESCE(NULLIF(d7.Koulutusaste_taso2_EN,'Missing data'),d7b.Koulutusaste_taso2_EN) as "Target level of ed. 2"
		,COALESCE(NULLIF(d7.iscfibroad2013_EN,'Missing data'),d7b.iscfibroad2013_EN) as "Target field of ed. 1"
		,COALESCE(NULLIF(d7.iscfinarrow2013_EN,'Missing data'),d7b.iscfinarrow2013_EN) as "Target field of ed. 2"
		,COALESCE(NULLIF(d7.iscfi2013_EN,'Missing data'),d7b.iscfi2013_EN) as "Target field of ed. 3"
		,COALESCE(NULLIF(d7.jarjestys_iscle2011,'ööö'),d7b.jarjestys_iscle2011) as jarj_isced_koulast1
		,COALESCE(NULLIF(d7.jarjestys_Koulutusaste_taso2,'ööö'),d7b.jarjestys_Koulutusaste_taso2) as jarj_isced_koulast2
		,COALESCE(NULLIF(d7.jarjestys_iscfibroad2013,'ööö'),d7b.jarjestys_iscfibroad2013) as jarj_isced_koulala1
		,COALESCE(NULLIF(d7.jarjestys_iscfinarrow2013,'ööö'),d7b.jarjestys_iscfinarrow2013) as jarj_isced_koulala2
		,COALESCE(NULLIF(d7.jarjestys_iscfi2013,'ööö'),d7b.jarjestys_iscfi2013) as jarj_isced_koulala3
		,COALESCE(NULLIF(d7.iscle2011_koodi,'-1'),d7b.iscle2011_koodi) as "Koodit Tavoitetutk. koul.aste 1"
		,COALESCE(NULLIF(d7.Koulutusaste_taso2_koodi,'-1'),d7b.Koulutusaste_taso2_koodi) as "Koodit Tavoitetutk. koul.aste 2"
		,COALESCE(NULLIF(d7.iscfibroad2013_koodi,'-1'),d7b.iscfibroad2013_koodi) as "Koodit Tavoitetutk. koul.ala 1"
		,COALESCE(NULLIF(d7.iscfinarrow2013_koodi,'-1'),d7b.iscfinarrow2013_koodi) as "Koodit Tavoitetutk. koul.ala 2"
		,COALESCE(NULLIF(d7.iscfi2013_koodi,'-1'),d7b.iscfi2013_koodi) as "Koodit Tavoitetutk. koul.ala 3"
...
FROM  dbo.f_aloittaneiden_lapaisy f 
...
LEFT JOIN dbo.d_sukupuoli AS d16 ON d16.id = f.sp_id 
LEFT JOIN dbo.d_tarkastelujakso AS d17 ON d17.id = f.tarkastelujakso_id 
LEFT JOIN dbo.d_alueluokitus AS d3 ON d3.id = f.alueluokitus_id 
LEFT JOIN dbo.d_alueluokitus AS d4 ON d4.id = f.saavutettu_alueluokitus_id 
LEFT JOIN dbo.d_ika AS d5 ON d5.id = f.ika_id 
LEFT JOIN [ANTERO].[dw].[d_ika] as d5b on d5b.ika_avain = d5.ika
/*										
LEFT JOIN dbo.d_ika as d5b on d5b.ika_avain = case
...
LEFT JOIN dbo.d_koulutusluokitus AS d8 ON d8.id = f.saavutettu_koulk_id 
LEFT JOIN dbo.d_koulutusluokitus AS d9 ON d9.id = f.pohjkoulk_id 
LEFT JOIN dbo.d_lahde AS d10 ON d10.id = f.lahde_id 
LEFT JOIN dbo.d_opetushallinnon_koulutus AS d11 ON d11.id = f.ophal_id 
LEFT JOIN dbo.d_opiskelijan_olo AS d12 ON d12.id = f.ololk_id 
LEFT JOIN dbo.d_oppilaitoksen_taustatiedot AS d13 ON d13.id = f.oppilaitoksen_taustatiedot_id 
LEFT JOIN dbo.d_oppilaitoksen_taustatiedot AS d14 ON d14.id = f.saavutettu_oppilaitoksen_taustatiedot_id 
LEFT JOIN dbo.d_rahoituslahde AS d15 ON d15.id = f.rahlahde_id

WHERE f.aineistokoodi = 'K3.9'
	AND d10.lahde_koodi in ('31','33','34','35','36')
