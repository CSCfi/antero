...
/****** Object:  View [dbo].[v_f_K2_17_ulkomaalaistaustaiset_opisk_ja_tutk]    Script Date: 3.5.2021 20:46:10 ******/
SET ANSI_NULLS ON
GO
...
/*** johdetut mittarit ***/
	  ...
	  ,hallinnonala2 = 
			case
				when ophal=1 then '1'
				when ophal=2 and al.maakunta_koodi<>'21' and opmopa not in ('902','903','904') /*ei tarjolla järjestäjätason tietoa*/ then '2'
				when ophal=2 then '3'
				else '-1'
			end
