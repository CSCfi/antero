USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_d_koulutusluokitus]    Script Date: 7.9.2018 12:49:21 ******/
SET ANSI_NULLS ON
GO
...
USING (
  SELECT DISTINCT
    ...
    COALESCE(koulutusluokitus2016koulutusastetaso1nimi, koulutusluokitus2016koulutusastetaso1nimi_sv, koulutusluokitus2016koulutusastetaso1nimi_en, t.nimi) AS koulutusluokitus2016koulutusastetaso1nimi,
    COALESCE(koulutusluokitus2016koulutusastetaso1nimi_sv, koulutusluokitus2016koulutusastetaso1nimi, koulutusluokitus2016koulutusastetaso1nimi_en, t.nimi_sv) AS koulutusluokitus2016koulutusastetaso1nimi_sv,
    COALESCE(koulutusluokitus2016koulutusastetaso1nimi_en, koulutusluokitus2016koulutusastetaso1nimi, koulutusluokitus2016koulutusastetaso1nimi_sv, t.nimi_en) AS koulutusluokitus2016koulutusastetaso1nimi_en,
