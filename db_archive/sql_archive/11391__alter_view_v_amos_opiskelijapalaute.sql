...
/****** Object:  View [dw].[v_amos_opiskelijapalaute]    Script Date: 17.11.2025 14.15.40 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN dw.d_amos_spl_jarjestaja_linkki d1 ON d1.ytunnus_amos_spl=f.ytunnus_amos_spl
