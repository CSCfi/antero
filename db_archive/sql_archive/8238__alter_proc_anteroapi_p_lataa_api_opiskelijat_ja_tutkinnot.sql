...
/****** Object:  StoredProcedure [dw].[p_lataa_api_opiskelijat_ja_tutkinnot]    Script Date: 27.10.2023 11:57:32 ******/
SET ANSI_NULLS ON
GO
...
IF ((((	select count (*) from (
		select	[Tilastovuosi],[Aineistotyyppi],[Sektori],[Korkeakoulu],[Koulutus],[Sukupuoli],[Tutkinnot],[Opiskelijat],[Uudet opiskelijat],
				...
				[Koodi Sektori],[Koodi Korkeakoulu],[Koodi Koulutus], rahoituslahde
