...
/****** Object:  View [dbo].[_v_aloittaneiden_lapaisy_sarakeryhmat_nykytila]    Script Date: 7.5.2020 20:20:56 ******/
SET ANSI_NULLS ON
GO
...
SELECT --TOP 0
	  ...
	  ,koulutuslaji2 = (select	
		  case 
			...
			-- Muokattu caseen käsittelyt koulutusaste_taso2_koodi, tilv -> alvv (koulk 742704 välissä pois käytöstä) ja koulk 751204 (alvv < min(alkaa)) / jsyrjala 8.5.2020
			when alo.klaji = '51' and alo.koulk = '751204' then '51b'
...
-- vipunen_tk.d_koulutusluokitus d
					  where d.koulutus_koodi = alo.koulk
							and Coalesce(nullif(alo.alvv_kk,''), alo.alvv) between YEAR(d.alkaa) and YEAR(isnull(d.paattyy,'9999-01-01')))
					  when '63' then
						case
