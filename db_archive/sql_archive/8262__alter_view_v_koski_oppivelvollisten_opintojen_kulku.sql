...
/****** Object:  View [dw].[v_koski_oppivelvollisten_opintojen_kulku]    Script Date: 6.11.2023 13:20:12 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN ANTERO.dw.d_kytkin d30 on d30.kytkin_koodi = CASE WHEN d17.kytkin_koodi + d18.kytkin_koodi + d21.kytkin_koodi + d22.kytkin_koodi + d24.kytkin_koodi + d26.kytkin_koodi > 0 THEN 1 ELSE 0 END
