...
/****** Object:  View [dw].[v_koski_amm_opiskelijat_ja_tutkinnot_cultures]    Script Date: 31.8.2023 18:46:28 ******/
SET ANSI_NULLS ON
GO
...
SELECT --top 1000
	...
	,[koulutusvienti_fi] = d19z.kytkin_fi
	...
	,[oppivelvollinen_fi] = d36.kytkin_fi
	--CSCVIPUNEN-3345 16.3.2023
	...
	,[koulutusvienti_sv] = d19z.kytkin_sv
	...
	,[oppivelvollinen_sv] = d36.kytkin_sv
	--CSCVIPUNEN-3345 16.3.2023
	...
	,[koulutusvienti_en] = d19z.kytkin_en
	...
	,[oppivelvollinen_en] = d36.kytkin_en
	--CSCVIPUNEN-3345 16.3.2023
	...
	,apusarake_tutkinnon_suorittanut_todistus = null --tutkinnot_todistus
	...
	,case
		when d37.opetuskieli_koodi is null then 9999
		when d37.opetuskieli_koodi = -1 then 9999
...
LEFT JOIN dw.d_kytkin d19z ON d19z.id = f.d_kytkin_koulutusvienti_id
