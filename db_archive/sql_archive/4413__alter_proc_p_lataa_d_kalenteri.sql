USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_d_kalenteri]    Script Date: 11.2.2021 11:31:57 ******/
SET ANSI_NULLS ON
GO
...
if exists (select * from dw.d_kalenteri where id != '-1') select @date=MAX(paivays) from dw.d_kalenteri where paivays <> '9999-12-31';
