...
/****** Object:  StoredProcedure [dw].[p_lataa_d_ainekelpoisuus]    Script Date: 8.7.2022 11:04:48 ******/
SET ANSI_NULLS ON
GO
...
DROP PROCEDURE IF EXISTS [dw].[p_lataa_d_ainekelpoisuus]

GO

CREATE PROCEDURE [dw].[p_lataa_d_ainekelpoisuus]
AS
