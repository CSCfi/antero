...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[sa].[sa_arvo_kohteet_taustatiedot_jaadytetty]') AND type in (N'U'))

BEGIN

CREATE TABLE [sa].[sa_arvo_kohteet_taustatiedot_jaadytetty](
 ...
 CONSTRAINT [PK__sa_arvo_kohteet_taustatiedot_jaadytetty] PRIMARY KEY CLUSTERED 
(
	[id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]

ALTER TABLE [sa].[sa_arvo_kohteet_taustatiedot_jaadytetty] ADD  CONSTRAINT [DF_sa_arvo_kohteet_taustatiedot_jaadytetty_loadtime]  DEFAULT (getdate()) FOR [loadtime]

ALTER TABLE [sa].[sa_arvo_kohteet_taustatiedot_jaadytetty] ADD  CONSTRAINT [DF_sa_arvo_kohteet_taustatiedot_jaadytetty_username]  DEFAULT (suser_sname()) FOR [username]
