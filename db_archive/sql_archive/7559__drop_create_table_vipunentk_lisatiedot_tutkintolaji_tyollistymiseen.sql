...
/****** Object:  Table [dbo].[tutkintolaji_tyollistymiseen]    Script Date: 5.4.2023 17:02:28 ******/
...
GO
INSERT [dbo].[tutkintolaji_tyollistymiseen] ([id], [luotu], [alkaa], [paattyy], [tutkintolaji_tyollistymiseen_koodi], [tutkintolaji_tyollistymiseen], [tutkintolaji_tyollistymiseen_SV], [tutkintolaji_tyollistymiseen_EN], [jarjestys], [virhetilanne], [poistettu], [tietolahde], [kommentti]) VALUES (18, CAST(N'2023-04-05' AS Date), CAST(N'1900-01-01' AS Date), CAST(N'9999-01-01' AS Date), N'45', N'Ammatillinen perustutkinto', N'Grundläggande yrkesexamen', N'Vocational upper secondary qualification', N'04', N'E', N' ', N'CSC', N'04 ja 05 depr.')
GO
...
GO
ALTER TABLE [dbo].[tutkintolaji_tyollistymiseen] ADD  CONSTRAINT [DF__tutkintolaji_tyollistymiseen__tietolahde]  DEFAULT ('CSC') FOR [tietolahde]
GO
