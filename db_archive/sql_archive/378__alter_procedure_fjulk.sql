...
JOIN [dw].d_julkaisun_kansainvalisyys s6 ON s1.[Julkaisumaa (julkaistu Suomessa   julkaistu ulkomailla)] = s6.julkaisun_kansainvalisyys_koodi
JOIN [dw].d_tieteenala s7 ON s1.[I Tieteenala] = s7.tieteenala_koodi
;