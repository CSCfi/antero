...
/****** Object:  View [dbo].[v_sa_4_2_Vaeston_koulutusrakenne_ja_paaasiallinen_toiminta]    Script Date: 11.3.2023 0:12:08 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
      ,[aineisto] = 'P' --oli nullaantunut korjauksen yhteydessä. JS 11.3.2023
      ,[sp]
      ,[aikielir1]
	  ,(CASE WHEN [syntv] = 'BBBB' THEN '' ELSE [syntv] END) AS syntv
      ,[tilvasmaak]
