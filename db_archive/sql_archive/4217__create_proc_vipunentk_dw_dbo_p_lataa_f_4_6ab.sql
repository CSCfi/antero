...
/****** Object:  StoredProcedure [dbo].[p_lataa_f_4_6ab]    Script Date: 8.1.2021 11:08:36 ******/
SET ANSI_NULLS ON
GO
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[p_lataa_f_4_6ab]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[p_lataa_f_4_6ab] AS' 
END
GO
...
SELECT
	...
	,f.tietolahde
	,f.rivinumero
FROM [VipunenTK_SA].[dbo].[v_sa_4_6ab_Tyovoimatutkimus_tyolliset_ja_tyottomat] f
