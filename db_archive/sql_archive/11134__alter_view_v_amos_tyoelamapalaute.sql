...
/****** Object:  View [dw].[v_amos_tyoelamapalaute]    Script Date: 3.9.2025 15.42.08 ******/
SET ANSI_NULLS ON
GO
			...
			case 
				...
				when rahoituskausi_amm in ('01.07.2020 - 30.06.2021', '01.07.2021 - 30.06.2022', '01.07.2022 - 30.06.2023', '01.07.2023 - 30.06.2024') then 
					...
					case 
						...
						else 1.0 * 1/0.6 + 2.0 * (0.6 - vastausosuus)
					end
			end
			as decimal(15,14)
		)
...
LEFT JOIN dw.d_organisaatioluokitus d1 ON d1.id = q3.d_organisaatio_oppilaitos_id
...
LEFT JOIN dw.d_alueluokitus d5 ON d5.id = q3.d_alueluokitus_oppilaitos_id
