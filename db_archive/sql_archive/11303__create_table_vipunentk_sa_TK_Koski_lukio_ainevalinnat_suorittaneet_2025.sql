...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[TK_Koski_lukio_ainevalinnat_suorittaneet_2025]') AND type in (N'U'))
CREATE TABLE [dbo].[TK_Koski_lukio_ainevalinnat_suorittaneet_2025](
