...
/****** Object:  StoredProcedure [dw].[p_lataa_f_indikaattorit_kk_tavoiteaikatiedot]    Script Date: 17.4.2024 12:26:17 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE  [dw].[p_lataa_f_indikaattorit_kk_tavoiteaikatiedot] as
