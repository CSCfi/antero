...
/****** Object:  View [dw].[v_haku_ja_valinta_toinen_aste_valmistava]    Script Date: 21.8.2021 16:04:15 ******/
SET ANSI_NULLS ON
GO
...
WHERE f.koulutuksen_alkamisvuosi > 2013 and 
...
FROM dw.f_haku_ja_valinta_aloituspaikat_ja_pistemaarat f
	  ...
	  WHERE d1.korkeakouluhaku=0 and f.koulutuksen_alkamisvuosi>2013 and d1.hakuryhma_koodi = '2'
