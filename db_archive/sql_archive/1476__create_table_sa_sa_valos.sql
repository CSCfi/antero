...
IF NOT EXISTS
	...
	AND TABLE_NAME='sa_valos')
CREATE TABLE [sa].[sa_valos](
	...
	CONSTRAINT [PK__sa_valos] PRIMARY KEY CLUSTERED
(
[id] ASC
...
ALTER TABLE [sa].[sa_valos] ADD  CONSTRAINT [DF__sa_valos__loadtime]  DEFAULT (getdate()) FOR [loadtime]
GO

ALTER TABLE [sa].[sa_valos] ADD  CONSTRAINT [DF__sa_valos__username]  DEFAULT (suser_name()) FOR [username]
GO
