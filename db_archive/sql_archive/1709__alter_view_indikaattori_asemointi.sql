...
SELECT tilastovuosi as 'Tilastointivuosi'
 ...
 where d1.rahoituslahde in ('Suomen Akatemia', 'Tekes', 'EU-puiteohjelmarahoitus') and d3.organisaatio_koodi not in ('02358', '01740', '01742', '01717', '02557') 
...
SELECT d15.vuosi
 ...
 left join VipunenTK.dbo.d_tieteenala d90 on d90.tieteenala_avain=d59.tieteenala_avain
 where kyselypohja in ('KANDIPALAUTE','AVOP-AMK') and d3.oppilaitostyyppi_koodi in ('41','42') and d3.organisaatio_koodi not in ('02358', '01740', '01742', '01717', '02557') 
