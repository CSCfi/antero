...
/****** Object:  View [dw].[v_virta_otp_opettajakelpoisuudet_jaadytys]    Script Date: 4.1.2023 13:38:22 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER VIEW [dw].[v_virta_otp_opettajakelpoisuudet_jaadytys] AS
...
FROM dw.f_virta_otp_opettajakelpoisuudet_jaadytys f
