...
/****** Object:  StoredProcedure [sa].[tarkista_taulujen_paivittyminen]    Script Date: 26.5.2025 22.07.56 ******/
SET ANSI_NULLS ON
GO
...
--Vaihe 2 vasta testissä, ei viedä tuotantoon ennen kuin voidaan indeksoida osasuorituksiin opiskeluoikeus_oid, joka nyt varchar(max). JS 26.5.2025
