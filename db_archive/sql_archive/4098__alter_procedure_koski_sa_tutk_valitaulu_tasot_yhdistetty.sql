USE [Koski_SA]
GO
/****** Object:  StoredProcedure [dbo].[p_lataa_tutkinnot_ja_tutkinnonosat_valitaulu_tasot_yhdistetty]    Script Date: 5.11.2020 19:02:37 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	...
	,diaarinumero
	,tutkinto = case when paataso=1 and suorituksen_tyyppi = 'ammatillinentutkinto' then f.oppija_oid else null end
