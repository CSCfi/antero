...
USING (
  SELECT
    ...
    --oppilaitostyyppi
    coalesce(l.koodi,t.koodi) as oppilaitostyyppikoodi,
    COALESCE(l.nimi, l.nimi_sv, l.nimi_en, t.nimi) AS oppilaitostyyppinimi,
    COALESCE(l.nimi_sv, l.nimi, l.nimi_en, t.nimi_sv) AS oppilaitostyyppinimi_sv,
    COALESCE(l.nimi_en, l.nimi, l.nimi_sv, t.nimi_en) AS oppilaitostyyppinimi_en,
    s.source
