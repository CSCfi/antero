...
/****** Object:  View [sa].[v_amos_oiva_tutkinto_oikeudet]    Script Date: 28.1.2021 11:49:43 ******/
SET ANSI_NULLS ON
GO
...
WITH luvat as (
	SELECT 
		...
		,rivi_nro = row_number() over (partition by l.jarjestajaYtunnus, l.alkupvm order by m.id desc,l.paatospvm desc)
	...
	left join sa.sa_oiva_maaraykset m on m.lupaId = l._source_id and m.koodisto='koulutussektori' and m.koodiarvo='3'
