...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_opettajakelpoisuudet_jaadytys]    Script Date: 10.1.2023 13:49:17 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	' FROM (' + 
		' SELECT DISTINCT' + 
			...
			' CASE' +  
				...
				' WHEN kelpoisuuskoodi1 = ' + '''' + 'IX' + '''' + ' THEN 1' + 
				' WHEN kelpoisuuskoodi1 = ' + '''' + 'AI' + '''' + ' AND ainepatevyys is null THEN 1' + 
			' END as yksi_org,' + 
			' pvm1,' + 
			' pvm2,' + 
			' aine_pvm,' + 
	...
	' FROM (' +
		...
		' INNER JOIN ANTERO.dbo.pat_temp_3 p2 on p2.kelpoisuus in (' + '''' + 'PE' + '''' + ', ' + '''' + 'ER' + '''' + ') and p1.henkilo = p2.henkilo' +
		' WHERE (p2.kelpoisuus = ' + '''' + 'ER' + '''' + ' and p1.kelpoisuus = ' + '''' + 'VA' + '''' + ') or (p1.kelpoisuus in (' + '''' + 'AI' + '''' + ', ' + '''' + 'ER' + '''' + ', ' + '''' + 'VA' + '''' + ') and p2.kelpoisuus = ' + '''' + 'PE' + '''' + ')) p' +	
		' OUTER APPLY (' +
	...
	' OUTER APPLY (' +
		' Select' +
			' CASE' + 
				' WHEN p.kelpoisuus = ' + '''' + 'VA_PE' + '''' + ' THEN REPLACE((SUBSTRING((SELECT ' + '''' + '_' + '''' + ' + patevyyskoodi AS ' + '''' + 'data()' + '''' + ' FROM ANTERO.sa.virta_opettajapatevyys_mappaus WHERE kelpoisuuskoodi in (' + '''' + 'VA' + '''' + ',' + '''' + 'PE' + '''' + ',' + '''' + 'AI' + '''' + ',' + '''' + 'JA' + '''' + ',' + '''' + 'JB' + '''' + ',' + '''' + 'JC' + '''' + ',' + '''' + 'EL' + '''' + ') FOR XML PATH(' + '''' + '''' + ')  ), 2 , 9999)),' + '''' + ' ' + '''' + ', ' + '''' + '''' + ')' +
				' WHEN p.kelpoisuus = ' + '''' + 'AI_PE' + '''' + ' THEN REPLACE((SUBSTRING((SELECT ' + '''' + '_' + '''' + ' + patevyyskoodi AS ' + '''' + 'data()' + '''' + ' FROM ANTERO.sa.virta_opettajapatevyys_mappaus WHERE kelpoisuuskoodi in (' + '''' + 'PE' + '''' + ',' + '''' + 'AI' + '''' + ',' + '''' + 'JA' + '''' + ',' + '''' + 'JB' + '''' + ',' + '''' + 'JC' + '''' + ',' + '''' + 'EL' + '''' + ') FOR XML PATH(' + '''' + '''' + ')  ), 2 , 9999)),' + '''' + ' ' + '''' + ', ' + '''' + '''' + ')' +
				' WHEN p.kelpoisuus = ' + '''' + 'ER_PE' + '''' + ' THEN REPLACE((SUBSTRING((SELECT ' + '''' + '_' + '''' + ' + patevyyskoodi AS ' + '''' + 'data()' + '''' + ' FROM ANTERO.sa.virta_opettajapatevyys_mappaus WHERE kelpoisuuskoodi in (' + '''' + 'PE' + '''' + ',' + '''' + 'AI' + '''' + ',' + '''' + 'ER' + '''' + ',' + '''' + 'JA' + '''' + ',' + '''' + 'JB' + '''' + ',' + '''' + 'JC' + '''' + ',' + '''' + 'EL' + '''' + ') FOR XML PATH(' + '''' + '''' + ')  ), 2 , 9999)),' + '''' + ' ' + '''' + ', ' + '''' + '''' + ')' +
				...
				' WHEN p.kelpoisuus = ' + '''' + 'OP' + '''' + ' THEN REPLACE((SUBSTRING((SELECT ' + '''' + '_' + '''' + ' + patevyyskoodi AS ' + '''' + 'data()' + '''' + ' FROM ANTERO.sa.virta_opettajapatevyys_mappaus WHERE kelpoisuuskoodi in (' + '''' + 'OP' + '''' + ',' + '''' + 'AI' + '''' + ',' + '''' + 'JA' + '''' + ',' + '''' + 'JB' + '''' + ',' + '''' + 'JC' + '''' + ',' + '''' + 'EL' + '''' + ') FOR XML PATH(' + '''' + '''' + ')  ), 2 , 9999)),' + '''' + ' ' + '''' + ', ' + '''' + '''' + ')' +
				' WHEN p.kelpoisuus = ' + '''' + 'ER' + '''' + ' THEN REPLACE((SUBSTRING((SELECT ' + '''' + '_' + '''' + ' + patevyyskoodi AS ' + '''' + 'data()' + '''' + ' FROM ANTERO.sa.virta_opettajapatevyys_mappaus WHERE kelpoisuuskoodi in (' + '''' + 'ER' + '''' + ',' + '''' + 'AI' + '''' + ',' + '''' + 'JA' + '''' + ',' + '''' + 'JB' + '''' + ',' + '''' + 'JC' + '''' + ',' + '''' + 'EL' + '''' + ') FOR XML PATH(' + '''' + '''' + ')  ), 2 , 9999)),' + '''' + ' ' + '''' + ', ' + '''' + '''' + ')' +
				' WHEN p.kelpoisuus = ' + '''' + 'PE' + '''' + ' THEN REPLACE((SUBSTRING((SELECT ' + '''' + '_' + '''' + ' + patevyyskoodi AS ' + '''' + 'data()' + '''' + ' FROM ANTERO.sa.virta_opettajapatevyys_mappaus WHERE kelpoisuuskoodi in (' + '''' + 'PE' + '''' + ',' + '''' + 'AI' + '''' + ',' + '''' + 'JA' + '''' + ',' + '''' + 'JB' + '''' + ',' + '''' + 'JC' + '''' + ',' + '''' + 'EL' + '''' + ') FOR XML PATH(' + '''' + '''' + ')  ), 2 , 9999)),' + '''' + ' ' + '''' + ', ' + '''' + '''' + ')' +
				' WHEN p.kelpoisuus in(' + '''' + 'AI' + '''' + ', ' + '''' + 'PD' + '''' + ', ' + '''' + 'LA' + '''' + ') THEN REPLACE((SUBSTRING((SELECT ' + '''' + '_' + '''' + ' + patevyyskoodi AS ' + '''' + 'data()' + '''' + ' FROM ANTERO.sa.virta_opettajapatevyys_mappaus WHERE kelpoisuuskoodi in (' + '''' + 'AI' + '''' + ',' + '''' + 'JA' + '''' + ',' + '''' + 'JB' + '''' + ',' + '''' + 'JC' + '''' + ', ' + '''' + 'EL' + '''' + ') FOR XML PATH(' + '''' + '''' + ')  ), 2 , 9999)),' + '''' + ' ' + '''' + ', ' + '''' + '''' + ')' +
