...
/****** Object:  View [dbo].[v_koulutusluokitus]    Script Date: 21.2.2018 14:38:54 ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT
      [koulutusluokitus_avain] = CAST ('ISCFIBROAD'+iscfibroad2013koodi AS nvarchar (10))
	  ,tilv
      ,[alkaa]
      ,[paattyy]
	  ,[koulutuskoodi] = '-1'
...
SELECT DISTINCT
      [koulutusluokitus_avain] = CAST ('ISCFINARROW'+iscfinarrow2013koodi AS nvarchar (10))
	  ,tilv
      ,[alkaa]
      ,[paattyy]
	  ,[koulutuskoodi] = '-1'
...
SELECT DISTINCT
      [koulutusluokitus_avain] = CAST ('KASTET2'+kaste_t2koodi AS nvarchar (10))
	  ,tilv
      ,[alkaa]
      ,[paattyy]
	  ,[koulutuskoodi] = '-1'
