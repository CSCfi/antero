...
/****** Object:  View [dw].[v_kk_rahoitusmalli_amk]    Script Date: 22.3.2020 11:53:33 ******/
SET ANSI_NULLS ON
GO
...
Päivitys: 20.2.2019
Kommentoitu arvon osuus pois ja lisätty opiskelijapalautteen pisteet manuaalisesta taulusta
-JKO
******/
...
SELECT 
	  ...
	  ,NULL as 'Ammattiasema'
		...
		-- Opiskelijapalaute --
	  ,NULL as 'Opiskelijapalautepisteet'
...
SELECT 
	  ...
	  , d4.ohjauksenala_koodi as 'Koodit OKM ohjauksen ala'
	  , '-1' as 'Koodit Koulutusnimike'
	  , d3a.amk_tunnus as 'Koodit organisaatio'
	  , NULL as 'Koodit kunta'
  	  , NULL AS 'jarjestys_iscle2011'
	  , NULL AS 'jarjestys_Koulutusaste_taso2'
	  , case 
	 ...
	 left join ANTERO.dw.d_ohjauksenala as d4 on d_ohjauksenala_id = d4.id
	 left join ANTERO.dw.d_amk as d3a on d_amk_id = d3a.id
	 left join ANTERO.dw.d_organisaatioluokitus d3 on d3.organisaatio_koodi = d3a.amk_tunnus
	 left join ANTERO.dw.d_tieteenala d90 on d90.id=f.d_tieteenala_id
	 left join VipunenTK_lisatiedot.dbo.tieteenalan_TTHV d90a on 'TA10_'+d90.tieteenala_koodi=d90a.Tieteenala2010
	 left join VipunenTK.dbo.d_tieteenala d91 on d90a.TTHV=d91.tieteenala_avain
	 where d1.julkaisunpaaluokka_koodi in ('A', 'B', 'C', 'D', 'E','F','I') and f.vuosi>2010 and d3a.amk_tunnus not in ('02358', '01740', '01742', '01717')
...
--Kommentoidaan arvo pois kuutiosta ja korvataan se manuaalisesti tuotetulla tiedolla vipunentk_lisatiedot.rahoitusmalli_korkeakoulut_opiskelijapalaute
...
SELECT
	 ...
	 ,d13.vuosi as 'Tilastovuosi - rahoitusmalli'
	  ...
	  , d12.jarjestys_okmohjauksenala_koodi as 'jarj. OKM ohjauksen ala'
	  , d2.jarjestys_OKM_ohjauksen_ala_amk_tav as 'jarj. rahoitusmalliala amk'
	  , d2.jarjestys_OKM_ohjauksen_ala_yo_tav as 'jarj. rahoitusmalliala yo'
	  , d90.jarjestys_paatieteenala2010 as 'jarj. paatieteenala'
	  , d90.jarjestys_tieteenala2010 as 'jarj. tieteenala'
	 ...
	 where 1=1
	 --and d3.oppilaitostyyppi_koodi='41' 
	 and d3.organisaatio_koodi not in ('02358', '01740', '01742', '01717','02557') 
	 --and kyselypohja in ('KANDIPALAUTE','AVOP-AMK','AVOP-YAMK') 
	 and rahoitusmallikysymys='1'
	 and d13.vuosi = 2018

UNION ALL


/****** Opiskelijapalaute manuaalisesta taulusta vipunentk_lisatiedot_opiskelijapalaute ******/

SELECT
	 f.tilastovuosi AS 'Tilastovuosi'
	 ,f.tilastovuosi as 'Tilastovuosi - rahoitusmalli'
      ,f.korkeakoulu  as 'Organisaatio'
	  ,f.sektori as 'Sektori'
	  ,NULL as 'Koulutusnimike'
	  ,NULL AS  'koulutusaste2002'
	  ,NULL as 'okmohjauksenala_fi'
	  ,NULL as 'Rahoitusmalliala (AMK)'
	  ,NULL as 'Rahoitusmalliala (YO)'
	  ,NULL as 'koulutusastetaso1_fi'
	  ,NULL as 'koulutusastetaso2_fi'
	  ,NULL as 'Koulutusala, taso 1'
	  ,NULL as 'Koulutusala, taso 2'
	  ,NULL as 'Koulutusala, taso 3'
	  ,NULL as 'Päätieteenala'
	  ...
	  -- Opiskelijapalaute --
	  ,cast(f.opiskelijapalaute as varchar(10)) as 'Opiskelijapalautepisteet'
	  ...
	  ,f.korkeakoulu_koodi as 'Koodit organisaatio'
	  ,NULL as 'Koodit kunta'
...
SELECT
	  ...
	  ,f.vuosi as 'Tilastovuosi - rahoitusmalli'
      ,d6.organisaatio_fi  as 'Organisaatio'
	  ,Sektori='Ammattikorkeakoulu'
	  ,NULL as 'Koulutusnimike'
	  ...
	  ,NULL as 'Koodit Koulutusnimike'
	  ,d6a.amk_tunnus 'Koodit organisaatio'
	  ,NULL as 'Koodit kunta'
	  ,NULL as 'jarj. koulutusaste, taso 1'
	  ,NULL as 'jarj. koulutusaste, taso 2'
	  ,case 
	...
	join dw.d_amk d6a on d6a.id=f.d_amk_id
	join dw.d_organisaatioluokitus d6 on d6.organisaatio_koodi = d6a.amk_tunnus
	...
	where d5.maatjavaltiot2_fi!='Ahvenanmaa' and d6a.amk_tunnus not in ('02358', '01740', '01742', '01717')
