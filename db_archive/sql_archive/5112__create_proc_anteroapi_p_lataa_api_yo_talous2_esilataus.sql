...
DROP PROCEDURE IF EXISTS [dw].[p_lataa_api_yo_talous2_esilataus]
GO
...
CREATE PROCEDURE [dw].[p_lataa_api_yo_talous2_esilataus] AS

TRUNCATE TABLE [dw].[api_yo_talous2]

INSERT INTO [dw].[api_yo_talous2]
...
FROM Antero.dw.f_yo_talous f
	INNER JOIN Antero.dw.d_yo d1 ON f.d_yo_id = d1.id
