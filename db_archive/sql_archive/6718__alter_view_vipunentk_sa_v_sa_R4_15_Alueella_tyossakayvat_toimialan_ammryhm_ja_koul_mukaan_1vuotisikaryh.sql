...
/****** Object:  View [dbo].[v_sa_R4_15_Alueella_tyossakayvat_toimialan_ammryhm_ja_koul_mukaan_1vuotisikaryh]    Script Date: 1.12.2022 9:15:04 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
      ...
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv)
FROM [TK_H9098_CSC].[dbo].[TK_K4_15_sopv_22]
