...
/****** Object:  StoredProcedure [dw].[p_lataa_f_virta_otp_opintopiste_pvm_amk]    Script Date: 10.3.2025 9.13.20 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN dw.d_organisaatioluokitus d3 ON d3.organisaatio_koodi = sa.oppilaitostunnus
