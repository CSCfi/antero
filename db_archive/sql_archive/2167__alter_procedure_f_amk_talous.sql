USE [ANTERO]
GO
/****** Object:  StoredProcedure [dw].[p_lataa_f_amk_talous]    Script Date: 13.3.2019 16:14:21 ******/
SET ANSI_NULLS ON
GO
...
(select tilik
  ...
  (varastojen_lisays_tai_vahennys
    ...
    ,tilkauden_voitto)) as unpvt
	  where aineistotyyppi = case when (select count(*) from sa.sa_suorat_amk_talous_6_liiketoiminnan_tuloslaskelma where tilik = unpvt.tilik and aineistotyyppi = 'L' and amk_koodi = unpvt.amk_koodi) > 0 then 'L' else 'E' end) f
