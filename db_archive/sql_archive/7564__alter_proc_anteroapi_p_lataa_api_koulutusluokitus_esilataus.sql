...
/****** Object:  StoredProcedure [dw].[p_lataa_api_koulutusluokitus_esilataus]    Script Date: 6.4.2023 9:20:00 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dw].[p_lataa_api_koulutusluokitus_esilataus] AS
...
,REPLACE(koulutusluokitus_fi, ';', ',') as koulutusluokitus_fi
,REPLACE(koulutusluokitus_sv, ';', ',') as koulutusluokitus_sv
,REPLACE(koulutusluokitus_en, ';', ',') as koulutusluokitus_en
...
FROM ANTERO.dw.d_koulutusluokitus f
