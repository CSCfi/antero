...
/****** Object:  View [dbo].[v_sa_5_2_Yliopistojen_tutkimustyovuodet_yliopistoittain]    Script Date: 12.1.2023 22:03:19 ******/
SET ANSI_NULLS ON
GO
...
SELECT [tilv]
      ...
      ,[rivinumero] = ROW_NUMBER() OVER(ORDER BY tilv) --select distinct tuturap
