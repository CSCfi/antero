...
/****** Object:  StoredProcedure [dw].[p_lataa_f_amk_keksintoilmoitukset_tieteenalat]    Script Date: 7.6.2023 12:19:20 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dw].[p_lataa_f_amk_keksintoilmoitukset_tieteenalat]
AS
...
SELECT * INTO #temp_julkaisut FROM (
	...
	FROM (
		SELECT  
			...
			CONCAT('AMK3B_H2_', ROW_NUMBER() OVER(ORDER BY Vuosi ASC)) as julkaisunTunnus
		FROM [ANTERO].[sa].[sa_suorat_amk3b_julkaisut_keksintoilmoitukset] s1
...
TRUNCATE TABLE dw.[f_amk_keksintoilmoitukset_tieteenalat];

INSERT INTO dw.[f_amk_keksintoilmoitukset_tieteenalat] (
	 [tilastovuosi]
...
SELECT
	...
	t2.d_tieteenala_id,
	t.julkaisunTunnus,
	'etl: p_lataa_f_amk_keksintoilmoitukset_tieteenalat'
