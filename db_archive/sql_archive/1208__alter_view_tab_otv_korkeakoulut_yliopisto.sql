...
/****** Object:  View [dbo].[v_f_tab_otv_korkeakoulut_yliopisto]    Script Date: 31.1.2018 15:04:51 ******/
SET ANSI_NULLS ON
GO
...
--Lukumäärämuuttujat
,[Opisk2]
,[Aloit2] = case when koulutusaste2002_koodi in(63,72) then Aloit2 else 0 end
