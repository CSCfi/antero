USE [Koski_SA]
GO
/****** Object:  Table [sa].[temp_tutkinnot_ja_tutkinnonosat_aikajaksot]    Script Date: 23.10.2019 17:52:39 ******/
SET ANSI_NULLS ON
GO
...
END
GO
/****** Object:  Table [sa].[temp_tutkinnot_ja_tutkinnonosat_liputa_ei_vos_rahoitettu_koulutus]    Script Date: 23.10.2019 17:52:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [sa].[temp_tutkinnot_ja_tutkinnonosat_osasuoritus_pl_eivos]    Script Date: 23.10.2019 17:52:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [sa].[temp_tutkinnot_ja_tutkinnonosat_paatason_suoritukset]    Script Date: 23.10.2019 17:52:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE TABLE [sa].[temp_tutkinnot_ja_tutkinnonosat_paatason_suoritukset](
	...
	[paatason_suoritus_id] [bigint] NULL,
	[tutkinto_koodi] [varchar](250) NULL,
	...
	[vahvistus_paiva] [datetime] NULL,
	[vahvistus_paiva_on] [int] NOT NULL,
	[vahvistus_paiva_kohdevuonna] [int] NOT NULL
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
END
GO
/****** Object:  Table [sa].[temp_tutkinnot_ja_tutkinnonosat_tutkinnon_osien_suoritukset]    Script Date: 23.10.2019 17:52:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
