...
/****** Läpäisy ******/
 SELECT
      ...
      ,[tutkinnot] = NULL
	  ,case when tarkastelujakso='7,5' and (d6.koulutuslaji2_koodi='51b' OR (d2.koulutus_koodi in (612101, 613101,613401) OR d2.koulutus_koodi=672401)) then 1 else 0 end AS 'YO_7v_aloittaneet_lkm'
	  ,case when tarkastelujakso='5,5' AND d2.koulutusaste2002_koodi=62 then 1 else 0 end AS 'AMK_5v_Aloittaneet_lkm'
	  ,case when tarkastelujakso='7,5' and (d6.koulutuslaji2_koodi='51b' OR (d2.koulutus_koodi in (612101, 613101,613401) OR d2.koulutus_koodi=672401)) and [1a Aloittaneiden opintojen kulku koulutuslajin mukaan prioriteettina mikä tahansa tutkinto]='Tutkinto alkuperäisessä tutkintolajissa' then 1 else 0 end AS '7v_suorittaneet_lkm'
	  ,case when tarkastelujakso='5,5' AND d2.koulutusaste2002_koodi=62 and [1a Aloittaneiden opintojen kulku koulutuslajin mukaan prioriteettina mikä tahansa tutkinto]='Tutkinto alkuperäisessä tutkintolajissa' then 1 else 0 end AS '5v_suorittaneet_lkm'
	  ,NULL --lasna
	  ,NULL --suorittanut55
...
OR (tarkastelujakso= '7,5' and  koulutussektori= 'Yiopistokoulutus' and (d6.koulutuslaji2_koodi='51b' OR (d2.koulutus_koodi in (612101, 613101,613401) OR d2.koulutus_koodi=672401)))) 
