...
/****** Object:  StoredProcedure [dw].[p_lataa_api_opiskelijat_ja_tutkinnot]    Script Date: 31.10.2024 7:54:37 ******/
SET ANSI_NULLS ON
GO
...
IF ((((	select count (*) from (
		select	[Tilastovuosi],[Aineistotyyppi],[Sektori],[Korkeakoulu],[Koulutus],[Sukupuoli],[Tutkinnot],[Opiskelijat],[opiskelijatFte],[Uudet opiskelijat],
				...
				[Koodi Sektori],[Koodi Korkeakoulu],[Koodi Koulutus], rahoituslahde, kirjoillaolo_tammi, kirjoillaolo_syys
