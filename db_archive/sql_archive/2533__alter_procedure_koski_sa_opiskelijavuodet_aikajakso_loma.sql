USE [Koski_SA]
GO
/****** Object:  StoredProcedure [sa].[p_lataa_opiskelijavuodet_opiskeluoikeus_aikajakso_loma]    Script Date: 18.10.2019 16:03:45 ******/
SET ANSI_NULLS ON
GO
...
WITH ed_jaksot AS (
	...
	INNER JOIN Koski_SA.sa.temp_opiskelijavuodet_opiskeluoikeus_oidit ooo ON ooo.opiskeluoikeus_oid = ooa.opiskeluoikeus_oid
)
