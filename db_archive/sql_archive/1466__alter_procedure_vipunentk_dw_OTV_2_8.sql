USE [VipunenTK_DW]
GO
/****** Object:  StoredProcedure [dbo].[p_lataa_OTV_f_2_8]    Script Date: 20.3.2018 17:02:48 ******/
SET ANSI_NULLS ON
GO
...
(case
	 ...
	 when f.tilastointivuosi = (select max(tilastointivuosi) from VipunenTK_DW.dbo.f_2_8_Korkeakouluopiskelijat) and f.aineisto <> 'L' then 'E' 
	 else 'L' 
	 end	
)
