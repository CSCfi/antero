-- replace suorittanut55: drop view made from dw.v_virta_otp_55_tilanne and create with view made from dw.v_virta_otp_55_suppea

-- copy from: dw.v_virta_otp_55_suppea
