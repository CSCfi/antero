...
/****** Object:  StoredProcedure [sa].[p_lataa_lukio_paatason_suoritus]    Script Date: 31.7.2023 16:21:36 ******/
SET ANSI_NULLS ON
GO
...
(
	...
	(
		...
		WHERE (
			ps.suorituksen_tyyppi IN ('ibtutkinto', 'ebtutkinto', 'europeanschoolofhelsinkivuosiluokkasecondaryupper', 'preiboppimaara', 'lukionoppiaineenoppimaara', 'lukionaineopinnot', 'lukionoppimaara', 'diatutkintovaihe', 'diavalmistavavaihe', 'luva', 'internationalschooldiplomavuosiluokka')
