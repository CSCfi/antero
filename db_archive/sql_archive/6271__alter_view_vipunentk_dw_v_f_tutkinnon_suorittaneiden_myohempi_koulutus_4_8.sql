...
/****** Object:  View [dbo].[v_f_tutkinnon_suorittaneiden_myohempi_koulutus_4_8]    Script Date: 23.6.2022 4:16:25 ******/
SET ANSI_NULLS ON
GO
...
*/
    ...
    Select 
	  ...
	  ,[luulkom] = Case when lu_ika <= jaksovuosi then luulkom else 'X' end --ulkom-arvot 1/0/null, erotellaan tiedon puuttuminen suorituksen puuttumisesta
	  ...
	  ,[ammulkom] = Case when amm_ika <= jaksovuosi then ammulkom else 'X' end
	  ...
	  ,[opistulkom] = Case when opist_ika <= jaksovuosi then opistulkom else 'X' end
	  ...
	  ,[ammkaulkom] = Case when ammka_ika <= jaksovuosi then ammkaulkom else 'X' end
	  ...
	  ,[amkulkom] = Case when amk_ika <= jaksovuosi then amkulkom else 'X' end
	  ...
	  ,[akkulkom] = Case when akk_ika <= jaksovuosi then akkulkom else 'X' end
	  ...
	  ,[ylamkulkom] = Case when ylamk_ika <= jaksovuosi then ylamkulkom else 'X' end
	  ...
	  ,[ykkulkom] = Case when ykk_ika <= jaksovuosi then ykkulkom else 'X' end
	  ...
	  ,[laakerulkom] = Case when laaker_ika <= jaksovuosi then laakerulkom else 'X' end
	  ...
	  ,[lisulkom] = Case when lis_ika <= jaksovuosi then lisulkom else 'X' end
	  ...
	  ,[tohtulkom] = Case when toht_ika <= jaksovuosi then tohtulkom else 'X' end
