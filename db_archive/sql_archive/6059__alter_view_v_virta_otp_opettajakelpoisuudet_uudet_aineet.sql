...
/****** Object:  View [dw].[v_virta_otp_opettajakelpoisuudet_uudet_aineet]    Script Date: 24.3.2022 10:11:16 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dw].[v_virta_otp_opettajakelpoisuudet_uudet_aineet] AS
...
SELECT		
	...
	,[5 kelpoisuutta] =
		...
		END
	,[Ainekelpoisuuksien määrä] = f.ainekelpoisuuksien_maara
...
JOIN dw.d_kytkin d7 on d7.kytkin_koodi = d3a.ammatillinen_opettajakoulutus
...
JOIN dw.d_kytkin d16 on d16.kytkin_koodi = d3a.ammatillinen_erityisopettajakoulutus
JOIN dw.d_kytkin d17 on d17.kytkin_koodi = d3a.ammatillinen_opinto_ohjaajakoulutus
JOIN dw.d_kytkin d18 on d18.kytkin_koodi = d3a.ruotsinkielinen_ammatillinen_opettajankoulutus
...
WHERE f.patevyys_ryhma = 'opettajaaineet'
