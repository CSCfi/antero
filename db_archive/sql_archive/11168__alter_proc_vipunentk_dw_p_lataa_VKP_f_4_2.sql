...
/****** Object:  StoredProcedure [dbo].[p_lataa_VKP_f_4_2]    Script Date: 5.9.2025 15.38.35 ******/
SET ANSI_NULLS ON
GO
...
SELECT
	...
	,d_kylla_ei_koulutusluokitus_korkein_viimeisin_aloitettu_sama_ka_id = coalesce(d25a.id,-1)
	,d_kylla_ei_koulutusluokitus_korkein_viimeisin_aloitettu_sama_ta_id = coalesce(d25b.id,-1)
...
LEFT JOIN VipunenTK..d_kylla_ei AS d25a ON d25a.kylla_ei_koodi=f.koulutusluokitus_korkein_viimeisin_aloitettu_sama_ka
LEFT JOIN VipunenTK..d_kylla_ei AS d25b ON d25b.kylla_ei_koodi=f.koulutusluokitus_korkein_viimeisin_aloitettu_sama_ta
