...
/****** Object:  View [dw].[v_st_rekrytointi_hakijat_ja_valitut]    Script Date: 30.1.2025 8.37.20 ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT
	...
	case when d17.maatjavaltiot2_koodi not in ('-1','246') and d16.organisaatio_koodi = '-1' then 1 else 0 end as tohtori_ulk_yo,
	...
	case when f.tunnus_sektori = 'yo' and d19.organisaatio_nykyinen_koodi = '-1' and yhdistynyt_henkilostotiedonkeruuseen = 1 then 1 else 0 end as ykk_ei_suomi,
